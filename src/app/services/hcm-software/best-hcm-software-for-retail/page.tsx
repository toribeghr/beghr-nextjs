...
export const metadata: Metadata = {
  ...
  description: 'What to look for in retail HCM software in 2026, the hourly, seasonal, and multi-store challenges retailers face, and why isolved plus BEG is a strong',
  ...
  twitter: { card: 'summary_large_image', title: 'Best HCM Software for Retail | Instant Price Quote | BEG', description: 'What to look for in retail HCM software in 2026, the hourly, seasonal, and multi-store challenges retailers face, and why isolved plus BEG is a strong', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Best HCM Software for Retail', item: 'https://www.beghr.com/services/hcm-software/best-hcm-software-for-retail' },
  ],
};
