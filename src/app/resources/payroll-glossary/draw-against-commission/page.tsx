...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/draw-against-commission' },
  openGraph: {
    title: 'Draw Against Commission | Payroll Glossary | BEG',
    description: 'Learn how draw-against-commission works, the difference between recoverable and non-recoverable draws, and FLSA minimum wage implications.',
    url: 'https://beghr.com/resources/payroll-glossary/draw-against-commission',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/draw-against-commission', url: 'https://beghr.com/resources/payroll-glossary/draw-against-commission', name: 'Draw Against Commission | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Draw Against Commission', description: 'Learn how draw-against-commission works, the difference between recoverable and non-recoverable draws, and FLSA minimum wage implications.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Draw Against Commission', item: 'https://beghr.com/resources/payroll-glossary/draw-against-commission' },
            ]},
          ]
        }) }} />
      </section>
