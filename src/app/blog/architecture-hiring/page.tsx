...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/architecture-hiring' },
  openGraph: {
    title: 'Architecture Hiring | BEG Blog',
    description: 'Architecture talent shortage trends, project architect and BIM manager hiring, and design comp insights for firm leaders who need to fill roles fast.',
    url: 'https://beghr.com/blog/architecture-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Architecture Hiring | BEG Blog', description: 'Architecture talent shortage trends, project architect and BIM manager hiring, and design comp insights for firm leaders who need to fill roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Architecture Hiring', item: 'https://beghr.com/blog/architecture-hiring' },
            ],
          }),
        }}
      />
