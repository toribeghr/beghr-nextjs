...
export const metadata: Metadata = {
  title: 'Engineering Recruiters in Atlanta | BEG',
  description: 'Engineering placement in Atlanta. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/engineering/atlanta' },
  openGraph: { title: 'Engineering Recruiters in Atlanta | BEG', description: 'Engineering placement in Atlanta in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/engineering/atlanta', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Engineering Recruiters in Atlanta | BEG', description: 'Engineering placement in Atlanta in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-engineering-atlanta');

export default function PlacementEngineeringAtlantaPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Atlanta"
      title="That open engineering role in Atlanta is costing you every week."
      description="Atlanta is a corporate-headquarters and logistics hub where finance, tech, and legal talent is heavily recruited. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Atlanta? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Atlanta</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Atlanta?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Atlanta and across Georgia, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
