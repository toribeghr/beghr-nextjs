...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/trades/long-beach' },
  openGraph: { title: 'Skilled Trades Recruiters in Long Beach | BEG', description: 'Skilled Trades placement in Long Beach in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/trades/long-beach', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Skilled Trades Recruiters in Long Beach | BEG', description: 'Skilled Trades placement in Long Beach in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementTradesLongbeachPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Skilled Trades placement\",\"name\":\"Skilled Trades Placement in Long Beach\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Long Beach\"},\"url\":\"https://beghr.com/services/job-placement/trades/long-beach\",\"description\":\"Permanent skilled trades placement in Long Beach in 23-35 days at roughly 50% less than contingency.\"}" }} />
