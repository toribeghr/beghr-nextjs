...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-home-health-managed-payroll-vs-in-house.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Home Health Payroll, Managed vs In-House Costs | BEG', description: 'Home health agency payroll outsourcing vs. hiring in-house. Real cost comparison for agencies with 15-150 staff. Travel time compensation, EVV complianc...', images: ['https://www.beghr.com/blog-images/blog-payroll-home-health-managed-payroll-vs-in-house.webp'] },
  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-payroll-home-health-managed-payroll-vs-in-house.webp", "headline": "Home Health Payroll | Managed vs. In-House. $25-$45 PEPM. | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/home-health/managed-payroll-vs-in-house"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-home-health-managed-payroll-vs-in-house.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Managed Payroll vs. In-House for Home Health Agencies', item: 'https://www.beghr.com/blog/payroll/home-health/managed-payroll-vs-in-house' },
            ],
          }),
        }}
      />
