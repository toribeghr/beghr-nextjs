  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-technology-technology-payroll-features-needed.webp" alt={`A modern tech office, software team collaborating at workstations`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
