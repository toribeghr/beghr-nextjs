...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/healthcare/oakland' },
  openGraph: { title: 'Healthcare Recruiters in Oakland | BEG', description: 'Healthcare placement in Oakland in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/healthcare/oakland', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Healthcare Recruiters in Oakland | BEG', description: 'Healthcare placement in Oakland in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
