...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/voluntary-withholding' },
  openGraph: {
    title: 'Voluntary Withholding | Payroll Glossary | BEG',
    description: 'Employee-authorized payroll deductions beyond required taxes -- includes benefits, retirement, and extra federal withholding.',
    url: 'https://beghr.com/resources/payroll-glossary/voluntary-withholding',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Voluntary Withholding | Payroll Glossary | BEG', description: 'Employee-authorized payroll deductions beyond required taxes -- includes benefits, retirement, and extra federal withholding.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/voluntary-withholding', url: 'https://beghr.com/resources/payroll-glossary/voluntary-withholding', name: 'Voluntary Withholding | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Voluntary Withholding', description: 'Employee-authorized payroll deductions beyond required taxes -- includes benefits, retirement, and extra federal withholding.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Voluntary Withholding', item: 'https://beghr.com/resources/payroll-glossary/voluntary-withholding' },
            ]},
          ]
        }) }} />
      </section>
