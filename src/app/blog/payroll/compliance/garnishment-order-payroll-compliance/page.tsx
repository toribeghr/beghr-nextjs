...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Wage Garnishment Orders: What Employers Must Do | BEG', description: 'Wage Garnishment Orders: Employer Compliance Guide. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
