...
export const metadata: Metadata = {
  title: 'Shift Differential Payroll | Senior Care Guide | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/senior-care/senior-care-shift-differential-payroll' },
  openGraph: {
    title: 'Shift Differential Payroll | Senior Care Guide | BEG',
    description: 'How to handle shift differential payroll in senior care: night shift premiums, regular rate overtime calculation, holiday pay, and common compliance errors.',
    url: 'https://beghr.com/blog/payroll/senior-care/senior-care-shift-differential-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Shift Differential Payroll | Senior Care Guide | BEG', description: 'How to handle shift differential payroll in senior care facilities. Regular rate overtime and compliance.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Shift Differential Payroll', item: 'https://beghr.com/blog/payroll/senior-care/senior-care-shift-differential-payroll' },
        ]
      }) }} />
    </article>
  );
