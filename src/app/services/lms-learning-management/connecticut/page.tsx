...
export const metadata: Metadata = {
  title: 'Connecticut Employee Training Compliance | LMS by BEG',
  description: 'Employee training and harassment-prevention compliance for Connecticut employers. isolved Learn & Grow, configured by BEG: assign, track, and prove trainin',
  alternates: { canonical: 'https://www.beghr.com/services/lms-learning-management/connecticut' },
  openGraph: { title: 'Connecticut Employee Training Compliance | LMS by BEG', description: 'Assign, track, and prove employee training for Connecticut employers with isolved Learn & Grow, configured by BEG.', url: 'https://www.beghr.com/services/lms-learning-management/connecticut', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Connecticut Employee Training Compliance | LMS by BEG', description: 'Assign, track, and prove employee training for Connecticut employers with isolved Learn & Grow.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('lms-connecticut');
...
export default function LmsStateConnecticutPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context':'https://schema.org','@type':'Article', headline:'Connecticut requires harassment-prevention training. Track it and prove it in one system.', description:'Employee training compliance for Connecticut employers with isolved Learn & Grow.', author:{ '@type':'Organization', name:'Business Executive Group', url:'https://www.beghr.com' }, publisher:{ '@type':'Organization', name:'Business Executive Group' }, datePublished:'2026-07-06', mainEntityOfPage:'https://www.beghr.com/services/lms-learning-management/connecticut' }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context':'https://schema.org','@type':'BreadcrumbList', itemListElement:[ { '@type':'ListItem', position:1, name:'Home', item:'https://www.beghr.com' }, { '@type':'ListItem', position:2, name:'Learning Management System', item:'https://www.beghr.com/services/lms-learning-management' }, { '@type':'ListItem', position:3, name:'Connecticut', item:'https://www.beghr.com/services/lms-learning-management/connecticut' } ] }) }} />
      ...
      <ServicePage
        showHeroImage={false}
        eyebrow="Learning Management · Connecticut"
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Connecticut Training Requirements</p>
              <h2>Where employee-training compliance stands in Connecticut</h2>
            </div>
            <div className="reveal" style={{ overflowX: 'auto', marginTop: '2rem' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.95rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                ...
                <tr>
                  ...
                  <td style={{ padding: '0.7rem 1rem', borderBottom: '1px solid #eee', color: '#444444' }}>Employers with 3 or more employees must provide 2 hours of sexual-harassment-prevention training to all employees within 6 months of hire, with supplemental training at least every 10 years. (Time’s Up Act (Public Acts 19-16 and 19-93))</td>
                </tr>
                <tr>
            ...
            <p className="reveal" style={{ fontSize: '0.82rem', color: '#888888', marginTop: '1rem', textAlign: 'center' }}>Sources: <a href="https://portal.ct.gov/chro/sexual-harassment-prevention-training/pages/sexual-harassment-prevention-resources" target="_blank" rel="noopener noreferrer">Connecticut harassment-training guidance</a>, <a href="https://en.wikipedia.org/wiki/Learning_management_system" target="_blank" rel="noopener noreferrer">Learning management system, overview</a>.</p>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '980px' }}>
            <div className="head center reveal">
              ...
              <h2>Assign, track, and prove Connecticut training in one system</h2>
            </div>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Employee training in Connecticut, answered</h2>
            </div>
