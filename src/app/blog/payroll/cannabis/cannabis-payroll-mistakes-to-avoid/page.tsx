...
export const metadata: Metadata = {
  title: 'Cannabis Payroll: Mistakes to Avoid | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Cannabis Payroll: Mistakes to Avoid | BEG', description: 'Managed payroll for cannabis. Payroll Mistakes to Avoid. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
