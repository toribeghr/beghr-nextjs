...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/brewery/outsource-brewery-payroll" },
  openGraph: {
    title: "Outsource Brewery Payroll | Taproom to Production | BEG",
    description: "Why breweries and distilleries outsource payroll, what to look for in a provider, and what changes immediately. BEG managed payroll at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/brewery/outsource-brewery-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Outsource Brewery Payroll | Taproom to Production | BEG", description: "Why craft breweries outsource payroll and what changes immediately after making the switch.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Outsource Brewery Payroll", "item": "https://beghr.com/blog/payroll/brewery/outsource-brewery-payroll" }
        ]
      }) }} />
    </article>
  );
