...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/year-end-payroll' },
  openGraph: {
    title: 'Year-End Payroll | Payroll Glossary | BEG',
    description: 'Annual payroll close process including W-2 production, tax reconciliation, and FUTA true-up -- all due by January 31.',
    url: 'https://beghr.com/resources/payroll-glossary/year-end-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Year-End Payroll | Payroll Glossary | BEG', description: 'Annual payroll close process including W-2 production, tax reconciliation, and FUTA true-up -- all due by January 31.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/year-end-payroll', url: 'https://beghr.com/resources/payroll-glossary/year-end-payroll', name: 'Year-End Payroll | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Year-End Payroll', description: 'Annual payroll close process including W-2 production, tax reconciliation, and FUTA true-up -- all due by January 31.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Year-End Payroll', item: 'https://beghr.com/resources/payroll-glossary/year-end-payroll' },
            ]},
          ]
        }) }} />
      </section>
