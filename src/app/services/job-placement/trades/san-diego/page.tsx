...
export default function PlacementTradesSandiegoPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Skilled Trades placement\",\"name\":\"Skilled Trades Placement in San Diego\",\"areaServed\":{\"@type\":\"City\",\"name\":\"San Diego\"},\"url\":\"https://beghr.com/services/job-placement/trades/san-diego\",\"description\":\"Permanent skilled trades placement in San Diego in 23-35 days at roughly 50% less than contingency.\"}" }} />
