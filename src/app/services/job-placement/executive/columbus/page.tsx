...
export const metadata: Metadata = {
  title: 'Executive Recruiters in Columbus | BEG',
  description: 'Executive placement in Columbus. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/executive/columbus' },
  openGraph: { title: 'Executive Recruiters in Columbus | BEG', description: 'Executive placement in Columbus in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/executive/columbus', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Executive Recruiters in Columbus | BEG', description: 'Executive placement in Columbus in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-executive-columbus');

export default function PlacementExecutiveColumbusPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Executive · Columbus"
      title="That open executive role in Columbus is costing you every week."
      description="Columbus is an insurance, finance, and logistics center where mid-market employers compete for the same talent. We source passive executive candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Executive roles in Columbus stay open because the best candidates are passive and rarely on job boards.</li>
              <li>BEG sources executive talent in Columbus directly and fills permanent roles in 23-35 days.</li>
              <li>Milestone billing costs roughly 50% less than contingency, with a 45-day replacement guarantee.</li>
            </ul>
          </aside>
        </div>
      </section>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Executive placement\",\"name\":\"Executive Placement in Columbus\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Columbus\"},\"url\":\"https://www.beghr.com/services/job-placement/executive/columbus\",\"description\":\"Permanent executive placement in Columbus in 23-35 days at roughly 50% less than contingency.\"}" }} />

      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            <p className="eyebrow">The Columbus Talent Market</p>
            <h2>Why executive roles are hard to fill in Columbus</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Columbus sits in the Midwest and is an insurance, finance, and logistics center where mid-market employers compete for the same talent. The strongest executive candidates here are already employed and are contacted constantly, which means a job posting reaches the people who are easiest to find, not the ones you actually want. We reach the passive executive talent in Columbus and the surrounding OH market directly, before they ever see a listing.
          </p>
        </div>
      </section>
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Executive in Columbus? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Executive placement near Columbus</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place executive candidates in Columbus?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent executive searches in Columbus and across Ohio, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
