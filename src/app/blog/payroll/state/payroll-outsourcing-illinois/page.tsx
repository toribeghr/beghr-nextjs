...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Payroll Outsourcing in Illinois: An Employer Guide | BEG',
    description: 'Payroll Outsourcing in Illinois: Employer Guide. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.',
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        ...
        <p>BEG serves businesses nationally, including Illinois. All Illinois state filings are included in the base PEPM fee. No per-state add-ons.</p>
