...
export const metadata: Metadata = {
  title: 'Sales Interview Questions That Reveal Real Quota Attainment and Methodology | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Sales Interview Questions That Reveal Real Quota Attainment and Methodology | BEG', description: 'Sales interviews that go beyond the pitch. The questions that reveal quota attainment history, pipeline discipline, and whether a candidate can sell in your specific environment.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/sales-hiring/sales-interview-questions');
