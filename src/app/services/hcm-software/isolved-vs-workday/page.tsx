...
export const metadata: Metadata = {
  title: 'iSolved vs Workday | One Platform + Claude AI | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/isolved-vs-workday' },
  openGraph: {
    title: 'iSolved vs Workday | One Platform + Claude AI | BEG',
    description: 'iSolved vs Workday compared across platform breadth, pricing, implementation, support, and AI. See which HCM fits the mid-market versus the large enterprise.',
    url: 'https://beghr.com/services/hcm-software/isolved-vs-workday',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved vs Workday | One Platform + Claude AI | BEG', description: 'iSolved vs Workday compared across platform breadth, pricing, implementation, support, and AI. See which HCM fits the mid-market versus the large enterprise.', images: ['https://beghr.com/assets/og-image.png'] },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'iSolved tends to fit better for mid-market companies that do not need enterprise scale. Workday is powerful but very expensive and often involves long implementations, which can be overkill for most mid-market firms. iSolved delivers a connected platform without that overhead.',
  },
  {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'iSolved vs Workday', item: 'https://beghr.com/services/hcm-software/isolved-vs-workday' },
  ],
};
      ...
      <section className="hero" style={{ background: '#000000', color: '#ffffff', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ fontSize: '1.15rem', color: '#cccccc', maxWidth: '700px' }}>
            Workday is an enterprise leader and a very powerful platform for the largest organizations. iSolved is a single connected platform built for the mid-market. Here is how they compare.
          </p>
