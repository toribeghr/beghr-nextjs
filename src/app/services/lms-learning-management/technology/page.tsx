...
export const metadata: Metadata = {
  title: 'Technology LMS | isolved Learn & Grow, Configured by BEG',
  description: 'Training software for technology. BEG resells and configures isolved Learn & Grow so you can assign security, compliance, and tools training, track completions, and stay audit-ready, nationwide.',
  ...
  twitter: { card: 'summary_large_image', title: 'Technology LMS | isolved Learn & Grow, Configured by BEG', description: 'Training software for technology. BEG resells and configures isolved Learn & Grow so you can assign security, compliance, and tools training, track completions, and stay audit-ready, nationwide.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
const FAQS: [string, string][] = [
  [
    ...
    'Yes. BEG resells, configures, implements, and supports isolved Learn & Grow, the learning management system built into the isolved platform. isolved builds the software; BEG sets it up around your technology roles and training requirements.',
  ],
  [
    'Can we upload our own training content?',
    'Yes. Alongside the isolved course library, you can upload your own videos, documents, slide decks, and quizzes, so your specific security, compliance, and tools training lives in the same system as everything else.',
  ],
  [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Roll out security and product training your whole org actually completes.',
            description: 'Training software for technology. BEG resells and configures isolved Learn & Grow so you can assign security, compliance, and tools training, track completions, and stay audit-ready, nationwide.',
      ...
      <ServicePage
        ...
        title="Roll out security and product training your whole org actually completes."
        description="Training technical and product staff on security, compliance, and tools training should not mean chasing sign-in sheets and expired certificates. isolved Learn & Grow, resold and configured by BEG, puts every course, assignment, and completion record in one system so your technology team stays trained, compliant, and audit-ready, in all 50 states."
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Every training gap in technology shows up as risk, not just a missing checkbox</h2>
            </div>
            <div className="beg-grid-3 reveal">
              {[
                {
                  stat: 'Compliance',
                  label: 'security, compliance, and tools training cannot lapse',
                  sub: 'In technology, a missed or expired training requirement becomes a liability the day an auditor, regulator, or client asks for proof. Paper records make that proof slow to find and easy to lose.',
                },
                {
                  stat: 'Turnover',
                  label: 'Every new hire starts training from zero',
                  sub: 'When technical and product staff turn over, someone re-runs the same onboarding and safety training by hand. That time adds up fast and pulls your best people off the floor.',
                },
                {
                  stat: 'No trail',
              ...
              {[
                {
                  ...
                  body: 'Your roles, required courses, and renewal schedules get built into the system around how technology actually trains, not a generic template.',
                },
                {
                  num: '02',
              ...
              {[
                {
                  ...
                  body: 'Required security, compliance, and tools training gets assigned by role the moment someone is hired, with due dates and reminders, so nothing depends on a manager remembering.',
                },
                {
                  title: 'Onboard new hires in days, not weeks',
                  body: 'New technical and product staff run a consistent onboarding path, including your own uploaded content, and get productive faster instead of shadowing until it sticks.',
                },
                {
