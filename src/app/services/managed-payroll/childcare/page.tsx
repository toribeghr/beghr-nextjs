...
export const metadata: Metadata = {
  title: 'Managed Payroll for Childcare Centers & Daycares | Staff Turnover & Compliance | BEG',
  description: 'Childcare and daycare payroll fully managed at $25–$45 PEPM. High-turnover staff processing, substitute tracking, and state subsidy compliance included. Request a free scope review.',
