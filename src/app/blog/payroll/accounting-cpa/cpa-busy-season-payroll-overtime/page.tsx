...
export const metadata: Metadata = {
  title: "CPA Busy Season Payroll + Overtime | FLSA Guide | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/accounting-cpa/cpa-busy-season-payroll-overtime" },
  openGraph: {
    title: "CPA Busy Season Payroll + Overtime | FLSA Guide | BEG",
    description: "CPA firm busy season payroll: FLSA overtime rules, exempt vs non-exempt staff classification, salary threshold, and overtime calculation for staff accountants. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/accounting-cpa/cpa-busy-season-payroll-overtime",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "CPA Busy Season Payroll + Overtime | FLSA Guide | BEG", description: "Busy season overtime rules for CPA firms: FLSA classification, exempt vs non-exempt, and calculation. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "Accounting / CPA", "item": "https://beghr.com/blog/payroll/accounting-cpa" },
          { "@type": "ListItem", "position": 5, "name": "Busy Season Payroll and Overtime", "item": "https://beghr.com/blog/payroll/accounting-cpa/cpa-busy-season-payroll-overtime" }
        ]
      }) }} />
    </article>
  );
