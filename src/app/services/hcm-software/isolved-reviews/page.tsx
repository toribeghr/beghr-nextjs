...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/isolved-reviews' },
  openGraph: {
    title: 'iSolved Reviews: Strengths & Considerations | BEG',
    description: 'A fair overview of iSolved: its strengths as a single connected HCM platform, honest considerations to weigh, and how BEG addresses them through implementation.',
    url: 'https://beghr.com/services/hcm-software/isolved-reviews',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved Reviews: Strengths & Considerations | BEG', description: 'A fair overview of iSolved: its strengths as a single connected HCM platform, honest considerations to weigh, and how BEG addresses them through implementation.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. iSolved is built for growing, more complex companies and is proven at scale. The single connected platform model is especially valuable as you add states, benefits complexity, and headcount.',
  },
  {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'iSolved Reviews', item: 'https://beghr.com/services/hcm-software/isolved-reviews' },
  ],
};
