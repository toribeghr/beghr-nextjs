...
export const metadata: Metadata = {
  title: 'Development Director Recruiting | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/nonprofit-hiring/development-director-recruiting' },
  openGraph: {
    title: 'Development Director Recruiting | BEG',
    description: 'A vacant development director seat puts fundraising at risk. How to recruit and close a strong development leader in 23-35 days.',
    url: 'https://beghr.com/blog/nonprofit-hiring/development-director-recruiting',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Development Director Recruiting | BEG', description: 'A vacant development director seat puts fundraising at risk. How to recruit and close a strong development leader in 23-35 days.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/nonprofit-hiring/development-director-recruiting');
...
export default function DevelopmentDirectorRecruitingPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Development Director Recruiting | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/nonprofit-hiring/development-director-recruiting"}) }} />
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <div style={{ background: '#000', color: '#fff', padding: '2.5rem', borderRadius: '8px', textAlign: 'center', margin: '3rem 0' }}>
          ...
          <p style={{ marginBottom: '1.5rem', color: '#ddd' }}>Free 15-minute call. Tell us the revenue mix, scope, and timeline. We will tell you what the search looks like and whether milestone placement fits.</p>
          <a href={CALENDLY} target="_blank" rel="noopener noreferrer"
