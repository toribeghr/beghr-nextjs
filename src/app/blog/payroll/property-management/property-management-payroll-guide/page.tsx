...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Property Management Payroll Guide 2026 | BEG", description: "Property management payroll: housing allowances, commissions, overtime, and multi-property consolidated payroll.", images: ["https://www.beghr.com/assets/og-image.png"] },
};
