...
export default function PlacementSupplychainTucsonPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Supply Chain placement\",\"name\":\"Supply Chain Placement in Tucson\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Tucson\"},\"url\":\"https://beghr.com/services/job-placement/supply-chain/tucson\",\"description\":\"Permanent supply chain placement in Tucson in 23-35 days at roughly 50% less than contingency.\"}" }} />
