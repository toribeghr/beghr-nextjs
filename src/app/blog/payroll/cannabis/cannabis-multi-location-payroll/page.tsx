...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Cannabis Payroll: Multi-Location Guide [2026] | BEG', description: 'Managed payroll for cannabis. Multi-Location Payroll Guide. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
