...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Law Firms: Payroll Software vs. Managed Payroll Service | BE', description: 'Managed payroll for law firms. Payroll Software vs. Managed Payroll Service. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
