...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/group-term-life-imputed' },
  openGraph: {
    title: 'Group Term Life Insurance (Imputed Income) | Payroll Glossary | BEG',
    description: 'Employer life insurance over $50,000 creates taxable imputed income calculated using IRS Table I rates by employee age.',
    url: 'https://beghr.com/resources/payroll-glossary/group-term-life-imputed',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Group Term Life Insurance (Imputed Income) | Payroll Glossary | BEG', description: 'Employer life insurance over $50,000 creates taxable imputed income calculated using IRS Table I rates by employee age.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Group Term Life Insurance (Imputed Income)', item: 'https://beghr.com/resources/payroll-glossary/group-term-life-imputed' },
            ]},
          ]
        }) }} />
      </section>
