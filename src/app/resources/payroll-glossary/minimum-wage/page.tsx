...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/minimum-wage' },
  openGraph: { title: 'Minimum Wage | Payroll Glossary | BEG', description: 'The lowest hourly rate an employer may legally pay, currently $7.25 federal, with many states and localities setting higher rates.', url: 'https://beghr.com/resources/payroll-glossary/minimum-wage', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Minimum Wage | Payroll Glossary | BEG', description: 'The lowest hourly rate an employer may legally pay, currently $7.25 federal, with many states and localities setting higher rates.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/minimum-wage', url: 'https://beghr.com/resources/payroll-glossary/minimum-wage', name: 'Minimum Wage | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Minimum Wage', description: 'The lowest hourly rate an employer may legally pay, currently $7.25 federal, with many states and localities setting higher rates.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Minimum Wage', item: 'https://beghr.com/resources/payroll-glossary/minimum-wage' },
            ]},
          ]
        }) }} />
      </section>
