...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-virginia' },
  openGraph: {
    title: 'Payroll Outsourcing in Virginia | BEG',
    description: 'Payroll Outsourcing in Virginia. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.',
    url: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-virginia',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing in Virginia | BEG', description: 'Payroll Outsourcing in Virginia. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
