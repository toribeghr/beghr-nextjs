...
export const metadata: Metadata = {
  ...
  description: 'HR Manager direct hire placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
