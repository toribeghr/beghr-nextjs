...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Nonprofit Payroll: New Hire Onboarding | BEG', description: 'Managed payroll for nonprofits. New Hire Payroll Onboarding. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
