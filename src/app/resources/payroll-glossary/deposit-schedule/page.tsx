...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/deposit-schedule' },
  openGraph: {
    title: 'Deposit Schedule (Form 941) | Payroll Glossary | BEG',
    description: 'Learn how the IRS deposit schedule for Form 941 works, how the lookback period determines your schedule, and what happens if you miss a deposit.',
    url: 'https://beghr.com/resources/payroll-glossary/deposit-schedule',
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Deposit Schedule (Form 941)', item: 'https://beghr.com/resources/payroll-glossary/deposit-schedule' },
            ]},
          ]
        }) }} />
      </section>
