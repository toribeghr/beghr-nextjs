...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/multi-unit-restaurant/restaurant-group-payroll-compliance" },
  openGraph: {
    title: "Restaurant Group Payroll Compliance 2026 | BEG",
    description: "Payroll compliance for multi-unit restaurant groups: tip pools, minimum wage by location, overtime rules, and FLSA requirements across all locations. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/multi-unit-restaurant/restaurant-group-payroll-compliance",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Restaurant Group Payroll Compliance 2026 | BEG", description: "Multi-unit restaurant payroll compliance: tip pools, minimum wage, overtime, and FLSA. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Restaurant Group Payroll Compliance", "item": "https://beghr.com/blog/payroll/multi-unit-restaurant/restaurant-group-payroll-compliance" }
        ]
      }) }} />
    </article>
  );
