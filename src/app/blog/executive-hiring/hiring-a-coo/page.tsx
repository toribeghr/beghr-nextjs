...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'How to Hire a COO (2026 Guide) | BEG', description: 'A COO search is high stakes and often confidential. A practical playbook to define, source, and close the right COO in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <RelatedTool
          variant="grader"
          eyebrow={`Free Tool`}
          heading={`Grade your executive job description in 30 seconds`}
