...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Multi-Location Engineering Firm Payroll, Simplified | BEG', description: 'Managed payroll for engineering. Multi-Location Payroll Guide. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
