...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Hiring Energy Project Managers Before It Stalls | BEG', description: 'A vacant project manager seat puts schedule, budget, and safety at risk. A playbook to hire energy project managers in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
