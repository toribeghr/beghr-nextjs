...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/base-period' },
  openGraph: {
    title: 'Base Period | Payroll Glossary | BEG',
    description: 'Learn what the base period is in unemployment insurance, how it affects benefit calculations, and what it means for employer tax rates.',
    url: 'https://beghr.com/resources/payroll-glossary/base-period',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/base-period', url: 'https://beghr.com/resources/payroll-glossary/base-period', name: 'Base Period | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Base Period', description: 'Learn what the base period is in unemployment insurance, how it affects benefit calculations, and what it means for employer tax rates.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Base Period', item: 'https://beghr.com/resources/payroll-glossary/base-period' },
            ]},
          ]
        }) }} />
      </section>
