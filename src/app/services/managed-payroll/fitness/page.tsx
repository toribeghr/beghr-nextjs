        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            ...
            <div className="faq-item">
              ...
              <p>Everything: payroll processing, trainer classification review, W-2 and 1099 processing, commission overtime calculations, state filings, year-end W-2s and 1099-NECs, and BEG support. No per-1099 fees.</p>
            </div>
            <div className="faq-item">
