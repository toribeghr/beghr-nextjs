...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/switch-from-adp-to-isolved' },
  openGraph: {
    title: 'Switch From ADP to iSolved | BEG Manages the Move',
    description: 'Switching from ADP to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.',
    url: 'https://beghr.com/services/hcm-software/switch-from-adp-to-isolved',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Switch From ADP to iSolved | BEG Manages the Move', description: 'Switching from ADP to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.', images: ['https://beghr.com/assets/og-image.png'] },
...
export default function SwitchFromADPToiSolvedPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Switch From ADP to iSolved', item: 'https://beghr.com/services/hcm-software/switch-from-adp-to-isolved' },
    ],
  };
