...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/salary-guide/technology' },
  openGraph: { title: 'Technology Salary Guide 2026 | BEG', description: 'Technology salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent technology talent in 23-35 days.', url: 'https://beghr.com/resources/salary-guide/technology', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Technology Salary Guide 2026 | BEG', description: 'Technology salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent technology talent in 23-35 days.', images: ['https://beghr.com/assets/og-image.png'] },
};
