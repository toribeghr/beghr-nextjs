...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Childcare Payroll Garnishments, Handled Right | BEG', description: 'Managed payroll for childcare. Payroll Garnishments: What You Need to Know. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
