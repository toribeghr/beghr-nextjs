...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Cannabis Payroll: Outsourcing Cost vs. In-House | BEG', description: 'Managed payroll for cannabis. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
