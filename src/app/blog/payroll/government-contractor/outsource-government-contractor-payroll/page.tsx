...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/government-contractor/outsource-government-contractor-payroll' },
  openGraph: {
    title: 'Why Government Contractors Outsource Payroll | BEG Guide',
    ...
    url: 'https://beghr.com/blog/payroll/government-contractor/outsource-government-contractor-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Why Government Contractors Outsource Payroll | BEG Guide', description: 'Why government contractors outsource payroll and what to look for in a managed payroll provider.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Outsource Government Contractor Payroll', item: 'https://beghr.com/blog/payroll/government-contractor/outsource-government-contractor-payroll' },
        ]
      }) }} />
    </article>
  );
