...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Technology & SaaS Companies: Payroll Features Every {label} ', description: 'Managed payroll for tech/SaaS. Payroll Features Every Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
