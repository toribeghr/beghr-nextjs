...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Farm & Agriculture Payroll Guide 2026 | H-2A + Seasonal | BEG', description: 'Complete farm payroll guide: H-2A workers, seasonal crews, MSPA compliance, and piece rate calculations.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
