...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/executive-hiring/executive-search-trends' },
  openGraph: {
    title: 'Executive Search Trends 2026 | BEG',
    description: 'Confidential, relationship-led search is replacing post-and-pray hiring at the top. The executive search trends boards and CEOs need to know in 2026.',
    url: 'https://beghr.com/blog/executive-hiring/executive-search-trends',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Executive Search Trends 2026 | BEG', description: 'Confidential, relationship-led search is replacing post-and-pray hiring at the top. The executive search trends boards and CEOs need to know in 2026.', images: ['https://beghr.com/assets/og-image.png'] },
};
