...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Pennsylvania Paid Sick Leave Explained: Local Rules Inside', description: 'No statewide Pennsylvania sick leave law, but Philadelphia and Pittsburgh have their own ordinances. What employers must build for 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
