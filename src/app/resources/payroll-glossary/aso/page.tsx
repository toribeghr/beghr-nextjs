...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/aso' },
  openGraph: {
    title: 'ASO (Administrative Services Organization) | Payroll Glossary | BEG',
    description: 'Learn what an ASO is, how it differs from a PEO, and whether an administrative services organization is the right HR model for your business.',
    url: 'https://beghr.com/resources/payroll-glossary/aso',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/aso', url: 'https://beghr.com/resources/payroll-glossary/aso', name: 'ASO (Administrative Services Organization) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'ASO (Administrative Services Organization)', description: 'Learn what an ASO is, how it differs from a PEO, and whether an administrative services organization is the right HR model for your business.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'ASO (Administrative Services Organization)', item: 'https://beghr.com/resources/payroll-glossary/aso' },
            ]},
          ]
        }) }} />
      </section>
