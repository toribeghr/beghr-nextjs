...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/case-studies/placement-accounting' },
  openGraph: {
    title: 'Accounting Placement Case Study | BEG',
    description: 'How BEG filled a senior accountant role in 24 days at roughly 50% less than contingency, using milestone-based permanent placement powered by isolved.',
    url: 'https://www.beghr.com/case-studies/placement-accounting',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'article',
  },
  twitter: { card: 'summary_large_image', title: 'Accounting Placement Case Study | BEG', description: 'How BEG filled a senior accountant role in 24 days at roughly 50% less than contingency, using milestone-based permanent placement powered by isolved.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article>
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: '820px', lineHeight: '1.8', fontSize: '1.05rem' }}>
          ...
          <div style={{ background: '#000', color: '#fff', padding: '2rem', borderRadius: '8px', textAlign: 'center', margin: '2.5rem 0' }}>
            <h3 style={{ color: '#ECAC60', margin: '0 0 0.75rem' }}>Need an accountant in seat before busy season?</h3>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Accounting Placement Case Study', item: 'https://www.beghr.com/case-studies/placement-accounting' },
        ],
      }) }} />
    </article>
  );
