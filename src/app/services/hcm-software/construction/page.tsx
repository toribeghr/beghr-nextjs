...
export const metadata: Metadata = {
  title: 'isolved HCM for Construction | Instant Price Quote | BEG',
  description: 'isolved HCM for construction. Certified payroll, prevailing wage, multi-job costing, and union rules on one connected platform.',
  alternates: { canonical: 'https://www.beghr.com/services/hcm-software/construction' },
  openGraph: {
    title: 'isolved HCM for Construction | Instant Price Quote | BEG',
    description: 'isolved HCM for construction. Certified payroll, prevailing wage, multi-job costing, and union rules on one connected platform.',
    url: 'https://www.beghr.com/services/hcm-software/construction',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'isolved HCM for Construction | Instant Price Quote | BEG', description: 'isolved HCM for construction. Certified payroll, prevailing wage, multi-job costing, and union rules on one connected platform.', images: ['https://www.beghr.com/assets/og-image.png'] },
            ...
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Certified payroll is not optional on prevailing wage work. The isolved platform tracks rates by job and produces the reporting so your team is not rebuilding it every week.</div>
                </div>
              ))()
            }
            {
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Yes. The isolved platform tracks prevailing wage rates by job and produces certified payroll reporting so your team is not rebuilding WH-347 style reports by hand each week. BEG configures it for the jurisdictions you work in.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Does isolved produce certified payroll reports?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. The isolved platform tracks prevailing wage rates by job and produces certified payroll reporting. BEG configures it for the jurisdictions you work in.' } },
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Construction', item: 'https://www.beghr.com/services/hcm-software/construction' },
            ],
          }),
        }}
      />
