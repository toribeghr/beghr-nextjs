...
export default function LmsTradesPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: 'https://www.beghr.com/services/lms-learning-management/trades',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Skilled Trades LMS', item: 'https://www.beghr.com/services/lms-learning-management/trades' },
            ],
          }),
        }}
      />
      ...
      <ServicePage
        ...
        heroStats={[
          ...
          { value: 'Built for Trades', label: 'Configured to your roles and requirements' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '980px' }}>
            <div className="head center reveal">
              ...
              <h2>Training built for how skilled trades teams actually operate</h2>
            </div>
            <div className="beg-grid-3 reveal">
              {[
                {
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Learning management for skilled trades, answered</h2>
            </div>
