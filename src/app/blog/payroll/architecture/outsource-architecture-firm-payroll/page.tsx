...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/architecture/outsource-architecture-firm-payroll" },
  openGraph: {
    title: "Outsource Architecture Firm Payroll | BEG Guide",
    description: "Why architecture firms outsource payroll: project coding, multi-state licensed staff, partner structures, and compliance. BEG at $25-$45 PEPM, 3-5 day setup.",
    url: "https://beghr.com/blog/payroll/architecture/outsource-architecture-firm-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Outsource Architecture Firm Payroll | BEG Guide", description: "Why architecture firms outsource payroll and how fast they can onboard. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Outsource Architecture Payroll", "item": "https://beghr.com/blog/payroll/architecture/outsource-architecture-firm-payroll" }
        ]
      }) }} />
    </article>
  );
