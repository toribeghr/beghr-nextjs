...
export const metadata: Metadata = {
  title: 'Hospitality Recruiters in Atlanta | BEG',
  description: 'Hospitality placement in Atlanta. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hospitality/atlanta' },
  openGraph: { title: 'Hospitality Recruiters in Atlanta | BEG', description: 'Hospitality placement in Atlanta in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hospitality/atlanta', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Hospitality Recruiters in Atlanta | BEG', description: 'Hospitality placement in Atlanta in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-hospitality-atlanta');

export default function PlacementHospitalityAtlantaPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Hospitality · Atlanta"
      title="That open hospitality role in Atlanta is costing you every week."
      description="Atlanta is a corporate-headquarters and logistics hub where finance, tech, and legal talent is heavily recruited. We source passive hospitality candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Hospitality in Atlanta? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Hospitality placement near Atlanta</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place hospitality candidates in Atlanta?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent hospitality searches in Atlanta and across Georgia, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
