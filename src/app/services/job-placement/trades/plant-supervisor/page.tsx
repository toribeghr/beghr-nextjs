      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Plant and site supervisors with a safety and output track record are rarely on the market. That is why a posting-and-waiting search rarely fills a plant supervisor seat with the right person. Our recruiters source passive plant supervisor candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
