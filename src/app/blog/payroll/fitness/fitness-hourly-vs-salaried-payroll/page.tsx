...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Fitness Payroll, Hourly vs Salaried (What to Know) | BEG', description: 'Managed payroll for fitness. Hourly vs. Salaried Employee Payroll. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
