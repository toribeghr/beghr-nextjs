...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-compare-payroll-manager-vs-outsourcing.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Payroll Manager vs Outsourcing | $60K-$100K vs. $25 PEPM | BEG', description: 'What does a payroll manager actually cost vs. managed payroll? Side-by-side breakdown of salary, benefits, errors, and total cost for companies with 20–...', images: ['https://www.beghr.com/blog-images/blog-compare-payroll-manager-vs-outsourcing.webp'] },
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-compare-payroll-manager-vs-outsourcing.webp" alt={`Business professionals comparing options on a laptop in a modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
