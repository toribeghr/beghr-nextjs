...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-architecture-hiring-architecture-salary-trends.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: "Architecture Salary Trends 2026: What They Don't Post | BEG", description: 'Architecture comp is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes a design hire.', images: ['https://www.beghr.com/blog-images/blog-architecture-hiring-architecture-salary-trends.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-architecture-hiring-architecture-salary-trends.webp" alt={`Architects reviewing building models and blueprints in a studio`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
