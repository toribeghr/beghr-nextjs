...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-technology-hiring-technology-interview-questions.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Tech Interview Questions: What Real Depth Looks Like | BEG', description: 'Tech interviews that go beyond algorithmic puzzles. The questions that reveal system design judgment, engineering leadership quality, and real software', images: ['https://www.beghr.com/blog-images/blog-technology-hiring-technology-interview-questions.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-technology-hiring-technology-interview-questions.webp" alt={`A modern tech office, software team collaborating at workstations`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
