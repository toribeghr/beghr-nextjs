...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/education/outsource-education-payroll" },
  openGraph: {
    title: "Outsource School Payroll | Private + Charter | BEG",
    description: "Why private and charter schools outsource payroll, what to look for in a provider, and how managed payroll compares to in-house. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/education/outsource-education-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Outsource School Payroll | Private + Charter | BEG", description: "Why private and charter schools outsource payroll and what to look for in a managed payroll provider.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Outsource Education Payroll", "item": "https://beghr.com/blog/payroll/education/outsource-education-payroll" }
        ]
      }) }} />
    </article>
  );
