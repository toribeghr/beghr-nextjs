...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/home-services/home-services-payroll-guide' },
  openGraph: {
    title: 'Home Services Payroll Guide 2026 | HVAC Plumbing | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/home-services/home-services-payroll-guide',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Home Services Payroll Guide 2026 | HVAC Plumbing | BEG', description: 'Complete payroll guide for HVAC, plumbing, electrical, and field tech companies.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Home Services Payroll Guide', item: 'https://beghr.com/blog/payroll/home-services/home-services-payroll-guide' },
        ]
      }) }} />
    </article>
  );
