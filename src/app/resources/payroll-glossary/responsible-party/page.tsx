...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/responsible-party' },
  openGraph: {
    title: 'Responsible Party (Trust Fund) | Payroll Glossary | BEG',
    description: 'Person liable for unpaid trust fund payroll taxes under the IRS 100% Trust Fund Recovery Penalty.',
    url: 'https://beghr.com/resources/payroll-glossary/responsible-party',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Responsible Party (Trust Fund) | Payroll Glossary | BEG', description: 'Person liable for unpaid trust fund payroll taxes under the IRS 100% Trust Fund Recovery Penalty.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/responsible-party', url: 'https://beghr.com/resources/payroll-glossary/responsible-party', name: 'Responsible Party (Trust Fund) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Responsible Party (Trust Fund)', description: 'Person liable for unpaid trust fund payroll taxes under the IRS 100% Trust Fund Recovery Penalty.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Responsible Party (Trust Fund)', item: 'https://beghr.com/resources/payroll-glossary/responsible-party' },
            ]},
          ]
        }) }} />
      </section>
