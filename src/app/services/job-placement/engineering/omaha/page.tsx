...
export const metadata: Metadata = {
  title: 'Engineering Recruiters in Omaha | BEG',
  description: 'Engineering placement in Omaha. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/engineering/omaha' },
  openGraph: { title: 'Engineering Recruiters in Omaha | BEG', description: 'Engineering placement in Omaha in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/engineering/omaha', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Engineering Recruiters in Omaha | BEG', description: 'Engineering placement in Omaha in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-engineering-omaha');

export default function PlacementEngineeringOmahaPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Omaha"
      title="That open engineering role in Omaha is costing you every week."
      description="Omaha is an insurance, finance, and healthcare market where employers compete hard for a limited candidate pool. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Omaha? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Omaha</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/engineering" style={{ color: '#000000', fontWeight: 600 }}>engineering placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/engineering/kansas-city" style={{ color: '#000000', fontWeight: 600 }}>Kansas City</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Omaha?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Omaha and across Nebraska, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
