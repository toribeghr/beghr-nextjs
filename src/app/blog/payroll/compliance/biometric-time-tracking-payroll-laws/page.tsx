...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Biometric Time Tracking Laws Payroll Teams Must Know | BEG', description: 'Biometric Time Tracking Laws and Payroll Compliance. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
