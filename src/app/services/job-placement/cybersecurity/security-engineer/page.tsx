...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/cybersecurity/security-engineer' },
  openGraph: { title: 'Security Engineer Recruiters | 23-35 Days | BEG', description: 'Security Engineer placement in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/cybersecurity/security-engineer', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Security Engineer Recruiters | 23-35 Days | BEG', description: 'Security Engineer placement in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-cybersecurity-security-engineer');

export default function PlacementCybersecuritySecurityengineerPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Cybersecurity · Security Engineer"
      title="Your security engineer search has been open too long."
      description="Security engineers field multiple offers at once, so a slow process loses them every time. We place permanent security engineer candidates in 23-35 days at roughly 50% less than contingency firms, with a 45-day replacement guarantee."
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Security Engineer searches stall because the best candidates are passive and field multiple offers.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Security Engineer placement\",\"name\":\"Security Engineer Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/cybersecurity/security-engineer\",\"description\":\"Permanent security engineer placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/cybersecurity" style={{ color: '#000000', fontWeight: 600 }}>cybersecurity placement service</Link>, or explore: <Link href="/services/job-placement/cybersecurity/ciso" style={{ color: '#000000', fontWeight: 600 }}>CISO</Link>, <Link href="/services/job-placement/cybersecurity/soc-analyst" style={{ color: '#000000', fontWeight: 600 }}>SOC Analyst</Link>, <Link href="/services/job-placement/cybersecurity/security-architect" style={{ color: '#000000', fontWeight: 600 }}>Security Architect</Link>, <Link href="/services/job-placement/cybersecurity/grc-analyst" style={{ color: '#000000', fontWeight: 600 }}>GRC Analyst</Link>.
          </p>
        </div>
      </section>
