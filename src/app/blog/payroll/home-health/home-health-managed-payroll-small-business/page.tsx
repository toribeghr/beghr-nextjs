...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Home Health Payroll for Agencies Under 25 Staff | BEG',
    description: 'Managed payroll for home health. Managed Payroll for Small Businesses (Under 25 Employees). $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
