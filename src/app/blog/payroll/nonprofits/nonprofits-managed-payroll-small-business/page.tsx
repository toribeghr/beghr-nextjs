...
export const metadata: Metadata = {
  title: 'Nonprofit Payroll: For Small Business (<25 EE) | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/nonprofits/nonprofits-managed-payroll-small-business' },
  openGraph: {
    title: 'Nonprofit Payroll: For Small Business (<25 EE) | BEG',
    description: 'Managed payroll for nonprofits. Managed Payroll for Small Businesses (Under 25 Employees). $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/nonprofits/nonprofits-managed-payroll-small-business',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Nonprofit Payroll: For Small Business (<25 EE) | BEG', description: 'Managed payroll for nonprofits. Managed Payroll for Small Businesses (Under 25 Employees). $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"Nonprofits & Religious Organizations: Managed Payroll for Small Businesses (Under 25 Employees) (2026)","item":"https://beghr.com/blog/payroll/nonprofits/nonprofits-managed-payroll-small-business"}]}`,
        }}
      />
    </article>
  );
