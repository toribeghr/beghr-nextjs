...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'How to Prepare for a Payroll Audit | BEG', description: 'How to Prepare for a Payroll Audit. Expert guidance from BEG managed payroll. Book a free 15-min call to review your payroll compliance at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
