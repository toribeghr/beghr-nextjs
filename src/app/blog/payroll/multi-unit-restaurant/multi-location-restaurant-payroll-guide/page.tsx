...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Multi-Location Restaurant Payroll Guide 2026 | BEG", description: "Consolidated payroll for multi-unit restaurant groups: tip credit, W-2 production, and per-location reporting. BEG at $25-$45 PEPM.", images: ["https://www.beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Multi-Location Restaurant Payroll Guide", "item": "https://www.beghr.com/blog/payroll/multi-unit-restaurant/multi-location-restaurant-payroll-guide" }
        ]
      }) }} />
    </article>
  );
