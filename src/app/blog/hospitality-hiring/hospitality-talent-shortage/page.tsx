...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Hospitality Talent Shortage 2026: What Nobody Warns | BEG', description: 'Turnover is high and the leadership pipeline is thin. What the 2026 hospitality shortage means for hiring and how to fill roles in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
