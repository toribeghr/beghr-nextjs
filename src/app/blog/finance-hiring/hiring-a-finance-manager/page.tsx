...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Hiring a Finance Manager Without Overpaying | BEG', description: 'A vacant finance manager seat slows forecasting and board reporting. A practical playbook to hire a finance manager in 23-35 days without settling.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
