...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Home Health Payroll, Must-Have Features for Agencies | BEG', description: 'Managed payroll for home health. Payroll Features Every Business Needs. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
