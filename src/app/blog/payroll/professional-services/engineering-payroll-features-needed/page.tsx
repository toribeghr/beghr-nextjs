...
export const metadata: Metadata = {
  title: 'Engineering Firm Payroll: Must-Have Features | BEG',
  description: 'Managed payroll for engineering. Payroll Features Every {label} Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
  alternates: { canonical: 'https://beghr.com/blog/payroll/professional-services/engineering-payroll-features-needed' },
  openGraph: {
    title: 'Engineering Firm Payroll: Must-Have Features | BEG',
    description: 'Managed payroll for engineering. Payroll Features Every {label} Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/professional-services/engineering-payroll-features-needed',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Engineering Firm Payroll: Must-Have Features | BEG', description: 'Managed payroll for engineering. Payroll Features Every {label} Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
  ...
  return (
    <article className="blog-post">
        ...
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              ...
              <h1>Engineering & Professional Services Firms: Payroll Features Every {label} Business Needs (2026)</h1>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Engineering & Professional Services Firms: Payroll Features Every {label} Business Needs (2026)","description":"Managed payroll for engineering. Payroll Features Every {label} Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.","datePublished":"2026-06-28","dateModified":"2026-06-28","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","worksFor":{"@type":"Organization","name":"Business Executive Group"}},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://beghr.com/assets/beg-header-image.png"}},"url":"https://beghr.com/blog/payroll/professional-services/engineering-payroll-features-needed","mainEntityOfPage":{"@type":"WebPage","@id":"https://beghr.com/blog/payroll/professional-services/engineering-payroll-features-needed"}}`,
        }}
      />
