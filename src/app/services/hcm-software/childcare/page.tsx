...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'isolved HCM for Childcare Centers | BEG', description: 'isolved HCM for childcare. Hourly staff, ratio and licensing compliance, multi-center management, and subsidy funding on one connected platform.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
