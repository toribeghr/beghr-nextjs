...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-sales-hiring-sales-talent-shortage.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'B2B Sales Talent Shortage 2026: What Nobody Tells You | BEG', description: 'Sales turnover is high and tenure is short. Why job postings fail in 2026 and how revenue leaders fill quota-carrying roles in 23-35 days anyway.', images: ['https://www.beghr.com/blog-images/blog-sales-hiring-sales-talent-shortage.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-sales-hiring-sales-talent-shortage.webp" alt={`A sales team on calls and reviewing a pipeline in a modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
