...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-veterinary-hiring-veterinary-interview-questions.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Veterinary Interview Questions: Who Actually Stays | BEG', description: 'Veterinary interviews that reveal clinical philosophy, client communication quality, and practice culture fit.', images: ['https://www.beghr.com/blog-images/blog-veterinary-hiring-veterinary-interview-questions.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-veterinary-hiring-veterinary-interview-questions.webp" alt={`A veterinary clinic with a vet examining a dog, staff assisting`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
