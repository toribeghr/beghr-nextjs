...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Nonprofit Interview Questions (What to Ask) | BEG', description: 'Nonprofit interviews that reveal fundraising track record, mission alignment, and operational leadership quality. Questions that identify executive directors and development directors who deliver.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
