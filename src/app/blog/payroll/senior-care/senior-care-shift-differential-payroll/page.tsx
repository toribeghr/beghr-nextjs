...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Shift Differential Payroll | Senior Care Guide | BEG', description: 'How to handle shift differential payroll in senior care facilities. Regular rate overtime and compliance.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
