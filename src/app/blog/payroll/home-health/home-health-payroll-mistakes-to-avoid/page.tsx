...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Home Health Payroll, Common Mistakes to Avoid | BEG', description: 'Managed payroll for home health. Payroll Mistakes to Avoid. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
