...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-calendars-payroll-tax-deadlines-2026.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Payroll Tax Deadlines 2026: Deposit Rules Explained | BEG', description: 'Payroll tax deadlines for 2026: monthly vs semiweekly depositor schedules, Form 941 and Form 940 filing patterns, plus an interactive deadline calendar.', images: ['https://www.beghr.com/blog-images/blog-payroll-calendars-payroll-tax-deadlines-2026.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-calendars-payroll-tax-deadlines-2026.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
