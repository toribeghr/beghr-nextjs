...
export const metadata: Metadata = {
  title: 'Managed Payroll Implementation Timeline: 3-5 Days to.. | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/intent/managed-payroll-implementation-timeline' },
  openGraph: {
    title: 'Managed Payroll Implementation Timeline: 3-5 Days to.. | BEG',
    description: 'Managed Payroll Implementation Timeline: 3-5 Days to Live. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/intent/managed-payroll-implementation-timeline',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Managed Payroll Implementation Timeline: 3-5 Days to.. | BEG', description: 'Managed Payroll Implementation Timeline: 3-5 Days to Live. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Managed Payroll Implementation Timeline: 3-5 Days to.. | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/payroll/intent/managed-payroll-implementation-timeline"}) }} />
