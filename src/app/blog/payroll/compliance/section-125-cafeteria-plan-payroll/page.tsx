...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Section 125 Cafeteria Plans for Payroll Teams | BEG', description: 'Section 125 Cafeteria Plans and Payroll Deductions. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
