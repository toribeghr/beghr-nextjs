...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing in Oregon: Paid Leave and More | BEG', description: 'Payroll Outsourcing in Oregon: Paid Leave and More. BEG provides managed payroll nationwide. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
