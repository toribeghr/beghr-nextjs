...
export const metadata: Metadata = {
  title: 'Hospitality Recruiters in Fresno | BEG',
  description: 'Hospitality placement in Fresno. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hospitality/fresno' },
  openGraph: { title: 'Hospitality Recruiters in Fresno | BEG', description: 'Hospitality placement in Fresno in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hospitality/fresno', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Hospitality Recruiters in Fresno | BEG', description: 'Hospitality placement in Fresno in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-hospitality-fresno');

export default function PlacementHospitalityFresnoPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Hospitality · Fresno"
      title="That open hospitality role in Fresno is costing you every week."
      description="Fresno is an agriculture, healthcare, and logistics market where professional roles are hard to fill locally. We source passive hospitality candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Hospitality in Fresno? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Hospitality placement near Fresno</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/hospitality" style={{ color: '#000000', fontWeight: 600 }}>hospitality placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/hospitality/sacramento" style={{ color: '#000000', fontWeight: 600 }}>Sacramento</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place hospitality candidates in Fresno?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent hospitality searches in Fresno and across California, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
