...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/peo' },
  openGraph: { title: 'PEO (Professional Employer Organization) | Payroll Glossary | BEG', description: 'A co-employment arrangement where a PEO becomes the employer of record for HR and benefits purposes while the client business directs the work.', url: 'https://beghr.com/resources/payroll-glossary/peo', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'PEO (Professional Employer Organization) | Payroll Glossary | BEG', description: 'A co-employment arrangement where a PEO becomes the employer of record for HR and benefits purposes while the client business directs the work.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/peo', url: 'https://beghr.com/resources/payroll-glossary/peo', name: 'PEO (Professional Employer Organization) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'PEO (Professional Employer Organization)', description: 'A co-employment arrangement where a PEO becomes the employer of record for HR and benefits purposes while the client business directs the work.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'PEO (Professional Employer Organization)', item: 'https://beghr.com/resources/payroll-glossary/peo' },
            ]},
          ]
        }) }} />
      </section>
