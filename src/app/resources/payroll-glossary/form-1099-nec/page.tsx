...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/form-1099-nec' },
  openGraph: { title: 'Form 1099-NEC | Payroll Glossary | BEG', description: 'IRS form used to report non-employee compensation of $600 or more paid to independent contractors, due January 31 each year.', url: 'https://beghr.com/resources/payroll-glossary/form-1099-nec', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Form 1099-NEC | Payroll Glossary | BEG', description: 'IRS form used to report non-employee compensation of $600 or more paid to independent contractors, due January 31 each year.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/form-1099-nec', url: 'https://beghr.com/resources/payroll-glossary/form-1099-nec', name: 'Form 1099-NEC | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Form 1099-NEC', description: 'IRS form used to report non-employee compensation of $600 or more paid to independent contractors, due January 31 each year.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Form 1099-NEC', item: 'https://beghr.com/resources/payroll-glossary/form-1099-nec' },
            ]},
          ]
        }) }} />
      </section>
