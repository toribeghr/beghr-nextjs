...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/managed-payroll/illinois' },
  openGraph: {
    title: 'Illinois Managed Payroll Services | BEG | $25-$45 PEPM',
    description: 'Fully managed payroll for Illinois employers at $25-$45 PEPM. Illinois payroll tax and WARN Act compliance. No migration required.',
    url: 'https://beghr.com/services/managed-payroll/illinois',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Illinois Managed Payroll Services | BEG | $25-$45 PEPM', description: 'Fully managed payroll for Illinois employers at $25-$45 PEPM. Illinois payroll tax and WARN Act compliance. No migration required.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Illinois', item: 'https://beghr.com/services/managed-payroll/illinois' },
            ],
          })
        }}
      />
