...
export const metadata: Metadata = {
  title: 'Technology Interview Questions That Reveal Engineering Depth and Delivery Track Record | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Technology Interview Questions That Reveal Engineering Depth and Delivery Track Record | BEG', description: 'Tech interviews that go beyond algorithmic puzzles. The questions that reveal system design judgment, engineering leadership quality, and real software delivery track record.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/technology-hiring/technology-interview-questions');
