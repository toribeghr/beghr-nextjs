...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Engineering Firm Payroll: For Mid-Size Business (25-.. | BEG', description: 'Managed payroll for engineering. Managed Payroll for Mid-Size Businesses (25-100 Employees). $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
