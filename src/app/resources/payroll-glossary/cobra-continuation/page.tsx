...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/cobra-continuation' },
  openGraph: {
    title: 'COBRA Continuation | Payroll Glossary | BEG',
    description: 'Learn how COBRA continuation coverage works, qualifying events, timelines, and employer notification obligations.',
    url: 'https://beghr.com/resources/payroll-glossary/cobra-continuation',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/cobra-continuation', url: 'https://beghr.com/resources/payroll-glossary/cobra-continuation', name: 'COBRA Continuation | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'COBRA Continuation', description: 'Learn how COBRA continuation coverage works, qualifying events, timelines, and employer notification obligations.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'COBRA Continuation', item: 'https://beghr.com/resources/payroll-glossary/cobra-continuation' },
            ]},
          ]
        }) }} />
      </section>
