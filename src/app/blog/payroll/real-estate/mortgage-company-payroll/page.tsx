...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Mortgage Company Payroll, LO Commission (What to Know) | BEG", description: "Mortgage payroll: loan officer commission, RESPA compliance, draw programs, and multi-state filings. BEG at $25-$45 PEPM.", images: ["https://www.beghr.com/assets/og-image.png"] },
};
