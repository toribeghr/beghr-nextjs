...
export const metadata: Metadata = {
  title: 'isolved HCM for Home Health | Instant Price Quote | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'isolved HCM for Home Health | Instant Price Quote | BEG', description: 'isolved HCM for home health. Visit-based pay, EVV, travel time and mileage, per-visit rates, and multi-state caregivers on one connected platform.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
            ...
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Visit-based pay plus travel time is where manual payroll breaks. The isolved platform applies per-visit rates, travel, and mileage every pay period.</div>
                </div>
              ))()
            }
            {
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#444444', maxWidth: '700px', margin: '1.5rem auto' }}>
            The best HCM software for home health is one that handles visit-based pay, travel and mileage, and multi-state caregivers in a single system. The isolved platform for home health manages per-visit rates, travel time, mileage reimbursement, multi-state payroll and tax, benefits administration, and talent management in one connected platform. BEG implements and maintains it for your specific agency model.
          </p>
          <div className="beg-grid-3 reveal">
            {[
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Yes. The isolved platform calculates per-visit rates, travel time, and mileage automatically, so caregivers are paid accurately for every visit. BEG configures your rate structure and reimbursement rules during implementation.</p>
            </div>
            <div className="faq-item">
              <h3>Does isolved work with electronic visit verification?</h3>
              <p>Yes. The isolved platform captures visit time that supports your electronic visit verification requirements and flows it straight into payroll. BEG configures the time capture so verified visits convert cleanly to pay.</p>
            </div>
            <div className="faq-item">
              <h3>Can isolved pay caregivers who work across multiple states?</h3>
              <p>Yes. The isolved platform handles multi-state payroll and tax automatically, so caregivers crossing state lines are taxed and paid correctly. BEG configures each state you operate in and keeps the rules current.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Can isolved handle visit-based and per-visit pay?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. The isolved platform calculates per-visit rates, travel time, and mileage automatically. BEG configures your rate structure and reimbursement rules.' } },
              { '@type': 'Question', name: 'Can isolved pay caregivers who work across multiple states?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. The isolved platform handles multi-state payroll and tax automatically so caregivers crossing state lines are taxed and paid correctly.' } },
