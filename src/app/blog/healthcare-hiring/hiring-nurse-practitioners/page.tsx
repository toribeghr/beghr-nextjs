...
export const metadata: Metadata = {
  title: 'Hiring Nurse Practitioners Without Overpaying | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-healthcare-hiring-hiring-nurse-practitioners.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Hiring Nurse Practitioners Without Overpaying | BEG', description: 'A vacant NP seat strains access and your team. A practical playbook to hire a nurse practitioner in 23-35 days with passive candidate sourcing.', images: ['https://www.beghr.com/blog-images/blog-healthcare-hiring-hiring-nurse-practitioners.webp'] },
};
  ...
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-healthcare-hiring-hiring-nurse-practitioners.webp", "headline": "Hiring Nurse Practitioners Without Overpaying | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/healthcare-hiring/hiring-nurse-practitioners"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-healthcare-hiring-hiring-nurse-practitioners.webp" alt={`A modern medical clinic with doctors and nurses caring for patients`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
