...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Agency Payroll: The Truth About Classification | BEG', description: 'Managed payroll for marketing agencies. Employee Classification for Payroll. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
