...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Financial Firm Payroll: 25-100 Employees, What Changes | BEG', description: 'Managed payroll for financial services. Managed Payroll for Mid-Size Businesses (25-100 Employees). $25-$45 PEPM all-inclusive.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
