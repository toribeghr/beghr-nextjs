...
export const metadata: Metadata = {
  title: 'Senior Care Payroll Guide 2026 | CNA + Shift Differential | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/senior-care/senior-care-payroll-guide' },
  openGraph: {
    title: 'Senior Care Payroll Guide 2026 | CNA + Shift Differential | BEG',
    description: 'Senior care facility payroll guide: CNA overtime rules, shift differential configuration, CMS staffing compliance, and payroll management for nursing homes and ALFs.',
    url: 'https://beghr.com/blog/payroll/senior-care/senior-care-payroll-guide',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Senior Care Payroll Guide 2026 | BEG', description: 'Senior care payroll: CNA overtime, shift differentials, CMS compliance. Complete guide for nursing homes and ALFs.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Senior Care Payroll Guide', item: 'https://beghr.com/blog/payroll/senior-care/senior-care-payroll-guide' },
        ]
      }) }} />
    </article>
  );
