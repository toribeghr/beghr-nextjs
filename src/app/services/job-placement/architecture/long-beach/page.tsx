...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/architecture/long-beach' },
  openGraph: { title: 'Architecture Recruiters in Long Beach | BEG', description: 'Architecture placement in Long Beach in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/architecture/long-beach', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Architecture Recruiters in Long Beach | BEG', description: 'Architecture placement in Long Beach in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementArchitectureLongbeachPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Architecture placement\",\"name\":\"Architecture Placement in Long Beach\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Long Beach\"},\"url\":\"https://beghr.com/services/job-placement/architecture/long-beach\",\"description\":\"Permanent architecture placement in Long Beach in 23-35 days at roughly 50% less than contingency.\"}" }} />
