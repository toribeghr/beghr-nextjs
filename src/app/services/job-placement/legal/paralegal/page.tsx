      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring a paralegal? Grade your job description first.</h2>
            <p style={{ maxWidth: '670px', margin: '0.75rem auto 0', color: '#555555', lineHeight: 1.7 }}>A vague job description attracts generalists, not the specialist you need. Paste your paralegal posting and get an instant 0 to 100 score, plus the fixes that attract practice-area-matched candidates. Free, instant, and nothing you paste leaves your browser.</p>
          </div>
        </div>
      </section>
