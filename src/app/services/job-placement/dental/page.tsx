...
export const metadata: Metadata = {
  title: 'Dental Placement & Recruiting | Instant Fee Quote | BEG',
  ...
  openGraph: { title: 'Dental Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill associate dentist, specialist, and practice roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', url: 'https://www.beghr.com/services/job-placement/dental', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Dental Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill associate dentist, specialist, and practice roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-dental');

export default function PlacementDentalPage() {
  return (
    <ServicePage
      ...
      heroCta={<PricingCta service="job-placement" industry="dental" />}
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Dental roles stay open because the strongest candidates are employed, passive, and rarely on job boards.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Dental placement\",\"name\":\"Dental Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://www.beghr.com/services/job-placement/dental\",\"description\":\"Permanent dental placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
          ...
          <div className="beg-grid-3 reveal">
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Of practices report an open clinical or management seat</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>DSO growth and a tight clinician pool have stretched hiring across the field. The strongest candidates are passive and reaching them takes proactive sourcing.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Per month absorbed per unfilled associate or manager seat</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>An associate dentist at roughly $100K is about $8,500 a month, before lost chair production. Every month the seat is open, that load falls on the rest of the practice.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Strong associates and specialists get multiple offers. A 90-day search is always fishing in a smaller pond than the one you started with.</div>
                </div>
              ))()
            }
          </div>
            ...
            {[
              {
                ...
                body: 'Milestone-based pricing replaces the standard 20-25% contingency fee. Total cost is roughly 50% less. For a $100,000 associate dentist placement, that difference is $10,000-$15,000 kept in your budget versus a contingency arrangement.',
              },
              {
                badge: 'Bonus 02',
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Associate dentists, dental specialists, practice managers, lead hygienists, treatment coordinators, regional dental managers, and other clinical and practice-operations roles.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'What roles do you place?', acceptedAnswer: { '@type': 'Answer', text: 'Associate dentists, dental specialists, practice managers, lead hygienists, treatment coordinators, regional dental managers, and other clinical and practice-operations roles.' } },
    ...
    <JobPlacementHubLinks industry="dental" />
