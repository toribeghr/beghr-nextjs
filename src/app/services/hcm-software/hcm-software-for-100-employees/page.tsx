...
const faqs = [
  ...
  },
  {
    ...
    a: 'Many 100-employee companies are running payroll in one tool, benefits in another, and time tracking in a third. The cost of stitching those together shows up as double entry, reconciliation, and reporting headaches. iSolved consolidates them into one connected platform, and BEG manages the move.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. iSolved is built for growing, more complex companies, including multi-state payroll and deeper benefits administration. That breadth is one of the main reasons firms choose it as they pass 100 employees.',
  },
  {
      ...
      <section className="hero" style={{ background: '#000000', color: '#ffffff', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ fontSize: '1.15rem', color: '#cccccc', maxWidth: '700px' }}>
            At 100 employees, HR is a real function and the patchwork of separate tools you started with begins to cost you. iSolved consolidates payroll, HR, time, and benefits onto one connected platform, with BEG managing the setup and support.
          </p>
