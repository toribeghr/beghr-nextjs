...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/alternatives-to-trinet' },
  openGraph: {
    title: 'Best TriNet Alternative | iSolved + Claude AI | BEG',
    description: 'Want more control than a PEO like TriNet gives? See the top TriNet alternatives for 50-500 employees, including iSolved, a connected platform managed by BEG.',
    url: 'https://beghr.com/services/hcm-software/alternatives-to-trinet',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Best TriNet Alternative | iSolved + Claude AI | BEG', description: 'Want more control than a PEO like TriNet gives? See the top TriNet alternatives for 50-500 employees, including iSolved, a connected platform managed by BEG.', images: ['https://beghr.com/assets/og-image.png'] },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Alternatives to TriNet', item: 'https://beghr.com/services/hcm-software/alternatives-to-trinet' },
  ],
};
