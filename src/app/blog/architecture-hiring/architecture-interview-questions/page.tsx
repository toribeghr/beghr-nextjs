...
export const metadata: Metadata = {
  title: 'Architecture Interview Questions That Reveal Real Talent | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Architecture Interview Questions That Reveal Real Talent | BEG', description: 'Most architecture interviews focus on portfolio and miss the judgment, leadership, and delivery record that decide whether a hire succeeds. The questions that matter.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/architecture-hiring/architecture-interview-questions');
