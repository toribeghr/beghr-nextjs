...
export const metadata: Metadata = {
  ...
  description: DESC,
  alternates: { canonical: 'https://beghr.com/resources/final-paycheck-calculator' },
  openGraph: {
    title: 'Final Paycheck Calculator by State (2026) | BEG',
    description: DESC,
    url: 'https://beghr.com/resources/final-paycheck-calculator',
    ...
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Final Paycheck Calculator', item: 'https://beghr.com/resources/final-paycheck-calculator' },
        ],
      }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        url: 'https://beghr.com/resources/final-paycheck-calculator', description: DESC,
