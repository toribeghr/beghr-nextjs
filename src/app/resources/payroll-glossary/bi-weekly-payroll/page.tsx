...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/bi-weekly-payroll' },
  openGraph: {
    title: 'Bi-Weekly Payroll | Payroll Glossary | BEG',
    description: 'Learn how bi-weekly payroll works, how it compares to semi-monthly, and what the 27-payroll-year means for salary calculations.',
    url: 'https://beghr.com/resources/payroll-glossary/bi-weekly-payroll',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/bi-weekly-payroll', url: 'https://beghr.com/resources/payroll-glossary/bi-weekly-payroll', name: 'Bi-Weekly Payroll | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Bi-Weekly Payroll', description: 'Learn how bi-weekly payroll works, how it compares to semi-monthly, and what the 27-payroll-year means for salary calculations.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Bi-Weekly Payroll', item: 'https://beghr.com/resources/payroll-glossary/bi-weekly-payroll' },
            ]},
          ]
        }) }} />
      </section>
