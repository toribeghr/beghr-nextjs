...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/agriculture/seasonal-agricultural-payroll' },
  openGraph: {
    title: 'Seasonal Farm Payroll | Hire and Terminate at Scale | BEG',
    description: 'Seasonal agricultural payroll guide: FLSA exemptions, peak-season ramp-up, onboarding at scale, pay frequency requirements, and year-end offboarding for farm workers.',
    url: 'https://beghr.com/blog/payroll/agriculture/seasonal-agricultural-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Seasonal Farm Payroll | Hire and Terminate at Scale | BEG', description: 'How to hire, pay, and terminate seasonal farm workers at scale. FLSA exemptions and year-end compliance.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Seasonal Agricultural Payroll', item: 'https://beghr.com/blog/payroll/agriculture/seasonal-agricultural-payroll' },
        ]
      }) }} />
    </article>
  );
