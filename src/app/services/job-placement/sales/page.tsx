...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/sales' },
  openGraph: { title: 'Sales Placement | AEs, VPs & Sales Leaders | BEG', description: 'Fill AE, sales director, and VP of Sales roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', url: 'https://beghr.com/services/job-placement/sales', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Sales Placement | AEs, VPs & Sales Leaders | BEG', description: 'Fill AE, sales director, and VP of Sales roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementSalesPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Sales placement\",\"name\":\"Sales Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/sales\",\"description\":\"Permanent sales placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
