...
export const metadata: Metadata = {
  title: 'Switch From Gusto to iSolved | BEG Manages It',
  description: 'Switching from Gusto to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.',
  alternates: { canonical: 'https://www.beghr.com/services/hcm-software/switch-from-gusto-to-isolved' },
  openGraph: {
    title: 'Switch From Gusto to iSolved | BEG Manages It',
    description: 'Switching from Gusto to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.',
    url: 'https://www.beghr.com/services/hcm-software/switch-from-gusto-to-isolved',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Switch From Gusto to iSolved | BEG Manages It', description: 'Switching from Gusto to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.', images: ['https://www.beghr.com/assets/og-image.png'] },
...
const faqs = [
  {
    q: 'Is switching from Gusto to iSolved really painless?',
  ...
  {
    q: 'Will I lose my Gusto payroll history when I switch?',
  ...
  {
    q: 'Why move from Gusto to iSolved as we grow?',
    a: 'Gusto is software only and built for small business. As you grow into complex multi-state payroll and the mid-market, iSolved gives you one connected platform plus a managed service from BEG.',
  },
  {
    q: 'How long does the switch from Gusto to iSolved take?',
    a: 'Most clients complete the move in 60 to 90 days with no interruption to payroll. BEG plans the timeline around your pay calendar.',
  },
  {
    q: 'Who supports the platform after we switch?',
    a: 'BEG does. You get a dedicated contact who supports, optimizes, and maintains your iSolved platform year-round, rather than administering software on your own.',
  },
];

export default function SwitchFromGustoToiSolvedPage() {
  const faqJsonLd = {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Switch From Gusto to iSolved', item: 'https://www.beghr.com/services/hcm-software/switch-from-gusto-to-isolved' },
    ],
  };
    ...
    <main>
      ...
      <section className="hero" style={{ background: '#000000', color: '#ffffff', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <p className="eyebrow" style={{ color: '#ECAC60' }}>HCM Software · Switch From Gusto</p>
          <h1 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '1rem' }}>
            How to Switch From Gusto to iSolved
          </h1>
          <p style={{ fontSize: '1.15rem', color: '#cccccc', maxWidth: '700px' }}>
            Outgrowing Gusto is a good problem, but moving payroll feels risky. It does not have to. BEG manages the entire migration from Gusto to iSolved, so you step up to one connected platform with a managed service behind it.
          </p>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ color: '#444', lineHeight: '1.7', marginBottom: '1.5rem' }}>
            Gusto serves small teams well. As you grow into complex multi-state payroll and the mid-market, a software only tool you administer yourself starts to feel thin. The thing that stops people from moving is the migration itself. So BEG owns it. We do not hand you a checklist and wish you luck. We run the migration for you.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
            {[
              { title: 'We manage the migration', desc: 'BEG moves your payroll history, employee records, and benefits data from Gusto into iSolved.' },
      ...
      <section style={{ background: '#f9f9f9', padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          {[
            { step: '1. Discovery and plan', desc: 'We review your Gusto setup, your pay calendar, and your growth plans, then build a timeline that fits your business.' },
      ...
      <section style={{ background: '#000000', color: '#ffffff', padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc', marginBottom: '1rem' }}>
            You move from a software only tool to one connected platform with a managed service. Payroll, HR, time, and benefits live together in iSolved, built for the mid-market you are growing into.
          </p>
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc', marginBottom: '1rem' }}>
            You also gain the only HCM platform with a Connector for Claude, generally available in June 2026, that completes real HR tasks through a conversation. Gusto has no equivalent.
          </p>
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc' }}>
            And you gain a partner. BEG implements, configures, supports, and optimizes iSolved for you, instead of leaving you to run it alone. The platform serves more than 7 million employees and Forrester documented a 330% ROI.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <h2 style={{ fontSize: '1.6rem', fontWeight: '700', marginBottom: '1.5rem' }}>Switching From Gusto FAQ</h2>
          {faqs.map(({ q, a }, i) => (
      ...
      <section style={{ background: '#ECAC60', padding: '3rem 0', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '700px' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: '800', color: '#000000', marginBottom: '0.75rem' }}>
            Ready to Switch From Gusto to iSolved?
          </h2>
