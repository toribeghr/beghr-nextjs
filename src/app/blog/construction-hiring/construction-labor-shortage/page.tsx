...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'The Construction Labor Shortage in 2026 | BEG', description: 'Skilled trades are retiring and fewer workers are entering. What the 2026 construction shortage means and how to fill management roles in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <RelatedTool
          variant="link"
          eyebrow={`Free Tool`}
          heading={`What is this open construction role costing you right now?`}
