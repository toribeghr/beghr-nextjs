        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Managed Payroll vs. In-House for Auto Dealerships', item: 'https://beghr.com/blog/payroll/auto-dealership/managed-payroll-vs-in-house' },
            ],
          }),
        }}
      />
