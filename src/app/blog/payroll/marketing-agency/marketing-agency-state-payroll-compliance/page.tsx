...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/marketing-agency/marketing-agency-state-payroll-compliance' },
  openGraph: {
    title: 'Marketing & PR Agencies: State Payroll Compliance Issues | B',
    description: 'Managed payroll for marketing agencies. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/marketing-agency/marketing-agency-state-payroll-compliance',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Marketing & PR Agencies: State Payroll Compliance Issues | B', description: 'Managed payroll for marketing agencies. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
