...
export const metadata: Metadata = {
  ...
  description: 'Direct hire recruiting for security engineer, architect, and CISO roles. 23-35 day fills at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/cybersecurity' },
  openGraph: { title: 'Cybersecurity Placement | Instant Fee Quote | BEG', description: 'Direct hire recruiting for security engineer, architect, and CISO roles. 23-35 day fills at roughly 50% less than contingency. 45-day guarantee.', url: 'https://www.beghr.com/services/job-placement/cybersecurity', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Cybersecurity Placement | Instant Fee Quote | BEG', description: 'Direct hire recruiting for security engineer, architect, and CISO roles. 23-35 day fills at roughly 50% less than contingency. 45-day guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementCybersecurityPage() {
  return (
    ...
    <JobPlacementHubLinks industry="cybersecurity" />
