...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-hr-outsourcing-leave-maryland-paid-sick-leave-explained.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Does Maryland Require Paid Sick Leave? | BEG', description: 'Does Maryland mandate paid sick leave? What a compliant policy needs, plus FMLA basics and how HR outsourcing keeps it current.', images: ['https://www.beghr.com/blog-images/blog-hr-outsourcing-leave-maryland-paid-sick-leave-explained.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-hr-outsourcing-leave-maryland-paid-sick-leave-explained.webp" alt={`An HR team reviewing employee documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
