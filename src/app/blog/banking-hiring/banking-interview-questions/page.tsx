...
export const metadata: Metadata = {
  title: 'Banking Interview Questions That Identify High-Performing Candidates | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Banking Interview Questions That Identify High-Performing Candidates | BEG', description: 'Commercial banking interviews that go beyond credentials. The questions that reveal credit judgment, relationship-building ability, and regulatory fitness.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/banking-hiring/banking-interview-questions');
