...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/services/managed-payroll/kansas' },
  openGraph: {
    title: 'Kansas Managed Payroll Services | BEG | $25-$45 PEPM',
    description: 'Fully managed payroll for Kansas employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.',
    url: 'https://www.beghr.com/services/managed-payroll/kansas',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Kansas Managed Payroll Services | BEG | $25-$45 PEPM', description: 'Fully managed payroll for Kansas employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Kansas', item: 'https://www.beghr.com/services/managed-payroll/kansas' },
            ],
          })
        }}
      />
