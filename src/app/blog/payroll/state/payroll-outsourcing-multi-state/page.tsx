...
export const metadata: Metadata = {
  title: 'Multi-State Payroll Outsourcing: Guide for Businesse.. | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-multi-state' },
  openGraph: {
    title: 'Multi-State Payroll Outsourcing: Guide for Businesse.. | BEG',
    description: 'Multi-State Payroll Outsourcing: Guide for Businesses in 2+ States. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.',
    url: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-multi-state',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Multi-State Payroll Outsourcing: Guide for Businesse.. | BEG', description: 'Multi-State Payroll Outsourcing: Guide for Businesses in 2+ States. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        ...
        <p>BEG serves businesses nationally, including Multi State. All Multi State state filings are included in the base PEPM fee. No per-state add-ons.</p>
