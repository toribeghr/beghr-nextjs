...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-manufacturing-outsourcing-payroll.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Manufacturing Payroll Outsourcing: Is It Worth It? | BEG', description: 'Manufacturing payroll outsourcing vs. hiring in-house. Real cost comparison: shift differentials, overtime, union CBA compliance. Save $55K-$100K annually.', images: ['https://www.beghr.com/blog-images/blog-payroll-manufacturing-outsourcing-payroll.webp'] },
  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-payroll-manufacturing-outsourcing-payroll.webp", "headline": "Manufacturing Payroll Outsourcing: Is It Worth It? | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/manufacturing/outsourcing-payroll"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-manufacturing-outsourcing-payroll.webp" alt={`A clean modern factory floor with workers operating machinery`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
