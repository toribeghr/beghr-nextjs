...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/time-to-fill-report' },
  openGraph: { title: 'Time-to-Fill Benchmark Report 2026 | BEG', description: 'Average days-to-fill by role in 2026, from public hiring benchmarks, each set against BEG permanent placement at a 23-35 day average.', url: 'https://beghr.com/resources/time-to-fill-report', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Time-to-Fill Benchmark Report 2026 | BEG', description: 'Average days-to-fill by role in 2026, from public hiring benchmarks, each set against BEG permanent placement at a 23-35 day average.', images: ['https://beghr.com/assets/og-image.png'] },
};
