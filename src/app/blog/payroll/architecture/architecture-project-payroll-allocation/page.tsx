...
export const metadata: Metadata = {
  title: "Architecture Project Payroll Allocation | AIA Billing | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/architecture/architecture-project-payroll-allocation" },
  openGraph: {
    title: "Architecture Project Payroll Allocation | AIA Billing | BEG",
    description: "How architecture firms align project-coded payroll with AIA billing structures. Track labor by project, improve profitability, and bill accurately. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/architecture/architecture-project-payroll-allocation",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Architecture Project Payroll Allocation | AIA Billing | BEG", description: "Project-coded payroll for architecture firms aligned to AIA billing. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Project Payroll Allocation", "item": "https://beghr.com/blog/payroll/architecture/architecture-project-payroll-allocation" }
        ]
      }) }} />
    </article>
  );
