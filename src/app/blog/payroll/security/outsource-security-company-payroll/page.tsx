...
export const metadata: Metadata = {
  title: "Outsource Security Company Payroll | BEG Guide",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/security/outsource-security-company-payroll" },
  openGraph: {
    title: "Outsource Security Company Payroll | BEG Guide",
    ...
    url: "https://beghr.com/blog/payroll/security/outsource-security-company-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Outsource Security Company Payroll | BEG Guide", description: "Why security companies outsource payroll and what changes immediately after switching to managed payroll.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Outsource Security Payroll", "item": "https://beghr.com/blog/payroll/security/outsource-security-company-payroll" }
        ]
      }) }} />
    </article>
  );
