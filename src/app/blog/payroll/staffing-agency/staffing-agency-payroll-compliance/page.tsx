...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/staffing-agency/staffing-agency-payroll-compliance' },
  openGraph: {
    title: 'Staffing Agency Payroll Compliance 2026 | BEG Guide',
    description: 'Staffing agency payroll compliance: IRS classification test, FLSA for temp workers, state registration, workers comp, and multi-state new hire reporting.',
    url: 'https://beghr.com/blog/payroll/staffing-agency/staffing-agency-payroll-compliance',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Staffing Agency Payroll Compliance 2026 | BEG Guide', description: 'Staffing agency payroll compliance: IRS classification, FLSA, state registration, and multi-state reporting.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Staffing Agency Payroll Compliance', item: 'https://beghr.com/blog/payroll/staffing-agency/staffing-agency-payroll-compliance' },
        ]
      }) }} />
    </article>
  );
