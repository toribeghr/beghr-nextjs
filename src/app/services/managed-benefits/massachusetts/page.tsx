...
export const metadata: Metadata = {
  title: 'Massachusetts Mini-COBRA Continuation Rules | BEG',
  description: 'Massachusetts mini-COBRA: state continuation coverage rules, employer size, 36 month limit, and who runs the notices. You keep your broker.',
  alternates: { canonical: 'https://www.beghr.com/services/managed-benefits/massachusetts' },
  openGraph: {
    title: 'Massachusetts Mini-COBRA Continuation Rules | BEG',
    description: 'Massachusetts mini-COBRA: state continuation coverage rules, employer size, 36 month limit, and who runs the notices. You keep your broker.',
    url: 'https://www.beghr.com/services/managed-benefits/massachusetts',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Massachusetts Mini-COBRA Continuation Rules | BEG', description: 'Massachusetts mini-COBRA: state continuation coverage rules, employer size, 36 month limit, and who runs the notices. You keep your broker.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('managed-benefits-massachusetts');
...
export default function ManagedBenefitsMassachusettsPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Massachusetts mini-COBRA and state continuation coverage rules',
            description: 'Massachusetts mini-COBRA: state continuation coverage rules, employer size, 36 month limit, and who runs the notices. You keep your broker.',
            author: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' },
            publisher: { '@type': 'Organization', name: 'Business Executive Group' },
            datePublished: '2026-07-05',
            mainEntityOfPage: 'https://www.beghr.com/services/managed-benefits/massachusetts',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Massachusetts', item: 'https://www.beghr.com/services/managed-benefits/massachusetts' },
            ],
          }),
        }}
      />
      <ServicePage
        showHeroImage={false}
        eyebrow="Managed Benefits · Massachusetts"
        title="Massachusetts makes small employers offer continuation. Someone has to run it."
        description="Massachusetts is a mini-COBRA state: smaller employers must let departing employees keep group coverage under state law. BEG Managed Benefits, powered by isolved, runs the notices, elections, and premium tracking so the rules are handled. You keep your broker; we do the administration."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="managed-benefits" />}
        heroStats={[
          { value: '36 months', label: 'Massachusetts state continuation limit' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '860px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Massachusetts Continuation, In Brief</p>
            ...
            <div style={{ overflowX: 'auto', marginTop: '2rem' }} className="reveal">
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>State law</td><td style={{ padding: '12px 16px', color: '#555555' }}>Mass. Gen. Laws ch. 176J, section 9</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Employers covered</td><td style={{ padding: '12px 16px', color: '#555555' }}>small group health benefit plans issued to employers with 2 to 19 eligible employees (below the federal COBRA 20-employee threshold)</td></tr>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Marketplace</td><td style={{ padding: '12px 16px', color: '#555555' }}>State-based marketplace: Massachusetts Health Connector (uses its own platform, not HealthCare.gov).</td></tr>
                </tbody>
              </table>
            </div>
            <p className="reveal" style={{ fontSize: '0.8rem', color: '#888888', marginTop: '1rem', textAlign: 'center', lineHeight: 1.6 }}>
              Source: <a href="https://malegislature.gov/Laws/GeneralLaws/PartI/TitleXXII/Chapter176J/Section9" target="_blank" rel="noopener noreferrer">Massachusetts statute and department of insurance (malegislature.gov)</a>. This page is general information, not legal advice.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>A small Massachusetts employer carries big-company continuation duties</h2>
            </div>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Massachusetts continuation coverage, answered</h2>
            </div>
