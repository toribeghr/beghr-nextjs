...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Agency Payroll: Managed for Under 25 Employees | BEG', description: 'Managed payroll for marketing agencies. Managed Payroll for Small Businesses (Under 25 Employees). $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
