...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/alternatives-to-workday' },
  openGraph: {
    title: 'Best Workday Alternative | iSolved + Claude AI | BEG',
    description: 'Workday too expensive and slow to implement for the mid-market? See the top Workday alternatives for 50-500 employees, including iSolved, managed by BEG.',
    url: 'https://beghr.com/services/hcm-software/alternatives-to-workday',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Best Workday Alternative | iSolved + Claude AI | BEG', description: 'Workday too expensive and slow to implement for the mid-market? See the top Workday alternatives for 50-500 employees, including iSolved, managed by BEG.', images: ['https://beghr.com/assets/og-image.png'] },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Alternatives to Workday', item: 'https://beghr.com/services/hcm-software/alternatives-to-workday' },
  ],
};
