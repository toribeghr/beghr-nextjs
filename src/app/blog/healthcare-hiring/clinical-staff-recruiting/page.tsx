...
export const metadata: Metadata = {
  title: 'Clinical Staff Recruiting (2026 Guide) | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/healthcare-hiring/clinical-staff-recruiting' },
  openGraph: {
    title: 'Clinical Staff Recruiting (2026 Guide) | BEG',
    description: 'The strongest clinical candidates are employed and passive. How to recruit nurses, NPs, and clinical leaders without relying on job boards.',
    url: 'https://beghr.com/blog/healthcare-hiring/clinical-staff-recruiting',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Clinical Staff Recruiting (2026 Guide) | BEG', description: 'The strongest clinical candidates are employed and passive. How to recruit nurses, NPs, and clinical leaders without relying on job boards.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/healthcare-hiring/clinical-staff-recruiting');
...
export default function ClinicalStaffRecruitingPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Clinical Staff Recruiting (2026 Guide) | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/healthcare-hiring/clinical-staff-recruiting"}) }} />
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <div style={{ background: '#000', color: '#fff', padding: '2.5rem', borderRadius: '8px', textAlign: 'center', margin: '3rem 0' }}>
          ...
          <p style={{ marginBottom: '1.5rem', color: '#ddd' }}>Free 15-minute call. Tell us the roles and the timeline. We will tell you what our clinical pipeline looks like and whether milestone placement fits.</p>
          <a href={CALENDLY} target="_blank" rel="noopener noreferrer"
