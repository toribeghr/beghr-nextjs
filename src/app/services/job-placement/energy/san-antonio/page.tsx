...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/energy/san-antonio' },
  openGraph: { title: 'Energy Recruiters in San Antonio | BEG', description: 'Energy placement in San Antonio in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/energy/san-antonio', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Energy Recruiters in San Antonio | BEG', description: 'Energy placement in San Antonio in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementEnergySanantonioPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Energy placement\",\"name\":\"Energy Placement in San Antonio\",\"areaServed\":{\"@type\":\"City\",\"name\":\"San Antonio\"},\"url\":\"https://beghr.com/services/job-placement/energy/san-antonio\",\"description\":\"Permanent energy placement in San Antonio in 23-35 days at roughly 50% less than contingency.\"}" }} />
