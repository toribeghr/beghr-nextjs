...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/events/outsource-event-company-payroll" },
  openGraph: {
    title: "Outsource Event Company Payroll | Seasonal | BEG",
    description: "Why event companies outsource payroll: seasonal crew cycles, multi-state compliance, AB5, and classification risk. BEG at $25-$45 PEPM, 3-5 day setup.",
    url: "https://beghr.com/blog/payroll/events/outsource-event-company-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Outsource Event Company Payroll | Seasonal | BEG", description: "Why event companies outsource payroll and how fast they can onboard. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Outsource Event Company Payroll", "item": "https://beghr.com/blog/payroll/events/outsource-event-company-payroll" }
        ]
      }) }} />
    </article>
  );
