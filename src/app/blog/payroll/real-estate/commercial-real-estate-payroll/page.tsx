...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/real-estate/commercial-real-estate-payroll" },
  openGraph: {
    title: "Commercial Real Estate Payroll | Brokers, Splits & Draws | BEG",
    ...
    url: "https://beghr.com/blog/payroll/real-estate/commercial-real-estate-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Commercial Real Estate Payroll | Brokers, Splits & Draws | BEG", description: "CRE payroll: broker commission splits, draw programs, contractor classification, and multi-state filings. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: "BEG manages CRE firm payroll at $25 per employee per month on your existing system, or $45 per employee per month on BEG's iSolved platform. For a 20-person firm with a mix of brokers and staff, that is $500 to $900 per month, all-inclusive: commission tracking support, multi-state withholding, tax filings, W-2 and 1099 production. No per-run fees.",
  },
];
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Commercial Real Estate Payroll", "item": "https://beghr.com/blog/payroll/real-estate/commercial-real-estate-payroll" }
        ]
      }) }} />
    </article>
  );
