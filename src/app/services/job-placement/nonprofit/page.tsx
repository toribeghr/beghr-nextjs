...
export const metadata: Metadata = {
  title: 'Nonprofit Placement & Recruiting | Instant Fee Quote | BEG',
  ...
  openGraph: { title: 'Nonprofit Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill executive director, development, and program roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day guarantee.', url: 'https://www.beghr.com/services/job-placement/nonprofit', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Nonprofit Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill executive director, development, and program roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementNonprofitPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Nonprofit placement\",\"name\":\"Nonprofit Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://www.beghr.com/services/job-placement/nonprofit\",\"description\":\"Permanent nonprofit placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
    ...
    <JobPlacementHubLinks industry="nonprofit" />
