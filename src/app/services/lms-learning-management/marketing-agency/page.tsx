...
export default function LmsMarketingAgencyPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: 'https://www.beghr.com/services/lms-learning-management/marketing-agency',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Marketing Agencies LMS', item: 'https://www.beghr.com/services/lms-learning-management/marketing-agency' },
            ],
          }),
        }}
      />
      ...
      <ServicePage
        ...
        heroStats={[
          ...
          { value: 'Built for Agencies', label: 'Configured to your roles and requirements' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '980px' }}>
            <div className="head center reveal">
              ...
              <h2>Training built for how marketing agencies teams actually operate</h2>
            </div>
            <div className="beg-grid-3 reveal">
              {[
                {
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Learning management for marketing agencies, answered</h2>
            </div>
