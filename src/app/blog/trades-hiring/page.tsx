...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/trades-hiring' },
  openGraph: {
    title: 'Skilled Trades Hiring | BEG Blog',
    description: 'Skilled trades shortage trends, hiring electricians, maintenance tech recruiting, and trades salary insights for employers who need to fill roles fast.',
    url: 'https://beghr.com/blog/trades-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Skilled Trades Hiring | BEG Blog', description: 'Skilled trades shortage trends, hiring electricians, maintenance tech recruiting, and trades salary insights for employers who need to fill roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Trades Hiring', item: 'https://beghr.com/blog/trades-hiring' },
            ],
          }),
        }}
      />
