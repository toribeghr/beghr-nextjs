...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Healthcare Payroll Outsourcing Cost (Full Breakdown) | BEG', description: 'Managed payroll for healthcare. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
