...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/form-w4' },
  openGraph: {
    title: 'Form W-4 | Payroll Glossary | BEG',
    description: 'Learn how Form W-4 works, the 2020 redesign, what happens with no W-4, and when employees should update it.',
    url: 'https://beghr.com/resources/payroll-glossary/form-w4',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/form-w4', url: 'https://beghr.com/resources/payroll-glossary/form-w4', name: 'Form W-4 | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Form W-4', description: 'Learn how Form W-4 works, the 2020 redesign, what happens with no W-4, and when employees should update it.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Form W-4', item: 'https://beghr.com/resources/payroll-glossary/form-w4' },
            ]},
          ]
        }) }} />
      </section>
