...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/creditor-garnishment' },
  openGraph: {
    title: 'Creditor Garnishment | Payroll Glossary | BEG',
    description: 'Learn how creditor garnishment works, the CCPA withholding limits, and what employers must do when they receive a creditor garnishment order.',
    url: 'https://beghr.com/resources/payroll-glossary/creditor-garnishment',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/creditor-garnishment', url: 'https://beghr.com/resources/payroll-glossary/creditor-garnishment', name: 'Creditor Garnishment | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Creditor Garnishment', description: 'Learn how creditor garnishment works, the CCPA withholding limits, and what employers must do when they receive a creditor garnishment order.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Creditor Garnishment', item: 'https://beghr.com/resources/payroll-glossary/creditor-garnishment' },
            ]},
          ]
        }) }} />
      </section>
