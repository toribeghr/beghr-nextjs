...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/salon-spa/spa-payroll-compliance" },
  openGraph: {
    title: "Spa Payroll Compliance 2026 | Massage + Esthetics | BEG",
    ...
    url: "https://beghr.com/blog/payroll/salon-spa/spa-payroll-compliance",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Spa Payroll Compliance 2026 | Massage + Esthetics | BEG", description: "Day spa payroll compliance: massage therapist classification, tip reporting, and state wage laws.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Spa Payroll Compliance", "item": "https://beghr.com/blog/payroll/salon-spa/spa-payroll-compliance" }
        ]
      }) }} />
    </article>
  );
