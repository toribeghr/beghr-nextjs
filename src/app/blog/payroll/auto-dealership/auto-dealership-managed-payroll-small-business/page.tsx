...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Auto Dealer Payroll: For Small Business (<25 EE) | BEG',
    description: 'Managed payroll for auto dealerships. Managed Payroll for Small Businesses (Under 25 Employees). $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
