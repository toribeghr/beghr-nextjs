...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-professional-services-accounting.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Accounting Firm Payroll, Outsourced vs. In-House | BEG', description: 'Accounting firm payroll outsourcing vs. hiring in-house. Partner comp, seasonal surge, QuickBooks integration. Save $60K-$95K annually at $25-$45 PEPM.', images: ['https://www.beghr.com/blog-images/blog-payroll-professional-services-accounting.webp'] },
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-professional-services-accounting.webp" alt={`An accountant reviewing spreadsheets and documents at a desk`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
