...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/401k-employer-match' },
  openGraph: {
    title: '401(k) Employer Match | Payroll Glossary | BEG',
    description: 'Employer 401(k) contribution matching employee deferrals -- not FICA-taxable when contributed but taxable upon distribution.',
    url: 'https://beghr.com/resources/payroll-glossary/401k-employer-match',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: '401(k) Employer Match | Payroll Glossary | BEG', description: 'Employer 401(k) contribution matching employee deferrals -- not FICA-taxable when contributed but taxable upon distribution.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/401k-employer-match', url: 'https://beghr.com/resources/payroll-glossary/401k-employer-match', name: '401(k) Employer Match | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: '401(k) Employer Match', description: 'Employer 401(k) contribution matching employee deferrals -- not FICA-taxable when contributed but taxable upon distribution.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: '401(k) Employer Match', item: 'https://beghr.com/resources/payroll-glossary/401k-employer-match' },
            ]},
          ]
        }) }} />
      </section>
