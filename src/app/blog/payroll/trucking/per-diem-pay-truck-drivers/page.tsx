...
export const metadata: Metadata = {
  title: 'Per Diem Pay for Truck Drivers: What Nobody Tells You | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/trucking/per-diem-pay-truck-drivers' },
  openGraph: {
    title: 'Per Diem Pay for Truck Drivers: What Nobody Tells You | BEG',
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Per Diem for Truck Drivers', item: 'https://www.beghr.com/blog/payroll/trucking/per-diem-pay-truck-drivers' },
        ],
      })}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
