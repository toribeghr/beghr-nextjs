...
export const metadata: Metadata = {
  title: 'ACA Reporting and the Employer Mandate for 50+ Emplo.. | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/compliance/aca-reporting-employer-mandate' },
  openGraph: {
    title: 'ACA Reporting and the Employer Mandate for 50+ Emplo.. | BEG',
    description: 'ACA Reporting and the Employer Mandate for 50+ Employees. Expert guidance from BEG managed payroll. Book a free 15-min call to review your payroll compliance at beghr.com.',
    url: 'https://beghr.com/blog/payroll/compliance/aca-reporting-employer-mandate',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'ACA Reporting and the Employer Mandate for 50+ Emplo.. | BEG', description: 'ACA Reporting and the Employer Mandate for 50+ Employees. Expert guidance from BEG managed payroll. Book a free 15-min call to review your payroll compliance at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "ACA Reporting and the Employer Mandate for 50+ Emplo.. | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/payroll/compliance/aca-reporting-employer-mandate"}) }} />
