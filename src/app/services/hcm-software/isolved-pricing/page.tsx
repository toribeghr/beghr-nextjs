...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/isolved-pricing' },
  openGraph: {
    title: 'iSolved Pricing Explained | BEG',
    description: 'How iSolved pricing works: scoped by modules and headcount, transparent, and tailored to your needs. BEG runs a custom cost comparison on what you are buying.',
    url: 'https://beghr.com/services/hcm-software/isolved-pricing',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved Pricing Explained | BEG', description: 'How iSolved pricing works: scoped by modules and headcount, transparent, and tailored to your needs. BEG runs a custom cost comparison on what you are buying.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'iSolved Pricing', item: 'https://beghr.com/services/hcm-software/isolved-pricing' },
  ],
};
