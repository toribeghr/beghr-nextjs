...
export const metadata: Metadata = {
  title: 'Best Paychex Alternative | iSolved + Claude AI | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/alternatives-to-paychex' },
  openGraph: {
    title: 'Best Paychex Alternative | iSolved + Claude AI | BEG',
    description: 'Looking for a Paychex alternative? Compare iSolved, managed by BEG, for companies with 50 to 500 employees. Modern UX, transparent scope, Claude AI, 330% ROI.',
    url: 'https://beghr.com/services/hcm-software/alternatives-to-paychex',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Best Paychex Alternative | iSolved + Claude AI | BEG', description: 'Looking for a Paychex alternative? Compare iSolved, managed by BEG, for companies with 50 to 500 employees. Modern UX, transparent scope, Claude AI, 330% ROI.', images: ['https://beghr.com/assets/og-image.png'] },
...
export default function AlternativesToPaychexPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Alternatives to Paychex', item: 'https://beghr.com/services/hcm-software/alternatives-to-paychex' },
    ],
  };
      ...
      <section className="hero" style={{ background: '#000000', color: '#ffffff', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <Link href={CALENDLY} target="_blank" rel="noopener noreferrer" className="btn btn--gold" style={{ marginTop: '2rem', display: 'inline-block' }}>
            See iSolved vs. Paychex for Free
          </Link>
        </div>
      </section>
