...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-cost-quickbooks-payroll-pricing-explained.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'QuickBooks Payroll Pricing Explained: Tiers, Linked | BEG', description: 'QuickBooks Payroll pricing explained: the published tier structure, what changes by tier, and why the sticker price is not your full cost.', images: ['https://www.beghr.com/blog-images/blog-payroll-cost-quickbooks-payroll-pricing-explained.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-cost-quickbooks-payroll-pricing-explained.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
