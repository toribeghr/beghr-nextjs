...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/resources/salary-guide/accounting-cpa' },
  openGraph: { title: 'Accounting & CPA Salary Guide 2026 | BEG', description: 'Accounting & CPA salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent accounting & cpa talent in 23-35 day', url: 'https://www.beghr.com/resources/salary-guide/accounting-cpa', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Accounting & CPA Salary Guide 2026 | BEG', description: 'Accounting & CPA salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent accounting & cpa talent in 23-35 day', images: ['https://www.beghr.com/assets/og-image.png'] },
};
