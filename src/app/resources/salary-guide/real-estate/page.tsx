...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/resources/salary-guide/real-estate' },
  openGraph: { title: 'Real Estate Salary Guide 2026 | BEG', description: 'Real Estate salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent real estate talent in 23-35 days.', url: 'https://www.beghr.com/resources/salary-guide/real-estate', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Real Estate Salary Guide 2026 | BEG', description: 'Real Estate salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent real estate talent in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
