...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-tennessee' },
  openGraph: {
    title: 'Payroll Outsourcing in Tennessee for Small Businesses | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-tennessee',
