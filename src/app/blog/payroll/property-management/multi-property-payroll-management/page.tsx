...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/property-management/multi-property-payroll-management" },
  openGraph: {
    title: "Multi-Property Payroll | Consolidated Reporting | BEG",
    ...
    url: "https://beghr.com/blog/payroll/property-management/multi-property-payroll-management",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Multi-Property Payroll | Consolidated Reporting | BEG", description: "How to consolidate payroll across multiple properties while maintaining per-property cost allocation and reporting.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Multi-Property Payroll", "item": "https://beghr.com/blog/payroll/property-management/multi-property-payroll-management" }
        ]
      }) }} />
    </article>
  );
