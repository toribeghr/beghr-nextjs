...
export const metadata: Metadata = {
  title: 'Trucking Payroll: When to Outsource | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/trucking/trucking-when-to-outsource-payroll' },
  openGraph: {
    title: 'Trucking Payroll: When to Outsource | BEG',
    description: 'Managed payroll for trucking. Signs Your Business Needs to Outsource Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/trucking/trucking-when-to-outsource-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Trucking Payroll: When to Outsource | BEG', description: 'Managed payroll for trucking. Signs Your Business Needs to Outsource Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
