...
export const metadata: Metadata = {
  title: 'Switch From ADP to isolved | BEG Manages the Move',
  description: 'Switching from ADP to isolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.',
  alternates: { canonical: 'https://www.beghr.com/services/hcm-software/switch-from-adp-to-isolved' },
  openGraph: {
    title: 'Switch From ADP to isolved | BEG Manages the Move',
    description: 'Switching from ADP to isolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.',
    url: 'https://www.beghr.com/services/hcm-software/switch-from-adp-to-isolved',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Switch From ADP to isolved | BEG Manages the Move', description: 'Switching from ADP to isolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.', images: ['https://www.beghr.com/assets/og-image.png'] },
...
const faqs = [
  {
    q: 'Is switching from ADP to isolved really painless?',
  ...
  {
    q: 'Will I lose my ADP payroll history when I switch?',
  ...
  {
    q: 'How long does the switch from ADP to isolved take?',
    a: 'Most clients complete the move in 60 to 90 days with no interruption to payroll. BEG plans the timeline around your pay calendar and your ADP renewal date.',
  },
  {
    q: 'What if my ADP contract is not up yet?',
    a: 'BEG can begin implementation now so you are ready to go live the moment your ADP contract expires. We help you plan the timeline around your renewal.',
  },
  {
...
export default function SwitchFromADPToisolvedPage() {
  const faqJsonLd = {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Switch From ADP to isolved', item: 'https://www.beghr.com/services/hcm-software/switch-from-adp-to-isolved' },
    ],
  };
    ...
    <main>
      ...
      <section className="hero" style={{ background: '#000000', color: '#ffffff', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <p className="eyebrow" style={{ color: '#ECAC60' }}>HCM Software · Switch From ADP</p>
          <h1 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '1rem' }}>
            How to Switch From ADP to isolved
          </h1>
          <p style={{ fontSize: '1.15rem', color: '#cccccc', maxWidth: '700px' }}>
            The fear of switching payroll providers keeps a lot of companies stuck. It does not have to. BEG manages the entire migration from ADP to isolved, so you move to one connected platform without the disruption you are worried about.
          </p>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ color: '#444', lineHeight: '1.7', marginBottom: '1.5rem' }}>
            ADP is a large legacy provider. It works, but for mid-market companies the cost and the impersonal support add up, and the thought of moving everything feels risky. The risk is what stops people. So BEG owns it. We do not hand you a checklist and wish you luck. We run the migration for you.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
            {[
              { title: 'We manage the migration', desc: 'BEG moves your payroll history, employee records, and benefits data from ADP into isolved.' },
      ...
      <section style={{ background: '#f9f9f9', padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          {[
            { step: '1. Discovery and plan', desc: 'We review your ADP setup, your pay calendar, and your renewal date, then build a timeline that fits your business.' },
      ...
      <section style={{ background: '#000000', color: '#ffffff', padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc', marginBottom: '1rem' }}>
            You move from a large generic provider to one connected platform. Payroll, HR, time, and benefits live together in isolved, so your data is consistent and your team stops stitching modules together.
          </p>
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc', marginBottom: '1rem' }}>
            You also gain the only HCM platform with a Connector for Claude, generally available in June 2026, that completes real HR tasks through a conversation. ADP has no equivalent.
          </p>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <h2 style={{ fontSize: '1.6rem', fontWeight: '700', marginBottom: '1.5rem' }}>Switching From ADP FAQ</h2>
          {faqs.map(({ q, a }, i) => (
      ...
      <section style={{ background: '#ECAC60', padding: '3rem 0', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '700px' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: '800', color: '#000000', marginBottom: '0.75rem' }}>
            Ready to Switch From ADP to isolved?
          </h2>
