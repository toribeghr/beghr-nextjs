...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/architecture/architecture-partner-draw-payroll" },
  openGraph: {
    title: "Architecture Partner Draw Payroll | K-1 + W-2 | BEG",
    description: "Architecture partnership payroll: managing partner draws, W-2 salaries, K-1 distributions, and reasonable compensation rules. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/architecture/architecture-partner-draw-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Architecture Partner Draw Payroll | K-1 + W-2 | BEG", description: "Architecture partnership payroll: partner draws, W-2 salaries, and K-1 distributions explained. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Partner Draw Payroll", "item": "https://beghr.com/blog/payroll/architecture/architecture-partner-draw-payroll" }
        ]
      }) }} />
    </article>
  );
