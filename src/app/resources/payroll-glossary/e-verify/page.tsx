...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/e-verify' },
  openGraph: {
    title: 'E-Verify | Payroll Glossary | BEG',
    description: 'Learn what E-Verify is, when it is required, how to enroll, and what to do when the system returns a tentative non-confirmation.',
    url: 'https://beghr.com/resources/payroll-glossary/e-verify',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/e-verify', url: 'https://beghr.com/resources/payroll-glossary/e-verify', name: 'E-Verify | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'E-Verify', description: 'Learn what E-Verify is, when it is required, how to enroll, and what to do when the system returns a tentative non-confirmation.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'E-Verify', item: 'https://beghr.com/resources/payroll-glossary/e-verify' },
            ]},
          ]
        }) }} />
      </section>
