...
export const metadata: Metadata = {
  title: "Therapy Practice Payroll | Per-Session Pay & PTO | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/healthcare/therapy-practice-payroll" },
  openGraph: {
    title: "Therapy Practice Payroll | Per-Session Pay & PTO | BEG",
    ...
    url: "https://beghr.com/blog/payroll/healthcare/therapy-practice-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Therapy Practice Payroll | Clinicians, Billing & PTO Accrual | BEG", description: "Therapy practice payroll: per-session pay, productivity thresholds, PTO for part-time clinicians, and contractor classification. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "Healthcare", "item": "https://beghr.com/blog/payroll/healthcare" },
          { "@type": "ListItem", "position": 5, "name": "Therapy Practice Payroll", "item": "https://beghr.com/blog/payroll/healthcare/therapy-practice-payroll" }
        ]
      }) }} />
    </article>
  );
