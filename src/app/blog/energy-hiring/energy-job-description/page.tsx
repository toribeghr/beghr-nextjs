...
export const metadata: Metadata = {
  title: 'How to Write an Energy Sector Job Description That Attracts Experienced Candidates | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'How to Write an Energy Sector Job Description That Attracts Experienced Candidates | BEG', description: 'Energy JDs that list certifications and skip operational context lose experienced candidates fast. How to write a job description for oil and gas, renewables, or power roles.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/energy-hiring/energy-job-description');
