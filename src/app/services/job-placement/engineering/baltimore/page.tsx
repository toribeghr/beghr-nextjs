...
export const metadata: Metadata = {
  title: 'Engineering Recruiters in Baltimore | BEG',
  description: 'Engineering placement in Baltimore. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/engineering/baltimore' },
  openGraph: { title: 'Engineering Recruiters in Baltimore | BEG', description: 'Engineering placement in Baltimore in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/engineering/baltimore', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Engineering Recruiters in Baltimore | BEG', description: 'Engineering placement in Baltimore in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-engineering-baltimore');

export default function PlacementEngineeringBaltimorePage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Baltimore"
      title="That open engineering role in Baltimore is costing you every week."
      description="Baltimore is a healthcare, biotech, and government-adjacent market where credentialed talent is in short supply. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Baltimore? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Baltimore</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/engineering" style={{ color: '#000000', fontWeight: 600 }}>engineering placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/engineering/washington-dc" style={{ color: '#000000', fontWeight: 600 }}>Washington</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Baltimore?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Baltimore and across Maryland, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
