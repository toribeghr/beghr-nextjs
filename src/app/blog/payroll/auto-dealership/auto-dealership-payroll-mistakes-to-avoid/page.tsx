...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Auto Dealer Payroll Mistakes to Avoid in 2026 | BEG', description: 'Managed payroll for auto dealerships. Payroll Mistakes to Avoid. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
