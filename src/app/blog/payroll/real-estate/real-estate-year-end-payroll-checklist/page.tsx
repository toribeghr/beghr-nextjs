...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Real Estate Payroll: Year-End Checklist | BEG', description: 'Managed payroll for real estate. Year-End Payroll Checklist. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
