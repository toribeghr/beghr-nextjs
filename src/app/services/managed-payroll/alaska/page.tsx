...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/managed-payroll/alaska' },
  openGraph: {
    title: 'Alaska Managed Payroll Services | BEG | $25-$45 PEPM',
    description: 'Fully managed payroll for Alaska employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.',
    url: 'https://beghr.com/services/managed-payroll/alaska',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Alaska Managed Payroll Services | BEG | $25-$45 PEPM', description: 'Fully managed payroll for Alaska employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Alaska', item: 'https://beghr.com/services/managed-payroll/alaska' },
            ],
          })
        }}
      />
