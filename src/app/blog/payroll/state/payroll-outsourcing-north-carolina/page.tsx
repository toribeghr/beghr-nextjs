...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-north-carolina' },
  openGraph: {
    title: 'Payroll Outsourcing in North Carolina | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-north-carolina',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing in North Carolina | BEG', description: 'Payroll Outsourcing in North Carolina. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
