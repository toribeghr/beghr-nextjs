...
export const metadata: Metadata = {
  title: "Multi-Location Restaurant Payroll Reports | BEG Guide",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/multi-unit-restaurant/multi-location-restaurant-payroll-reporting" },
  openGraph: {
    title: "Multi-Location Restaurant Payroll Reports | BEG Guide",
    description: "Per-location payroll reporting for multi-unit restaurant groups: labor cost by location, FOH vs BOH breakdown, P&L integration, and operator-level visibility. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/multi-unit-restaurant/multi-location-restaurant-payroll-reporting",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Multi-Location Restaurant Payroll Reports | BEG Guide", description: "Per-location payroll reporting for multi-unit restaurant operators. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Multi-Location Payroll Reporting", "item": "https://beghr.com/blog/payroll/multi-unit-restaurant/multi-location-restaurant-payroll-reporting" }
        ]
      }) }} />
    </article>
  );
