...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Missouri Paid Sick Leave: A Status Still in Flux | BEG', description: 'Missouri voter-approved sick leave rules were modified by the legislature. What employers should verify before finalizing policy.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
