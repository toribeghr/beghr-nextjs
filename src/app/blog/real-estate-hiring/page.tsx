...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/real-estate-hiring' },
  openGraph: {
    title: 'Real Estate Hiring | BEG Blog',
    description: 'Real estate talent trends, hiring a property manager, asset manager recruiting, and salary insights for leaders who need to fill roles fast.',
    url: 'https://beghr.com/blog/real-estate-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Real Estate Hiring | BEG Blog', description: 'Real estate talent trends, hiring a property manager, asset manager recruiting, and salary insights for leaders who need to fill roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Real Estate Hiring', item: 'https://beghr.com/blog/real-estate-hiring' },
            ],
          }),
        }}
      />
