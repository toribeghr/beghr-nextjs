...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/backup-withholding' },
  openGraph: {
    title: 'Backup Withholding | Payroll Glossary | BEG',
    description: 'Learn what backup withholding is, when it applies to vendor payments, and how to avoid it by collecting accurate W-9 information.',
    url: 'https://beghr.com/resources/payroll-glossary/backup-withholding',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/backup-withholding', url: 'https://beghr.com/resources/payroll-glossary/backup-withholding', name: 'Backup Withholding | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Backup Withholding', description: 'Learn what backup withholding is, when it applies to vendor payments, and how to avoid it by collecting accurate W-9 information.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Backup Withholding', item: 'https://beghr.com/resources/payroll-glossary/backup-withholding' },
            ]},
          ]
        }) }} />
      </section>
