...
export const metadata: Metadata = {
  title: 'How to Hire Commercial Lenders Fast | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/banking-hiring/hiring-commercial-lenders' },
  openGraph: {
    title: 'How to Hire Commercial Lenders Fast | BEG',
    description: 'A vacant commercial lender seat stalls your loan pipeline. A practical playbook to hire lenders in 23-35 days with passive candidate sourcing.',
    url: 'https://beghr.com/blog/banking-hiring/hiring-commercial-lenders',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'How to Hire Commercial Lenders Fast | BEG', description: 'A vacant commercial lender seat stalls your loan pipeline. A practical playbook to hire lenders in 23-35 days with passive candidate sourcing.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/banking-hiring/hiring-commercial-lenders');
...
export default function HiringCommercialLendersPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "How to Hire Commercial Lenders Fast | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/banking-hiring/hiring-commercial-lenders"}) }} />
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <div style={{ background: '#000', color: '#fff', padding: '2.5rem', borderRadius: '8px', textAlign: 'center', margin: '3rem 0' }}>
          ...
          <p style={{ marginBottom: '1.5rem', color: '#ddd' }}>Free 15-minute call. Tell us the segment, market, and timeline. We will tell you what the search looks like and whether milestone placement fits.</p>
          <a href={CALENDLY} target="_blank" rel="noopener noreferrer"
