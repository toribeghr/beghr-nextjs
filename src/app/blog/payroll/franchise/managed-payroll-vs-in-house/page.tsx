...
export const metadata: Metadata = {
  title: 'Managed Payroll vs In-House for Franchise Owners | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-franchise-managed-payroll-vs-in-house.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Managed Payroll vs In-House for Franchise Owners | BEG', description: 'Franchise payroll outsourcing vs. hiring in-house. Real cost comparison for multi-location franchise operators. Multi-brand management, state minimum wa...', images: ['https://www.beghr.com/blog-images/blog-payroll-franchise-managed-payroll-vs-in-house.webp'] },
  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-payroll-franchise-managed-payroll-vs-in-house.webp", "headline": "Managed Payroll vs. Hiring In-House for Franchise Owners | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/franchise/managed-payroll-vs-in-house"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-franchise-managed-payroll-vs-in-house.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
