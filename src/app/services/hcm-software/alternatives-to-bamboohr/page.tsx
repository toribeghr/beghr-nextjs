...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/alternatives-to-bamboohr' },
  openGraph: {
    title: 'Best BambooHR Alternative | iSolved + Claude AI | BEG',
    description: 'Outgrowing BambooHR payroll add-ons and per-employee costs? See the top BambooHR alternatives for 50-500 employees, including iSolved, managed by BEG.',
    url: 'https://beghr.com/services/hcm-software/alternatives-to-bamboohr',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Best BambooHR Alternative | iSolved + Claude AI | BEG', description: 'Outgrowing BambooHR payroll add-ons and per-employee costs? See the top BambooHR alternatives for 50-500 employees, including iSolved, managed by BEG.', images: ['https://beghr.com/assets/og-image.png'] },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Alternatives to BambooHR', item: 'https://beghr.com/services/hcm-software/alternatives-to-bamboohr' },
  ],
};
