...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.beghr.com/blog-images/blog-payroll-retail-seasonal-retail-payroll.webp", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Seasonal Retail Payroll: Peak Hiring, Final Pay & SUI | BEG", description: "Seasonal retail payroll: peak hiring, final pay timing, SUI impact, and offboarding compliance. BEG at $25-$45 PEPM.", images: ["https://www.beghr.com/blog-images/blog-payroll-retail-seasonal-retail-payroll.webp"] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-retail-seasonal-retail-payroll.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
      ...
      <section className="container" style={{ maxWidth: "820px", paddingTop: "3rem", paddingBottom: "4rem" }}>
        ...
        <div style={{ background: "#f5f0e8", border: "2px solid #ECAC60", borderRadius: "8px", padding: "2rem", marginBottom: "2.5rem" }}>
          ...
          <p style={{ lineHeight: "1.7", marginBottom: "1rem" }}>
            BEG manages seasonal retail payroll at $25 to $45 per employee per month. You pay for active employees only.
          </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "BlogPosting",
        "image": "https://beghr.com/blog-images/blog-payroll-retail-seasonal-retail-payroll.webp",
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "Retail", "item": "https://www.beghr.com/blog/payroll/retail" },
          { "@type": "ListItem", "position": 5, "name": "Seasonal Retail Payroll", "item": "https://www.beghr.com/blog/payroll/retail/seasonal-retail-payroll" }
        ]
      }) }} />
