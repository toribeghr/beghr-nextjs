...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Alaska Paid Sick Leave Explained (2026) | BEG', description: 'Does Alaska mandate paid sick leave? What a compliant policy needs: accrual, carryover, uses, and how FMLA fits in for 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
