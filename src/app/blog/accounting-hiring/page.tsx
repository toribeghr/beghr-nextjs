...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/accounting-hiring' },
  openGraph: {
    title: 'Accounting & CPA Hiring | BEG Blog',
    description: 'CPA shortage trends, controller hiring, busy-season staffing, and accounting comp insights for finance leaders who need to fill roles fast.',
    url: 'https://beghr.com/blog/accounting-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Accounting & CPA Hiring | BEG Blog', description: 'CPA shortage trends, controller hiring, busy-season staffing, and accounting comp insights for finance leaders who need to fill roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Accounting Hiring', item: 'https://beghr.com/blog/accounting-hiring' },
            ],
          }),
        }}
      />
