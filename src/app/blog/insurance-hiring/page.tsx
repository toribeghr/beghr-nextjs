...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/insurance-hiring' },
  openGraph: {
    title: 'Insurance Hiring | BEG Blog',
    description: 'Insurance talent crisis trends, underwriter and producer recruiting, and comp insights for carriers and agencies who need to fill roles fast.',
    url: 'https://beghr.com/blog/insurance-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Insurance Hiring | BEG Blog', description: 'Insurance talent crisis trends, underwriter and producer recruiting, and comp insights for carriers and agencies who need to fill roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Insurance Hiring', item: 'https://beghr.com/blog/insurance-hiring' },
            ],
          }),
        }}
      />
