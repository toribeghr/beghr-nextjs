...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/sui-taxable-wage-base' },
  openGraph: {
    title: 'SUI Taxable Wage Base | Payroll Glossary | BEG',
    description: 'The per-employee annual earnings cap subject to state unemployment tax -- varies from $7,000 to over $60,000 depending on the state.',
    url: 'https://beghr.com/resources/payroll-glossary/sui-taxable-wage-base',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'SUI Taxable Wage Base | Payroll Glossary | BEG', description: 'The per-employee annual earnings cap subject to state unemployment tax -- varies from $7,000 to over $60,000 depending on the state.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/sui-taxable-wage-base', url: 'https://beghr.com/resources/payroll-glossary/sui-taxable-wage-base', name: 'SUI Taxable Wage Base | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'SUI Taxable Wage Base', description: 'The per-employee annual earnings cap subject to state unemployment tax -- varies from $7,000 to over $60,000 depending on the state.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'SUI Taxable Wage Base', item: 'https://beghr.com/resources/payroll-glossary/sui-taxable-wage-base' },
            ]},
          ]
        }) }} />
      </section>
