...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'The Tech Talent Shortage in 2026 | BEG', description: 'Demand for specialized engineers keeps climbing while the qualified pool stays thin. How to fill technology roles in 23-35 days anyway.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <RelatedTool
          variant="link"
          eyebrow={`Free Tool`}
          heading={`What is this open technology role costing you right now?`}
