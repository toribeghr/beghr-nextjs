        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Property Management', item: 'https://beghr.com/blog/payroll/real-estate/property-management' },
            ],
          }),
        }}
      />
