...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/isolved-vs-deel' },
  openGraph: {
    title: 'iSolved vs Deel | One Platform + Claude AI | BEG',
    description: 'iSolved vs Deel compared on platform fit, pricing, implementation, support, and AI. See which fits a domestic single-platform need versus global payroll and EOR.',
    url: 'https://beghr.com/services/hcm-software/isolved-vs-deel',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved vs Deel | One Platform + Claude AI | BEG', description: 'iSolved vs Deel compared on platform fit, pricing, implementation, support, and AI. See which fits a domestic single-platform need versus global payroll and EOR.', images: ['https://beghr.com/assets/og-image.png'] },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'iSolved vs Deel', item: 'https://beghr.com/services/hcm-software/isolved-vs-deel' },
  ],
};
