...
export const metadata: Metadata = {
  title: 'California Mini-COBRA Continuation Rules | BEG',
  description: 'California mini-COBRA: state continuation coverage rules, employer size, 36 month limit, and who runs the notices. You keep your broker.',
  alternates: { canonical: 'https://www.beghr.com/services/managed-benefits/california' },
  openGraph: {
    title: 'California Mini-COBRA Continuation Rules | BEG',
    description: 'California mini-COBRA: state continuation coverage rules, employer size, 36 month limit, and who runs the notices. You keep your broker.',
    url: 'https://www.beghr.com/services/managed-benefits/california',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'California Mini-COBRA Continuation Rules | BEG', description: 'California mini-COBRA: state continuation coverage rules, employer size, 36 month limit, and who runs the notices. You keep your broker.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('managed-benefits-california');
...
export default function ManagedBenefitsCaliforniaPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'California mini-COBRA and state continuation coverage rules',
            description: 'California mini-COBRA: state continuation coverage rules, employer size, 36 month limit, and who runs the notices. You keep your broker.',
            author: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' },
            publisher: { '@type': 'Organization', name: 'Business Executive Group' },
            datePublished: '2026-07-05',
            mainEntityOfPage: 'https://www.beghr.com/services/managed-benefits/california',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'California', item: 'https://www.beghr.com/services/managed-benefits/california' },
            ],
          }),
        }}
      />
      <ServicePage
        showHeroImage={false}
        eyebrow="Managed Benefits · California"
        title="California makes small employers offer continuation. Someone has to run it."
        description="California is a mini-COBRA state: smaller employers must let departing employees keep group coverage under state law. BEG Managed Benefits, powered by isolved, runs the notices, elections, and premium tracking so the rules are handled. You keep your broker; we do the administration."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="managed-benefits" />}
        heroStats={[
          { value: '36 months', label: 'California state continuation limit' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '860px' }}>
            <div className="head center reveal">
              <p className="eyebrow">California Continuation, In Brief</p>
              <h2>What California law requires</h2>
            </div>
            <div style={{ overflowX: 'auto', marginTop: '2rem' }} className="reveal">
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>State law</td><td style={{ padding: '12px 16px', color: '#555555' }}>Cal. Health &amp; Safety Code section 1366.20 et seq. (health care service plans, DMHC); Cal. Ins. Code section 10128.50 et seq. (disability/health insurers, CDI)</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Employers covered</td><td style={{ padding: '12px 16px', color: '#555555' }}>employers with 2 to 19 eligible employees (below the 20-employee federal COBRA threshold); also extends federal COBRA beneficiaries to a combined 36 months</td></tr>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Marketplace</td><td style={{ padding: '12px 16px', color: '#555555' }}>State-based marketplace: Covered California (uses its own platform, not HealthCare.gov).</td></tr>
                </tbody>
              </table>
            </div>
            <p className="reveal" style={{ fontSize: '0.8rem', color: '#888888', marginTop: '1rem', textAlign: 'center', lineHeight: 1.6 }}>
              Source: <a href="https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=HSC&sectionNum=1366.20." target="_blank" rel="noopener noreferrer">California statute and department of insurance (leginfo.legislature.ca.gov)</a>. This page is general information, not legal advice.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>A small California employer carries big-company continuation duties</h2>
            </div>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>California continuation coverage, answered</h2>
            </div>
