...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing in Michigan: What Employers Need.. | BEG', description: 'Payroll Outsourcing in Michigan: What Employers Need to Know. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
