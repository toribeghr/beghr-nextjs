...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Vet Practice Payroll Features: What Nobody Tells You | BEG', description: 'Managed payroll for veterinary. Payroll Features Every Business Needs. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
