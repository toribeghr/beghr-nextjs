...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/managed-payroll/florida' },
  openGraph: {
    title: 'Florida Managed Payroll Services | BEG | $25-$45 PEPM',
    description: 'Fully managed payroll for Florida employers at $25-$45 PEPM. No state income tax, simplified compliance. No migration required.',
    url: 'https://beghr.com/services/managed-payroll/florida',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Florida Managed Payroll Services | BEG | $25-$45 PEPM', description: 'Fully managed payroll for Florida employers at $25-$45 PEPM. No state income tax, simplified compliance. No migration required.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Florida', item: 'https://beghr.com/services/managed-payroll/florida' },
            ],
          })
        }}
      />
