...
export const metadata: Metadata = {
  title: 'Switch Rippling to isolved | Instant Price Quote | BEG',
  description: 'Switching from Rippling to isolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round.',
  alternates: { canonical: 'https://www.beghr.com/services/hcm-software/switch-from-rippling-to-isolved' },
  openGraph: {
    title: 'Switch Rippling to isolved | Instant Price Quote | BEG',
    description: 'Switching from Rippling to isolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round.',
    url: 'https://www.beghr.com/services/hcm-software/switch-from-rippling-to-isolved',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Switch Rippling to isolved | Instant Price Quote | BEG', description: 'Switching from Rippling to isolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round.', images: ['https://www.beghr.com/assets/og-image.png'] },
...
const faqs = [
  {
    q: 'Is switching from Rippling to isolved really painless?',
  ...
  {
    q: 'Will I lose my Rippling data when I switch?',
  ...
  {
    q: 'How long does the switch from Rippling to isolved take?',
    a: 'Most clients complete the move in 60 to 90 days with no interruption to payroll. BEG plans the timeline around your pay calendar and your Rippling renewal date.',
  },
  {
    q: 'Rippling is very IT-centric. Will isolved feel different?',
    a: 'Yes. Rippling is built around IT and device management as much as HR. The isolved platform is a connected HCM system focused on payroll, HR, time, and benefits, and BEG runs it for you so it does not all land on your IT team.',
  },
  {
...
export default function SwitchFromRipplingToisolvedPage() {
  const faqJsonLd = {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Switch From Rippling to isolved', item: 'https://www.beghr.com/services/hcm-software/switch-from-rippling-to-isolved' },
    ],
  };
    ...
    <main>
      ...
      <section className="hero" style={{ background: '#000000', color: '#ffffff', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <p className="eyebrow" style={{ color: '#ECAC60' }}>HCM Software · Switch From Rippling</p>
          <h1 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '1rem' }}>
            How to Switch From Rippling to isolved
          </h1>
          <p style={{ fontSize: '1.15rem', color: '#cccccc', maxWidth: '700px' }}>
            The fear of switching providers keeps a lot of companies stuck. It does not have to. BEG manages the entire migration from Rippling to isolved, so you move to one connected, HR-focused platform without the disruption you are worried about.
          </p>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ color: '#444', lineHeight: '1.7', marginBottom: '1.5rem' }}>
            Rippling is a modern, powerful all-in-one for HR, IT, and payroll. It is also complex, IT-centric, and software-only, with pricing that can be hard to pin down. For teams that want HR and payroll at the center, run by a partner rather than configured in-house, the move makes sense. The risk of moving is what stops people. So BEG owns it. We do not hand you a checklist and wish you luck. We run the migration for you.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
            {[
              { title: 'We manage the migration', desc: 'BEG moves your payroll history, employee records, and benefits data from Rippling into isolved.' },
      ...
      <section style={{ background: '#f9f9f9', padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          {[
            { step: '1. Discovery and plan', desc: 'We review your Rippling setup, your pay calendar, and your renewal date, then build a timeline that fits your business.' },
      ...
      <section style={{ background: '#000000', color: '#ffffff', padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc', marginBottom: '1rem' }}>
            You move from a complex, IT-centric system to one connected, HR-focused platform. Payroll, HR, time, and benefits live together in isolved, so your data is consistent and your team is not configuring a sprawling tool on its own.
          </p>
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc', marginBottom: '1rem' }}>
            You also gain the only HCM platform with a Connector for Claude, generally available in June 2026, that completes real HR tasks through a conversation. Rippling has no equivalent.
          </p>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <h2 style={{ fontSize: '1.6rem', fontWeight: '700', marginBottom: '1.5rem' }}>Switching From Rippling FAQ</h2>
          {faqs.map(({ q, a }, i) => (
      ...
      <section style={{ background: '#ECAC60', padding: '3rem 0', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '700px' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: '800', color: '#000000', marginBottom: '0.75rem' }}>
            Ready to Switch From Rippling to isolved?
          </h2>
