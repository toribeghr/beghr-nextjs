...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/nonprofits/501c3-payroll-compliance" },
  openGraph: {
    title: "501(c)(3) Payroll Compliance | Nonprofit FICA, FUTA & 990 | BEG",
    ...
    url: "https://beghr.com/blog/payroll/nonprofits/501c3-payroll-compliance",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "501(c)(3) Payroll Compliance | Nonprofit FICA, FUTA & 990 | BEG", description: "Nonprofit payroll: FICA exemptions, FUTA rules, 990 exec comp reporting, and volunteer classification. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: "BEG manages 501(c)(3) nonprofit payroll at $25 per employee per month on your existing system, or $45 per employee per month on BEG's iSolved platform. We understand FICA applicability, FUTA exemption, and 990 compensation disclosure requirements. For a 20-person nonprofit, that is $500 to $900 per month, all-inclusive. No per-run fees.",
  },
];
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "Nonprofits", "item": "https://beghr.com/blog/payroll/nonprofits" },
          { "@type": "ListItem", "position": 5, "name": "501(c)(3) Payroll", "item": "https://beghr.com/blog/payroll/nonprofits/501c3-payroll-compliance" }
        ]
      }) }} />
    </article>
  );
