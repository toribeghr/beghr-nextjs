...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/alternatives-to-ukg' },
  openGraph: {
    title: 'Best UKG Alternative | iSolved + Claude AI | BEG',
    description: 'Find UKG too complex and enterprise-priced for the mid-market? See the top UKG alternatives for 50-500 employees, including iSolved, managed by BEG.',
    url: 'https://beghr.com/services/hcm-software/alternatives-to-ukg',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Best UKG Alternative | iSolved + Claude AI | BEG', description: 'Find UKG too complex and enterprise-priced for the mid-market? See the top UKG alternatives for 50-500 employees, including iSolved, managed by BEG.', images: ['https://beghr.com/assets/og-image.png'] },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Alternatives to UKG', item: 'https://beghr.com/services/hcm-software/alternatives-to-ukg' },
  ],
};
