...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Auto Dealer Payroll State Compliance [2026] | BEG', description: 'Managed payroll for auto dealerships. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
