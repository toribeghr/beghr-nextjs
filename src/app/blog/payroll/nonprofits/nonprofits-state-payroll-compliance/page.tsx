...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Nonprofit State Payroll Compliance (What to Know) | BEG', description: 'Managed payroll for nonprofits. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
