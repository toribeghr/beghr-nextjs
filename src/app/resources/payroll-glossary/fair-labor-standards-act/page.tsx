...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/fair-labor-standards-act' },
  openGraph: {
    title: 'Fair Labor Standards Act (FLSA) | Payroll Glossary | BEG',
    description: 'Learn what the FLSA covers, who it applies to, how it defines overtime, and what the penalties are for violations.',
    url: 'https://beghr.com/resources/payroll-glossary/fair-labor-standards-act',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/fair-labor-standards-act', url: 'https://beghr.com/resources/payroll-glossary/fair-labor-standards-act', name: 'Fair Labor Standards Act (FLSA) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Fair Labor Standards Act (FLSA)', description: 'Learn what the FLSA covers, who it applies to, how it defines overtime, and what the penalties are for violations.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Fair Labor Standards Act (FLSA)', item: 'https://beghr.com/resources/payroll-glossary/fair-labor-standards-act' },
            ]},
          ]
        }) }} />
      </section>
