...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing in Virginia, Explained | BEG', description: 'Payroll Outsourcing in Virginia. BEG provides managed payroll nationwide. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
