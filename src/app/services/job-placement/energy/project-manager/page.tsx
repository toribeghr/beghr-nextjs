...
export const metadata: Metadata = {
  ...
  description: 'Energy Project Manager direct hire placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
...
export default function PlacementEnergyProjectmanagerPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Energy · Energy Project Manager"
      title="Your energy project manager search has been open too long."
      description="Project managers who deliver capital projects on time and budget are passive and heavily recruited. We place permanent energy project manager candidates in 23-35 days at roughly 50% less than contingency firms, with a 45-day replacement guarantee."
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Energy Project Manager searches stall because the best candidates are passive and field multiple offers.</li>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>The best energy project manager candidates are not on job boards</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Project managers who deliver capital projects on time and budget are passive and heavily recruited. That is why a posting-and-waiting search rarely fills a energy project manager seat with the right person. Our recruiters source passive energy project manager candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'How long does it take to place a energy project manager?', acceptedAnswer: { '@type': 'Answer', text: 'On average 23-35 days from discovery call to placed hire, with an 86% fill rate on active searches.' } },
