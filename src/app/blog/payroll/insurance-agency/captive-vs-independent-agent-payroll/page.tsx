...
export const metadata: Metadata = {
  title: "Captive vs Independent Insurance Agent Payroll | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/insurance-agency/captive-vs-independent-agent-payroll" },
  openGraph: {
    title: "Captive vs Independent Insurance Agent Payroll | BEG",
    description: "Captive vs independent insurance agent payroll: W-2 vs 1099 classification rules, IRS tests, state insurance department factors, and audit risk. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/insurance-agency/captive-vs-independent-agent-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Captive vs Independent Insurance Agent Payroll | BEG", description: "W-2 vs 1099 for captive and independent insurance agents. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Captive vs Independent Agent Payroll", "item": "https://beghr.com/blog/payroll/insurance-agency/captive-vs-independent-agent-payroll" }
        ]
      }) }} />
    </article>
  );
