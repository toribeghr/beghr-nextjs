...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/security/security-company-payroll-compliance" },
  openGraph: {
    title: "Security Company Payroll Compliance 2026 | BEG Guide",
    ...
    url: "https://beghr.com/blog/payroll/security/security-company-payroll-compliance",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Security Company Payroll Compliance 2026 | BEG Guide", description: "Security company payroll compliance: state licensing, workers comp, multi-state registration, and records.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Security Payroll Compliance", "item": "https://beghr.com/blog/payroll/security/security-company-payroll-compliance" }
        ]
      }) }} />
    </article>
  );
