...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: "Government Contractor Salary Trends 2026: What's Hidden | BEG", description: 'GovCon comp is climbing, especially for cleared talent, but pay is only part of the decision. What actually closes a government contractor hire.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
