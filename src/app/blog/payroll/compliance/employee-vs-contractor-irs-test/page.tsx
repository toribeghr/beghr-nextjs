...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Employee vs. Contractor: The IRS Test Explained | BEG', description: 'Employee vs. Contractor: IRS Classification Test Explained. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
