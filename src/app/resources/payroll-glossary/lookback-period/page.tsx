...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/lookback-period' },
  openGraph: { title: 'Lookback Period (IRS) | Payroll Glossary | BEG', description: 'The 12-month IRS period from July 1 to June 30 used to determine an employer\'s Form 941 deposit schedule for the following year.', url: 'https://beghr.com/resources/payroll-glossary/lookback-period', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Lookback Period (IRS) | Payroll Glossary | BEG', description: 'The 12-month IRS period from July 1 to June 30 used to determine an employer\'s Form 941 deposit schedule for the following year.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/lookback-period', url: 'https://beghr.com/resources/payroll-glossary/lookback-period', name: 'Lookback Period (IRS) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Lookback Period (IRS)', description: 'The 12-month IRS period from July 1 to June 30 used to determine an employer\'s Form 941 deposit schedule for the following year.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Lookback Period (IRS)', item: 'https://beghr.com/resources/payroll-glossary/lookback-period' },
            ]},
          ]
        }) }} />
      </section>
