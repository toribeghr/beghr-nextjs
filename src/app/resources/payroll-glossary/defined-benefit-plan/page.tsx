...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/defined-benefit-plan' },
  openGraph: {
    title: 'Defined Benefit Plan | Payroll Glossary | BEG',
    description: 'Learn what a defined benefit plan is, how benefits are calculated, and the payroll and ERISA obligations employers must meet.',
    url: 'https://beghr.com/resources/payroll-glossary/defined-benefit-plan',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/defined-benefit-plan', url: 'https://beghr.com/resources/payroll-glossary/defined-benefit-plan', name: 'Defined Benefit Plan | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Defined Benefit Plan', description: 'Learn what a defined benefit plan is, how benefits are calculated, and the payroll and ERISA obligations employers must meet.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Defined Benefit Plan', item: 'https://beghr.com/resources/payroll-glossary/defined-benefit-plan' },
            ]},
          ]
        }) }} />
      </section>
