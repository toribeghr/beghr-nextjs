...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Development Director Recruiting | BEG', description: 'A vacant development director seat puts fundraising at risk. How to recruit and close a strong development leader in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <RelatedTool
          variant="grader"
          eyebrow={`Free Tool`}
          heading={`Grade your nonprofit job description in 30 seconds`}
