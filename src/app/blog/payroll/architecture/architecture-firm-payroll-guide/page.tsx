...
export const metadata: Metadata = {
  title: "Architecture Firm Payroll Guide 2026 | PE + Partners | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/architecture/architecture-firm-payroll-guide" },
  openGraph: {
    title: "Architecture Firm Payroll Guide 2026 | PE + Partners | BEG",
    description: "Architecture firm payroll: AIA project billing, licensed architect and PE tracking, partner draws, multi-state staff, and overtime compliance. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/architecture/architecture-firm-payroll-guide",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Architecture Firm Payroll Guide 2026 | PE + Partners | BEG", description: "Architecture firm payroll: project billing, licensed staff tracking, partner draws, and overtime. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "Architecture", "item": "https://beghr.com/blog/payroll/architecture" },
          { "@type": "ListItem", "position": 5, "name": "Architecture Firm Payroll Guide", "item": "https://beghr.com/blog/payroll/architecture/architecture-firm-payroll-guide" }
        ]
      }) }} />
    </article>
  );
