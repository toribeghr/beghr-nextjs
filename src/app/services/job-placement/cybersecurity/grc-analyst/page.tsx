...
export const metadata: Metadata = {
  title: 'GRC Analyst Recruiters | 23-35 Days | BEG',
  description: 'GRC Analyst placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/cybersecurity/grc-analyst' },
  openGraph: { title: 'GRC Analyst Recruiters | 23-35 Days | BEG', description: 'GRC Analyst placement in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/cybersecurity/grc-analyst', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'GRC Analyst Recruiters | 23-35 Days | BEG', description: 'GRC Analyst placement in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-cybersecurity-grc-analyst');

export default function PlacementCybersecurityGrcanalystPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Cybersecurity · GRC Analyst"
      title="Your grc analyst search has been open too long."
      description="Governance, risk, and compliance specialists are scarce as regulation tightens. We place permanent grc analyst candidates in 23-35 days at roughly 50% less than contingency firms, with a 45-day replacement guarantee."
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>GRC Analyst searches stall because the best candidates are passive and field multiple offers.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"GRC Analyst placement\",\"name\":\"GRC Analyst Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://www.beghr.com/services/job-placement/cybersecurity/grc-analyst\",\"description\":\"Permanent grc analyst placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />

      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            <p className="eyebrow">Why This Role Is Hard To Fill</p>
            <h2>The best grc analyst candidates are not on job boards</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Governance, risk, and compliance specialists are scarce as regulation tightens. That is why a posting-and-waiting search rarely fills a grc analyst seat with the right person. We source passive grc analyst candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'How long does it take to place a grc analyst?', acceptedAnswer: { '@type': 'Answer', text: 'On average 23-35 days from discovery call to placed hire, with an 86% fill rate on active searches.' } },
