...
export const metadata: Metadata = {
  ...
  description: 'CFO direct hire placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            A CFO search is confidential, relationship-led, and almost never run through a public posting. That is why a posting-and-waiting search rarely fills a cfo seat with the right person. Our recruiters source passive cfo candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
