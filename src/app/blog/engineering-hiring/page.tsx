...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/engineering-hiring' },
  openGraph: {
    title: 'Engineering Hiring | BEG Blog',
    description: 'Engineering talent shortage trends, mechanical and project engineer recruiting, and comp insights for leaders who need to fill engineering roles fast.',
    url: 'https://beghr.com/blog/engineering-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Engineering Hiring | BEG Blog', description: 'Engineering talent shortage trends, mechanical and project engineer recruiting, and comp insights for leaders who need to fill engineering roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Engineering Hiring', item: 'https://beghr.com/blog/engineering-hiring' },
            ],
          }),
        }}
      />
