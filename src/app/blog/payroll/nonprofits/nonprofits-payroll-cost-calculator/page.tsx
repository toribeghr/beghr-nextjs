...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Nonprofit Payroll Costs [+ Free Calculator] | BEG', description: 'Managed payroll for nonprofits. How to Calculate Your Payroll Costs. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
