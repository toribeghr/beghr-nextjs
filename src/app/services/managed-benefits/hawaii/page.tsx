...
export const metadata: Metadata = {
  title: 'Hawaii Mini-COBRA Continuation Rules | BEG',
  description: 'Hawaii mini-COBRA: state continuation coverage rules, employer size, 3 month limit, and who runs the notices. You keep your broker.',
  alternates: { canonical: 'https://www.beghr.com/services/managed-benefits/hawaii' },
  openGraph: {
    title: 'Hawaii Mini-COBRA Continuation Rules | BEG',
    description: 'Hawaii mini-COBRA: state continuation coverage rules, employer size, 3 month limit, and who runs the notices. You keep your broker.',
    url: 'https://www.beghr.com/services/managed-benefits/hawaii',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Hawaii Mini-COBRA Continuation Rules | BEG', description: 'Hawaii mini-COBRA: state continuation coverage rules, employer size, 3 month limit, and who runs the notices. You keep your broker.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('managed-benefits-hawaii');
...
export default function ManagedBenefitsHawaiiPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Hawaii mini-COBRA and state continuation coverage rules',
            description: 'Hawaii mini-COBRA: state continuation coverage rules, employer size, 3 month limit, and who runs the notices. You keep your broker.',
            author: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' },
            publisher: { '@type': 'Organization', name: 'Business Executive Group' },
            datePublished: '2026-07-05',
            mainEntityOfPage: 'https://www.beghr.com/services/managed-benefits/hawaii',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Hawaii', item: 'https://www.beghr.com/services/managed-benefits/hawaii' },
            ],
          }),
        }}
      />
      <ServicePage
        showHeroImage={false}
        eyebrow="Managed Benefits · Hawaii"
        title="Hawaii makes small employers offer continuation. Someone has to run it."
        description="Hawaii is a mini-COBRA state: smaller employers must let departing employees keep group coverage under state law. BEG Managed Benefits, powered by isolved, runs the notices, elections, and premium tracking so the rules are handled. You keep your broker; we do the administration."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="managed-benefits" />}
        heroStats={[
          { value: '3 months', label: 'Hawaii state continuation limit' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '860px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Hawaii Continuation, In Brief</p>
              <h2>What Hawaii law requires</h2>
            </div>
            <div style={{ overflowX: 'auto', marginTop: '2rem' }} className="reveal">
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>State law</td><td style={{ padding: '12px 16px', color: '#555555' }}>Haw. Rev. Stat. section 393-15 (Continuation of coverage in case of inability to earn wages), part of the Prepaid Health Care Act (HRS ch. 393)</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Employers covered</td><td style={{ padding: '12px 16px', color: '#555555' }}>all employers subject to the Prepaid Health Care Act (generally any employer with employees working 20+ hours/week); this is not a sub-20 small-employer mini-COBRA</td></tr>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Marketplace</td><td style={{ padding: '12px 16px', color: '#555555' }}>Uses HealthCare.gov (Hawaii shut down its state exchange, the Hawaii Health Connector, and uses the federal platform).</td></tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>A small Hawaii employer carries big-company continuation duties</h2>
            </div>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Hawaii continuation coverage, answered</h2>
            </div>
