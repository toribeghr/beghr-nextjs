...
export const metadata: Metadata = {
  title: 'Engineering Recruiters in Colorado Springs | BEG',
  description: 'Engineering placement in Colorado Springs. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/engineering/colorado-springs' },
  openGraph: { title: 'Engineering Recruiters in Colorado Springs | BEG', description: 'Engineering placement in Colorado Springs in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/engineering/colorado-springs', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Engineering Recruiters in Colorado Springs | BEG', description: 'Engineering placement in Colorado Springs in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-engineering-colorado-springs');

export default function PlacementEngineeringColoradospringsPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Colorado Springs"
      title="That open engineering role in Colorado Springs is costing you every week."
      description="Colorado Springs is a defense, aerospace, and healthcare market where cleared and specialized talent is scarce. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Colorado Springs? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Colorado Springs</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/engineering" style={{ color: '#000000', fontWeight: 600 }}>engineering placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/engineering/denver" style={{ color: '#000000', fontWeight: 600 }}>Denver</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Colorado Springs?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Colorado Springs and across Colorado, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
