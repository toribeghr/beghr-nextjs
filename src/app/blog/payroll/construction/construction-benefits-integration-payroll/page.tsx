...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Construction Payroll Benefits Integration | BEG', description: 'Managed payroll for construction. Integrating Benefits with Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
