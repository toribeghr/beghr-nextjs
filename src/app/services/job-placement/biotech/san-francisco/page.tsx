...
export default function PlacementBiotechSanfranciscoPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Biotech placement\",\"name\":\"Biotech Placement in San Francisco\",\"areaServed\":{\"@type\":\"City\",\"name\":\"San Francisco\"},\"url\":\"https://beghr.com/services/job-placement/biotech/san-francisco\",\"description\":\"Permanent biotech placement in San Francisco in 23-35 days at roughly 50% less than contingency.\"}" }} />
