...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Healthcare Payroll Setup, A Practice Owner Guide | BEG', description: 'Managed payroll for healthcare. Payroll Setup Guide. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
