...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/accounting-hiring/busy-season-staffing' },
  openGraph: {
    title: 'Busy-Season Staffing: Plan Ahead of Tax Season | BEG',
    description: 'The firms that survive busy season hire before the crunch. How to plan accounting and tax staffing months ahead and fill roles in 23-35 days.',
    url: 'https://beghr.com/blog/accounting-hiring/busy-season-staffing',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Busy-Season Staffing: Plan Ahead of Tax Season | BEG', description: 'The firms that survive busy season hire before the crunch. How to plan accounting and tax staffing months ahead and fill roles in 23-35 days.', images: ['https://beghr.com/assets/og-image.png'] },
};
