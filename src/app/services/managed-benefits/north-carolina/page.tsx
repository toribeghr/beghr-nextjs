...
export const metadata: Metadata = {
  title: 'North Carolina Mini-COBRA Continuation Rules | BEG',
  description: 'North Carolina mini-COBRA: state continuation coverage rules, employer size, 18 month limit, and who runs the notices. You keep your broker.',
  alternates: { canonical: 'https://www.beghr.com/services/managed-benefits/north-carolina' },
  openGraph: {
    title: 'North Carolina Mini-COBRA Continuation Rules | BEG',
    description: 'North Carolina mini-COBRA: state continuation coverage rules, employer size, 18 month limit, and who runs the notices. You keep your broker.',
    url: 'https://www.beghr.com/services/managed-benefits/north-carolina',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'North Carolina Mini-COBRA Continuation Rules | BEG', description: 'North Carolina mini-COBRA: state continuation coverage rules, employer size, 18 month limit, and who runs the notices. You keep your broker.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('managed-benefits-north-carolina');
...
export default function ManagedBenefitsNorthCarolinaPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'North Carolina mini-COBRA and state continuation coverage rules',
            description: 'North Carolina mini-COBRA: state continuation coverage rules, employer size, 18 month limit, and who runs the notices. You keep your broker.',
            author: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' },
            publisher: { '@type': 'Organization', name: 'Business Executive Group' },
            datePublished: '2026-07-05',
            mainEntityOfPage: 'https://www.beghr.com/services/managed-benefits/north-carolina',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'North Carolina', item: 'https://www.beghr.com/services/managed-benefits/north-carolina' },
            ],
          }),
        }}
      />
      <ServicePage
        showHeroImage={false}
        eyebrow="Managed Benefits · North Carolina"
        title="North Carolina makes small employers offer continuation. Someone has to run it."
        description="North Carolina is a mini-COBRA state: smaller employers must let departing employees keep group coverage under state law. BEG Managed Benefits, powered by isolved, runs the notices, elections, and premium tracking so the rules are handled. You keep your broker; we do the administration."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="managed-benefits" />}
        heroStats={[
          { value: '18 months', label: 'North Carolina state continuation limit' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '860px' }}>
            <div className="head center reveal">
              <p className="eyebrow">North Carolina Continuation, In Brief</p>
              <h2>What North Carolina law requires</h2>
            </div>
            <div style={{ overflowX: 'auto', marginTop: '2rem' }} className="reveal">
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>State law</td><td style={{ padding: '12px 16px', color: '#555555' }}>N.C. Gen. Stat. sections 58-53-5, 58-53-10, 58-53-35 (Article 53, Part 1)</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Employers covered</td><td style={{ padding: '12px 16px', color: '#555555' }}>All fully-insured group health policies (hospital/surgical/major medical) delivered or issued in North Carolina, regardless of employer size; self-insured plans are excluded (G.S. 58-53-115).</td></tr>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Marketplace</td><td style={{ padding: '12px 16px', color: '#555555' }}>Uses the federal marketplace, HealthCare.gov (North Carolina does not run a state-based exchange).</td></tr>
                </tbody>
              </table>
            </div>
            <p className="reveal" style={{ fontSize: '0.8rem', color: '#888888', marginTop: '1rem', textAlign: 'center', lineHeight: 1.6 }}>
              Source: <a href="https://www.ncleg.gov/EnactedLegislation/Statutes/PDF/ByArticle/Chapter_58/Article_53.pdf" target="_blank" rel="noopener noreferrer">North Carolina statute and department of insurance (www.ncleg.gov)</a>. This page is general information, not legal advice.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>A small North Carolina employer carries big-company continuation duties</h2>
            </div>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>North Carolina continuation coverage, answered</h2>
            </div>
