...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Franchise Payroll Recordkeeping (What to Know) | BEG', description: 'Managed payroll for franchise. Payroll Recordkeeping Requirements. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
