...
export const metadata: Metadata = {
  ...
  description: 'Full isolved HCM platform review. Payroll, benefits, time and attendance, talent management, and the Connector for Claude. Who isolved fits best and',
