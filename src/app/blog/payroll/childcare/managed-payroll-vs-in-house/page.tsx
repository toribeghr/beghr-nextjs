        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Managed Payroll vs. In-House for Childcare Centers', item: 'https://www.beghr.com/blog/payroll/childcare/managed-payroll-vs-in-house' },
            ],
          }),
        }}
      />
