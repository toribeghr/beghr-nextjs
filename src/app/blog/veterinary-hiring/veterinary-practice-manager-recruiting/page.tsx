...
export const metadata: Metadata = {
  title: 'Recruiting a Vet Practice Manager: What Nobody Tells You | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-veterinary-hiring-veterinary-practice-manager-recruiting.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Recruiting a Vet Practice Manager: What Nobody Tells You | BEG', description: 'The right practice manager protects your margin and your team. How to find and hire a strong veterinary practice manager in 23-35 days.', images: ['https://www.beghr.com/blog-images/blog-veterinary-hiring-veterinary-practice-manager-recruiting.webp'] },
};
  ...
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-veterinary-hiring-veterinary-practice-manager-recruiting.webp", "headline": "Recruiting a Veterinary Practice Manager | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/veterinary-hiring/veterinary-practice-manager-recruiting"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-veterinary-hiring-veterinary-practice-manager-recruiting.webp" alt={`A veterinary clinic with a vet examining a dog, staff assisting`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
