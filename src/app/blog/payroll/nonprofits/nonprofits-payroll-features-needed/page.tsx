...
export const metadata: Metadata = {
  ...
  description: 'Managed payroll for nonprofits. Payroll Features Every {label} Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
  ...
  twitter: { card: 'summary_large_image', title: 'Nonprofit Payroll: Must-Have Features | BEG', description: 'Managed payroll for nonprofits. Payroll Features Every {label} Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              ...
              <h1>Nonprofits & Religious Organizations: Payroll Features Every {label} Business Needs (2026)</h1>
