...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/call-back-pay' },
  openGraph: {
    title: 'Call-Back Pay | Payroll Glossary | BEG',
    description: 'Learn what call-back pay is, when it is required, and how it affects overtime calculations under the FLSA.',
    url: 'https://beghr.com/resources/payroll-glossary/call-back-pay',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/call-back-pay', url: 'https://beghr.com/resources/payroll-glossary/call-back-pay', name: 'Call-Back Pay | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Call-Back Pay', description: 'Learn what call-back pay is, when it is required, and how it affects overtime calculations under the FLSA.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Call-Back Pay', item: 'https://beghr.com/resources/payroll-glossary/call-back-pay' },
            ]},
          ]
        }) }} />
      </section>
