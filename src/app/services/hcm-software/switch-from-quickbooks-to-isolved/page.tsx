...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/switch-from-quickbooks-to-isolved' },
  openGraph: {
    title: 'Switch From QuickBooks Payroll to iSolved | BEG',
    description: 'Outgrown QuickBooks Payroll? Switching to iSolved is painless when BEG manages the migration, configures the platform, and supports you year-round. Book a call.',
    url: 'https://beghr.com/services/hcm-software/switch-from-quickbooks-to-isolved',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Switch From QuickBooks Payroll to iSolved | BEG', description: 'Outgrown QuickBooks Payroll? Switching to iSolved is painless when BEG manages the migration, configures the platform, and supports you year-round. Book a call.', images: ['https://beghr.com/assets/og-image.png'] },
...
export default function SwitchFromQuickBooksToiSolvedPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Switch From QuickBooks to iSolved', item: 'https://beghr.com/services/hcm-software/switch-from-quickbooks-to-isolved' },
    ],
  };
