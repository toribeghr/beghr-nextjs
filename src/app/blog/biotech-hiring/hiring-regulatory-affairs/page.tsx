...
export const metadata: Metadata = {
  title: 'How to Hire a Regulatory Affairs Manager | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/biotech-hiring/hiring-regulatory-affairs' },
  openGraph: {
    title: 'How to Hire a Regulatory Affairs Manager | BEG',
    description: 'A vacant regulatory affairs seat stalls submissions and risks compliance. A playbook to hire in 23-35 days with passive candidate sourcing.',
    url: 'https://beghr.com/blog/biotech-hiring/hiring-regulatory-affairs',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'How to Hire a Regulatory Affairs Manager | BEG', description: 'A vacant regulatory affairs seat stalls submissions and risks compliance. A playbook to hire in 23-35 days with passive candidate sourcing.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/biotech-hiring/hiring-regulatory-affairs');
...
export default function HiringRegulatoryAffairsPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "How to Hire a Regulatory Affairs Manager | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/biotech-hiring/hiring-regulatory-affairs"}) }} />
