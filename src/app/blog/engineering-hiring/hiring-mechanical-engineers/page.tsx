...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'How to Hire Mechanical Engineers Fast | BEG', description: 'A vacant mechanical engineer seat stalls your product and projects. A practical playbook to hire mechanical engineers in 23-35 days without settling.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <RelatedTool
          variant="grader"
          eyebrow={`Free Tool`}
          heading={`Grade your engineering job description in 30 seconds`}
