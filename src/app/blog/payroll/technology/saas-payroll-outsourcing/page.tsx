        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Saas Payroll Outsourcing', item: 'https://beghr.com/blog/payroll/technology/saas-payroll-outsourcing' },
            ],
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://beghr.com/blog/payroll/technology/saas-payroll-outsourcing',
            mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://beghr.com/blog/payroll/technology/saas-payroll-outsourcing' },
          }),
        }}
      />
    </article>
