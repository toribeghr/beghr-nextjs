...
export const metadata: Metadata = {
  title: 'Nonprofit Payroll: Year-End Checklist | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/nonprofits/nonprofits-year-end-payroll-checklist' },
  openGraph: {
    title: 'Nonprofit Payroll: Year-End Checklist | BEG',
    description: 'Managed payroll for nonprofits. Year-End Payroll Checklist. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/nonprofits/nonprofits-year-end-payroll-checklist',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Nonprofit Payroll: Year-End Checklist | BEG', description: 'Managed payroll for nonprofits. Year-End Payroll Checklist. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
