...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/alternatives-to-gusto' },
  openGraph: {
    title: 'Best Gusto Alternative | iSolved + Claude AI | BEG',
    description: 'Outgrowing Gusto? Compare iSolved, managed by BEG, for companies with 50 to 500 employees. Multi-state payroll, managed service, Claude AI, and 330% ROI.',
    url: 'https://beghr.com/services/hcm-software/alternatives-to-gusto',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Best Gusto Alternative | iSolved + Claude AI | BEG', description: 'Outgrowing Gusto? Compare iSolved, managed by BEG, for companies with 50 to 500 employees. Multi-state payroll, managed service, Claude AI, and 330% ROI.', images: ['https://beghr.com/assets/og-image.png'] },
...
export default function AlternativesToGustoPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Alternatives to Gusto', item: 'https://beghr.com/services/hcm-software/alternatives-to-gusto' },
    ],
  };
