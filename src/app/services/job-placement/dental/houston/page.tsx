...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/dental/houston' },
  openGraph: { title: 'Dental Recruiters in Houston | BEG', description: 'Dental placement in Houston in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/dental/houston', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Dental Recruiters in Houston | BEG', description: 'Dental placement in Houston in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementDentalHoustonPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Dental placement\",\"name\":\"Dental Placement in Houston\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Houston\"},\"url\":\"https://beghr.com/services/job-placement/dental/houston\",\"description\":\"Permanent dental placement in Houston in 23-35 days at roughly 50% less than contingency.\"}" }} />
