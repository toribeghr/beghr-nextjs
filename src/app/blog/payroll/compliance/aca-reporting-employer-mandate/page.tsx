...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'ACA Reporting for Employers With 50+ Employees | BEG',
    description: 'ACA Reporting and the Employer Mandate for 50+ Employees. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/compliance/aca-reporting-employer-mandate',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-compliance-aca-reporting-employer-mandate.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'ACA Reporting for Employers With 50+ Employees | BEG', description: 'ACA Reporting and the Employer Mandate for 50+ Employees. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-compliance-aca-reporting-employer-mandate.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-payroll-compliance-aca-reporting-employer-mandate.webp", "headline": "ACA Reporting for Employers With 50+ Employees | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/compliance/aca-reporting-employer-mandate"}) }} />
      <section className="hero">
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              <p className="eyebrow">Blog · Payroll Management</p>
              <h1>ACA Reporting and the Employer Mandate for 50+ Employees</h1>
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-compliance-aca-reporting-employer-mandate.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        ...
        <p>This guide covers the compliance topic addressed in ACA Reporting and the Employer Mandate for 50+ Employees and what employers need to know.</p>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"ACA Reporting and the Employer Mandate for 50+ Employees","description":"ACA Reporting and the Employer Mandate for 50+ Employees. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.","datePublished":"2026-06-28","dateModified":"2026-06-28","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","worksFor":{"@type":"Organization","name":"Business Executive Group"}},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://www.beghr.com/assets/beg-header-image.png"}},"url":"https://www.beghr.com/blog/payroll/compliance/aca-reporting-employer-mandate","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.beghr.com/blog/payroll/compliance/aca-reporting-employer-mandate"}}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://www.beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"ACA Reporting and the Employer Mandate for 50+ Employees","item":"https://www.beghr.com/blog/payroll/compliance/aca-reporting-employer-mandate"}]}`,
        }}
      />
