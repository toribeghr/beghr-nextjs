...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/hcm-software-for-50-employees' },
  openGraph: {
    title: 'HCM Software for a 50-Employee Company | BEG',
    description: 'HCM software for a 50-employee company. See why a single connected iSolved platform, implemented and supported by BEG, fits firms outgrowing basic payroll.',
    url: 'https://beghr.com/services/hcm-software/hcm-software-for-50-employees',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'HCM Software for a 50-Employee Company | BEG', description: 'HCM software for a 50-employee company. See why a single connected iSolved platform, implemented and supported by BEG, fits firms outgrowing basic payroll.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'HCM Software for a 50-Employee Company', item: 'https://beghr.com/services/hcm-software/hcm-software-for-50-employees' },
  ],
};
