...
export const metadata: Metadata = {
  title: 'Ohio Employee Training Compliance | LMS by BEG',
  description: 'Employee training and harassment-prevention compliance for Ohio employers. isolved Learn & Grow, configured by BEG: assign, track, and prove training. Inst',
  alternates: { canonical: 'https://www.beghr.com/services/lms-learning-management/ohio' },
  openGraph: { title: 'Ohio Employee Training Compliance | LMS by BEG', description: 'Assign, track, and prove employee training for Ohio employers with isolved Learn & Grow, configured by BEG.', url: 'https://www.beghr.com/services/lms-learning-management/ohio', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Ohio Employee Training Compliance | LMS by BEG', description: 'Assign, track, and prove employee training for Ohio employers with isolved Learn & Grow.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('lms-ohio');

const FAQS: [string, string][] = [
  ['Does Ohio require sexual harassment training?', 'No statewide sexual-harassment-training mandate for private employers today; federal EEOC guidance still applies.'],
  ['How do we prove training compliance in Ohio?', 'isolved Learn & Grow assigns required courses by role, tracks completion and renewal dates, and produces an audit-ready record on demand, so proving compliance is a report you pull, not a scramble.'],
  ...
  ['Do you serve employers in Ohio?', 'Yes. BEG configures and supports isolved Learn & Grow for Ohio employers, delivered remotely, and for teams across all 50 states.'],
];

export default function LmsStateOhioPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context':'https://schema.org','@type':'Article', headline:'Keep your Ohio team trained and audit-ready, in one system.', description:'Employee training compliance for Ohio employers with isolved Learn & Grow.', author:{ '@type':'Organization', name:'Business Executive Group', url:'https://www.beghr.com' }, publisher:{ '@type':'Organization', name:'Business Executive Group' }, datePublished:'2026-07-06', mainEntityOfPage:'https://www.beghr.com/services/lms-learning-management/ohio' }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context':'https://schema.org','@type':'BreadcrumbList', itemListElement:[ { '@type':'ListItem', position:1, name:'Home', item:'https://www.beghr.com' }, { '@type':'ListItem', position:2, name:'Learning Management System', item:'https://www.beghr.com/services/lms-learning-management' }, { '@type':'ListItem', position:3, name:'Ohio', item:'https://www.beghr.com/services/lms-learning-management/ohio' } ] }) }} />
      ...
      <ServicePage
        showHeroImage={false}
        eyebrow="Learning Management · Ohio"
        title="Keep your Ohio team trained and audit-ready, in one system."
        description="Federal OSHA safety and EEOC anti-harassment training still apply to Ohio employers, and multi-state teams add more. isolved Learn & Grow, configured by BEG, puts every required course, assignment, and completion record in one system so your Ohio team stays trained and audit-ready, nationwide."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="hcm-software" label="Get Instant Pricing" preselectModule="lms" />}
        heroStats={[
          { value: 'One system', label: 'Training and records for Ohio teams' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Ohio Training Requirements</p>
              <h2>Where employee-training compliance stands in Ohio</h2>
            </div>
            ...
            <p className="reveal" style={{ fontSize: '0.82rem', color: '#888888', marginTop: '1rem', textAlign: 'center' }}>Sources: <a href="https://www.eeoc.gov/harassment" target="_blank" rel="noopener noreferrer">EEOC and Ohio guidance</a>, <a href="https://en.wikipedia.org/wiki/Learning_management_system" target="_blank" rel="noopener noreferrer">Learning management system, overview</a>.</p>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '980px' }}>
            <div className="head center reveal">
              ...
              <h2>Assign, track, and prove Ohio training in one system</h2>
            </div>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Employee training in Ohio, answered</h2>
            </div>
