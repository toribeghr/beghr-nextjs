...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Does Illinois Require Paid Sick Leave? | BEG', description: 'Does Illinois mandate paid sick leave? What a compliant policy needs, plus FMLA basics and how HR outsourcing keeps it current.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
