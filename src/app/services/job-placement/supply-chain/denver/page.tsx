...
export default function PlacementSupplychainDenverPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Supply Chain · Denver"
      title="That open supply chain role in Denver is costing you every week."
      description="Denver is a fast-growing relocation magnet where employers compete with lifestyle-driven candidate expectations. We source passive supply chain candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Supply Chain roles in Denver stay open because the best candidates are passive and rarely on job boards.</li>
              <li>BEG sources supply chain talent in Denver directly and fills permanent roles in 23-35 days.</li>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Why supply chain roles are hard to fill in Denver</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Denver sits in the West and is a fast-growing relocation magnet where employers compete with lifestyle-driven candidate expectations. The strongest supply chain candidates here are already employed and are contacted constantly, which means a job posting reaches the people who are easiest to find, not the ones you actually want. We reach the passive supply chain talent in Denver and the surrounding CO market directly, before they ever see a listing.
          </p>
        </div>
      </section>
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Supply Chain in Denver? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Supply Chain placement near Denver</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/supply-chain" style={{ color: '#000000', fontWeight: 600 }}>supply chain placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/supply-chain/colorado-springs" style={{ color: '#000000', fontWeight: 600 }}>Colorado Springs</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place supply chain candidates in Denver?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent supply chain searches in Denver and across Colorado, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
