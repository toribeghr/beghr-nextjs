...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/accounting-cpa/accounting-firm-partner-draw-payroll" },
  openGraph: {
    title: "Accounting Firm Partner Draw Payroll | K-1 + W-2 | BEG",
    description: "Partner draw and compensation payroll for accounting firms: K-1 guaranteed payments, W-2 salary for S-corp partners, reasonable compensation, and entity structure. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/accounting-cpa/accounting-firm-partner-draw-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Accounting Firm Partner Draw Payroll | K-1 + W-2 | BEG", description: "Partner draw payroll for accounting firms: K-1 vs W-2, reasonable comp, and entity structure. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Partner Draw Payroll", "item": "https://beghr.com/blog/payroll/accounting-cpa/accounting-firm-partner-draw-payroll" }
        ]
      }) }} />
    </article>
  );
