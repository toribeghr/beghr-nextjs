...
export const metadata: Metadata = {
  title: 'Real Estate Payroll: Direct Deposit Setup | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/real-estate/real-estate-direct-deposit-setup' },
  openGraph: {
    title: 'Real Estate Payroll: Direct Deposit Setup | BEG',
    description: 'Managed payroll for real estate. Setting Up Direct Deposit. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/real-estate/real-estate-direct-deposit-setup',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Real Estate Payroll: Direct Deposit Setup | BEG', description: 'Managed payroll for real estate. Setting Up Direct Deposit. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
