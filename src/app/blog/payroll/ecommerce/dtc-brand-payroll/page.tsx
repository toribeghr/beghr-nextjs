...
export const metadata: Metadata = {
  title: "DTC Brand Payroll | Warehouse, Fulfillment & Remote Teams | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/ecommerce/dtc-brand-payroll" },
  openGraph: {
    title: "DTC Brand Payroll | Warehouse, Fulfillment & Remote Teams | BEG",
    ...
    url: "https://beghr.com/blog/payroll/ecommerce/dtc-brand-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "DTC Brand Payroll | Warehouse, Fulfillment & Remote Teams | BEG", description: "DTC brand payroll: warehouse staff, remote marketing, variable headcount, and multi-state compliance. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "DTC Brand Payroll", "item": "https://beghr.com/blog/payroll/ecommerce/dtc-brand-payroll" }
        ]
      }) }} />
    </article>
  );
