...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Multi-State Payroll Outsourcing for 2+ State Employers | BEG', description: 'Multi-State Payroll Outsourcing: Guide for Businesses in 2+ States. BEG provides managed payroll nationwide. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
