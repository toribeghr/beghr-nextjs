...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Florida Paid Sick Leave Explained: What Employers Must Know', description: 'Does Florida require paid sick leave? What employers must build instead, including local-ordinance and multi-state remote employee risk.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
