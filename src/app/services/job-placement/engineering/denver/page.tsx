...
export const metadata: Metadata = {
  title: 'Engineering Recruiters in Denver | BEG',
  description: 'Engineering placement in Denver. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/engineering/denver' },
  openGraph: { title: 'Engineering Recruiters in Denver | BEG', description: 'Engineering placement in Denver in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/engineering/denver', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Engineering Recruiters in Denver | BEG', description: 'Engineering placement in Denver in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-engineering-denver');

export default function PlacementEngineeringDenverPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Denver"
      title="That open engineering role in Denver is costing you every week."
      description="Denver is a fast-growing relocation magnet where employers compete with lifestyle-driven candidate expectations. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Denver? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Denver</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/engineering" style={{ color: '#000000', fontWeight: 600 }}>engineering placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/engineering/colorado-springs" style={{ color: '#000000', fontWeight: 600 }}>Colorado Springs</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Denver?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Denver and across Colorado, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
