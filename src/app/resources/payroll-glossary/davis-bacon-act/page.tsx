...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/davis-bacon-act' },
  openGraph: {
    title: 'Davis-Bacon Act | Payroll Glossary | BEG',
    description: 'Learn what the Davis-Bacon Act requires, how prevailing wage rates are determined, and what certified payroll compliance looks like.',
    url: 'https://beghr.com/resources/payroll-glossary/davis-bacon-act',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/davis-bacon-act', url: 'https://beghr.com/resources/payroll-glossary/davis-bacon-act', name: 'Davis-Bacon Act | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Davis-Bacon Act', description: 'Learn what the Davis-Bacon Act requires, how prevailing wage rates are determined, and what certified payroll compliance looks like.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Davis-Bacon Act', item: 'https://beghr.com/resources/payroll-glossary/davis-bacon-act' },
            ]},
          ]
        }) }} />
      </section>
