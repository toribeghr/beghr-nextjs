...
export const metadata: Metadata = {
  title: 'Financial Firm Payroll: Must-Have Features | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Financial Firm Payroll: Must-Have Features | BEG', description: 'Managed payroll for financial services. Payroll Features Every Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
