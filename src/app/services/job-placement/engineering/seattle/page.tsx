...
export const metadata: Metadata = {
  title: 'Engineering Recruiters in Seattle | BEG',
  description: 'Engineering placement in Seattle. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/engineering/seattle' },
  openGraph: { title: 'Engineering Recruiters in Seattle | BEG', description: 'Engineering placement in Seattle in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/engineering/seattle', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Engineering Recruiters in Seattle | BEG', description: 'Engineering placement in Seattle in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-engineering-seattle');

export default function PlacementEngineeringSeattlePage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Seattle"
      title="That open engineering role in Seattle is costing you every week."
      description="Seattle is a tech and healthcare market with some of the highest compensation expectations outside the Bay Area. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Seattle? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Seattle</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Seattle?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Seattle and across Washington, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
