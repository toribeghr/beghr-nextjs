...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/isolved-vs-quickbooks-payroll' },
  openGraph: {
    title: 'iSolved vs QuickBooks Payroll | One Platform + AI | BEG',
    description: 'iSolved vs QuickBooks Payroll compared on platform breadth, pricing, support, and AI. See which fits basic small-business payroll versus a full connected HCM.',
    url: 'https://beghr.com/services/hcm-software/isolved-vs-quickbooks-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved vs QuickBooks Payroll | One Platform + AI | BEG', description: 'iSolved vs QuickBooks Payroll compared on platform breadth, pricing, support, and AI. See which fits basic small-business payroll versus a full connected HCM.', images: ['https://beghr.com/assets/og-image.png'] },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'iSolved vs QuickBooks Payroll', item: 'https://beghr.com/services/hcm-software/isolved-vs-quickbooks-payroll' },
  ],
};
