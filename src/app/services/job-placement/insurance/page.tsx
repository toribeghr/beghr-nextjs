...
export const metadata: Metadata = {
  title: 'Insurance Placement | Instant Fee Quote | BEG',
  description: 'Fill underwriter, producer, and claims roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/insurance' },
  openGraph: { title: 'Insurance Placement | Instant Fee Quote | BEG', description: 'Fill underwriter, producer, and claims roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', url: 'https://www.beghr.com/services/job-placement/insurance', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Insurance Placement | Instant Fee Quote | BEG', description: 'Fill underwriter, producer, and claims roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-insurance');
...
export default function PlacementInsurancePage() {
  return (
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Insurance roles stay open because the strongest candidates are employed, passive, and rarely on job boards.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Insurance placement\",\"name\":\"Insurance Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://www.beghr.com/services/job-placement/insurance\",\"description\":\"Permanent insurance placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
          ...
          <div className="beg-grid-3 reveal">
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  <div style={{ fontSize: '2rem', fontWeight: '800', color: '#000000', lineHeight: 1 }}>400,000+</div>
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Insurance workers expected to retire this decade</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>The experience leaving the industry far outpaces the talent entering it. The seasoned candidates you need are passive, and reaching them takes proactive sourcing.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Per month absorbed per unfilled underwriting seat</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>A commercial lines underwriter at roughly $105K is about $9,000 a month. Every month the seat is open, accounts go unquoted and renewals get rushed.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  <div style={{ fontSize: '2rem', fontWeight: '800', color: '#000000', lineHeight: 1 }}>2-4 weeks</div>
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Window before an experienced candidate accepts another offer</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Licensed, experienced insurance talent is scarce and heavily courted. A 90-day search is always fishing in a smaller pond than the one you started with.</div>
                </div>
              ))()
            }
          </div>
            ...
            {[
              {
                ...
                body: 'Milestone-based pricing replaces the standard 20-25% contingency fee, and total cost is roughly 50% less. For a $105,000 commercial lines underwriter placement, that difference is $10,500-$15,750 kept in your budget versus a contingency arrangement.',
              },
              {
                badge: 'Bonus 02',
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Insurance? Grade your job description first.</h2>
            <p style={{ maxWidth: '670px', margin: '0.75rem auto 0', color: '#555555', lineHeight: 1.7 }}>A weak posting quietly kills your pipeline. Paste your insurance job description and get an instant 0 to 100 score, plus the exact fixes that get strong candidates to apply. Free, instant, and nothing you paste leaves your browser.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="beg-grid-2 reveal">
            <div>
              ...
              <p style={{ color: '#cccccc', lineHeight: '1.7', fontSize: '0.97rem' }}>An open underwriting or production seat does not just sit idle. Submissions go unquoted, renewals get rushed, and revenue that should be bound walks to a competing carrier or agency. An underwriter seat open for 90 days can cost an agency lost new business, strained renewals, and roughly $27,000 in absorbed overhead before the search even ends.</p>
            </div>
            <div>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Commercial lines underwriters, producers, claims managers, actuaries, account managers, and other carrier and agency roles across personal and commercial lines.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'What roles do you place?', acceptedAnswer: { '@type': 'Answer', text: 'Commercial lines underwriters, producers, claims managers, actuaries, account managers, and other carrier and agency roles across personal and commercial lines.' } },
