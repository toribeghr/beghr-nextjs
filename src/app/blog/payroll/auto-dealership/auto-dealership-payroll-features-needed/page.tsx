...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Auto Dealer Payroll: Must-Have Features [2026] | BEG', description: 'Managed payroll for auto dealerships. Payroll Features Every Business Needs. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
