...
export const metadata: Metadata = {
  ...
  description: 'Direct hire recruiting for project architect, design director, and BIM roles. 23-35 day fills at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/architecture' },
  openGraph: { title: 'Architecture Placement | Instant Fee Quote | BEG', description: 'Direct hire recruiting for project architect, design director, and BIM roles. 23-35 day fills at roughly 50% less than contingency. 45-day guarantee.', url: 'https://www.beghr.com/services/job-placement/architecture', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Architecture Placement | Instant Fee Quote | BEG', description: 'Direct hire recruiting for project architect, design director, and BIM roles. 23-35 day fills at roughly 50% less than contingency. 45-day guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementArchitecturePage() {
  return (
    <ServicePage
      ...
      heroCta={<PricingCta service="job-placement" industry="architecture" />}
    ...
    <JobPlacementHubLinks industry="architecture" />
