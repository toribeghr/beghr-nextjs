...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Childcare Payroll: Outsource or Keep In-House | BEG', description: 'Managed payroll for childcare. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        ...
        <p>All-inclusive: payroll processing, tax filing, W-2 production, licensing-tied payroll records, subsidy payment coordination, and year-round compliance monitoring. No per-run fees, no add-on modules, no year-end surcharges.</p>
