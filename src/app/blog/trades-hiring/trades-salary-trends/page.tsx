...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/trades-hiring/trades-salary-trends' },
  openGraph: {
    title: 'Skilled Trades Salary Trends 2026 | BEG',
    description: 'Trades pay is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes a skilled trades hire.',
    url: 'https://beghr.com/blog/trades-hiring/trades-salary-trends',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Skilled Trades Salary Trends 2026 | BEG', description: 'Trades pay is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes a skilled trades hire.', images: ['https://beghr.com/assets/og-image.png'] },
};
