...
export const metadata: Metadata = {
  ...
  description: 'Trades and manufacturing payroll at $25–$35 PEPM. Union compliance, certified payroll, and multi-site management included. Request a scope review.',
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="beg-grid-2 reveal">
            <div>
              ...
              <p style={{ color: '#cccccc', lineHeight: '1.7', fontSize: '0.97rem' }}>An internal payroll specialist at your trades and manufacturing operation costs $60,000–$100,000 per year in fully-loaded compensation. Fully managed payroll at $25–$35 PEPM on a 50-person team costs $15,000–$21,000 per year. Every pay cycle on a union contract is a compliance event. One missed CBA provision or incorrect fringe benefit calculation triggers a grievance or audit.</p>
            </div>
            <div>
