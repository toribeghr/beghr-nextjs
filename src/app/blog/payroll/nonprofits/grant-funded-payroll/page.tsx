...
export const metadata: Metadata = {
  title: "Grant-Funded Payroll | Cost Allocation & Audit Compliance | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/nonprofits/grant-funded-payroll" },
  openGraph: {
    title: "Grant-Funded Payroll | Cost Allocation & Audit Compliance | BEG",
    ...
    url: "https://beghr.com/blog/payroll/nonprofits/grant-funded-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Grant-Funded Payroll | Cost Allocation, Time Tracking & Audits | BEG", description: "Grant-funded payroll: cost allocation, time tracking, funder compliance, and single audit. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Grant-Funded Payroll", "item": "https://beghr.com/blog/payroll/nonprofits/grant-funded-payroll" }
        ]
      }) }} />
    </article>
  );
