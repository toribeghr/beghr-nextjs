...
export const metadata: Metadata = {
  title: 'Church Payroll Guides | BEG Blog',
  description: 'Payroll guides, compliance resources, and managed payroll insights for church nationwide. BEG managed payroll at $25-$45 PEPM.',
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/church' },
  openGraph: {
    title: 'Church Payroll Guides | BEG Blog',
    description: 'Payroll guides, compliance resources, and managed payroll insights for church nationwide. BEG managed payroll at $25-$45 PEPM.',
    url: 'https://www.beghr.com/blog/payroll/church',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Church Payroll Guides | BEG Blog', description: 'Payroll guides, compliance resources, and managed payroll insights for church nationwide. BEG managed payroll at $25-$45 PEPM.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const posts = [
  {
    "title": "Church Payroll & FICA | Which Employees Are Exempt",
  ...
  {
    "title": "Minister Housing Allowance | How to Set It Up in Payroll",
...
export default function ChurchPayrollHubPage() {
  return (
    <>
        ...
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              <p className="eyebrow">Blog &middot; Payroll Management &middot; Churches and Religious Organizations</p>
              <h1>Church Payroll Guides</h1>
              <p className="lede" style={{ margin: '18px 0 28px' }}>
                Payroll guides, compliance resources, and managed payroll insights for church nationwide.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          <div className="head center reveal">
            <h2>Church Payroll Guides</h2>
            <p>Guides covering payroll compliance, cost comparisons, and best practices for church.</p>
          </div>
          <div className="cards">
            {posts.map((post) => (
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Churches and Religious Organizations', item: 'https://www.beghr.com/blog/payroll/church' },
            ],
          })
        }}
      />
