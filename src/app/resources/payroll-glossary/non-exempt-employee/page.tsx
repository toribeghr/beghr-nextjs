...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/resources/payroll-glossary/non-exempt-employee' },
  openGraph: { title: 'Non-Exempt Employee | Payroll Glossary | BEG', description: 'Employee covered by FLSA minimum wage and overtime requirements who must receive at least 1.5x their regular rate for hours over 40 per workweek.', url: 'https://www.beghr.com/resources/payroll-glossary/non-exempt-employee', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Non-Exempt Employee | Payroll Glossary | BEG', description: 'Employee covered by FLSA minimum wage and overtime requirements who must receive at least 1.5x their regular rate for hours over 40 per workweek.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://www.beghr.com/resources/payroll-glossary/non-exempt-employee', url: 'https://www.beghr.com/resources/payroll-glossary/non-exempt-employee', name: 'Non-Exempt Employee | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Non-Exempt Employee', description: 'Employee covered by FLSA minimum wage and overtime requirements who must receive at least 1.5x their regular rate for hours over 40 per workweek.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://www.beghr.com/resources/payroll-glossary' } },
            { '@type': 'FAQPage', mainEntity: faqs.map(f => ({ '@type': 'Question', name: f.q, acceptedAnswer: { '@type': 'Answer', text: f.a } })) },
            { '@type': 'BreadcrumbList', itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.beghr.com' },
              { '@type': 'ListItem', position: 2, name: 'Resources', item: 'https://www.beghr.com/resources' },
              { '@type': 'ListItem', position: 3, name: 'Payroll Glossary', item: 'https://www.beghr.com/resources/payroll-glossary' },
              { '@type': 'ListItem', position: 4, name: 'Non-Exempt Employee', item: 'https://www.beghr.com/resources/payroll-glossary/non-exempt-employee' },
            ]},
          ]
        }) }} />
      </section>
