...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-executive-hiring-ceo-succession-planning.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'CEO Succession Planning: Before the Board Steps In | BEG', description: 'CEO transitions are the highest-stakes hire a board makes. How to plan succession early, confidentially, and without destabilizing the company.', images: ['https://www.beghr.com/blog-images/blog-executive-hiring-ceo-succession-planning.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-executive-hiring-ceo-succession-planning.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
