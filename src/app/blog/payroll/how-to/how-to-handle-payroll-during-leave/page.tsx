...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'How to Handle Payroll During FMLA or Medical Leave | BEG',
    description: 'How to Handle Payroll During FMLA or Medical Leave. Step-by-step guidance from BEG managed payroll specialists. Questions? Get instant pricing at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/how-to/how-to-handle-payroll-during-leave',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-how-to-how-to-handle-payroll-during-leave.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'How to Handle Payroll During FMLA or Medical Leave | BEG', description: 'How to Handle Payroll During FMLA or Medical Leave. Step-by-step guidance from BEG managed payroll specialists. Questions? Get instant pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-how-to-how-to-handle-payroll-during-leave.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-how-to-how-to-handle-payroll-during-leave.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>

      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        <p>How to Handle Payroll During FMLA or Medical Leave is one of the most common payroll questions from business owners who want to get it right. This guide covers the steps clearly.</p>
