...
export const metadata: Metadata = {
  title: "Urgent Care Payroll | Clinical Staff, Overtime & HIPAA Ops | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/healthcare/urgent-care-payroll" },
  openGraph: {
    title: "Urgent Care Payroll | Clinical Staff, Overtime & HIPAA Ops | BEG",
    ...
    url: "https://beghr.com/blog/payroll/healthcare/urgent-care-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Urgent Care Payroll | Clinical Staff, Overtime & HIPAA Ops | BEG", description: "Urgent care payroll: physician comp, clinical overtime, credential tracking, and multi-site compliance. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Urgent Care Payroll", "item": "https://beghr.com/blog/payroll/healthcare/urgent-care-payroll" }
        ]
      }) }} />
    </article>
  );
