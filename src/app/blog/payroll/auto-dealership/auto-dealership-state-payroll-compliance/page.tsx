...
export const metadata: Metadata = {
  title: 'Auto Dealer Payroll: State Compliance Guide | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Auto Dealer Payroll: State Compliance Guide | BEG', description: 'Managed payroll for auto dealerships. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
