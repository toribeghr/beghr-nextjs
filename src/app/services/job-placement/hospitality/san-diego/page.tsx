...
export const metadata: Metadata = {
  title: 'Hospitality Recruiters in San Diego | BEG',
  description: 'Hospitality placement in San Diego. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hospitality/san-diego' },
  openGraph: { title: 'Hospitality Recruiters in San Diego | BEG', description: 'Hospitality placement in San Diego in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hospitality/san-diego', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Hospitality Recruiters in San Diego | BEG', description: 'Hospitality placement in San Diego in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-hospitality-san-diego');

export default function PlacementHospitalitySandiegoPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Hospitality · San Diego"
      title="That open hospitality role in San Diego is costing you every week."
      description="San Diego is a biotech, defense, and healthcare hub where specialized candidates field multiple offers. We source passive hospitality candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Hospitality in San Diego? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Hospitality placement near San Diego</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/hospitality" style={{ color: '#000000', fontWeight: 600 }}>hospitality placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/hospitality/los-angeles" style={{ color: '#000000', fontWeight: 600 }}>Los Angeles</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place hospitality candidates in San Diego?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent hospitality searches in San Diego and across California, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
