...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-nonprofit-hiring-development-director-recruiting.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Development Director Recruiting: Before You Launch | BEG', description: 'A vacant development director seat puts fundraising at risk. How to recruit and close a strong development leader in 23-35 days.', images: ['https://www.beghr.com/blog-images/blog-nonprofit-hiring-development-director-recruiting.webp'] },
};
  ...
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-nonprofit-hiring-development-director-recruiting.webp", "headline": "Development Director Recruiting: Before You Launch | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/nonprofit-hiring/development-director-recruiting"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-nonprofit-hiring-development-director-recruiting.webp" alt={`A nonprofit team and volunteers collaborating in a community space`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
