...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/resources/salary-guide/manufacturing' },
  openGraph: { title: 'Manufacturing Salary Guide 2026 | BEG', description: 'Manufacturing salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent manufacturing talent in 23-35 days.', url: 'https://www.beghr.com/resources/salary-guide/manufacturing', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Manufacturing Salary Guide 2026 | BEG', description: 'Manufacturing salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent manufacturing talent in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
