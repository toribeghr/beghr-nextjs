...
export const metadata: Metadata = {
  title: 'Engineering Firm Payroll: Outsourcing Cost vs. In-Ho.. | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Engineering Firm Payroll: Outsourcing Cost vs. In-Ho.. | BEG', description: 'Managed payroll for engineering. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
