...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/section-125' },
  openGraph: {
    title: 'Section 125 Cafeteria Plan | Payroll Glossary | BEG',
    description: 'IRS code allowing pre-tax benefit elections that reduce FICA for both employer and employee on qualified benefit amounts.',
    url: 'https://beghr.com/resources/payroll-glossary/section-125',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Section 125 Cafeteria Plan | Payroll Glossary | BEG', description: 'IRS code allowing pre-tax benefit elections that reduce FICA for both employer and employee on qualified benefit amounts.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/section-125', url: 'https://beghr.com/resources/payroll-glossary/section-125', name: 'Section 125 Cafeteria Plan | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Section 125 Cafeteria Plan', description: 'IRS code allowing pre-tax benefit elections that reduce FICA for both employer and employee on qualified benefit amounts.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Section 125 Cafeteria Plan', item: 'https://beghr.com/resources/payroll-glossary/section-125' },
            ]},
          ]
        }) }} />
      </section>
