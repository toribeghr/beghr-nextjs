...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/healthcare-hiring/hiring-nurse-practitioners' },
  openGraph: {
    title: 'How to Hire Nurse Practitioners Fast | BEG',
    description: 'A vacant NP seat strains access and your team. A practical playbook to hire a nurse practitioner in 23-35 days with passive candidate sourcing.',
    url: 'https://beghr.com/blog/healthcare-hiring/hiring-nurse-practitioners',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'How to Hire Nurse Practitioners Fast | BEG', description: 'A vacant NP seat strains access and your team. A practical playbook to hire a nurse practitioner in 23-35 days with passive candidate sourcing.', images: ['https://beghr.com/assets/og-image.png'] },
};
