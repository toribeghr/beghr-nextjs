...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/dental-hiring' },
  openGraph: {
    title: 'Dental Hiring | BEG Blog',
    description: 'Dental staffing shortage trends, associate dentist and practice manager hiring, and salary insights for practice owners who need to fill roles fast.',
    url: 'https://beghr.com/blog/dental-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Dental Hiring | BEG Blog', description: 'Dental staffing shortage trends, associate dentist and practice manager hiring, and salary insights for practice owners who need to fill roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Dental Hiring', item: 'https://beghr.com/blog/dental-hiring' },
            ],
          }),
        }}
      />
