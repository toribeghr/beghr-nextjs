...
export const metadata: Metadata = {
  title: 'Skilled Trades Recruiters in Long Beach | BEG',
  description: 'Skilled Trades placement in Long Beach. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/trades/long-beach' },
  openGraph: { title: 'Skilled Trades Recruiters in Long Beach | BEG', description: 'Skilled Trades placement in Long Beach in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/trades/long-beach', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Skilled Trades Recruiters in Long Beach | BEG', description: 'Skilled Trades placement in Long Beach in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-trades-long-beach');

export default function PlacementTradesLongbeachPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Skilled Trades · Long Beach"
      title="That open skilled trades role in Long Beach is costing you every week."
      description="Long Beach is a logistics, healthcare, and port-economy market drawing from the same pool as greater Los Angeles. We source passive skilled trades candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Skilled Trades roles in Long Beach stay open because the best candidates are passive and rarely on job boards.</li>
              <li>BEG sources skilled trades talent in Long Beach directly and fills permanent roles in 23-35 days.</li>
              <li>Milestone billing costs roughly 50% less than contingency, with a 45-day replacement guarantee.</li>
            </ul>
          </aside>
        </div>
      </section>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Skilled Trades placement\",\"name\":\"Skilled Trades Placement in Long Beach\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Long Beach\"},\"url\":\"https://www.beghr.com/services/job-placement/trades/long-beach\",\"description\":\"Permanent skilled trades placement in Long Beach in 23-35 days at roughly 50% less than contingency.\"}" }} />

      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            <p className="eyebrow">The Long Beach Talent Market</p>
            <h2>Why skilled trades roles are hard to fill in Long Beach</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Long Beach sits in the West and is a logistics, healthcare, and port-economy market drawing from the same pool as greater Los Angeles. The strongest skilled trades candidates here are already employed and are contacted constantly, which means a job posting reaches the people who are easiest to find, not the ones you actually want. We reach the passive skilled trades talent in Long Beach and the surrounding CA market directly, before they ever see a listing.
          </p>
        </div>
      </section>
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Skilled Trades in Long Beach? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Skilled Trades placement near Long Beach</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place skilled trades candidates in Long Beach?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent skilled trades searches in Long Beach and across California, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
