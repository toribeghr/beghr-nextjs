...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Franchise Payroll Mistakes, Before They Cost You | BEG', description: 'Managed payroll for franchise. Payroll Mistakes to Avoid. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
