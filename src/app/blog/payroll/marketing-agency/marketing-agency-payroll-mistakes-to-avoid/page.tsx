...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Agency Payroll Mistakes Nobody Warns You About | BEG', description: 'Managed payroll for marketing agencies. Payroll Mistakes to Avoid. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
