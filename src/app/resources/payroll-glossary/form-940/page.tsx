...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/form-940' },
  openGraph: {
    title: 'Form 940 | Payroll Glossary | BEG',
    description: 'Learn how to file Form 940, when FUTA deposits are required, the FUTA tax rate, and how state unemployment credits reduce the amount owed.',
    url: 'https://beghr.com/resources/payroll-glossary/form-940',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/form-940', url: 'https://beghr.com/resources/payroll-glossary/form-940', name: 'Form 940 | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Form 940', description: 'Learn how to file Form 940, when FUTA deposits are required, the FUTA tax rate, and how state unemployment credits reduce the amount owed.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Form 940', item: 'https://beghr.com/resources/payroll-glossary/form-940' },
            ]},
          ]
        }) }} />
      </section>
