...
export const metadata: Metadata = {
  title: "Brewery Production Staff Payroll | Overtime + Shifts | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/brewery/brewery-production-payroll" },
  openGraph: {
    title: "Brewery Production Staff Payroll | Overtime + Shifts | BEG",
    ...
    url: "https://beghr.com/blog/payroll/brewery/brewery-production-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Brewery Production Staff Payroll | Overtime + Shifts | BEG", description: "Payroll for brewery production staff: shift differentials, overtime calculation, and safety incentive administration.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "Brewery", "item": "https://beghr.com/blog/payroll/brewery" },
          { "@type": "ListItem", "position": 5, "name": "Brewery Production Payroll", "item": "https://beghr.com/blog/payroll/brewery/brewery-production-payroll" }
        ]
      }) }} />
    </article>
  );
