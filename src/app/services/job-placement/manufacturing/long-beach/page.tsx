...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/manufacturing/long-beach' },
  ...
  twitter: { card: 'summary_large_image', title: 'Manufacturing Recruiters in Long Beach | BEG', description: 'Manufacturing placement in Long Beach in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementManufacturingLongbeachPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Manufacturing placement\",\"name\":\"Manufacturing Placement in Long Beach\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Long Beach\"},\"url\":\"https://beghr.com/services/job-placement/manufacturing/long-beach\",\"description\":\"Permanent manufacturing placement in Long Beach in 23-35 days at roughly 50% less than contingency.\"}" }} />
