...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/marketing-hiring' },
  openGraph: {
    title: 'Marketing Hiring | BEG Blog',
    description: 'Marketing talent trends, hiring a marketing director, demand gen recruiting, and salary insights for leaders who need to fill marketing roles fast.',
    url: 'https://beghr.com/blog/marketing-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Marketing Hiring | BEG Blog', description: 'Marketing talent trends, hiring a marketing director, demand gen recruiting, and salary insights for leaders who need to fill marketing roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Marketing Hiring', item: 'https://beghr.com/blog/marketing-hiring' },
            ],
          }),
        }}
      />
