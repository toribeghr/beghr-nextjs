...
export const metadata: Metadata = {
  title: 'Cannabis LMS | isolved Learn & Grow, Configured by BEG',
  description: 'Training software for cannabis. BEG resells and configures isolved Learn & Grow so you can assign state compliance, seed-to-sale, and safety training, track completions, and stay audit-ready, nationwide.',
  ...
  twitter: { card: 'summary_large_image', title: 'Cannabis LMS | isolved Learn & Grow, Configured by BEG', description: 'Training software for cannabis. BEG resells and configures isolved Learn & Grow so you can assign state compliance, seed-to-sale, and safety training, track completions, and stay audit-ready, nationwide.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
const FAQS: [string, string][] = [
  [
    ...
    'Yes. BEG resells, configures, implements, and supports isolved Learn & Grow, the learning management system built into the isolved platform. isolved builds the software; BEG sets it up around your cannabis roles and training requirements.',
  ],
  [
    'Can we upload our own training content?',
    'Yes. Alongside the isolved course library, you can upload your own videos, documents, slide decks, and quizzes, so your specific state compliance, seed-to-sale, and safety training lives in the same system as everything else.',
  ],
  [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Keep a fast-growing cannabis team trained on ever-changing state rules.',
            description: 'Training software for cannabis. BEG resells and configures isolved Learn & Grow so you can assign state compliance, seed-to-sale, and safety training, track completions, and stay audit-ready, nationwide.',
      ...
      <ServicePage
        ...
        title="Keep a fast-growing cannabis team trained on ever-changing state rules."
        description="Training dispensary and cultivation staff on state compliance, seed-to-sale, and safety training should not mean chasing sign-in sheets and expired certificates. isolved Learn & Grow, resold and configured by BEG, puts every course, assignment, and completion record in one system so your cannabis team stays trained, compliant, and audit-ready, in all 50 states."
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Every training gap in cannabis shows up as risk, not just a missing checkbox</h2>
            </div>
            <div className="beg-grid-3 reveal">
              {[
                {
                  stat: 'Compliance',
                  label: 'state compliance, seed-to-sale, and safety training cannot lapse',
                  sub: 'In cannabis, a missed or expired training requirement becomes a liability the day an auditor, regulator, or client asks for proof. Paper records make that proof slow to find and easy to lose.',
                },
                {
                  stat: 'Turnover',
                  label: 'Every new hire starts training from zero',
                  sub: 'When dispensary and cultivation staff turn over, someone re-runs the same onboarding and safety training by hand. That time adds up fast and pulls your best people off the floor.',
                },
                {
                  stat: 'No trail',
              ...
              {[
                {
                  ...
                  body: 'Your roles, required courses, and renewal schedules get built into the system around how cannabis actually trains, not a generic template.',
                },
                {
                  num: '02',
              ...
              {[
                {
                  ...
                  body: 'Required state compliance, seed-to-sale, and safety training gets assigned by role the moment someone is hired, with due dates and reminders, so nothing depends on a manager remembering.',
                },
                {
                  title: 'Onboard new hires in days, not weeks',
                  body: 'New dispensary and cultivation staff run a consistent onboarding path, including your own uploaded content, and get productive faster instead of shadowing until it sticks.',
                },
                {
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '760px' }}>
            <p className="reveal" style={{ fontSize: '0.82rem', color: '#888888', textAlign: 'center' }}>
              Further reading and sources: <a href="https://cannabis.ny.gov/workforce" target="_blank" rel="noopener noreferrer">NY cannabis workforce training</a>, <a href="https://en.wikipedia.org/wiki/Learning_management_system" target="_blank" rel="noopener noreferrer">Learning management system, overview</a>.
            </p>
          </div>
        </section>
        <section className="section">
