...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'FUTA and SUTA Unemployment Tax for Employers | BEG', description: 'FUTA and SUTA: Employer Unemployment Tax Guide. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
