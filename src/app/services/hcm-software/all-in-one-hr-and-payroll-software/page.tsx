...
export const metadata: Metadata = {
  ...
  description: 'All-in-one HR and payroll software puts payroll, HR, time, and benefits on one connected platform, not stitched tools.',
  ...
  twitter: { card: 'summary_large_image', title: 'All-in-One HR & Payroll Software | Instant Quote | BEG', description: 'All-in-one HR and payroll software puts payroll, HR, time, and benefits on one connected platform, not stitched tools.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
