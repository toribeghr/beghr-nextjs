...
export const metadata: Metadata = {
  title: 'Employee vs. Contractor: IRS Classification Test Exp.. | BEG',
  description: 'Employee vs. Contractor: IRS Classification Test Explained. Expert guidance from BEG managed payroll. Book a free 15-min call to review your payroll',
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/compliance/employee-vs-contractor-irs-test' },
  openGraph: {
    title: 'Employee vs. Contractor: IRS Classification Test Exp.. | BEG',
    description: 'Employee vs. Contractor: IRS Classification Test Explained. Expert guidance from BEG managed payroll. Book a free 15-min call to review your payroll compliance at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/compliance/employee-vs-contractor-irs-test',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Employee vs. Contractor: IRS Classification Test Exp.. | BEG', description: 'Employee vs. Contractor: IRS Classification Test Explained. Expert guidance from BEG managed payroll. Book a free 15-min call to review your payroll compliance at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Employee vs. Contractor: IRS Classification Test Exp.. | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/compliance/employee-vs-contractor-irs-test"}) }} />
