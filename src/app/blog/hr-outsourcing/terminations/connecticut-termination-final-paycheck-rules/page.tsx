...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-hr-outsourcing-terminations-connecticut-termination-final-paycheck-rules.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Connecticut Termination and Final Paycheck Rules (2026)', description: 'What Connecticut employers must handle when ending employment: final pay, overtime, PFL, and separation documentation.', images: ['https://www.beghr.com/blog-images/blog-hr-outsourcing-terminations-connecticut-termination-final-paycheck-rules.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-hr-outsourcing-terminations-connecticut-termination-final-paycheck-rules.webp" alt={`An HR team reviewing employee documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
