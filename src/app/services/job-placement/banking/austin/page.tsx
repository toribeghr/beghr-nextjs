...
export default function PlacementBankingAustinPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Banking placement\",\"name\":\"Banking Placement in Austin\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Austin\"},\"url\":\"https://beghr.com/services/job-placement/banking/austin\",\"description\":\"Permanent banking placement in Austin in 23-35 days at roughly 50% less than contingency.\"}" }} />
