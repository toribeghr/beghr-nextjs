...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/employee-self-service-software' },
  openGraph: {
    title: 'Employee Self-Service Software | BEG',
    description: 'Employee self-service software so staff update info, view pay stubs, and request PTO online. Fewer HR tickets with iSolved, configured and supported by BEG.',
    url: 'https://beghr.com/services/hcm-software/employee-self-service-software',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Employee Self-Service Software | BEG', description: 'Employee self-service software so staff update info, view pay stubs, and request PTO online. Fewer HR tickets with iSolved, configured and supported by BEG.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Employee Self-Service Software', item: 'https://beghr.com/services/hcm-software/employee-self-service-software' },
  ],
};
      ...
      <section style={{ background: '#000000', color: '#ffffff', padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc' }}>
            The questions worth asking are how many routine requests HR fields each week, how spread out your workforce is, whether employees need mobile access, and whether you want a partner configuring the portal or prefer to manage it yourself. iSolved is a strong fit when request volume and workforce spread are in the picture and you want BEG managing it. BEG will run a fair comparison against your current process rather than push you toward an answer.
          </p>
        </div>
      </section>
