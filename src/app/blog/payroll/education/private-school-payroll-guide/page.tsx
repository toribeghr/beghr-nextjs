...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/education/private-school-payroll-guide" },
  openGraph: {
    title: "Private School Payroll Guide 2026 | Teachers + Staff | BEG",
    description: "How private schools handle 10-month teacher pay spread over 12, summer benefits, substitute payroll, and 403(b) administration. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/education/private-school-payroll-guide",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Private School Payroll Guide 2026 | Teachers + Staff | BEG", description: "How private schools handle 10-month teacher pay, substitute payroll, and 403(b) administration. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Private School Payroll Guide", "item": "https://beghr.com/blog/payroll/education/private-school-payroll-guide" }
        ]
      }) }} />
    </article>
  );
