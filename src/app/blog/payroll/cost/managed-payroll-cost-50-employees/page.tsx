...
export const metadata: Metadata = {
  title: 'Managed Payroll Cost for 50-Employee Companies | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/cost/managed-payroll-cost-50-employees' },
  openGraph: {
    title: 'Managed Payroll Cost for 50-Employee Companies | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/cost/managed-payroll-cost-50-employees',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Managed Payroll Cost for 50-Employee Companies | BEG', description: 'Managed Payroll Cost for 50-Employee Companies. Managed payroll at $25-$45 PEPM all-inclusive. Get a free cost comparison for your business size at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Managed Payroll Cost for 50-Employee Companies | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/payroll/cost/managed-payroll-cost-50-employees"}) }} />
