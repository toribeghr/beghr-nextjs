...
export const metadata: Metadata = {
  title: 'Hospitality Recruiters in Austin | BEG',
  description: 'Hospitality placement in Austin. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hospitality/austin' },
  openGraph: { title: 'Hospitality Recruiters in Austin | BEG', description: 'Hospitality placement in Austin in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hospitality/austin', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Hospitality Recruiters in Austin | BEG', description: 'Hospitality placement in Austin in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-hospitality-austin');

export default function PlacementHospitalityAustinPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Hospitality · Austin"
      title="That open hospitality role in Austin is costing you every week."
      description="Austin is a tech and professional-services boomtown where candidate demand consistently outpaces supply. We source passive hospitality candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Hospitality in Austin? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Hospitality placement near Austin</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/hospitality" style={{ color: '#000000', fontWeight: 600 }}>hospitality placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/hospitality/san-antonio" style={{ color: '#000000', fontWeight: 600 }}>San Antonio</Link>, <Link href="/services/job-placement/hospitality/houston" style={{ color: '#000000', fontWeight: 600 }}>Houston</Link>, <Link href="/services/job-placement/hospitality/dallas" style={{ color: '#000000', fontWeight: 600 }}>Dallas</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place hospitality candidates in Austin?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent hospitality searches in Austin and across Texas, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
