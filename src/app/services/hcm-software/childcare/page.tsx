...
export const metadata: Metadata = {
  title: 'isolved HCM for Childcare | Instant Price Quote | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/services/hcm-software/childcare' },
  openGraph: {
    title: 'isolved HCM for Childcare | Instant Price Quote | BEG',
    description: 'isolved HCM for childcare. Hourly staff, ratio and licensing compliance, multi-center management, and subsidy funding on one connected platform.',
    url: 'https://www.beghr.com/services/hcm-software/childcare',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'isolved HCM for Childcare | Instant Price Quote | BEG', description: 'isolved HCM for childcare. Hourly staff, ratio and licensing compliance, multi-center management, and subsidy funding on one connected platform.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
            ...
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Staffing to ratio and keeping certifications current is where manual tracking breaks. The platform keeps staff records and credentials with their pay.</div>
                </div>
              ))()
            }
            {
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#444444', maxWidth: '700px', margin: '1.5rem auto' }}>
            The best HCM software for childcare is one that handles hourly staff, credential tracking, and multiple centers in a single system. The isolved platform for childcare manages hourly time capture, staff certifications, multi-center reporting, benefits administration, and talent management in one connected platform. BEG implements and maintains it for your specific center structure, including how you track subsidy-funded enrollment cost.
          </p>
          <div className="beg-grid-3 reveal">
            {[
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Yes. The isolved platform keeps staff records, certifications, and time in one place so you can staff to ratio and stay licensing-ready. BEG configures which credentials each role requires and tracks renewals across every center.</p>
            </div>
            <div className="faq-item">
              <h3>Does isolved work for a multi-center childcare operator?</h3>
              <p>Yes. The isolved platform runs multiple centers in one platform while keeping each location distinct for reporting and cost tracking. BEG configures the structure to match how you operate and fund each center.</p>
            </div>
            <div className="faq-item">
              <h3>Can isolved handle our hourly classroom staff?</h3>
              <p>Yes. The isolved platform captures hourly time, applies overtime rules, and flows it straight into payroll for teachers, aides, and floaters. BEG configures your pay rules so every hourly employee is paid correctly.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Can isolved help us stay compliant with ratio and licensing rules?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. The isolved platform keeps staff records, certifications, and time in one place so you can staff to ratio and stay licensing-ready. BEG configures and tracks renewals.' } },
              { '@type': 'Question', name: 'Does isolved work for a multi-center childcare operator?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. The isolved platform runs multiple centers in one platform while keeping each location distinct for reporting and cost tracking.' } },
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Childcare', item: 'https://www.beghr.com/services/hcm-software/childcare' },
            ],
          }),
        }}
      />
