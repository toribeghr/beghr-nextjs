...
export const metadata: Metadata = {
  title: 'Nurse Practitioner Recruiters | 23-35 Days | BEG',
  description: 'Nurse Practitioner placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/healthcare/nurse-practitioner' },
  openGraph: { title: 'Nurse Practitioner Recruiters | 23-35 Days | BEG', description: 'Nurse Practitioner placement in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/healthcare/nurse-practitioner', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Nurse Practitioner Recruiters | 23-35 Days | BEG', description: 'Nurse Practitioner placement in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-healthcare-nurse-practitioner');

export default function PlacementHealthcareNursepractitionerPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Healthcare · Nurse Practitioner"
      title="Your nurse practitioner search has been open too long."
      description="NPs are in severe demand as care shifts to advanced practice providers, and the best ones field multiple offers. We place permanent nurse practitioner candidates in 23-35 days at roughly 50% less than contingency firms, with a 45-day replacement guarantee."
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Nurse Practitioner searches stall because the best candidates are passive and field multiple offers.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Nurse Practitioner placement\",\"name\":\"Nurse Practitioner Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://www.beghr.com/services/job-placement/healthcare/nurse-practitioner\",\"description\":\"Permanent nurse practitioner placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />

      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            <p className="eyebrow">Why This Role Is Hard To Fill</p>
            <h2>The best nurse practitioner candidates are not on job boards</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            NPs are in severe demand as care shifts to advanced practice providers, and the best ones field multiple offers. That is why a posting-and-waiting search rarely fills a nurse practitioner seat with the right person. We source passive nurse practitioner candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/healthcare" style={{ color: '#000000', fontWeight: 600 }}>healthcare placement service</Link>, or explore: <Link href="/services/job-placement/healthcare/registered-nurse" style={{ color: '#000000', fontWeight: 600 }}>Registered Nurse</Link>, <Link href="/services/job-placement/healthcare/physician-assistant" style={{ color: '#000000', fontWeight: 600 }}>Physician Assistant</Link>, <Link href="/services/job-placement/healthcare/clinical-director" style={{ color: '#000000', fontWeight: 600 }}>Clinical Director</Link>, <Link href="/services/job-placement/healthcare/physician" style={{ color: '#000000', fontWeight: 600 }}>Physician</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'How long does it take to place a nurse practitioner?', acceptedAnswer: { '@type': 'Answer', text: 'On average 23-35 days from discovery call to placed hire, with an 86% fill rate on active searches.' } },
