...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/energy/plant-supervisor' },
  openGraph: { title: 'Plant Supervisor Recruiters | 23-35 Days | BEG', description: 'Plant Supervisor placement in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/energy/plant-supervisor', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Plant Supervisor Recruiters | 23-35 Days | BEG', description: 'Plant Supervisor placement in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-energy-plant-supervisor');

export default function PlacementEnergyPlantsupervisorPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Energy · Plant Supervisor"
      title="Your plant supervisor search has been open too long."
      description="Plant supervisors with the right process and safety record are a small, sought-after pool. We place permanent plant supervisor candidates in 23-35 days at roughly 50% less than contingency firms, with a 45-day replacement guarantee."
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Plant Supervisor placement\",\"name\":\"Plant Supervisor Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/energy/plant-supervisor\",\"description\":\"Permanent plant supervisor placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Plant supervisors with the right process and safety record are a small, sought-after pool. That is why a posting-and-waiting search rarely fills a plant supervisor seat with the right person. We source passive plant supervisor candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
