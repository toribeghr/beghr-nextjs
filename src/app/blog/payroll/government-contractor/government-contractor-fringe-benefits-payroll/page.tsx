...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/government-contractor/government-contractor-fringe-benefits-payroll' },
  openGraph: {
    title: 'Government Contractor Fringe Benefits: SCA & Davis-Bacon | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/government-contractor/government-contractor-fringe-benefits-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Government Contractor Fringe Benefits: SCA & Davis-Bacon | BEG', description: 'SCA and Davis-Bacon fringe benefit requirements for government contractors: bona fide benefits vs cash-in-lieu.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Fringe Benefits Payroll', item: 'https://beghr.com/blog/payroll/government-contractor/government-contractor-fringe-benefits-payroll' },
        ]
      }) }} />
    </article>
  );
