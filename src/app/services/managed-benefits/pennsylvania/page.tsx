...
export const metadata: Metadata = {
  title: 'Pennsylvania Mini-COBRA Continuation Rules | BEG',
  description: 'Pennsylvania mini-COBRA: state continuation coverage rules, employer size, 9 month limit, and who runs the notices. You keep your broker.',
  alternates: { canonical: 'https://www.beghr.com/services/managed-benefits/pennsylvania' },
  openGraph: {
    title: 'Pennsylvania Mini-COBRA Continuation Rules | BEG',
    description: 'Pennsylvania mini-COBRA: state continuation coverage rules, employer size, 9 month limit, and who runs the notices. You keep your broker.',
    url: 'https://www.beghr.com/services/managed-benefits/pennsylvania',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Pennsylvania Mini-COBRA Continuation Rules | BEG', description: 'Pennsylvania mini-COBRA: state continuation coverage rules, employer size, 9 month limit, and who runs the notices. You keep your broker.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('managed-benefits-pennsylvania');

const FAQS: [string, string][] = [
  [
    'Does Pennsylvania have a mini-COBRA law?',
  ...
  [
    'How long does Pennsylvania continuation coverage last?',
  ...
  [
    'Who is eligible to continue coverage in Pennsylvania?',
  ...
  [
    'Does Pennsylvania mini-COBRA replace federal COBRA?',
  ...
  [
    'Who handles the Pennsylvania continuation notices and tracking?',
    'The employer and insurer carry the notice and election duties, and the exposure accrues per person if they are missed. BEG Managed Benefits, powered by isolved, runs enrollment, notices, election tracking, and premium status in one system. You keep your broker; we do the administration.',
  ],
];

export default function ManagedBenefitsPennsylvaniaPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Pennsylvania mini-COBRA and state continuation coverage rules',
            description: 'Pennsylvania mini-COBRA: state continuation coverage rules, employer size, 9 month limit, and who runs the notices. You keep your broker.',
            author: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' },
            publisher: { '@type': 'Organization', name: 'Business Executive Group' },
            datePublished: '2026-07-05',
            mainEntityOfPage: 'https://www.beghr.com/services/managed-benefits/pennsylvania',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Pennsylvania', item: 'https://www.beghr.com/services/managed-benefits/pennsylvania' },
            ],
          }),
        }}
      />
      <ServicePage
        showHeroImage={false}
        eyebrow="Managed Benefits · Pennsylvania"
        title="Pennsylvania makes small employers offer continuation. Someone has to run it."
        description="Pennsylvania is a mini-COBRA state: smaller employers must let departing employees keep group coverage under state law. BEG Managed Benefits, powered by isolved, runs the notices, elections, and premium tracking so the rules are handled. You keep your broker; we do the administration."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="managed-benefits" />}
        heroStats={[
          { value: '9 months', label: 'Pennsylvania state continuation limit' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '860px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Pennsylvania Continuation, In Brief</p>
              <h2>What Pennsylvania law requires</h2>
            </div>
            <div style={{ overflowX: 'auto', marginTop: '2rem' }} className="reveal">
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>State law</td><td style={{ padding: '12px 16px', color: '#555555' }}>40 P.S. section 764j (added by Act 2 of 2009)</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Employers covered</td><td style={{ padding: '12px 16px', color: '#555555' }}>Small employers with at least 2 but fewer than 20 employees (below the federal COBRA threshold), whose group health insurance is fully insured.</td></tr>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Marketplace</td><td style={{ padding: '12px 16px', color: '#555555' }}>Runs its own state-based marketplace: Pennie (https://pennie.com/).</td></tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>A small Pennsylvania employer carries big-company continuation duties</h2>
            </div>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Pennsylvania continuation coverage, answered</h2>
            </div>
