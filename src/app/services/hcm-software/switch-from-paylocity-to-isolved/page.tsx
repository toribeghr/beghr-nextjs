...
export const metadata: Metadata = {
  title: 'Switch From Paylocity to iSolved | BEG Manages It',
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/switch-from-paylocity-to-isolved' },
  openGraph: {
    title: 'Switch From Paylocity to iSolved | BEG Manages It',
    description: 'Switching from Paylocity to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.',
    url: 'https://beghr.com/services/hcm-software/switch-from-paylocity-to-isolved',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Switch From Paylocity to iSolved | BEG Manages It', description: 'Switching from Paylocity to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.', images: ['https://beghr.com/assets/og-image.png'] },
...
const faqs = [
  {
    q: 'Is switching from Paylocity to iSolved really painless?',
  ...
  {
    q: 'Will I lose my Paylocity payroll history when I switch?',
  ...
  {
    q: 'Our last implementation was rough. How is BEG different?',
  ...
  {
    q: 'How long does the switch from Paylocity to iSolved take?',
    a: 'Most clients complete the move in 60 to 90 days with no interruption to payroll. BEG plans the timeline around your pay calendar and your Paylocity renewal date.',
  },
  {
    q: 'Who supports the platform after we switch?',
    a: 'BEG does. You get a dedicated contact who supports, optimizes, and maintains your iSolved platform year-round.',
  },
];

export default function SwitchFromPaylocityToiSolvedPage() {
  const faqJsonLd = {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Switch From Paylocity to iSolved', item: 'https://beghr.com/services/hcm-software/switch-from-paylocity-to-isolved' },
    ],
  };
    ...
    <main>
      ...
      <section className="hero" style={{ background: '#000000', color: '#ffffff', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <p className="eyebrow" style={{ color: '#ECAC60' }}>HCM Software · Switch From Paylocity</p>
          <h1 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '1rem' }}>
            How to Switch From Paylocity to iSolved
          </h1>
          <p style={{ fontSize: '1.15rem', color: '#cccccc', maxWidth: '700px' }}>
            If a rough implementation or support friction has you looking, the fear of switching again is real. BEG manages the entire migration from Paylocity to iSolved, so you move to one connected platform with a partner who owns the work.
          </p>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ color: '#444', lineHeight: '1.7', marginBottom: '1.5rem' }}>
            Paylocity is a capable mid-market HCM with strong engagement features. If you are weighing a move, it is often about implementation or support friction, not the feature list. Having been through a hard rollout once, the worry is doing it again. So BEG owns it. We do not hand you a checklist and wish you luck. We run the migration for you.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
            {[
              { title: 'We manage the migration', desc: 'BEG moves your payroll history, employee records, and benefits data from Paylocity into iSolved.' },
      ...
      <section style={{ background: '#f9f9f9', padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          {[
            { step: '1. Discovery and plan', desc: 'We review your Paylocity setup, your pay calendar, and your renewal date, then build a timeline that fits your business.' },
      ...
      <section style={{ background: '#000000', color: '#ffffff', padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc', marginBottom: '1rem' }}>
            You move to one connected platform with a partner who owns implementation and support. Payroll, HR, time, and benefits live together in iSolved, built for the same mid-market companies Paylocity serves.
          </p>
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc', marginBottom: '1rem' }}>
            You also gain the only HCM platform with a Connector for Claude, generally available in June 2026, that completes real HR tasks through a conversation. Paylocity has no equivalent.
          </p>
          <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#cccccc' }}>
            And you gain a partner. BEG implements, configures, supports, and optimizes iSolved for you, with one dedicated contact. The platform serves more than 7 million employees and Forrester documented a 330% ROI.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <h2 style={{ fontSize: '1.6rem', fontWeight: '700', marginBottom: '1.5rem' }}>Switching From Paylocity FAQ</h2>
          {faqs.map(({ q, a }, i) => (
      ...
      <section style={{ background: '#ECAC60', padding: '3rem 0', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '700px' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: '800', color: '#000000', marginBottom: '0.75rem' }}>
            Ready to Switch From Paylocity to iSolved?
          </h2>
