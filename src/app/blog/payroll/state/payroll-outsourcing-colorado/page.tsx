...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing in Colorado: New 2026 Rules | BEG', description: 'Payroll Outsourcing in Colorado: New Laws and Requirements. BEG provides managed payroll nationwide. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
