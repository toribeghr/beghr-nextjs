...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Law Firm Payroll: The Truth About State Compliance | BEG', description: 'Managed payroll for law firms. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
