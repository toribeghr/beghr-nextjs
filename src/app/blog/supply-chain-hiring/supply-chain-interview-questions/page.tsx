...
export const metadata: Metadata = {
  title: 'Supply Chain Interview Questions for Logistics Managers, Planners, and Ops Leaders | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Supply Chain Interview Questions for Logistics Managers, Planners, and Ops Leaders | BEG', description: 'Supply chain interviews that reveal real demand planning accuracy, supplier management depth, and disruption response experience. Questions that identify the right operations and logistics hire.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/supply-chain-hiring/supply-chain-interview-questions');
