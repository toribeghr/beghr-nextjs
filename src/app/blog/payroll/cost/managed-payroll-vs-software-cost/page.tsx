...
export const metadata: Metadata = {
  title: 'Managed Payroll vs. Software: Which Costs Less | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/cost/managed-payroll-vs-software-cost' },
  openGraph: {
    title: 'Managed Payroll vs. Software: Which Costs Less | BEG',
    description: 'Managed Payroll vs. Payroll Software: Full Cost Comparison. Managed payroll at $25-$45 PEPM all-inclusive. Get a free cost comparison for your business size at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/cost/managed-payroll-vs-software-cost',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-cost-managed-payroll-vs-software-cost.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Managed Payroll vs. Software: Which Costs Less | BEG', description: 'Managed Payroll vs. Payroll Software: Full Cost Comparison. Managed payroll at $25-$45 PEPM all-inclusive. Get a free cost comparison for your business size at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-cost-managed-payroll-vs-software-cost.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-payroll-cost-managed-payroll-vs-software-cost.webp", "headline": "Managed Payroll vs. Software: Which Costs Less | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/cost/managed-payroll-vs-software-cost"}) }} />
      <section className="hero">
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              <p className="eyebrow">Blog · Payroll Management</p>
              <h1>Managed Payroll vs. Payroll Software: Full Cost Comparison</h1>
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-cost-managed-payroll-vs-software-cost.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Managed Payroll vs. Payroll Software: Full Cost Comparison","description":"Managed Payroll vs. Payroll Software: Full Cost Comparison. Managed payroll at $25-$45 PEPM all-inclusive. Get a free cost comparison for your business size at beghr.com.","datePublished":"2026-06-28","dateModified":"2026-06-28","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","worksFor":{"@type":"Organization","name":"Business Executive Group"}},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://www.beghr.com/assets/beg-header-image.png"}},"url":"https://www.beghr.com/blog/payroll/cost/managed-payroll-vs-software-cost","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.beghr.com/blog/payroll/cost/managed-payroll-vs-software-cost"}}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://www.beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"Managed Payroll vs. Payroll Software: Full Cost Comparison","item":"https://www.beghr.com/blog/payroll/cost/managed-payroll-vs-software-cost"}]}`,
        }}
      />
