...
export const metadata: Metadata = {
  title: 'Hospitality Recruiters in Milwaukee | BEG',
  description: 'Hospitality placement in Milwaukee. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hospitality/milwaukee' },
  openGraph: { title: 'Hospitality Recruiters in Milwaukee | BEG', description: 'Hospitality placement in Milwaukee in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hospitality/milwaukee', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Hospitality Recruiters in Milwaukee | BEG', description: 'Hospitality placement in Milwaukee in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-hospitality-milwaukee');

export default function PlacementHospitalityMilwaukeePage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Hospitality · Milwaukee"
      title="That open hospitality role in Milwaukee is costing you every week."
      description="Milwaukee is a manufacturing, finance, and healthcare market where mid-sized employers compete with Chicago. We source passive hospitality candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Hospitality in Milwaukee? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Hospitality placement near Milwaukee</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place hospitality candidates in Milwaukee?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent hospitality searches in Milwaukee and across Wisconsin, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
