...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Colorado Paid Sick Leave Explained (2026) | BEG', description: 'Does Colorado mandate paid sick leave and paid family leave? How the two programs differ, and what employers must do in 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
