...
export const metadata: Metadata = {
  title: 'Healthcare Interview Questions for Nurses, NPs, and Clinical Directors | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Healthcare Interview Questions for Nurses, NPs, and Clinical Directors | BEG', description: 'Healthcare interviews that reveal clinical judgment, patient care philosophy, and culture fit. The questions that identify nurse practitioners, RNs, and clinical directors who will stay.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/healthcare-hiring/healthcare-interview-questions');
