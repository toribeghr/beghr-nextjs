...
export default function PlacementConstructionmanagementAlbuquerquePage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Construction Management placement\",\"name\":\"Construction Management Placement in Albuquerque\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Albuquerque\"},\"url\":\"https://beghr.com/services/job-placement/construction-management/albuquerque\",\"description\":\"Permanent construction management placement in Albuquerque in 23-35 days at roughly 50% less than contingency.\"}" }} />
