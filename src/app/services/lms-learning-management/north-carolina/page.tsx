...
export const metadata: Metadata = {
  title: 'North Carolina Employee Training Compliance | LMS by BEG',
  description: 'Employee training and harassment-prevention compliance for North Carolina employers. isolved Learn & Grow, configured by BEG: assign, track, and prove trai',
  alternates: { canonical: 'https://www.beghr.com/services/lms-learning-management/north-carolina' },
  openGraph: { title: 'North Carolina Employee Training Compliance | LMS by BEG', description: 'Assign, track, and prove employee training for North Carolina employers with isolved Learn & Grow, configured by BEG.', url: 'https://www.beghr.com/services/lms-learning-management/north-carolina', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'North Carolina Employee Training Compliance | LMS by BEG', description: 'Assign, track, and prove employee training for North Carolina employers with isolved Learn & Grow.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('lms-north-carolina');
...
export default function LmsStateNorthCarolinaPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context':'https://schema.org','@type':'Article', headline:'Keep your North Carolina team trained and audit-ready, in one system.', description:'Employee training compliance for North Carolina employers with isolved Learn & Grow.', author:{ '@type':'Organization', name:'Business Executive Group', url:'https://www.beghr.com' }, publisher:{ '@type':'Organization', name:'Business Executive Group' }, datePublished:'2026-07-06', mainEntityOfPage:'https://www.beghr.com/services/lms-learning-management/north-carolina' }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context':'https://schema.org','@type':'BreadcrumbList', itemListElement:[ { '@type':'ListItem', position:1, name:'Home', item:'https://www.beghr.com' }, { '@type':'ListItem', position:2, name:'Learning Management System', item:'https://www.beghr.com/services/lms-learning-management' }, { '@type':'ListItem', position:3, name:'North Carolina', item:'https://www.beghr.com/services/lms-learning-management/north-carolina' } ] }) }} />
      ...
      <ServicePage
        showHeroImage={false}
        eyebrow="Learning Management · North Carolina"
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              <p className="eyebrow">North Carolina Training Requirements</p>
              <h2>Where employee-training compliance stands in North Carolina</h2>
            </div>
            <div className="reveal" style={{ overflowX: 'auto', marginTop: '2rem' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.95rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                ...
                <tr>
                  ...
                  <td style={{ padding: '0.7rem 1rem', borderBottom: '1px solid #eee', color: '#444444' }}>North Carolina operates an OSHA-approved State Plan with its own documented safety-training requirements.</td>
                </tr>
                <tr>
            ...
            <p className="reveal" style={{ fontSize: '0.82rem', color: '#888888', marginTop: '1rem', textAlign: 'center' }}>Sources: <a href="https://www.eeoc.gov/harassment" target="_blank" rel="noopener noreferrer">EEOC and North Carolina guidance</a>, <a href="https://www.osha.gov/stateplans/nc" target="_blank" rel="noopener noreferrer">North Carolina safety training</a>, <a href="https://en.wikipedia.org/wiki/Learning_management_system" target="_blank" rel="noopener noreferrer">Learning management system, overview</a>.</p>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '980px' }}>
            <div className="head center reveal">
              ...
              <h2>Assign, track, and prove North Carolina training in one system</h2>
            </div>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Employee training in North Carolina, answered</h2>
            </div>
