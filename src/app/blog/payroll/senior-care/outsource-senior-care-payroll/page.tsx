...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/senior-care/outsource-senior-care-payroll' },
  openGraph: {
    title: 'Outsource Senior Care Payroll | Save Time + Cost | BEG',
    description: 'Should senior care facilities outsource payroll? What operators get, cost vs in-house comparison, and how BEG onboards senior care facilities in 3-5 business days.',
    url: 'https://beghr.com/blog/payroll/senior-care/outsource-senior-care-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Outsource Senior Care Payroll | Save Time + Cost | BEG', description: 'Why senior care facilities outsource payroll and what BEG delivers at $25-$45 PEPM.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Outsource Senior Care Payroll', item: 'https://beghr.com/blog/payroll/senior-care/outsource-senior-care-payroll' },
        ]
      }) }} />
    </article>
  );
