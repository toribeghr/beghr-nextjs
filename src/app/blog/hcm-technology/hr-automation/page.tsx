...
export const metadata: Metadata = {
  title: 'HR Automation 2026 | What to Automate vs. What to Skip | BEG',
  description: 'HR automation guide for growing companies. Payroll, benefits, onboarding, and compliance workflows. What to automate first and when to outsource instead.',
  ...
  twitter: { card: 'summary_large_image', title: 'HR Automation 2026 | What to Automate vs. What to Skip | BEG', description: 'HR automation guide for growing companies. Payroll, benefits, onboarding, and compliance workflows. Time savings by function, what to automate first, an...', images: ['https://beghr.com/assets/og-image.png'] },
