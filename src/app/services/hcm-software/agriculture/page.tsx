...
export const metadata: Metadata = {
  title: 'HCM Software for Agriculture | isolved + BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'HCM Software for Agriculture | isolved + BEG', description: 'HCM software built for agriculture: seasonal workforce, multi-state compliance, piece-rate and hourly pay, and H-2A visa tracking on one connected isolved platform.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
