...
export const metadata: Metadata = {
  title: 'Your Payroll Provider Failed: Emergency Steps for Em.. | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/problems/payroll-provider-failed-what-to-do' },
  openGraph: {
    title: 'Your Payroll Provider Failed: Emergency Steps for Em.. | BEG',
    description: 'Your Payroll Provider Failed: Emergency Steps for Employers. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/problems/payroll-provider-failed-what-to-do',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Your Payroll Provider Failed: Emergency Steps for Em.. | BEG', description: 'Your Payroll Provider Failed: Emergency Steps for Employers. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
