...
export const metadata: Metadata = {
  title: 'Farm & Agriculture Payroll Guide 2026 | H-2A + Seasonal | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/agriculture/agriculture-farm-payroll-guide' },
  openGraph: {
    title: 'Farm & Agriculture Payroll Guide 2026 | H-2A + Seasonal | BEG',
    description: 'Complete farm payroll guide: H-2A visa workers, seasonal crew pay, FLSA agricultural exemptions, MSPA compliance, and piece rate calculations for 2026.',
    url: 'https://beghr.com/blog/payroll/agriculture/agriculture-farm-payroll-guide',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Farm & Agriculture Payroll Guide 2026 | H-2A + Seasonal | BEG', description: 'Complete farm payroll guide: H-2A workers, seasonal crews, MSPA compliance, and piece rate calculations.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Agriculture Farm Payroll Guide', item: 'https://beghr.com/blog/payroll/agriculture/agriculture-farm-payroll-guide' },
        ]
      }) }} />
    </article>
  );
