...
export const metadata: Metadata = {
  title: 'The Healthcare Talent Shortage in 2026 | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'The Healthcare Talent Shortage in 2026 | BEG', description: 'Clinician retirements are up and the pipeline is thin. What the 2026 healthcare shortage means for hiring and how to fill roles in 23-35 days anyway.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/healthcare-hiring/healthcare-talent-shortage');
...
export default function HealthcareTalentShortagePage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "The Healthcare Talent Shortage in 2026 | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/healthcare-hiring/healthcare-talent-shortage"}) }} />
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <div style={{ background: '#000', color: '#fff', padding: '2.5rem', borderRadius: '8px', textAlign: 'center', margin: '3rem 0' }}>
          ...
          <p style={{ marginBottom: '1.5rem', color: '#ddd' }}>Free 15-minute call. Tell us the role and the timeline. We will tell you what our clinical pipeline looks like and whether milestone placement fits.</p>
          <a href={CALENDLY} target="_blank" rel="noopener noreferrer"
        ...
        <RelatedTool
          variant="link"
          eyebrow={`Free Tool`}
          heading={`What is this open healthcare role costing you right now?`}
