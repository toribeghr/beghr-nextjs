...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Virginia Handbook Rules (2026 Guide) | BEG', description: 'What a Virginia employee handbook must cover in 2026: federal baseline, state additions, common mistakes, and update triggers.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
