...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/salon-spa/salon-commission-payroll" },
  openGraph: {
    title: "Salon Commission Payroll | Tips + Chargebacks | BEG",
    ...
    url: "https://beghr.com/blog/payroll/salon-spa/salon-commission-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Salon Commission Payroll | Tips + Chargebacks | BEG", description: "Salon commission payroll: splits, chargebacks, tip pooling, and minimum wage compliance.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Salon Commission Payroll", "item": "https://beghr.com/blog/payroll/salon-spa/salon-commission-payroll" }
        ]
      }) }} />
    </article>
  );
