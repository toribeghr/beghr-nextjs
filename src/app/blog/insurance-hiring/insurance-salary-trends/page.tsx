...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Insurance Salary Trends 2026: What Averages Hide | BEG', description: 'Insurance comp is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes an insurance hire in 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
