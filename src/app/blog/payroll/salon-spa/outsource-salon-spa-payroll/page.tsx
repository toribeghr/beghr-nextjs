...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Outsource Salon Payroll | Commission + Tips | BEG", description: "Why salons and spas outsource payroll and what changes immediately after switching to managed payroll.", images: ["https://www.beghr.com/assets/og-image.png"] },
};
