...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Does Indiana Require Paid Sick Leave? | BEG', description: 'Does Indiana mandate paid sick leave? What employers must still watch for, plus FMLA basics and how HR outsourcing keeps policy current.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
