...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Delaware Employee Handbook Rules (2026 Guide) | BEG', description: 'What a Delaware employee handbook must cover in 2026: federal baselines, the new state paid family leave benefit, and common mistakes.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
