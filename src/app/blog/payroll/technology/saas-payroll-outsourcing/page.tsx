...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-technology-saas-payroll-outsourcing.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'SaaS Payroll Outsourcing: Cost vs. an In-House Hire | BEG', description: 'SaaS company payroll outsourcing vs. hiring in-house. RSU tax events, multi-state remote, contractor classification. Save $70K-$110K annually at $25-$45...', images: ['https://www.beghr.com/blog-images/blog-payroll-technology-saas-payroll-outsourcing.webp'] },
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-technology-saas-payroll-outsourcing.webp" alt={`A modern tech office, software team collaborating at workstations`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
