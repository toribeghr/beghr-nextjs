...
export const metadata: Metadata = {
  title: 'Illinois Mini-COBRA Continuation Rules | BEG',
  description: 'Illinois mini-COBRA: state continuation coverage rules, employer size, 12 month limit, and who runs the notices. You keep your broker.',
  alternates: { canonical: 'https://www.beghr.com/services/managed-benefits/illinois' },
  openGraph: {
    title: 'Illinois Mini-COBRA Continuation Rules | BEG',
    description: 'Illinois mini-COBRA: state continuation coverage rules, employer size, 12 month limit, and who runs the notices. You keep your broker.',
    url: 'https://www.beghr.com/services/managed-benefits/illinois',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Illinois Mini-COBRA Continuation Rules | BEG', description: 'Illinois mini-COBRA: state continuation coverage rules, employer size, 12 month limit, and who runs the notices. You keep your broker.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('managed-benefits-illinois');

const FAQS: [string, string][] = [
  [
    'Does Illinois have a mini-COBRA law?',
  ...
  [
    'Who is eligible to continue coverage in Illinois?',
  ...
  [
    'Does Illinois mini-COBRA replace federal COBRA?',
  ...
  [
    'Who handles the Illinois continuation notices and tracking?',
    'The employer and insurer carry the notice and election duties, and the exposure accrues per person if they are missed. BEG Managed Benefits, powered by isolved, runs enrollment, notices, election tracking, and premium status in one system. You keep your broker; we do the administration.',
  ],
];

export default function ManagedBenefitsIllinoisPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Illinois mini-COBRA and state continuation coverage rules',
            description: 'Illinois mini-COBRA: state continuation coverage rules, employer size, 12 month limit, and who runs the notices. You keep your broker.',
            author: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' },
            publisher: { '@type': 'Organization', name: 'Business Executive Group' },
            datePublished: '2026-07-05',
            mainEntityOfPage: 'https://www.beghr.com/services/managed-benefits/illinois',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Illinois', item: 'https://www.beghr.com/services/managed-benefits/illinois' },
            ],
          }),
        }}
      />
      <ServicePage
        showHeroImage={false}
        eyebrow="Managed Benefits · Illinois"
        title="Illinois makes small employers offer continuation. Someone has to run it."
        description="Illinois is a mini-COBRA state: smaller employers must let departing employees keep group coverage under state law. BEG Managed Benefits, powered by isolved, runs the notices, elections, and premium tracking so the rules are handled. You keep your broker; we do the administration."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="managed-benefits" />}
        heroStats={[
          { value: '12 months', label: 'Illinois state continuation limit' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '860px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Illinois Continuation, In Brief</p>
              <h2>What Illinois law requires</h2>
            </div>
            <div style={{ overflowX: 'auto', marginTop: '2rem' }} className="reveal">
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>State law</td><td style={{ padding: '12px 16px', color: '#555555' }}>215 ILCS 5/367e (insurance companies); 215 ILCS 125/4-9.2 (HMOs); spousal continuation at 215 ILCS 5/367.2</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Employers covered</td><td style={{ padding: '12px 16px', color: '#555555' }}>applies to fully-insured group accident and health policies and HMO contracts regardless of employer size (not limited to sub-20 groups); functions as state continuation for groups not covered by, or in addition to, federal COBRA</td></tr>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Marketplace</td><td style={{ padding: '12px 16px', color: '#555555' }}>Illinois is transitioning to its own state-based marketplace (Get Covered Illinois); it has operated as a state-based marketplace on the federal platform. Consumers currently enroll via.</td></tr>
                </tbody>
              </table>
            </div>
            <p className="reveal" style={{ fontSize: '0.8rem', color: '#888888', marginTop: '1rem', textAlign: 'center', lineHeight: 1.6 }}>
              Source: <a href="https://www.ilga.gov/legislation/ilcs/documents/021500050K367e.htm" target="_blank" rel="noopener noreferrer">Illinois statute and department of insurance (www.ilga.gov)</a>. This page is general information, not legal advice.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>A small Illinois employer carries big-company continuation duties</h2>
            </div>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Illinois continuation coverage, answered</h2>
            </div>
