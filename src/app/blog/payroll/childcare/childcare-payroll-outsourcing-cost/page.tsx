...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Childcare Payroll: Outsource or Keep In-House | BEG', description: 'Managed payroll for childcare. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
