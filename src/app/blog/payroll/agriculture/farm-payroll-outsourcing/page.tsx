...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Farm Payroll Outsourcing | Why It Works | BEG', description: 'Why agriculture businesses outsource payroll and what to look for in a provider.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
