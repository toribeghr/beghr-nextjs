...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/insurance-agency/insurance-producer-commission-payroll" },
  openGraph: {
    title: "Insurance Producer Commission Payroll | Draws | BEG",
    description: "How to manage insurance producer commission payroll: timing, draw reconciliation, clawbacks, and withholding requirements. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/insurance-agency/insurance-producer-commission-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Insurance Producer Commission Payroll | Draws | BEG", description: "Commission payroll for insurance producers: timing, draws, reconciliation, and withholding. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Producer Commission Payroll", "item": "https://beghr.com/blog/payroll/insurance-agency/insurance-producer-commission-payroll" }
        ]
      }) }} />
    </article>
  );
