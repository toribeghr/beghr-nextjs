...
export const metadata: Metadata = {
  title: 'Tennessee Mini-COBRA Continuation Rules | BEG',
  description: 'Tennessee mini-COBRA: state continuation coverage rules, employer size, 15 month limit, and who runs the notices. You keep your broker.',
  alternates: { canonical: 'https://www.beghr.com/services/managed-benefits/tennessee' },
  openGraph: {
    title: 'Tennessee Mini-COBRA Continuation Rules | BEG',
    description: 'Tennessee mini-COBRA: state continuation coverage rules, employer size, 15 month limit, and who runs the notices. You keep your broker.',
    url: 'https://www.beghr.com/services/managed-benefits/tennessee',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Tennessee Mini-COBRA Continuation Rules | BEG', description: 'Tennessee mini-COBRA: state continuation coverage rules, employer size, 15 month limit, and who runs the notices. You keep your broker.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('managed-benefits-tennessee');
...
export default function ManagedBenefitsTennesseePage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Tennessee mini-COBRA and state continuation coverage rules',
            description: 'Tennessee mini-COBRA: state continuation coverage rules, employer size, 15 month limit, and who runs the notices. You keep your broker.',
            author: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' },
            publisher: { '@type': 'Organization', name: 'Business Executive Group' },
            datePublished: '2026-07-05',
            mainEntityOfPage: 'https://www.beghr.com/services/managed-benefits/tennessee',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Tennessee', item: 'https://www.beghr.com/services/managed-benefits/tennessee' },
            ],
          }),
        }}
      />
      <ServicePage
        showHeroImage={false}
        eyebrow="Managed Benefits · Tennessee"
        title="Tennessee makes small employers offer continuation. Someone has to run it."
        description="Tennessee is a mini-COBRA state: smaller employers must let departing employees keep group coverage under state law. BEG Managed Benefits, powered by isolved, runs the notices, elections, and premium tracking so the rules are handled. You keep your broker; we do the administration."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="managed-benefits" />}
        heroStats={[
          { value: '15 months', label: 'Tennessee state continuation limit' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '860px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Tennessee Continuation, In Brief</p>
              <h2>What Tennessee law requires</h2>
            </div>
            <div style={{ overflowX: 'auto', marginTop: '2rem' }} className="reveal">
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>State law</td><td style={{ padding: '12px 16px', color: '#555555' }}>Tenn. Code Ann. section 56-7-2312 (Continuation of terminated group coverage; conversion)</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Employers covered</td><td style={{ padding: '12px 16px', color: '#555555' }}>All fully-insured group hospital/surgical/major medical policies delivered or issued in Tennessee, regardless of employer size (applies to commercial insurers, nonprofit insurers, prepaid plans/HMOs, and state government employee plans).</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Maximum continuation</td><td style={{ padding: '12px 16px', color: '#555555' }}>Up to 15 months</td></tr>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Marketplace</td><td style={{ padding: '12px 16px', color: '#555555' }}>Uses the federal marketplace, HealthCare.gov (Tennessee does not run a state-based exchange).</td></tr>
                </tbody>
              </table>
            </div>
            <p className="reveal" style={{ fontSize: '0.8rem', color: '#888888', marginTop: '1rem', textAlign: 'center', lineHeight: 1.6 }}>
              Source: <a href="https://codes.findlaw.com/tn/title-56-insurance/tn-code-sect-56-7-2312/" target="_blank" rel="noopener noreferrer">Tennessee statute and department of insurance (codes.findlaw.com)</a>. This page is general information, not legal advice.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>A small Tennessee employer carries big-company continuation duties</h2>
            </div>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Tennessee continuation coverage, answered</h2>
            </div>
