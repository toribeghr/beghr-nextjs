...
export default function SwitchFromPaylocityToisolvedPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Switch From Paylocity to isolved', item: 'https://www.beghr.com/services/hcm-software/switch-from-paylocity-to-isolved' },
    ],
  };
