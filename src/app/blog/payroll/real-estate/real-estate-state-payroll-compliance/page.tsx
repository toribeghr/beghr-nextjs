...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Real Estate Payroll Compliance by State: What to Know | BEG', description: 'Managed payroll for real estate. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
