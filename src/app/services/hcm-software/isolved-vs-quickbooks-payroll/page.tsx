...
const faqs = [
  ...
  },
  {
    ...
    a: 'QuickBooks Payroll is basic small-business payroll tied to accounting, not a full HCM. The platform is a single connected isolved system that brings payroll, HR, time, and benefits together. The core difference is basic payroll versus a complete HCM platform.',
  },
  {
      ...
      <section className="hero" style={{ background: '#000000', color: '#ffffff', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ fontSize: '1.15rem', color: '#cccccc', maxWidth: '700px' }}>
            QuickBooks Payroll is basic small-business payroll attached to accounting. The platform is a single connected isolved system for payroll, HR, time, and benefits. Here is how they compare.
          </p>
