...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Financial Firm Payroll: What Misclassification Costs | BEG', description: 'Managed payroll for financial services. Employee Classification for Payroll. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
