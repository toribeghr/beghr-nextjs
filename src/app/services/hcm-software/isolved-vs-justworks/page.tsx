...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/isolved-vs-justworks' },
  openGraph: {
    title: 'iSolved vs Justworks | One Platform + Claude AI | BEG',
    description: 'iSolved vs Justworks compared on platform breadth, pricing, control, support, and AI. See which fits growing firms versus a small-business PEO co-employment model.',
    url: 'https://beghr.com/services/hcm-software/isolved-vs-justworks',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved vs Justworks | One Platform + Claude AI | BEG', description: 'iSolved vs Justworks compared on platform breadth, pricing, control, support, and AI. See which fits growing firms versus a small-business PEO co-employment model.', images: ['https://beghr.com/assets/og-image.png'] },
...
const faqs = [
  {
    q: 'Is Justworks a good fit for a small business?',
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'iSolved vs Justworks', item: 'https://beghr.com/services/hcm-software/isolved-vs-justworks' },
  ],
};
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            <div style={{ background: '#ECAC60', padding: '1.5rem', borderRadius: '8px' }}>
              ...
              <ul style={{ margin: 0, paddingLeft: '1.2rem', lineHeight: '1.8' }}>
                ...
                <li>Customization and control as you grow</li>
                <li>Forrester-documented 330% ROI</li>
              </ul>
            </div>
            <div style={{ background: '#ffffff', border: '2px solid #e0e0e0', padding: '1.5rem', borderRadius: '8px' }}>
              <strong style={{ display: 'block', fontSize: '1.1rem', marginBottom: '0.5rem' }}>Justworks wins on:</strong>
              <ul style={{ margin: 0, paddingLeft: '1.2rem', lineHeight: '1.8' }}>
                <li>A simple, friendly PEO experience for small teams</li>
                <li>Easy HR and benefits through co-employment</li>
                <li>Speed to get started for very small businesses</li>
                <li>A clean fit for simple, hands-off needs</li>
              </ul>
            </div>
          </div>
        </div>
