...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/cafeteria-plan' },
  openGraph: {
    title: 'Cafeteria Plan (Section 125) | Payroll Glossary | BEG',
    description: 'Learn how a Section 125 cafeteria plan works, which benefits qualify, and the FICA savings it creates for employers and employees.',
    url: 'https://beghr.com/resources/payroll-glossary/cafeteria-plan',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/cafeteria-plan', url: 'https://beghr.com/resources/payroll-glossary/cafeteria-plan', name: 'Cafeteria Plan (Section 125) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Cafeteria Plan (Section 125)', description: 'Learn how a Section 125 cafeteria plan works, which benefits qualify, and the FICA savings it creates for employers and employees.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Cafeteria Plan (Section 125)', item: 'https://beghr.com/resources/payroll-glossary/cafeteria-plan' },
            ]},
          ]
        }) }} />
      </section>
