...
export const metadata: Metadata = {
  title: 'South Dakota Paid Sick Leave Explained (2026) | BEG',
  description: 'Does South Dakota require paid sick leave? What employers must know about local ordinances, remote workers, and FMLA in 2026.',
  alternates: { canonical: 'https://www.beghr.com/blog/hr-outsourcing/leave/south-dakota-paid-sick-leave-explained' },
  openGraph: {
    title: 'South Dakota Paid Sick Leave Explained (2026) | BEG',
    description: 'Does South Dakota require paid sick leave? What employers must know about local ordinances, remote workers, and FMLA in 2026.',
    url: 'https://www.beghr.com/blog/hr-outsourcing/leave/south-dakota-paid-sick-leave-explained',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-hr-outsourcing-leave-south-dakota-paid-sick-leave-explained.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'South Dakota Paid Sick Leave Explained (2026) | BEG', description: 'Does South Dakota require paid sick leave? What employers must know about local ordinances, remote workers, and FMLA in 2026.', images: ['https://www.beghr.com/blog-images/blog-hr-outsourcing-leave-south-dakota-paid-sick-leave-explained.webp'] },
};

const faqs = [
  {
    question: 'Does South Dakota require employers to offer paid sick leave?',
    answer: 'No. South Dakota has no statewide paid sick leave mandate. Employers may offer paid sick leave voluntarily, but there is no state law requiring accrual, carryover, or a minimum number of hours.',
  },
  {
    question: 'Can a city in South Dakota require paid sick leave?',
  ...
  {
    question: 'What if a South Dakota employer has remote workers in other states?',
  ...
  {
    question: 'Does FMLA guarantee paid sick leave in South Dakota?',
  ...
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BlogPosting",
        "image": "https://beghr.com/blog-images/blog-hr-outsourcing-leave-south-dakota-paid-sick-leave-explained.webp", "headline": "South Dakota Paid Sick Leave Explained: What Employers Must Know", "description": "Does South Dakota require paid sick leave? What employers must know about local ordinances, remote workers, and FMLA in 2026.", "datePublished": "2026-07-06", "dateModified": "2026-07-06", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/hr-outsourcing/leave/south-dakota-paid-sick-leave-explained"}) }} />
        ...
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              ...
              <h1>South Dakota Paid Sick Leave Explained: What Employers Must Know</h1>
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-hr-outsourcing-leave-south-dakota-paid-sick-leave-explained.webp" alt={`An HR team reviewing employee documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>

      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        <p>South Dakota does not mandate paid sick leave statewide. Employers are free to design their own policy, but must watch for local ordinance activity and account for remote employees working from mandate states.</p>

        <p>South Dakota is one of many states where paid sick leave is left entirely to employer discretion, with no statewide statute setting accrual rates, carryover rules, or permitted uses. That does not mean the topic is risk-free. Employers headquartered in South Dakota that hire remote workers, expand into other cities, or bring on employees who live in mandate states can find themselves subject to obligations that have nothing to do with South Dakota law at all.</p>

        <p>This is exactly where <a href="/services/hr-outsourcing">HR outsourcing</a> earns its keep: a policy built only around South Dakota's baseline can leave a company exposed the moment its workforce spreads beyond state lines.</p>
        ...
        <p>A company based in South Dakota that hires a remote worker living in a state with a paid sick leave mandate generally has to comply with that state's law for that employee, regardless of where the company itself is headquartered. This catches many growing employers off guard, since it is natural to assume one policy can cover the whole team. Policy should be built around where people actually work, not just where the company is registered.</p>

        <p>Employers expanding through talent acquisition and remote hiring should treat each new state as a fresh compliance question rather than assuming South Dakota's light-touch rules travel with the employee. A single national policy document, if it is not built carefully, can either overpromise benefits that South Dakota does not require or underdeliver on what a mandate state actually requires for a remote hire living there.</p>
        ...
        <p>Even without a state mandate, a written voluntary sick leave or PTO policy protects the company by setting clear expectations. A workable policy generally addresses how time accrues or is granted, whether unused time carries over into the next year, what uses are permitted, what documentation an employee may be asked to provide for extended absences, and how much advance notice is expected for foreseeable absences. Because South Dakota sets no statutory floor, the company has flexibility here, but that flexibility should be used deliberately rather than left undefined.</p>

        <p>Employers that also operate in other states should build the South Dakota-based policy as one part of a broader, multi-state leave framework rather than as a single flat document, so that adding a mandate-state hire later does not require rebuilding the whole policy from scratch.</p>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.93rem' }}>
            <thead>
              <tr style={{ background: '#000', color: '#fff' }}>
                ...
                <th style={{ padding: '0.75rem', textAlign: 'left' }}>South Dakota status</th>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Does South Dakota require employers to offer paid sick leave?","acceptedAnswer":{"@type":"Answer","text":"No. South Dakota has no statewide paid sick leave mandate. Employers may offer paid sick leave voluntarily, but there is no state law requiring accrual, carryover, or a minimum number of hours."}},{"@type":"Question","name":"Can a city in South Dakota require paid sick leave?","acceptedAnswer":{"@type":"Answer","text":"Local ordinances can change over time, and requirements vary by city and county. Confirm current local ordinance status with the state labor office before finalizing a policy."}},{"@type":"Question","name":"What if a South Dakota employer has remote workers in other states?","acceptedAnswer":{"@type":"Answer","text":"A remote employee working from a mandate state is generally covered by that state's paid sick leave rules regardless of where the company is headquartered, so policy should match where people actually work."}},{"@type":"Question","name":"Does FMLA guarantee paid sick leave in South Dakota?","acceptedAnswer":{"@type":"Answer","text":"No. FMLA provides unpaid, job-protected leave for eligible employees at covered employers based on headcount. It is a separate protection from paid sick leave and should not be confused with it."}},{"@type":"Question","name":"Is BEG a PEO?","acceptedAnswer":{"@type":"Answer","text":"No. There is no co-employment and no employer-of-record change. Your company stays the employer; the HR professionals support your team. HR outsourcing, powered by isolved."}}]}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"HR Outsourcing","item":"https://www.beghr.com/blog/hr-outsourcing"},{"@type":"ListItem","position":4,"name":"South Dakota Paid Sick Leave Explained: What Employers Must Know","item":"https://www.beghr.com/blog/hr-outsourcing/leave/south-dakota-paid-sick-leave-explained"}]}`,
        }}
      />
