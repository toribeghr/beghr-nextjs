...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Home Health Payroll | Managed vs. In-House. $25-$45 PEPM. | BEG', description: 'Home health agency payroll outsourcing vs. hiring in-house. Real cost comparison for agencies with 15–150 staff. Travel time compensation, EVV complianc...', images: ['https://www.beghr.com/assets/og-image.png'] },
