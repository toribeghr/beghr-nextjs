...
export const metadata: Metadata = {
  ...
  description: 'Maintenance Technician placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://beghr.com/services/job-placement/trades/maintenance-technician' },
  openGraph: { title: 'Maintenance Technician Recruiters | 23-35 Days | BEG', description: 'Maintenance Technician placement in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/trades/maintenance-technician', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Maintenance Technician Recruiters | 23-35 Days | BEG', description: 'Maintenance Technician placement in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementTradesMaintenancetechnicianPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Maintenance Technician placement\",\"name\":\"Maintenance Technician Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/trades/maintenance-technician\",\"description\":\"Permanent maintenance technician placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Industrial maintenance techs who can keep a line running are hard to find and keep. That is why a posting-and-waiting search rarely fills a maintenance technician seat with the right person. We source passive maintenance technician candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
