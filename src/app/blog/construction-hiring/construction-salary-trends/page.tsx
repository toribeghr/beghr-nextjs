...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: "Construction Salary Trends 2026: What Pay Won't Fix | BEG", description: 'Construction management comp is climbing in 2026, but the best candidates are passive and pay is only part of the decision. What closes a hire.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function ConstructionSalaryTrendsPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Construction Salary Trends 2026: What Pay Won't Fix | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/construction-hiring/construction-salary-trends"}) }} />
