...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/managed-payroll/tennessee' },
  openGraph: {
    title: 'Tennessee Managed Payroll Services | BEG | $25-$45 PEPM',
    description: 'Fully managed payroll for Tennessee employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.',
    url: 'https://beghr.com/services/managed-payroll/tennessee',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Tennessee Managed Payroll Services | BEG | $25-$45 PEPM', description: 'Fully managed payroll for Tennessee employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Tennessee', item: 'https://beghr.com/services/managed-payroll/tennessee' },
            ],
          })
        }}
      />
