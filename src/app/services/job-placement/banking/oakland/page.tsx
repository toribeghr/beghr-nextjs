...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/banking/oakland' },
  openGraph: { title: 'Banking Recruiters in Oakland | BEG', description: 'Banking placement in Oakland in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/banking/oakland', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Banking Recruiters in Oakland | BEG', description: 'Banking placement in Oakland in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementBankingOaklandPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Banking placement\",\"name\":\"Banking Placement in Oakland\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Oakland\"},\"url\":\"https://www.beghr.com/services/job-placement/banking/oakland\",\"description\":\"Permanent banking placement in Oakland in 23-35 days at roughly 50% less than contingency.\"}" }} />
