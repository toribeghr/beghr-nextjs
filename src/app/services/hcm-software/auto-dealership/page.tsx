            ...
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Hourly plus commission is where manual dealership payroll breaks. iSolved applies the right pay rules by department and role every pay period.</div>
                </div>
              ))()
            }
            {
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#444444', maxWidth: '700px', margin: '1.5rem auto' }}>
            The best HCM software for a dealer group is one that handles commission and spiff pay, hourly plus commission roles, and separate departments in a single system. iSolved for dealerships manages sales, service, and parts pay, multi-rooftop time capture, benefits administration, and talent management in one connected platform. BEG implements and maintains it for your specific store structure.
          </p>
          <div className="beg-grid-3 reveal">
            {[
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Yes. iSolved calculates commission, spiffs, and hourly plus commission pay automatically by department and role, so sales, service, and parts staff are all paid correctly. BEG configures your specific pay plans during implementation.</p>
            </div>
            <div className="faq-item">
              <h3>Does iSolved work for a multi-rooftop dealer group?</h3>
              <p>Yes. iSolved rolls up multiple rooftops under one dealer group while keeping each store distinct for reporting. You see labor cost by location and department, and BEG configures the structure to match how you operate.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Can iSolved handle commission and spiff pay for our dealership?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. iSolved calculates commission, spiffs, and hourly plus commission pay automatically by department and role. BEG configures your specific pay plans.' } },
              { '@type': 'Question', name: 'Does iSolved work for a multi-rooftop dealer group?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. iSolved rolls up multiple rooftops under one dealer group while keeping each store distinct for reporting on labor cost by location and department.' } },
