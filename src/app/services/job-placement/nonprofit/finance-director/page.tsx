...
export const metadata: Metadata = {
  ...
  description: 'Nonprofit Finance Director placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://beghr.com/services/job-placement/nonprofit/finance-director' },
  openGraph: { title: 'Nonprofit Finance Director Recruiters | 23-35 Days | BEG', description: 'Nonprofit Finance Director placement in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/nonprofit/finance-director', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Nonprofit Finance Director Recruiters | 23-35 Days | BEG', description: 'Nonprofit Finance Director placement in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementNonprofitFinancedirectorPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Nonprofit Finance Director placement\",\"name\":\"Nonprofit Finance Director Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/nonprofit/finance-director\",\"description\":\"Permanent nonprofit finance director placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Finance directors who understand grant accounting and fund management are a thin, in-demand pool. That is why a posting-and-waiting search rarely fills a nonprofit finance director seat with the right person. We source passive nonprofit finance director candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
