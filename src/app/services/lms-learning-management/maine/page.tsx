...
export const metadata: Metadata = {
  title: 'Maine Employee Training Compliance | LMS by BEG',
  description: 'Employee training and harassment-prevention compliance for Maine employers. isolved Learn & Grow, configured by BEG: assign, track, and prove training. Ins',
  alternates: { canonical: 'https://www.beghr.com/services/lms-learning-management/maine' },
  openGraph: { title: 'Maine Employee Training Compliance | LMS by BEG', description: 'Assign, track, and prove employee training for Maine employers with isolved Learn & Grow, configured by BEG.', url: 'https://www.beghr.com/services/lms-learning-management/maine', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Maine Employee Training Compliance | LMS by BEG', description: 'Assign, track, and prove employee training for Maine employers with isolved Learn & Grow.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('lms-maine');
...
export default function LmsStateMainePage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context':'https://schema.org','@type':'Article', headline:'Maine requires harassment-prevention training. Track it and prove it in one system.', description:'Employee training compliance for Maine employers with isolved Learn & Grow.', author:{ '@type':'Organization', name:'Business Executive Group', url:'https://www.beghr.com' }, publisher:{ '@type':'Organization', name:'Business Executive Group' }, datePublished:'2026-07-06', mainEntityOfPage:'https://www.beghr.com/services/lms-learning-management/maine' }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context':'https://schema.org','@type':'BreadcrumbList', itemListElement:[ { '@type':'ListItem', position:1, name:'Home', item:'https://www.beghr.com' }, { '@type':'ListItem', position:2, name:'Learning Management System', item:'https://www.beghr.com/services/lms-learning-management' }, { '@type':'ListItem', position:3, name:'Maine', item:'https://www.beghr.com/services/lms-learning-management/maine' } ] }) }} />
      ...
      <ServicePage
        showHeroImage={false}
        eyebrow="Learning Management · Maine"
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Maine Training Requirements</p>
              <h2>Where employee-training compliance stands in Maine</h2>
            </div>
            <div className="reveal" style={{ overflowX: 'auto', marginTop: '2rem' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.95rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                ...
                <tr>
                  ...
                  <td style={{ padding: '0.7rem 1rem', borderBottom: '1px solid #eee', color: '#444444' }}>Employers with 15 or more employees must provide sexual-harassment-prevention training to all employees within 1 year of hire, with additional supervisor-specific training within 1 year of taking on supervisory duties; annual written notice to employees is also required. (26 M.R.S.A. Section 807)</td>
                </tr>
                <tr>
            ...
            <p className="reveal" style={{ fontSize: '0.82rem', color: '#888888', marginTop: '1rem', textAlign: 'center' }}>Sources: <a href="https://legislature.maine.gov/statutes/26/title26sec807.html" target="_blank" rel="noopener noreferrer">Maine harassment-training guidance</a>, <a href="https://en.wikipedia.org/wiki/Learning_management_system" target="_blank" rel="noopener noreferrer">Learning management system, overview</a>.</p>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '980px' }}>
            <div className="head center reveal">
              ...
              <h2>Assign, track, and prove Maine training in one system</h2>
            </div>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Employee training in Maine, answered</h2>
            </div>
