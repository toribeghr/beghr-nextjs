...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/brewery/taproom-tip-credit-payroll" },
  openGraph: {
    title: "Taproom Tip Credit Payroll | State Rules Explained | BEG",
    description: "How craft breweries apply the FLSA tip credit for taproom servers: tip pooling, tip reporting, state variations, and overtime on tipped wages. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/brewery/taproom-tip-credit-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Taproom Tip Credit Payroll | State Rules Explained | BEG", description: "Brewery taproom tip credit: FLSA rules, tip pooling, state variations, and overtime calculation for tipped servers.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Taproom Tip Credit", "item": "https://beghr.com/blog/payroll/brewery/taproom-tip-credit-payroll" }
        ]
      }) }} />
    </article>
  );
