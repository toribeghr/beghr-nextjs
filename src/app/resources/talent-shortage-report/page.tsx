...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/talent-shortage-report' },
  openGraph: { title: '2026 Talent Shortage Report | BEG', description: 'Where hiring shortages are worst in 2026 across accounting, cybersecurity, healthcare, skilled trades, and sales, plus why most job postings fail to fill.', url: 'https://beghr.com/resources/talent-shortage-report', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'article' },
  twitter: { card: 'summary_large_image', title: '2026 Talent Shortage Report | BEG', description: 'Where hiring shortages are worst in 2026 across accounting, cybersecurity, healthcare, skilled trades, and sales, plus why most job postings fail to fill.', images: ['https://beghr.com/assets/og-image.png'] },
};
