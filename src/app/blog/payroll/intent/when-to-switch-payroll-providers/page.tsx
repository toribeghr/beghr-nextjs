...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/intent/when-to-switch-payroll-providers' },
  openGraph: {
    title: 'When Is the Right Time to Switch Payroll Providers? | BEG',
    description: 'When Is the Right Time to Switch Payroll Providers?. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/intent/when-to-switch-payroll-providers',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'When Is the Right Time to Switch Payroll Providers? | BEG', description: 'When Is the Right Time to Switch Payroll Providers?. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
