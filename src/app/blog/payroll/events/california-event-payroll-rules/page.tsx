...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/events/california-event-payroll-rules" },
  openGraph: {
    title: "California Event Payroll Rules | AB5 + 1-Day | BEG",
    description: "California event payroll: AB5 worker classification, 1-day worker rules, entertainment wage orders, minimum wage, and overtime for events in California. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/events/california-event-payroll-rules",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "California Event Payroll Rules | AB5 + 1-Day | BEG", description: "California event payroll: AB5, 1-day worker rules, entertainment wage orders, and overtime. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "California Event Payroll Rules", "item": "https://beghr.com/blog/payroll/events/california-event-payroll-rules" }
        ]
      }) }} />
    </article>
  );
