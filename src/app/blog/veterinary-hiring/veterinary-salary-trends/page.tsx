...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Veterinary Salary Trends 2026: What Actually Closes | BEG', description: 'Veterinary comp is climbing, but the best DVMs are passive and pay is only part of the decision. What actually closes a veterinary hire in 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
