...
export const metadata: Metadata = {
  title: 'Banking Talent Trends 2026: What Changed Fast | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-banking-hiring-banking-talent-trends.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Banking Talent Trends 2026: What Changed Fast | BEG', description: 'Retirements rise and fintech competes for talent. What the 2026 banking labor market means for hiring and how to fill roles in 23-35 days.', images: ['https://www.beghr.com/blog-images/blog-banking-hiring-banking-talent-trends.webp'] },
};
...
export default function BankingTalentTrendsPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Banking Talent Trends 2026: What Changed Fast | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/banking-hiring/banking-talent-trends"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-banking-hiring-banking-talent-trends.webp" alt={`Banking Talent Trends 2026: What Changed Fast`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
