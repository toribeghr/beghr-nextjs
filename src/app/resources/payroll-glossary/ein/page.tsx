...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/ein' },
  openGraph: {
    title: 'Employer Identification Number (EIN) | Payroll Glossary | BEG',
    description: 'Learn what an EIN is, how to apply for one, and why every employer needs it for payroll, tax filing, and banking.',
    url: 'https://beghr.com/resources/payroll-glossary/ein',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/ein', url: 'https://beghr.com/resources/payroll-glossary/ein', name: 'Employer Identification Number (EIN) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Employer Identification Number (EIN)', description: 'Learn what an EIN is, how to apply for one, and why every employer needs it for payroll, tax filing, and banking.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Employer Identification Number (EIN)', item: 'https://beghr.com/resources/payroll-glossary/ein' },
            ]},
          ]
        }) }} />
      </section>
