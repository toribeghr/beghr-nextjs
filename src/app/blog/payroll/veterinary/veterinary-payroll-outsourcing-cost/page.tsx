...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/veterinary/veterinary-payroll-outsourcing-cost' },
  openGraph: {
    title: 'Vet Practice Payroll: Outsourcing Cost vs. In-House | BEG',
    description: 'Managed payroll for veterinary. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/veterinary/veterinary-payroll-outsourcing-cost',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Vet Practice Payroll: Outsourcing Cost vs. In-House | BEG', description: 'Managed payroll for veterinary. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
