...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/accounting-hiring/controller-hiring' },
  openGraph: {
    title: 'How to Hire a Controller Fast (2026 Guide) | BEG',
    description: 'A vacant controller seat risks your close and audit. A practical playbook to hire a controller in 23-35 days with passive candidate sourcing.',
    url: 'https://beghr.com/blog/accounting-hiring/controller-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'How to Hire a Controller Fast (2026 Guide) | BEG', description: 'A vacant controller seat risks your close and audit. A practical playbook to hire a controller in 23-35 days with passive candidate sourcing.', images: ['https://beghr.com/assets/og-image.png'] },
};
