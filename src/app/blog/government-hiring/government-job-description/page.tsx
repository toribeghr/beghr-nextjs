...
export const metadata: Metadata = {
  title: 'How to Write a Government Contractor Job Description That Attracts Cleared Professionals | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'How to Write a Government Contractor Job Description That Attracts Cleared Professionals | BEG', description: 'Government contractor JDs that bury the clearance level and contract details lose cleared candidates fast. How to write a job description that brings in the right talent.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/government-hiring/government-job-description');
