...
export const metadata: Metadata = {
  title: 'Hiring a Finance Manager Without Overpaying | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/finance-hiring/hiring-a-finance-manager' },
  openGraph: {
    title: 'Hiring a Finance Manager Without Overpaying | BEG',
    description: 'A vacant finance manager seat slows forecasting and board reporting. A practical playbook to hire a finance manager in 23-35 days without settling.',
    url: 'https://www.beghr.com/blog/finance-hiring/hiring-a-finance-manager',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-finance-hiring-hiring-a-finance-manager.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Hiring a Finance Manager Without Overpaying | BEG', description: 'A vacant finance manager seat slows forecasting and board reporting. A practical playbook to hire a finance manager in 23-35 days without settling.', images: ['https://www.beghr.com/blog-images/blog-finance-hiring-hiring-a-finance-manager.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-finance-hiring-hiring-a-finance-manager.webp" alt={`Hiring a Finance Manager Without Overpaying`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
