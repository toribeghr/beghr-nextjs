...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Louisiana Minimum Wage 2026: What Employers Must Know | BEG', description: 'Louisiana has no state minimum wage law in 2026, so the federal $7.25 rate applies. See overtime rules and what it means for payroll compliance.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
