...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/staffing-agency/outsource-staffing-agency-payroll' },
  openGraph: {
    title: 'Outsource Staffing Agency Payroll | Benefits + Process | BEG',
    description: 'Should you outsource staffing agency payroll? What outsourcing covers, how it handles W-2 vs 1099, weekly cycles, and BEG onboarding in 3-5 business days.',
    url: 'https://beghr.com/blog/payroll/staffing-agency/outsource-staffing-agency-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Outsource Staffing Agency Payroll | Benefits + Process | BEG', description: 'What outsourcing staffing agency payroll covers and how BEG onboards agencies in 3-5 business days.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Outsource Staffing Agency Payroll', item: 'https://beghr.com/blog/payroll/staffing-agency/outsource-staffing-agency-payroll' },
        ]
      }) }} />
    </article>
  );
