...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Tech Company Payroll: Employee Classification Rules | BEG', description: 'Managed payroll for tech/SaaS. Employee Classification for Payroll. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
