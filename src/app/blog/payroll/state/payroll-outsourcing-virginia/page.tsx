...
export const metadata: Metadata = {
  title: 'Payroll Outsourcing in Virginia | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing in Virginia | BEG', description: 'Payroll Outsourcing in Virginia. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
