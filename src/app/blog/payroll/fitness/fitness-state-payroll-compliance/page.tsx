...
export const metadata: Metadata = {
  title: 'Fitness Studio Payroll: State Compliance Guide | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Fitness Studio Payroll: State Compliance Guide | BEG', description: 'Managed payroll for fitness. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
