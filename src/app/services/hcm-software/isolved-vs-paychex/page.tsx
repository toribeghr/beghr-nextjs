...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/isolved-vs-paychex' },
  openGraph: {
    title: 'iSolved vs Paychex | One Platform + Claude AI | BEG',
    description: 'iSolved vs Paychex compared across platform, pricing and add-ons, implementation, support, and AI. See which HCM fits a modern mid-market company best.',
    url: 'https://beghr.com/services/hcm-software/isolved-vs-paychex',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved vs Paychex | One Platform + Claude AI | BEG', description: 'iSolved vs Paychex compared across platform, pricing and add-ons, implementation, support, and AI. See which HCM fits a modern mid-market company best.', images: ['https://beghr.com/assets/og-image.png'] },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'iSolved vs Paychex', item: 'https://beghr.com/services/hcm-software/isolved-vs-paychex' },
  ],
};
