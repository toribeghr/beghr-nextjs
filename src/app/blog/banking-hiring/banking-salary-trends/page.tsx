...
export const metadata: Metadata = {
  title: 'Banking Salary Trends 2026: The Truth About the Gaps | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/banking-hiring/banking-salary-trends' },
  openGraph: {
    title: 'Banking Salary Trends 2026: The Truth About the Gaps | BEG',
    description: 'Banking pay is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes a banking hire in 2026.',
    url: 'https://www.beghr.com/blog/banking-hiring/banking-salary-trends',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-banking-hiring-banking-salary-trends.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Banking Salary Trends 2026: The Truth About the Gaps | BEG', description: 'Banking pay is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes a banking hire in 2026.', images: ['https://www.beghr.com/blog-images/blog-banking-hiring-banking-salary-trends.webp'] },
};
...
export default function BankingSalaryTrendsPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Banking Salary Trends 2026: The Truth About the Gaps | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/banking-hiring/banking-salary-trends"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-banking-hiring-banking-salary-trends.webp" alt={`Banking Salary Trends 2026: The Truth About the Gaps`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
