...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Trucking Payroll: Multi-Location Payroll Guide | BEG', description: 'Managed payroll for trucking. Multi-Location Payroll Guide. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
