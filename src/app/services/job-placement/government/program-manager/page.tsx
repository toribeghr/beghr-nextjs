...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/government/program-manager' },
  openGraph: { title: 'Program Manager Recruiters | 23-35 Days | BEG', description: 'Program Manager placement in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/government/program-manager', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Program Manager Recruiters | 23-35 Days | BEG', description: 'Program Manager placement in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-government-program-manager');

export default function PlacementGovernmentProgrammanagerPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Government · Program Manager"
      title="Your program manager search has been open too long."
      description="Program managers who can deliver on active awards are passive and recruited across primes and agencies. We place permanent program manager candidates in 23-35 days at roughly 50% less than contingency firms, with a 45-day replacement guarantee."
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Program Manager searches stall because the best candidates are passive and field multiple offers.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Program Manager placement\",\"name\":\"Program Manager Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/government/program-manager\",\"description\":\"Permanent program manager placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
