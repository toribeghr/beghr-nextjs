...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Senior Care Payroll Guide 2026 | BEG', description: 'Senior care payroll: CNA overtime, shift differentials, CMS compliance. Complete guide for nursing homes and ALFs.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
