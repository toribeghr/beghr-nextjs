...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/onboarding-software' },
  openGraph: {
    title: 'Onboarding Software | BEG',
    description: 'Onboarding software for new-hire workflows, e-signature, I-9 and W-4 forms, and first-day readiness. iSolved onboarding on one platform, supported by BEG.',
    url: 'https://beghr.com/services/hcm-software/onboarding-software',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Onboarding Software | BEG', description: 'Onboarding software for new-hire workflows, e-signature, I-9 and W-4 forms, and first-day readiness. iSolved onboarding on one platform, supported by BEG.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Onboarding Software', item: 'https://beghr.com/services/hcm-software/onboarding-software' },
  ],
};
