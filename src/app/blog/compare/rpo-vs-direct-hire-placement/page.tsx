...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/compare/rpo-vs-direct-hire-placement' },
  openGraph: {
    title: 'RPO vs Direct-Hire Placement | BEG',
    description: 'RPO vs direct-hire placement compared on cost, commitment, and speed. See when each fits and where milestone-based placement saves roughly 50%.',
    url: 'https://beghr.com/blog/compare/rpo-vs-direct-hire-placement',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'RPO vs Direct-Hire Placement | BEG', description: 'RPO vs direct-hire placement compared on cost, commitment, and speed. See when each fits and where milestone-based placement saves roughly 50%.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/compare/rpo-vs-direct-hire-placement');

export default function RpoVsDirectHirePlacementPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "RPO vs Direct-Hire Placement | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/compare/rpo-vs-direct-hire-placement"}) }} />
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <div style={{ background: '#000', color: '#fff', padding: '2.5rem', borderRadius: '8px', textAlign: 'center', margin: '3rem 0' }}>
          ...
          <p style={{ marginBottom: '1.5rem', color: '#ddd' }}>Free 15-minute call. Tell us how many roles you are filling and over what timeline, and we will give you an honest read.</p>
          <a href={CALENDLY} target="_blank" rel="noopener noreferrer"
