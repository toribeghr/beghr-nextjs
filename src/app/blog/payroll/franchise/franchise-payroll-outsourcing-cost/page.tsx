...
export const metadata: Metadata = {
  title: 'Franchise Payroll: Outsourcing Cost vs. In-House | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Franchise Payroll: Outsourcing Cost vs. In-House | BEG', description: 'Managed payroll for franchise. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
