...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/resources/salary-guide/insurance' },
  openGraph: { title: 'Insurance Salary Guide 2026 | BEG', description: 'Insurance salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent insurance talent in 23-35 days.', url: 'https://www.beghr.com/resources/salary-guide/insurance', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Insurance Salary Guide 2026 | BEG', description: 'Insurance salary ranges for 2026, by role. Indicative national pay from public data, plus how to hire permanent insurance talent in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
