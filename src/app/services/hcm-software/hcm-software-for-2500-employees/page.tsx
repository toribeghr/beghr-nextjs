...
export const metadata: Metadata = {
  title: 'HCM Software for 2,500-Employee Companies | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'HCM Software for 2,500-Employee Companies | BEG', description: 'HCM software for a 2,500-employee company. One connected isolved platform for enterprise-scale payroll, HR, time, and benefits with BEG-managed implementation and support.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
