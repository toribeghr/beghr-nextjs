...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/earned-sick-leave' },
  openGraph: {
    title: 'Earned Sick Leave | Payroll Glossary | BEG',
    description: 'Learn how earned sick leave laws work, which states require it, typical accrual rules, and what employers must do to comply.',
    url: 'https://beghr.com/resources/payroll-glossary/earned-sick-leave',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/earned-sick-leave', url: 'https://beghr.com/resources/payroll-glossary/earned-sick-leave', name: 'Earned Sick Leave | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Earned Sick Leave', description: 'Learn how earned sick leave laws work, which states require it, typical accrual rules, and what employers must do to comply.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Earned Sick Leave', item: 'https://beghr.com/resources/payroll-glossary/earned-sick-leave' },
            ]},
          ]
        }) }} />
      </section>
