...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Managed Payroll Timeline: How Long Does It Take? | BEG', description: 'Managed Payroll Implementation Timeline: 3-5 Days to Live. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Managed Payroll Timeline: How Long Does It Take? | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/intent/managed-payroll-implementation-timeline"}) }} />
