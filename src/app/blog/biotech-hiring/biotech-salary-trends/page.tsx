...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-biotech-hiring-biotech-salary-trends.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Biotech Salary Trends 2026: What the Data Hides | BEG', description: 'Biotech pay is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes a biotech hire in 2026.', images: ['https://www.beghr.com/blog-images/blog-biotech-hiring-biotech-salary-trends.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-biotech-hiring-biotech-salary-trends.webp" alt={`Scientists working in a modern biotech laboratory`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
