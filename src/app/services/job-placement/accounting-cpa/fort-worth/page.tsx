...
export default function PlacementAccountingcpaFortworthPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Accounting & CPA placement\",\"name\":\"Accounting & CPA Placement in Fort Worth\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Fort Worth\"},\"url\":\"https://beghr.com/services/job-placement/accounting-cpa/fort-worth\",\"description\":\"Permanent accounting & cpa placement in Fort Worth in 23-35 days at roughly 50% less than contingency.\"}" }} />
