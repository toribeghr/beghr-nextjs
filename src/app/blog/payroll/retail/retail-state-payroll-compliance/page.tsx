...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/retail/retail-state-payroll-compliance' },
  openGraph: {
    title: 'Retail Payroll: State Compliance Guide | BEG',
    description: 'Managed payroll for retail. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/retail/retail-state-payroll-compliance',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Retail Payroll: State Compliance Guide | BEG', description: 'Managed payroll for retail. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
