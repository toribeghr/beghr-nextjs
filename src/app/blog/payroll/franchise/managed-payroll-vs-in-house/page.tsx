        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Managed Payroll vs. In-House for Franchise Owners', item: 'https://beghr.com/blog/payroll/franchise/managed-payroll-vs-in-house' },
            ],
          }),
        }}
      />
