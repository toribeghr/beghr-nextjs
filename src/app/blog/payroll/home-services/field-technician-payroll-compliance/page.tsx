...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/home-services/field-technician-payroll-compliance' },
  openGraph: {
    title: 'Field Technician Payroll Compliance | Overtime + Travel | BEG',
    description: 'Field technician payroll compliance: when drive time is compensable, overtime for service techs, tool reimbursement minimum wage rules, and on-call pay requirements.',
    url: 'https://beghr.com/blog/payroll/home-services/field-technician-payroll-compliance',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Field Technician Payroll Compliance | Overtime + Travel | BEG', description: 'FLSA compliance for field techs: drive time, overtime, tool reimbursement, and on-call pay.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Field Technician Payroll Compliance', item: 'https://beghr.com/blog/payroll/home-services/field-technician-payroll-compliance' },
        ]
      }) }} />
    </article>
  );
