...
export const metadata: Metadata = {
  title: "SCA Payroll for Security Companies | BEG Guide",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/security/service-contract-act-security-payroll" },
  openGraph: {
    title: "SCA Payroll for Security Companies | BEG Guide",
    ...
    url: "https://beghr.com/blog/payroll/security/service-contract-act-security-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "SCA Payroll for Security Companies | BEG Guide", description: "Service Contract Act compliance for security companies: pay rates, benefits, certified payroll, and audits.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "SCA Security Payroll", "item": "https://beghr.com/blog/payroll/security/service-contract-act-security-payroll" }
        ]
      }) }} />
    </article>
  );
