...
export const metadata: Metadata = {
  title: 'HR Manager Recruiters | 23-35 Days | BEG',
  description: 'HR Manager placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hr/hr-manager' },
  openGraph: { title: 'HR Manager Recruiters | 23-35 Days | BEG', description: 'HR Manager placement in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hr/hr-manager', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'HR Manager Recruiters | 23-35 Days | BEG', description: 'HR Manager placement in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-hr-hr-manager');

export default function PlacementHrHrmanagerPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · HR · HR Manager"
      title="Your hr manager search has been open too long."
      description="Hands-on HR managers are in high demand across the growing mid-market. We place permanent hr manager candidates in 23-35 days at roughly 50% less than contingency firms, with a 45-day replacement guarantee."
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>HR Manager searches stall because the best candidates are passive and field multiple offers.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"HR Manager placement\",\"name\":\"HR Manager Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://www.beghr.com/services/job-placement/hr/hr-manager\",\"description\":\"Permanent hr manager placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />

      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            <p className="eyebrow">Why This Role Is Hard To Fill</p>
            <h2>The best hr manager candidates are not on job boards</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Hands-on HR managers are in high demand across the growing mid-market. That is why a posting-and-waiting search rarely fills a hr manager seat with the right person. We source passive hr manager candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/hr" style={{ color: '#000000', fontWeight: 600 }}>hr placement service</Link>, or explore: <Link href="/services/job-placement/hr/hr-director" style={{ color: '#000000', fontWeight: 600 }}>HR Director</Link>, <Link href="/services/job-placement/hr/talent-acquisition-manager" style={{ color: '#000000', fontWeight: 600 }}>Talent Acquisition Manager</Link>, <Link href="/services/job-placement/hr/people-operations-manager" style={{ color: '#000000', fontWeight: 600 }}>People Operations Manager</Link>, <Link href="/services/job-placement/hr/chro" style={{ color: '#000000', fontWeight: 600 }}>CHRO</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'How long does it take to place a hr manager?', acceptedAnswer: { '@type': 'Answer', text: 'On average 23-35 days from discovery call to placed hire, with an 86% fill rate on active searches.' } },
