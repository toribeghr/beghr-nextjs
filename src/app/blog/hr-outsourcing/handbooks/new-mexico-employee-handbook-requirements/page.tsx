...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'New Mexico Employee Handbook Rules (2026 Guide) | BEG', description: 'What a New Mexico employee handbook must cover in 2026: federal baseline, paid sick leave, overtime, and policies employers get wrong.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "New Mexico Employee Handbook Requirements", "datePublished": "2026-07-06", "dateModified": "2026-07-06", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/hr-outsourcing/handbooks/new-mexico-employee-handbook-requirements"}) }} />
