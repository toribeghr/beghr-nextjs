...
export default function PlacementTechnologyColoradospringsPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Technology placement\",\"name\":\"Technology Placement in Colorado Springs\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Colorado Springs\"},\"url\":\"https://beghr.com/services/job-placement/technology/colorado-springs\",\"description\":\"Permanent technology placement in Colorado Springs in 23-35 days at roughly 50% less than contingency.\"}" }} />
