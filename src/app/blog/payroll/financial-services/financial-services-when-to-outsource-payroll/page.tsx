...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Financial Firm Payroll: Signs It Is Time to Outsource | BEG', description: 'Managed payroll for financial services. Signs Your Business Needs to Outsource Payroll. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
