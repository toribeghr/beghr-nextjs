...
export const metadata: Metadata = {
  ...
  description: 'Performance management software for reviews, goals, and feedback cycles tied to compensation and employee records.',
  ...
  twitter: { card: 'summary_large_image', title: 'Performance Mgmt Software | Instant Price Quote | BEG', description: 'Performance management software for reviews, goals, and feedback cycles tied to compensation and employee records.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
