...
export const metadata: Metadata = {
  ...
  description: 'Managed payroll for financial services. Payroll Features Every {label} Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
  ...
  twitter: { card: 'summary_large_image', title: 'Financial Firm Payroll: Must-Have Features | BEG', description: 'Managed payroll for financial services. Payroll Features Every {label} Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
  ...
  return (
    <article className="blog-post">
        ...
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              ...
              <h1>Financial Services & Accounting Firms: Payroll Features Every {label} Business Needs (2026)</h1>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"Financial Services & Accounting Firms: Payroll Features Every {label} Business Needs (2026)","item":"https://beghr.com/blog/payroll/financial-services/financial-services-payroll-features-needed"}]}`,
        }}
      />
    </article>
  );
