...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Oklahoma Minimum Wage 2026: Federal Rate Applies | BEG', description: 'Oklahoma minimum wage 2026 is $7.25/hour for larger employers under federal law. See overtime rules, caveats, and get a free managed payroll quote.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
