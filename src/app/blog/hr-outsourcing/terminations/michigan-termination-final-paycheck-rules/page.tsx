...
export const metadata: Metadata = {
  title: 'Michigan Termination Rules: Get the Final Paycheck Right | BEG',
  description: 'Michigan termination and final paycheck rules for 2026: at-will basics, final pay timing, documentation, and how HR outsourcing helps.',
  alternates: { canonical: 'https://www.beghr.com/blog/hr-outsourcing/terminations/michigan-termination-final-paycheck-rules' },
  openGraph: {
    title: 'Michigan Termination Rules: Get the Final Paycheck Right | BEG',
    description: 'Michigan termination and final paycheck rules for 2026: at-will basics, final pay timing, documentation, and how HR outsourcing helps.',
    url: 'https://www.beghr.com/blog/hr-outsourcing/terminations/michigan-termination-final-paycheck-rules',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-hr-outsourcing-terminations-michigan-termination-final-paycheck-rules.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Michigan Termination Rules: Get the Final Paycheck Right | BEG', description: 'Michigan termination and final paycheck rules for 2026: at-will basics, final pay timing, documentation, and how HR outsourcing helps.', images: ['https://www.beghr.com/blog-images/blog-hr-outsourcing-terminations-michigan-termination-final-paycheck-rules.webp'] },
};

const faqs = [
  {
    question: 'Is Michigan an at-will employment state?',
  ...
  {
    question: 'When is a final paycheck due in Michigan?',
    answer: 'Timing can range from immediately to the next scheduled payday depending on the situation. Confirm Michigan’s current rule with the state labor office before finalizing any termination.',
  },
  {
    question: 'Does separation documentation affect unemployment claims in Michigan?',
  ...
  {
    question: 'How does BEG support Michigan terminations?',
    answer: 'Certified HR professionals guide documentation, final pay timing, and COBRA notices for Michigan employers on the Expert plan, powered by isolved, so nothing falls through the cracks.',
  },
];
  ...
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BlogPosting",
        "image": "https://beghr.com/blog-images/blog-hr-outsourcing-terminations-michigan-termination-final-paycheck-rules.webp", "headline": "Michigan Termination and Final Paycheck Rules for 2026", "description": "Michigan termination and final paycheck rules for 2026: at-will basics, final pay timing, documentation, and how HR outsourcing helps.", "datePublished": "2026-07-06", "dateModified": "2026-07-06", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/hr-outsourcing/terminations/michigan-termination-final-paycheck-rules"}) }} />
        ...
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              ...
              <h1>Michigan Termination and Final Paycheck Rules for 2026</h1>
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-hr-outsourcing-terminations-michigan-termination-final-paycheck-rules.webp" alt={`An HR team reviewing employee documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>

      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        <p>Michigan is an at-will state, but final paycheck timing and separation documentation carry real risk. Get both wrong and a routine exit turns into an unemployment dispute or a wage claim.</p>
        ...
        <p>Final paycheck timing rules vary significantly depending on whether a termination is voluntary or involuntary, and they range from immediately upon separation to the next scheduled payday depending on the circumstances and the state. Rather than guessing at a specific deadline, treat final pay as a compliance step that has to be verified every time: confirm Michigan&apos;s current rule with the <a href="https://www.dol.gov/agencies/whd/state/contacts" target="_blank" rel="noopener noreferrer">state labor office</a> before the termination meeting, not after. Rules can change, and applying an outdated deadline is one of the more common ways employers create avoidable wage claims.</p>

        <p>This verification step matters even more in a state like Michigan, where the minimum wage is scheduled to rise further on January 1, 2027 and then move to formula-based adjustments. A wage and pay practice built around today&apos;s state minimum wage needs a process for catching that change rather than relying on a number printed once in a handbook.</p>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.93rem' }}>
            <thead>
              <tr style={{ background: '#000', color: '#fff' }}>
                ...
                <th style={{ padding: '0.75rem', textAlign: 'left' }}>Michigan context</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                ['Overtime owed at separation', 'FLSA: 1.5x after 40 hours per week', 'Weekly over 40; applies to employers of 2 or more'],
                ['Minimum wage reference', 'Federal floor is static', 'Higher state minimum wage, scheduled to rise further on January 1, 2027, then formula-adjusted'],
                ['Paid sick leave payout', 'No federal mandate', 'State sick leave law in effect; confirm payout treatment at termination'],
        ...
        <p>A termination touches documentation, final pay calculation, benefits notices, and unemployment response all at once, which is exactly where a generic checklist falls short and a dedicated HR professional earns their keep. <a href="/services/hr-outsourcing">HR outsourcing</a>, powered by isolved, gives Michigan employers a certified HR professional who reviews the documentation file before the termination meeting, confirms current final pay and sick leave payout rules with the state, coordinates the COBRA or state continuation notice, and prepares the employer to respond to an unemployment claim with a clean record. The same team also supports talent acquisition and recruiting, so backfilling the role after a termination does not fall entirely on a manager already stretched thin.</p>

        <p>See the <a href="/services/hr-outsourcing/michigan">Michigan HR outsourcing page</a> for details specific to this state, or <a href="/services/hr-outsourcing">get instant pricing</a> to compare plans. Employers building out the underlying policy language should also see the <a href="/blog/hr-outsourcing/terminations/minnesota-termination-final-paycheck-rules">Minnesota termination and final paycheck rules</a> for how a neighboring state approaches the same issues.</p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Is Michigan an at-will employment state?","acceptedAnswer":{"@type":"Answer","text":"Yes, with recognized exceptions such as public policy, implied contract, and anti-discrimination protections. Most employees can be terminated at any time for any lawful reason, but exceptions still apply."}},{"@type":"Question","name":"When is a final paycheck due in Michigan?","acceptedAnswer":{"@type":"Answer","text":"Timing can range from immediately to the next scheduled payday depending on the situation. Confirm Michigan's current rule with the state labor office before finalizing any termination."}},{"@type":"Question","name":"Does separation documentation affect unemployment claims in Michigan?","acceptedAnswer":{"@type":"Answer","text":"Yes. Clear, consistent documentation of the reason for separation is often the deciding factor in whether an unemployment claim is approved or contested successfully."}},{"@type":"Question","name":"Is BEG a PEO?","acceptedAnswer":{"@type":"Answer","text":"No. There is no co-employment and no employer-of-record change. Your company stays the employer; the HR professionals support your team through every termination. Powered by isolved."}},{"@type":"Question","name":"How does BEG support Michigan terminations?","acceptedAnswer":{"@type":"Answer","text":"Certified HR professionals guide documentation, final pay timing, and COBRA notices for Michigan employers on the Expert plan, powered by isolved, so nothing falls through the cracks."}}]}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"HR Outsourcing","item":"https://www.beghr.com/blog/hr-outsourcing"},{"@type":"ListItem","position":4,"name":"Michigan Termination and Final Paycheck Rules for 2026","item":"https://www.beghr.com/blog/hr-outsourcing/terminations/michigan-termination-final-paycheck-rules"}]}`,
        }}
      />
      ...
      <RelatedPosts posts={[
        ...
        { category: "HR Outsourcing", title: "Massachusetts Termination and Final Paycheck Rules", excerpt: "At-will basics, final pay timing, and documentation for Massachusetts employers.", href: "/blog/hr-outsourcing/terminations/massachusetts-termination-final-paycheck-rules" },
