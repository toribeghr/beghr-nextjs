...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/managed-payroll/wyoming' },
  openGraph: {
    title: 'Wyoming Managed Payroll Services | BEG | $25-$45 PEPM',
    description: 'Fully managed payroll for Wyoming employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.',
    url: 'https://beghr.com/services/managed-payroll/wyoming',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Wyoming Managed Payroll Services | BEG | $25-$45 PEPM', description: 'Fully managed payroll for Wyoming employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Wyoming', item: 'https://beghr.com/services/managed-payroll/wyoming' },
            ],
          })
        }}
      />
