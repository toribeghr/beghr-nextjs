...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Construction Payroll Garnishments, Handled Right | BEG', description: 'Managed payroll for construction. Payroll Garnishments: What You Need to Know. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
