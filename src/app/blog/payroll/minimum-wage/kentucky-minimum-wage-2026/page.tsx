...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-minimum-wage-kentucky-minimum-wage-2026.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Kentucky Minimum Wage 2026: What Employers Must Know | BEG', description: 'Kentucky minimum wage 2026 is $7.25 per hour. See the 7th-day overtime rule and what it means for payroll compliance in Kentucky this year.', images: ['https://www.beghr.com/blog-images/blog-payroll-minimum-wage-kentucky-minimum-wage-2026.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-minimum-wage-kentucky-minimum-wage-2026.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
