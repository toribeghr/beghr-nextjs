...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "isolved HCM for Skilled Trades | Instant Quote | BEG",
    description: "isolved HCM for trades and manufacturing. Union compliance, certified payroll, and multi-site management on one platform. Implemented by BEG.",
    url: "https://www.beghr.com/services/hcm-software/trades",
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: "isolved HCM for Skilled Trades | Instant Quote | BEG", description: "isolved HCM for trades and manufacturing. Union compliance, certified payroll, and multi-site management on one platform. Implemented by BEG.", images: ['https://www.beghr.com/assets/og-image.png'] },
};
          ...
          <div className="beg-grid-3 reveal">
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  <div style={{ fontSize: '2rem', fontWeight: '800', color: '#000000', lineHeight: 1 }}>CBA</div>
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Collective bargaining agreement terms enforced in every payroll run</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>isolved calculates union wage rates, overtime premiums, fringe benefits, and apprenticeship ratios automatically from your CBA terms.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Workforce management across multiple project locations</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Different prevailing wage rates by project and jurisdiction, isolved tracks them all without manual rate tables.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Trades and manufacturing firms see high ROI from union compliance automation, overtime cost reduction, and certified payroll generation savings.</div>
                </div>
              ))()
            }
          </div>
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#444444', maxWidth: '700px', margin: '1.5rem auto' }}>
            isolved for trades and manufacturing handles union CBA compliance, prevailing wage tracking by jurisdiction, certified payroll report generation, multi-site workforce management, apprenticeship ratio tracking, and benefits administration in one connected platform.
          </p>
          <div className="beg-grid-3 reveal">
            {[
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="beg-grid-2 reveal">
            <div>
              ...
              <p style={{ color: '#cccccc', lineHeight: '1.7', fontSize: '0.97rem' }}>BEG times implementation to your current platform renewal and configures isolved for your specific union CBAs and prevailing wage schedules before your first managed payroll run. Miss that window and you are paying for two platforms or locked in for another year. BEG will help you plan around your renewal date.</p>
            </div>
            <div>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Union and non-union tradespeople, electricians, plumbers, HVAC technicians, welders, ironworkers, heavy equipment operators, production workers, and field supervisors.</p>
            </div>
            <div className="faq-item">
