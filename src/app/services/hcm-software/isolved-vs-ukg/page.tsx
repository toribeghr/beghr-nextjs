...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/isolved-vs-ukg' },
  openGraph: {
    title: 'iSolved vs UKG | One Platform + Claude AI | BEG',
    description: 'iSolved vs UKG compared across platform breadth, pricing, implementation, support, and AI. See which HCM fits the mid-market versus large, complex enterprises.',
    url: 'https://beghr.com/services/hcm-software/isolved-vs-ukg',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved vs UKG | One Platform + Claude AI | BEG', description: 'iSolved vs UKG compared across platform breadth, pricing, implementation, support, and AI. See which HCM fits the mid-market versus large, complex enterprises.', images: ['https://beghr.com/assets/og-image.png'] },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'iSolved vs UKG', item: 'https://beghr.com/services/hcm-software/isolved-vs-ukg' },
  ],
};
      ...
      <section className="hero" style={{ background: '#000000', color: '#ffffff', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ fontSize: '1.15rem', color: '#cccccc', maxWidth: '700px' }}>
            UKG is a powerful enterprise workforce management platform built for large, complex organizations. iSolved is a single connected platform built for the mid-market. Here is how they compare.
          </p>
