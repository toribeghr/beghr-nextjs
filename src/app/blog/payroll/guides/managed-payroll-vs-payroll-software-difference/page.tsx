...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Managed Payroll vs. Payroll Software: The Core Diffe.. | BEG', description: 'Managed Payroll vs. Payroll Software: The Core Difference. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
