...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/home-health' },
  openGraph: {
    title: 'iSolved HCM for Home Health | BEG',
    description: 'iSolved HCM for home health. Visit-based pay, EVV, travel time and mileage, per-visit rates, and multi-state caregivers on one connected platform.',
    url: 'https://beghr.com/services/hcm-software/home-health',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved HCM for Home Health | BEG', description: 'iSolved HCM for home health. Visit-based pay, EVV, travel time and mileage, per-visit rates, and multi-state caregivers on one connected platform.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Home Health', item: 'https://beghr.com/services/hcm-software/home-health' },
            ],
          }),
        }}
      />
