...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Hospitality Salary Trends 2026: What Averages Hide | BEG', description: 'Hospitality comp is climbing, but the best leaders are passive and pay is only part of the decision. What actually closes a hospitality hire.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
