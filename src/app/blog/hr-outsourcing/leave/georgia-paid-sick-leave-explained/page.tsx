...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Georgia Paid Sick Leave Explained: Employer Requirements', description: 'Does Georgia mandate paid sick leave? What Georgia employers should build instead, including local-ordinance and remote hiring risk.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
