        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Managed Payroll vs. In-House for Fitness Studios', item: 'https://beghr.com/blog/payroll/fitness/managed-payroll-vs-in-house' },
            ],
          }),
        }}
      />
