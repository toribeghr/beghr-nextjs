...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/manufacturing-hiring' },
  openGraph: {
    title: 'Manufacturing Hiring | BEG Blog',
    description: 'Manufacturing talent shortage trends, plant manager and quality engineer hiring, and salary insights for operations leaders who fill roles fast.',
    url: 'https://beghr.com/blog/manufacturing-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Manufacturing Hiring | BEG Blog', description: 'Manufacturing talent shortage trends, plant manager and quality engineer hiring, and salary insights for operations leaders who fill roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Manufacturing Hiring', item: 'https://beghr.com/blog/manufacturing-hiring' },
            ],
          }),
        }}
      />
