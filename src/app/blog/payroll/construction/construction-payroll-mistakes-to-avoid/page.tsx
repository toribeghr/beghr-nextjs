...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Construction Payroll Mistakes Contractors Still Make | BEG', description: 'Managed payroll for construction. Payroll Mistakes to Avoid. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
