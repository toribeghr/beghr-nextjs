...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/features/payroll-run-frequency-options' },
  openGraph: {
    title: 'Weekly, Bi-Weekly, Semi-Monthly Payroll: Which Is Be.. | BEG',
    description: 'Weekly, Bi-Weekly, Semi-Monthly Payroll: Which Is Best?. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/features/payroll-run-frequency-options',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Weekly, Bi-Weekly, Semi-Monthly Payroll: Which Is Be.. | BEG', description: 'Weekly, Bi-Weekly, Semi-Monthly Payroll: Which Is Best?. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
