...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Restaurant Payroll Setup, An Owner Guide | BEG', description: 'Managed payroll for restaurants. Payroll Setup Guide. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
