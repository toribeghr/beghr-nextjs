    ...
    <article>
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: '820px', lineHeight: '1.8', fontSize: '1.05rem' }}>
          ...
          <div style={{ background: '#000', color: '#fff', padding: '2rem', borderRadius: '8px', textAlign: 'center', margin: '2.5rem 0' }}>
            <h3 style={{ color: '#ECAC60', margin: '0 0 0.75rem' }}>Running payroll yourself?</h3>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Restaurant Case Study', item: 'https://www.beghr.com/case-studies/restaurant' },
        ],
      }) }} />
    </article>
  );
