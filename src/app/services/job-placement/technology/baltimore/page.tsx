...
export default function PlacementTechnologyBaltimorePage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Technology placement\",\"name\":\"Technology Placement in Baltimore\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Baltimore\"},\"url\":\"https://beghr.com/services/job-placement/technology/baltimore\",\"description\":\"Permanent technology placement in Baltimore in 23-35 days at roughly 50% less than contingency.\"}" }} />
