...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/services/managed-payroll/minnesota' },
  openGraph: {
    title: 'Minnesota Managed Payroll Services | BEG | $25-$45 PEPM',
    description: 'Fully managed payroll for Minnesota employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.',
    url: 'https://www.beghr.com/services/managed-payroll/minnesota',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Minnesota Managed Payroll Services | BEG | $25-$45 PEPM', description: 'Fully managed payroll for Minnesota employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Minnesota', item: 'https://www.beghr.com/services/managed-payroll/minnesota' },
            ],
          })
        }}
      />
