...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Franchise Payroll Peak Season, Without the Scramble | BEG', description: 'Managed payroll for franchise. Managing Payroll During Peak Season. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
