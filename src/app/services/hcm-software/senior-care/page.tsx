            ...
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Nights, weekends, and holiday differentials are where manual payroll breaks. iSolved applies the right rate by shift and facility every pay period.</div>
                </div>
              ))()
            }
            {
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Yes. iSolved schedules around-the-clock coverage and applies night, weekend, and holiday differentials automatically by shift and facility. BEG configures your differential rules so every caregiver is paid correctly.</p>
            </div>
            <div className="faq-item">
              <h3>Does iSolved track caregiver credentials and expirations?</h3>
              <p>Yes. iSolved stores caregiver credentials and flags upcoming expirations so you stay survey-ready. BEG configures which credentials each role requires and how renewals are tracked across every facility.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Can iSolved handle 24/7 shift coverage and differentials?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. iSolved schedules around-the-clock coverage and applies night, weekend, and holiday differentials automatically by shift and facility. BEG configures the rules.' } },
              { '@type': 'Question', name: 'Does iSolved track caregiver credentials and expirations?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. iSolved stores caregiver credentials and flags upcoming expirations so you stay survey-ready across every facility.' } },
