...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/manufacturing/supply-chain-manager' },
  openGraph: { title: 'Supply Chain Manager Recruiters | 23-35 Days | BEG', description: 'Supply Chain Manager placement in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/manufacturing/supply-chain-manager', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
