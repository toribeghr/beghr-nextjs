...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/government-contractor/dod-contractor-payroll-requirements' },
  openGraph: {
    title: 'DoD Contractor Payroll: ITAR, DCAA & Cleared Employees | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/government-contractor/dod-contractor-payroll-requirements',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'DoD Contractor Payroll: ITAR, DCAA & Cleared Employees | BEG', description: 'DoD contractor payroll compliance: ITAR, DCAA audit readiness, cleared employees, and indirect cost allocation.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'DoD Contractor Payroll', item: 'https://beghr.com/blog/payroll/government-contractor/dod-contractor-payroll-requirements' },
        ]
      }) }} />
    </article>
  );
