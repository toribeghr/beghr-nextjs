...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/trades/fresno' },
  openGraph: { title: 'Skilled Trades Recruiters in Fresno | BEG', description: 'Skilled Trades placement in Fresno in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/trades/fresno', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Skilled Trades Recruiters in Fresno | BEG', description: 'Skilled Trades placement in Fresno in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementTradesFresnoPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Skilled Trades placement\",\"name\":\"Skilled Trades Placement in Fresno\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Fresno\"},\"url\":\"https://www.beghr.com/services/job-placement/trades/fresno\",\"description\":\"Permanent skilled trades placement in Fresno in 23-35 days at roughly 50% less than contingency.\"}" }} />
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Skilled Trades in Fresno? Grade your job description first.</h2>
