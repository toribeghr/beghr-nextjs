...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-illinois' },
  openGraph: {
    title: 'Payroll Outsourcing in Illinois: Employer Guide | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-illinois',
