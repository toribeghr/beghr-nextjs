...
export default function PlacementSalesLongbeachPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Sales placement\",\"name\":\"Sales Placement in Long Beach\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Long Beach\"},\"url\":\"https://beghr.com/services/job-placement/sales/long-beach\",\"description\":\"Permanent sales placement in Long Beach in 23-35 days at roughly 50% less than contingency.\"}" }} />
