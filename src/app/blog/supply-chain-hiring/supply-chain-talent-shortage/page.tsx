...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'The Supply Chain Talent Shortage 2026 | BEG', description: 'Demand for supply chain talent outpaces supply. What the 2026 shortage means for hiring and how to fill operations roles in 23-35 days anyway.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <RelatedTool
          variant="link"
          eyebrow={`Free Tool`}
          heading={`What is this open supply chain role costing you right now?`}
