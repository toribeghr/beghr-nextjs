...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-pennsylvania' },
  openGraph: {
    title: 'Payroll Outsourcing in Pennsylvania: Compliance Over.. | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-pennsylvania',
