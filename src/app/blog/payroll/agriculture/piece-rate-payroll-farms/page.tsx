...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/agriculture/piece-rate-payroll-farms' },
  openGraph: {
    title: 'Piece Rate Payroll for Farms | Calculation + Compliance | BEG',
    description: 'How to calculate piece rate payroll for agricultural workers correctly: minimum wage floor, overtime for piece rate, record-keeping under FLSA, and common errors.',
    url: 'https://beghr.com/blog/payroll/agriculture/piece-rate-payroll-farms',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Piece Rate Payroll for Farms | Calculation + Compliance | BEG', description: 'How to calculate piece rate payroll for agricultural workers correctly under FLSA.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Piece Rate Payroll for Farms', item: 'https://beghr.com/blog/payroll/agriculture/piece-rate-payroll-farms' },
        ]
      }) }} />
    </article>
  );
