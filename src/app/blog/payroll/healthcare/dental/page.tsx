...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Dental Office Payroll Outsourcing | $25 PEPM vs. $60K Hire | BEG', description: 'Dental office payroll outsourcing vs. hiring in-house. Hygienist tips, associate dentist comp, DSO payroll. Save $55K–$90K annually at $25–$45 PEPM.', images: ['https://beghr.com/assets/og-image.png'] },
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Dental', item: 'https://beghr.com/blog/payroll/healthcare/dental' },
            ],
          }),
        }}
      />
