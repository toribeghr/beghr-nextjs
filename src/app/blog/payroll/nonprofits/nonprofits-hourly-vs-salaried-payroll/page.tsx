...
export const metadata: Metadata = {
  title: 'Nonprofit Payroll: Hourly vs. Salaried Guide | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Nonprofit Payroll: Hourly vs. Salaried Guide | BEG', description: 'Managed payroll for nonprofits. Hourly vs. Salaried Employee Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
