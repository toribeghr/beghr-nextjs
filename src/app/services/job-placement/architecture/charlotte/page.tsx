...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/architecture/charlotte' },
  openGraph: { title: 'Architecture Recruiters in Charlotte | BEG', description: 'Architecture placement in Charlotte in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/architecture/charlotte', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Architecture Recruiters in Charlotte | BEG', description: 'Architecture placement in Charlotte in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Architecture roles in Charlotte stay open because the best candidates are passive and rarely on job boards.</li>
              <li>BEG sources architecture talent in Charlotte directly and fills permanent roles in 23-35 days.</li>
              <li>Milestone billing costs roughly 50% less than contingency, with a 45-day replacement guarantee.</li>
            </ul>
          </aside>
        </div>
      </section>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Architecture placement\",\"name\":\"Architecture Placement in Charlotte\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Charlotte\"},\"url\":\"https://www.beghr.com/services/job-placement/architecture/charlotte\",\"description\":\"Permanent architecture placement in Charlotte in 23-35 days at roughly 50% less than contingency.\"}" }} />
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Architecture in Charlotte? Grade your job description first.</h2>
