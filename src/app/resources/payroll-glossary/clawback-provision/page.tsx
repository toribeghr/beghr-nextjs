...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/clawback-provision' },
  openGraph: {
    title: 'Clawback Provision | Payroll Glossary | BEG',
    description: 'Learn what clawback provisions are, when they are enforceable, and the payroll and tax implications of recovering previously paid compensation.',
    url: 'https://beghr.com/resources/payroll-glossary/clawback-provision',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/clawback-provision', url: 'https://beghr.com/resources/payroll-glossary/clawback-provision', name: 'Clawback Provision | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Clawback Provision', description: 'Learn what clawback provisions are, when they are enforceable, and the payroll and tax implications of recovering previously paid compensation.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Clawback Provision', item: 'https://beghr.com/resources/payroll-glossary/clawback-provision' },
            ]},
          ]
        }) }} />
      </section>
