...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-nevada' },
  openGraph: {
    title: 'Payroll Outsourcing in Nevada for Service Businesses | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-nevada',
