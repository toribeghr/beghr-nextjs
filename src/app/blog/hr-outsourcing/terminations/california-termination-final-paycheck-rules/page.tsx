...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'California Termination and Final Paycheck Rules (2026)', description: 'What California employers must handle when ending employment: final pay, daily overtime, PFL, and documentation in 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
