...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Payroll Outsourcing in Arizona for Growing Businesses | BEG',
    description: 'Payroll Outsourcing in Arizona for Growing Businesses. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.',
...
export default function Page() {
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Payroll Outsourcing in Arizona for Growing Businesses | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/state/payroll-outsourcing-arizona"}) }} />
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        ...
        <p>BEG serves businesses nationally, including Arizona. All Arizona state filings are included in the base PEPM fee. No per-state add-ons.</p>
