...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/performance-management-software' },
  openGraph: {
    title: 'Performance Management Software | BEG',
    description: 'Performance management software for reviews, goals, and feedback cycles tied to compensation and employee records. iSolved on one platform, supported by BEG.',
    url: 'https://beghr.com/services/hcm-software/performance-management-software',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Performance Management Software | BEG', description: 'Performance management software for reviews, goals, and feedback cycles tied to compensation and employee records. iSolved on one platform, supported by BEG.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Performance Management Software', item: 'https://beghr.com/services/hcm-software/performance-management-software' },
  ],
};
