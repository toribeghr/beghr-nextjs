...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/applicant-tracking-software' },
  openGraph: {
    title: 'Applicant Tracking Software | BEG',
    description: 'Applicant tracking software for job posting, candidate pipelines, offer letters, and onboarding handoff. iSolved hiring on one platform, supported by BEG.',
    url: 'https://beghr.com/services/hcm-software/applicant-tracking-software',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Applicant Tracking Software | BEG', description: 'Applicant tracking software for job posting, candidate pipelines, offer letters, and onboarding handoff. iSolved hiring on one platform, supported by BEG.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. iSolved generates offer letters from templates, routes them for approval, and sends them for electronic signature. Once a candidate accepts, their information is ready to flow into onboarding so nobody rekeys names, addresses, or pay rates.',
  },
  {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Applicant Tracking Software', item: 'https://beghr.com/services/hcm-software/applicant-tracking-software' },
  ],
};
