...
export default function PlacementMarketingColumbusPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Marketing placement\",\"name\":\"Marketing Placement in Columbus\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Columbus\"},\"url\":\"https://beghr.com/services/job-placement/marketing/columbus\",\"description\":\"Permanent marketing placement in Columbus in 23-35 days at roughly 50% less than contingency.\"}" }} />
