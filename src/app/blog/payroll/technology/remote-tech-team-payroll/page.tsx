...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/technology/remote-tech-team-payroll" },
  openGraph: {
    title: "Remote Tech Team Payroll | Multi-State, Distributed Teams | BEG",
    ...
    url: "https://beghr.com/blog/payroll/technology/remote-tech-team-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Remote Tech Team Payroll | Multi-State, Distributed Teams | BEG", description: "Remote tech payroll: multi-state withholding, contractor classification, nexus, and EOR alternatives. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: "BEG manages remote tech team payroll at $25 per employee per month on your existing payroll system, or $45 per employee per month on BEG's iSolved platform. Both include multi-state withholding, quarterly and annual filings in all active states, and W-2 production. No per-run fees, no per-state surcharges. For a 20-person distributed team, that is $500 to $900 per month all-in.",
  },
];
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Remote Tech Team Payroll", "item": "https://beghr.com/blog/payroll/technology/remote-tech-team-payroll" }
        ]
      }) }} />
    </article>
  );
