...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/trades/san-diego' },
  openGraph: { title: 'Skilled Trades Recruiters in San Diego | BEG', description: 'Skilled Trades placement in San Diego in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/trades/san-diego', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Skilled Trades Recruiters in San Diego | BEG', description: 'Skilled Trades placement in San Diego in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Skilled Trades roles in San Diego stay open because the best candidates are passive and rarely on job boards.</li>
              <li>BEG sources skilled trades talent in San Diego directly and fills permanent roles in 23-35 days.</li>
              <li>Milestone billing costs roughly 50% less than contingency, with a 45-day replacement guarantee.</li>
            </ul>
          </aside>
        </div>
      </section>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Skilled Trades placement\",\"name\":\"Skilled Trades Placement in San Diego\",\"areaServed\":{\"@type\":\"City\",\"name\":\"San Diego\"},\"url\":\"https://www.beghr.com/services/job-placement/trades/san-diego\",\"description\":\"Permanent skilled trades placement in San Diego in 23-35 days at roughly 50% less than contingency.\"}" }} />
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Skilled Trades in San Diego? Grade your job description first.</h2>
