...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'New Jersey Termination Rules: Final Pay Done Right | BEG', description: 'New Jersey termination and final paycheck rules for 2026: at-will basics, final pay timing, documentation, and how HR outsourcing helps.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
