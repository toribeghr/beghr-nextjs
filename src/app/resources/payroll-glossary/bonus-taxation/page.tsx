...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/bonus-taxation' },
  openGraph: {
    title: 'Bonus Taxation | Payroll Glossary | BEG',
    description: 'Understand how bonuses are taxed federally, the flat rate vs. aggregate method, and how to calculate withholding on supplemental wages.',
    url: 'https://beghr.com/resources/payroll-glossary/bonus-taxation',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/bonus-taxation', url: 'https://beghr.com/resources/payroll-glossary/bonus-taxation', name: 'Bonus Taxation | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Bonus Taxation', description: 'Understand how bonuses are taxed federally, the flat rate vs. aggregate method, and how to calculate withholding on supplemental wages.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Bonus Taxation', item: 'https://beghr.com/resources/payroll-glossary/bonus-taxation' },
            ]},
          ]
        }) }} />
      </section>
