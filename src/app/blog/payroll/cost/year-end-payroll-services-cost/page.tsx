...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Year-End Payroll Services Cost: W-2s, 1099s, and Fil.. | BEG', description: 'Year-End Payroll Services Cost: W-2s, 1099s, and Filing. Managed payroll at $25-$45 PEPM all-inclusive. Get a free cost comparison for your business size at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
