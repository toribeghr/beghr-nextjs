...
export const metadata: Metadata = {
  title: 'Construction Mgmt Placement | Instant Fee Quote | BEG',
  description: 'Fill PM, estimator, and superintendent roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/construction-management' },
  openGraph: { title: 'Construction Mgmt Placement | Instant Fee Quote | BEG', description: 'Fill PM, estimator, and superintendent roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', url: 'https://www.beghr.com/services/job-placement/construction-management', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Construction Mgmt Placement | Instant Fee Quote | BEG', description: 'Fill PM, estimator, and superintendent roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-construction-management');

export default function PlacementConstructionmanagementPage() {
  return (
    <ServicePage
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Construction Management roles stay open because the strongest candidates are employed, passive, and rarely on job boards.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Construction Management placement\",\"name\":\"Construction Management Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://www.beghr.com/services/job-placement/construction-management\",\"description\":\"Permanent construction management placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
          ...
          <div className="beg-grid-3 reveal">
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Additional construction workers needed to meet demand</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>The industry is short hundreds of thousands of people while project pipelines grow. The experienced managers you need are passive, and reaching them takes proactive sourcing.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Per month absorbed per unfilled PM seat</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>A construction PM at roughly $120K is about $10,000 a month. While the seat is open, schedules slip, change orders pile up, and margin erodes.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Proven PMs and superintendents are heavily recruited and quickly hired. A 90-day search is always fishing in a smaller pond than the one you started with.</div>
                </div>
              ))()
            }
          </div>
            ...
            {[
              {
                ...
                body: 'Milestone-based pricing replaces the standard 20-25% contingency fee, and total cost is roughly 50% less. For a $130,000 construction project manager placement, that difference is $13,000-$19,500 kept in your budget versus a contingency arrangement.',
              },
              {
                badge: 'Bonus 02',
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Construction project managers, estimators, superintendents, preconstruction managers, project executives, and other field and office roles across commercial, residential, and civil construction.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'What roles do you place?', acceptedAnswer: { '@type': 'Answer', text: 'Construction project managers, estimators, superintendents, preconstruction managers, project executives, and other field and office roles across commercial, residential, and civil construction.' } },
