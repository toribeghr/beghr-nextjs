...
export const metadata: Metadata = {
  title: 'Executive Interview Questions That Reveal Leadership Track Record | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Executive Interview Questions That Reveal Leadership Track Record | BEG', description: 'Leadership interviews that go beyond vision and values. The questions that reveal whether an executive has actually grown revenue, navigated a crisis, and built a team that performed.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/executive-hiring/executive-interview-questions');
