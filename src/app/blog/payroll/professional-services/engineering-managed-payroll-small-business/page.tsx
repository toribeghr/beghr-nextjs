...
export const metadata: Metadata = {
  title: 'Engineering Firm Payroll: For Small Business (<25 EE) | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/professional-services/engineering-managed-payroll-small-business' },
  openGraph: {
    title: 'Engineering Firm Payroll: For Small Business (<25 EE) | BEG',
    description: 'Managed payroll for engineering. Managed Payroll for Small Businesses (Under 25 Employees). $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/professional-services/engineering-managed-payroll-small-business',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Engineering Firm Payroll: For Small Business (<25 EE) | BEG', description: 'Managed payroll for engineering. Managed Payroll for Small Businesses (Under 25 Employees). $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
