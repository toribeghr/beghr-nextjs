...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/brewery/craft-brewery-payroll-compliance" },
  openGraph: {
    title: "Craft Brewery Payroll Compliance 2026 | TTB + State | BEG",
    description: "Craft brewery payroll compliance: TTB record-keeping, state liquor license labor conditions, and W-2 reporting for breweries and distilleries. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/brewery/craft-brewery-payroll-compliance",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Craft Brewery Payroll Compliance 2026 | TTB + State | BEG", description: "Craft brewery payroll compliance: TTB record-keeping, state liquor license labor rules, and W-2 reporting.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Craft Brewery Payroll Compliance", "item": "https://beghr.com/blog/payroll/brewery/craft-brewery-payroll-compliance" }
        ]
      }) }} />
    </article>
  );
