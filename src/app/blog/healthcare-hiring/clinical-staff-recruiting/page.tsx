...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Clinical Staff Recruiting (2026 Guide) | BEG', description: 'The strongest clinical candidates are employed and passive. How to recruit nurses, NPs, and clinical leaders without relying on job boards.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <RelatedTool
          variant="grader"
          eyebrow={`Free Tool`}
          heading={`Grade your healthcare job description in 30 seconds`}
