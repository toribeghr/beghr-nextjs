...
export const metadata: Metadata = {
  title: 'Accounting & CPA Placement | Controllers, Tax & Audit | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/accounting-cpa' },
  openGraph: { title: 'Accounting & CPA Placement | Controllers, Tax & Audit | BEG', description: 'Fill controller, tax, audit, and CPA roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee. Book a call.', url: 'https://beghr.com/services/job-placement/accounting-cpa', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Accounting & CPA Placement | Controllers, Tax & Audit | BEG', description: 'Fill controller, tax, audit, and CPA roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee. Book a call.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-accounting-cpa');

export default function PlacementAccountingcpaPage() {
  return (
    <ServicePage
      imageSrc="/assets/hero-images/finance.svg"
      imageAlt="Accounting team with an open controller or CPA position"
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Accounting &amp; CPA roles stay open because the strongest candidates are employed, passive, and rarely on job boards.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Accounting & CPA placement\",\"name\":\"Accounting & CPA Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/accounting-cpa\",\"description\":\"Permanent accounting & cpa placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
          ...
          <div className="beg-grid-3 reveal">
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  <div style={{ fontSize: '2rem', fontWeight: '800', color: '#000000', lineHeight: 1 }}>300,000+</div>
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Accountants who left the profession in recent years</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>The supply of qualified candidates is shrinking while demand climbs. The strongest accountants are passive, and reaching them takes proactive sourcing.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  <div style={{ fontSize: '2rem', fontWeight: '800', color: '#000000', lineHeight: 1 }}>$11,000+</div>
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Per month absorbed per unfilled senior accounting seat</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>A controller at roughly $130K is about $11,000 a month. Every month the seat is open, that load falls on a team already stretched thin.</div>
                </div>
              ))()
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Qualified CPAs get multiple offers. A 90-day search is always fishing in a smaller pond than the one you started with.</div>
                </div>
              ))()
            }
          </div>
            ...
            {[
              {
                ...
                body: 'Milestone-based pricing replaces the standard 20-25% contingency fee. Total cost is roughly 50% less. For a $130,000 controller placement, that difference is $13,000-$19,000 kept in your budget versus a contingency arrangement.',
              },
              {
                badge: 'Bonus 02',
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Accounting &amp; CPA? Grade your job description first.</h2>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Controllers, CFOs, tax managers, audit managers, senior accountants, accounting managers, staff accountants, and other accounting and finance roles in public accounting and industry.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'What roles do you place?', acceptedAnswer: { '@type': 'Answer', text: 'Controllers, CFOs, tax managers, audit managers, senior accountants, accounting managers, staff accountants, and other accounting and finance roles in public accounting and industry.' } },
