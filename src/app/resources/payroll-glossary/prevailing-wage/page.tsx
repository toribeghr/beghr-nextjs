...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/prevailing-wage' },
  openGraph: { title: 'Prevailing Wage | Payroll Glossary | BEG', description: 'The hourly wage and fringe benefit rate set by the DOL for a specific occupation in a geographic area, required on federal and many state contracts.', url: 'https://beghr.com/resources/payroll-glossary/prevailing-wage', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Prevailing Wage | Payroll Glossary | BEG', description: 'The hourly wage and fringe benefit rate set by the DOL for a specific occupation in a geographic area, required on federal and many state contracts.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Prevailing Wage', item: 'https://beghr.com/resources/payroll-glossary/prevailing-wage' },
            ]},
          ]
        }) }} />
      </section>
