...
export const metadata: Metadata = {
  title: 'Switch From Rippling to iSolved | BEG Manages It',
  description: 'Switching from Rippling to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.',
  alternates: { canonical: 'https://beghr.com/services/hcm-software/switch-from-rippling-to-isolved' },
  openGraph: {
    title: 'Switch From Rippling to iSolved | BEG Manages It',
    description: 'Switching from Rippling to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.',
    url: 'https://beghr.com/services/hcm-software/switch-from-rippling-to-isolved',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Switch From Rippling to iSolved | BEG Manages It', description: 'Switching from Rippling to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.', images: ['https://beghr.com/assets/og-image.png'] },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. Rippling is built around IT and device management as much as HR. iSolved is a connected HCM platform focused on payroll, HR, time, and benefits, and BEG runs it for you so it does not all land on your IT team.',
  },
  {
...
export default function SwitchFromRipplingToiSolvedPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Switch From Rippling to iSolved', item: 'https://beghr.com/services/hcm-software/switch-from-rippling-to-isolved' },
    ],
  };
