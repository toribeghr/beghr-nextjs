...
export const metadata: Metadata = {
  title: 'Nonprofit State Payroll Compliance (What to Know) | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/nonprofits/nonprofits-state-payroll-compliance' },
  openGraph: {
    title: 'Nonprofit State Payroll Compliance (What to Know) | BEG',
    description: 'Managed payroll for nonprofits. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/nonprofits/nonprofits-state-payroll-compliance',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-nonprofits-nonprofits-state-payroll-compliance.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Nonprofit State Payroll Compliance (What to Know) | BEG', description: 'Managed payroll for nonprofits. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-nonprofits-nonprofits-state-payroll-compliance.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-payroll-nonprofits-nonprofits-state-payroll-compliance.webp", "headline": "Nonprofit Payroll: State Compliance Guide | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/nonprofits/nonprofits-state-payroll-compliance"}) }} />
      <section className="hero">
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              <p className="eyebrow">Blog · Payroll Management · Nonprofit</p>
              <h1>Nonprofits & Religious Organizations: State Payroll Compliance Issues (2026)</h1>
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-nonprofits-nonprofits-state-payroll-compliance.webp" alt={`A nonprofit team and volunteers collaborating in a community space`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Nonprofits & Religious Organizations: State Payroll Compliance Issues (2026)","description":"Managed payroll for nonprofits. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.","datePublished":"2026-06-28","dateModified":"2026-06-28","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","worksFor":{"@type":"Organization","name":"Business Executive Group"}},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://www.beghr.com/assets/beg-header-image.png"}},"url":"https://www.beghr.com/blog/payroll/nonprofits/nonprofits-state-payroll-compliance","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.beghr.com/blog/payroll/nonprofits/nonprofits-state-payroll-compliance"}}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://www.beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"Nonprofits & Religious Organizations: State Payroll Compliance Issues (2026)","item":"https://www.beghr.com/blog/payroll/nonprofits/nonprofits-state-payroll-compliance"}]}`,
        }}
      />
