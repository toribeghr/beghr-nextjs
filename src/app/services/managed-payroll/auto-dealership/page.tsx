...
export const metadata: Metadata = {
  title: 'Managed Payroll for Auto Dealerships | Commission, Flat-Rate & Clawback Payroll | BEG',
  description: 'Auto dealership payroll fully managed at $25–$45 PEPM. Commission draws, flat-rate tech pay, finance manager clawbacks, and demo vehicle taxes handled. Request a free scope review.',
