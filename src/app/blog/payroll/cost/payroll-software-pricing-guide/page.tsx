...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-cost-payroll-software-pricing-guide.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Payroll Software Pricing Guide: DIY vs Managed Cost | BEG', description: 'Payroll software pricing guide: DIY vs full-service vs managed models, what drives cost, and how to compare true effective PEPM across providers.', images: ['https://www.beghr.com/blog-images/blog-payroll-cost-payroll-software-pricing-guide.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-cost-payroll-software-pricing-guide.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
