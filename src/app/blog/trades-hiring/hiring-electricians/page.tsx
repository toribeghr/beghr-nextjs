...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Hiring Electricians Fast in 2026: How Does It Work? | BEG', description: 'Licensed electricians are scarce and in demand. A practical playbook to source and hire qualified electricians in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
