...
export const metadata: Metadata = {
  title: 'Architecture Salary Trends 2026 | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/architecture-hiring/architecture-salary-trends' },
  openGraph: {
    title: 'Architecture Salary Trends 2026 | BEG',
    description: 'Architecture comp is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes a design hire.',
    url: 'https://beghr.com/blog/architecture-hiring/architecture-salary-trends',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Architecture Salary Trends 2026 | BEG', description: 'Architecture comp is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes a design hire.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/architecture-hiring/architecture-salary-trends');
...
export default function ArchitectureSalaryTrendsPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Architecture Salary Trends 2026 | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/architecture-hiring/architecture-salary-trends"}) }} />
