...
export const metadata: Metadata = {
  title: 'Nonprofit Interview Questions for Executive Directors, Development Directors, and Program Leaders | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Nonprofit Interview Questions for Executive Directors, Development Directors, and Program Leaders | BEG', description: 'Nonprofit interviews that reveal fundraising track record, mission alignment, and operational leadership quality. Questions that identify executive directors and development directors who deliver.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/nonprofit-hiring/nonprofit-interview-questions');
