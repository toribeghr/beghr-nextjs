  ...
  return (
    <article className="blog-post">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Staffing Payroll', item: 'https://beghr.com/blog/payroll/retail/staffing-payroll' },
            ],
          }),
        }}
      />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        url: 'https://beghr.com/blog/payroll/retail/staffing-payroll',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://beghr.com/blog/payroll/retail/staffing-payroll' },
      }) }} />
    </article>
  );
}
