...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/flsa-overtime' },
  openGraph: {
    title: 'FLSA Overtime | Payroll Glossary | BEG',
    description: 'Learn how FLSA overtime works, how the regular rate is calculated, what the workweek is, and which employees are exempt.',
    url: 'https://beghr.com/resources/payroll-glossary/flsa-overtime',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/flsa-overtime', url: 'https://beghr.com/resources/payroll-glossary/flsa-overtime', name: 'FLSA Overtime | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'FLSA Overtime', description: 'Learn how FLSA overtime works, how the regular rate is calculated, what the workweek is, and which employees are exempt.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'FLSA Overtime', item: 'https://beghr.com/resources/payroll-glossary/flsa-overtime' },
            ]},
          ]
        }) }} />
      </section>
