        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Restaurant', item: 'https://beghr.com/blog/payroll/hospitality/restaurant' },
            ],
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://beghr.com/blog/payroll/hospitality/restaurant',
            mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://beghr.com/blog/payroll/hospitality/restaurant' },
          }),
        }}
      />
    </article>
