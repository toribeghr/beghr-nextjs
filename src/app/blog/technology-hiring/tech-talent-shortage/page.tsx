...
export const metadata: Metadata = {
  title: 'The Tech Talent Shortage in 2026 | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/technology-hiring/tech-talent-shortage' },
  openGraph: {
    title: 'The Tech Talent Shortage in 2026 | BEG',
    description: 'Demand for specialized engineers keeps climbing while the qualified pool stays thin. How to fill technology roles in 23-35 days anyway.',
    url: 'https://beghr.com/blog/technology-hiring/tech-talent-shortage',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'The Tech Talent Shortage in 2026 | BEG', description: 'Demand for specialized engineers keeps climbing while the qualified pool stays thin. How to fill technology roles in 23-35 days anyway.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/technology-hiring/tech-talent-shortage');
