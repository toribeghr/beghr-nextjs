...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/fmla' },
  openGraph: { title: 'FMLA (Family and Medical Leave Act) | Payroll Glossary | BEG', description: 'Federal law requiring employers with 50+ employees to provide up to 12 weeks of unpaid, job-protected leave for qualifying family or medical reasons.', url: 'https://beghr.com/resources/payroll-glossary/fmla', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'FMLA (Family and Medical Leave Act) | Payroll Glossary | BEG', description: 'Federal law requiring employers with 50+ employees to provide up to 12 weeks of unpaid, job-protected leave for qualifying family or medical reasons.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/fmla', url: 'https://beghr.com/resources/payroll-glossary/fmla', name: 'FMLA (Family and Medical Leave Act) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'FMLA (Family and Medical Leave Act)', description: 'Federal law requiring employers with 50+ employees to provide up to 12 weeks of unpaid, job-protected leave for qualifying family or medical reasons.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'FMLA (Family and Medical Leave Act)', item: 'https://beghr.com/resources/payroll-glossary/fmla' },
            ]},
          ]
        }) }} />
      </section>
