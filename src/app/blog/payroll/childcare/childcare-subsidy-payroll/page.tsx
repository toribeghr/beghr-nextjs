...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Childcare Subsidy Payroll | Managing Mixed-Funding Right | BEG', description: 'How childcare centers manage payroll when staff costs are funded by a mix of state subsidies, CCDF, Head Start grants, and private tuition -- documentati...', images: ['https://www.beghr.com/assets/og-image.png'] },
