...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/pay-card' },
  openGraph: { title: 'Pay Card (Payroll Card) | Payroll Glossary | BEG', description: 'Prepaid debit card used to pay employees without bank accounts, subject to state laws on fees and mandatory employee choice requirements.', url: 'https://beghr.com/resources/payroll-glossary/pay-card', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Pay Card (Payroll Card) | Payroll Glossary | BEG', description: 'Prepaid debit card used to pay employees without bank accounts, subject to state laws on fees and mandatory employee choice requirements.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Pay Card (Payroll Card)', item: 'https://beghr.com/resources/payroll-glossary/pay-card' },
            ]},
          ]
        }) }} />
      </section>
