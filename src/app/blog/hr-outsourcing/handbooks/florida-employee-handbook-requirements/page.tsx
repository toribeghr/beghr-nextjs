...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Florida Employee Handbook Rules (2026 Guide) | BEG', description: 'What a Florida employee handbook must cover in 2026: federal baselines, the rising minimum wage schedule, and common mistakes.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
