...
export default function PlacementHealthcareJacksonvillePage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Healthcare placement\",\"name\":\"Healthcare Placement in Jacksonville\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Jacksonville\"},\"url\":\"https://beghr.com/services/job-placement/healthcare/jacksonville\",\"description\":\"Permanent healthcare placement in Jacksonville in 23-35 days at roughly 50% less than contingency.\"}" }} />
