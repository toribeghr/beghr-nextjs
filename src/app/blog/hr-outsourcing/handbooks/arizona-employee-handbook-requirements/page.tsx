...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Arizona Employee Handbook Rules (2026 Guide) | BEG', description: 'What an Arizona employee handbook must cover in 2026: federal baselines, state paid sick leave, overtime rules, and employer mistakes to avoid.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
