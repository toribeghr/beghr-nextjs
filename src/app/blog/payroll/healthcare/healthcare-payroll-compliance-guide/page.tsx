...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Healthcare Payroll Compliance Guide (Full Breakdown) | BEG', description: 'Managed payroll for healthcare. Payroll Compliance Guide. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
