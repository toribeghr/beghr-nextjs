...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/technology/oklahoma-city' },
  openGraph: { title: 'Technology Recruiters in Oklahoma City | BEG', description: 'Technology placement in Oklahoma City in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/technology/oklahoma-city', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Technology Recruiters in Oklahoma City | BEG', description: 'Technology placement in Oklahoma City in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementTechnologyOklahomacityPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Technology placement\",\"name\":\"Technology Placement in Oklahoma City\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Oklahoma City\"},\"url\":\"https://www.beghr.com/services/job-placement/technology/oklahoma-city\",\"description\":\"Permanent technology placement in Oklahoma City in 23-35 days at roughly 50% less than contingency.\"}" }} />
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Technology in Oklahoma City? Grade your job description first.</h2>
