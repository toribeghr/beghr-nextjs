...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Fitness Payroll Direct Deposit Setup, Step by Step | BEG', description: 'Managed payroll for fitness. Setting Up Direct Deposit. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
