...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-agriculture-h2a-worker-payroll-compliance.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'H-2A Worker Payroll Compliance | Housing + Deductions | BEG', description: 'H-2A worker payroll: AEWR rates, housing deductions, piece rate, and DOL compliance guide.', images: ['https://www.beghr.com/blog-images/blog-payroll-agriculture-h2a-worker-payroll-compliance.webp'] },
};
