...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Banking Salary Trends 2026: The Truth About the Gaps | BEG', description: 'Banking pay is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes a banking hire in 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
