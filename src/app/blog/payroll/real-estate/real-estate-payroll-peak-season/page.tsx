...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: "Real Estate Payroll in Peak Season: A Broker's Guide | BEG", description: 'Managed payroll for real estate. Managing Payroll During Peak Season. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
