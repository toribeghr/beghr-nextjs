...
export const metadata: Metadata = {
  title: 'Nonprofit Payroll: Managing Peak Season Payroll | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/nonprofits/nonprofits-payroll-peak-season' },
  openGraph: {
    title: 'Nonprofit Payroll: Managing Peak Season Payroll | BEG',
    description: 'Managed payroll for nonprofits. Managing Payroll During Peak Season. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/nonprofits/nonprofits-payroll-peak-season',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Nonprofit Payroll: Managing Peak Season Payroll | BEG', description: 'Managed payroll for nonprofits. Managing Payroll During Peak Season. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
