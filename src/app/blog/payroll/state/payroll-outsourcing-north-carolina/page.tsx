...
export const metadata: Metadata = {
  title: 'Payroll Outsourcing in North Carolina Explained | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/state/payroll-outsourcing-north-carolina' },
  openGraph: {
    title: 'Payroll Outsourcing in North Carolina Explained | BEG',
    description: 'Payroll Outsourcing in North Carolina. BEG provides managed payroll nationwide. Get instant pricing at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/state/payroll-outsourcing-north-carolina',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-state-payroll-outsourcing-north-carolina.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing in North Carolina Explained | BEG', description: 'Payroll Outsourcing in North Carolina. BEG provides managed payroll nationwide. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-state-payroll-outsourcing-north-carolina.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-state-payroll-outsourcing-north-carolina.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>

      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        <p>Payroll outsourcing for businesses operating in North Carolina means knowing not just federal payroll requirements, but the specific state obligations that apply to North Carolina employers.</p>

        <h2 style={{ marginTop: '2rem', marginBottom: '1rem', borderBottom: '2px solid #ECAC60', paddingBottom: '0.5rem' }}>North Carolina Payroll Requirements for Employers</h2>

        <p>North Carolina employers must handle: state income tax withholding (where applicable), state unemployment insurance (SUTA), state new hire reporting, and any North Carolina-specific payroll laws that go beyond federal requirements.</p>

        <p>Specifics vary by state. If you operate in North Carolina and have questions about your specific obligations, a 15-minute call with BEG payroll covers the state-specific requirements for your business type.</p>

        <h2 style={{ marginTop: '2rem', marginBottom: '1rem', borderBottom: '2px solid #ECAC60', paddingBottom: '0.5rem' }}>What BEG Managed Payroll Covers in North Carolina</h2>

        <ul style={{ marginLeft: '1.5rem', marginBottom: '1rem' }}>
          <li style={{ marginBottom: '0.5rem' }}>North Carolina state income tax withholding and remittance</li>
          <li style={{ marginBottom: '0.5rem' }}>North Carolina SUTA registration and payments</li>
          <li style={{ marginBottom: '0.5rem' }}>North Carolina new hire reporting within the required timeframe</li>
          <li style={{ marginBottom: '0.5rem' }}>Federal tax deposits and quarterly/annual IRS filings</li>
          <li style={{ marginBottom: '0.5rem' }}>Year-end W-2 production for all North Carolina employees</li>
          <li style={{ marginBottom: '0.5rem' }}>Compliance monitoring for North Carolina payroll law changes</li>
        </ul>

        <h2 style={{ marginTop: '2rem', marginBottom: '1rem', borderBottom: '2px solid #ECAC60', paddingBottom: '0.5rem' }}>Managed Payroll Cost for North Carolina Businesses</h2>
        ...
        <p>BEG serves businesses nationally, including North Carolina. All North Carolina state filings are included in the base PEPM fee.</p>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Payroll Outsourcing in North Carolina","description":"Payroll Outsourcing in North Carolina. BEG provides managed payroll nationwide. Get instant pricing at beghr.com.","datePublished":"2026-06-28","dateModified":"2026-06-28","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","worksFor":{"@type":"Organization","name":"Business Executive Group"}},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://www.beghr.com/assets/beg-header-image.png"}},"url":"https://www.beghr.com/blog/payroll/state/payroll-outsourcing-north-carolina","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.beghr.com/blog/payroll/state/payroll-outsourcing-north-carolina"}}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://www.beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"Payroll Outsourcing in North Carolina","item":"https://www.beghr.com/blog/payroll/state/payroll-outsourcing-north-carolina"}]}`,
        }}
      />
