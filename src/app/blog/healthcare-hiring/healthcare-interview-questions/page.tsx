...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-healthcare-hiring-healthcare-interview-questions.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Healthcare Interview Questions That Actually Work | BEG', description: 'Healthcare interviews that reveal clinical judgment, patient care philosophy, and culture fit.', images: ['https://www.beghr.com/blog-images/blog-healthcare-hiring-healthcare-interview-questions.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-healthcare-hiring-healthcare-interview-questions.webp" alt={`A modern medical clinic with doctors and nurses caring for patients`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
