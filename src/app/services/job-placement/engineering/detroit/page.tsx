...
export default function PlacementEngineeringDetroitPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Detroit"
      title="That open engineering role in Detroit is costing you every week."
      description="Detroit is an automotive, engineering, and manufacturing market where technical leadership is hard to source. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Engineering roles in Detroit stay open because the best candidates are passive and rarely on job boards.</li>
              <li>BEG sources engineering talent in Detroit directly and fills permanent roles in 23-35 days.</li>
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Detroit? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Detroit</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Detroit?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Detroit and across Michigan, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
