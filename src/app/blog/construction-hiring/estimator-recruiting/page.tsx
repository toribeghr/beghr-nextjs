...
export const metadata: Metadata = {
  title: 'Estimator Recruiting: The Truth About This Fill | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/construction-hiring/estimator-recruiting' },
  openGraph: {
    title: 'Estimator Recruiting: The Truth About This Fill | BEG',
    description: 'A weak estimate sinks a project before it starts. Why estimators are the hardest construction hire and how to fill the role in 23-35 days.',
    url: 'https://www.beghr.com/blog/construction-hiring/estimator-recruiting',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-construction-hiring-estimator-recruiting.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Estimator Recruiting: The Truth About This Fill | BEG', description: 'A weak estimate sinks a project before it starts. Why estimators are the hardest construction hire and how to fill the role in 23-35 days.', images: ['https://www.beghr.com/blog-images/blog-construction-hiring-estimator-recruiting.webp'] },
};
  ...
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-construction-hiring-estimator-recruiting.webp", "headline": "Estimator Recruiting: The Truth About This Fill | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/construction-hiring/estimator-recruiting"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-construction-hiring-estimator-recruiting.webp" alt={`A real construction site, workers in hard hats and hi-vis vests reviewing plans`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
