...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Childcare Payroll for Part-Time Workers [2026] | BEG', description: 'Managed payroll for childcare. Managing Part-Time Worker Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
