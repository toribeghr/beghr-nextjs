...
export const metadata: Metadata = {
  title: 'BEG vs Kforce: Permanent Placement Compared | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'BEG vs Kforce: Permanent Placement Compared | BEG', description: 'BEG vs Kforce on permanent placement compared fairly.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('blog-compare-beg-vs-kforce');
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <div style={{ background: '#000', color: '#fff', padding: '2.5rem', borderRadius: '8px', textAlign: 'center', margin: '3rem 0' }}>
          ...
          <a href={CALENDLY} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', background: '#ECAC60', color: '#000', padding: '1rem 2.5rem', borderRadius: '4px', fontWeight: 700, textDecoration: 'none' }}>
