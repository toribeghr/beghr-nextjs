  ...
  return (
    <article className="blog-post">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Hotels Resorts', item: 'https://beghr.com/blog/payroll/hospitality-general/hotels-resorts' },
            ],
          }),
        }}
      />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        url: 'https://beghr.com/blog/payroll/hospitality-general/hotels-resorts',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://beghr.com/blog/payroll/hospitality-general/hotels-resorts' },
      }) }} />
    </article>
  );
}
