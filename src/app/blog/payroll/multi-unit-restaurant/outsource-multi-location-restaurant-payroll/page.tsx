...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/multi-unit-restaurant/outsource-multi-location-restaurant-payroll" },
  openGraph: {
    title: "Outsource Multi-Location Restaurant Payroll | BEG",
    description: "Why multi-unit restaurant groups outsource payroll: consolidated compliance, tip credit management, high-volume W-2s, and per-location reporting. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/multi-unit-restaurant/outsource-multi-location-restaurant-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Outsource Multi-Location Restaurant Payroll | BEG", description: "Why multi-unit restaurant groups outsource payroll. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Outsource Multi-Location Restaurant Payroll", "item": "https://beghr.com/blog/payroll/multi-unit-restaurant/outsource-multi-location-restaurant-payroll" }
        ]
      }) }} />
    </article>
  );
