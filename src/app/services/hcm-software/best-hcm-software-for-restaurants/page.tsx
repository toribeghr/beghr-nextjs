...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/best-hcm-software-for-restaurants' },
  openGraph: {
    title: 'Best HCM Software for Restaurants 2026 | BEG',
    description: 'What to look for in restaurant HCM software in 2026, the tips, turnover, and scheduling challenges operators face, and why iSolved plus BEG is a strong pick.',
    url: 'https://beghr.com/services/hcm-software/best-hcm-software-for-restaurants',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Best HCM Software for Restaurants 2026 | BEG', description: 'What to look for in restaurant HCM software in 2026, the tips, turnover, and scheduling challenges operators face, and why iSolved plus BEG is a strong pick.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Best HCM Software for Restaurants', item: 'https://beghr.com/services/hcm-software/best-hcm-software-for-restaurants' },
  ],
};
    ...
    <main>
      ...
      <RelatedPosts
        ...
        posts={[
          ...
          { category: 'HCM technology', title: 'HR Automation: What to Automate, What Not To, and How Much Time You Save (2026)', excerpt: 'Onboarding and tipped payroll are high-volume tasks in restaurants. Here is what to automate and what to keep human.', href: '/blog/hcm-technology/hr-automation' },
          { category: 'HCM technology', title: 'Payroll Tax Compliance 2026: What Changed and What Your System Must Handle', excerpt: 'Tip credit rules, overtime, and what your HCM platform should be tracking automatically.', href: '/blog/hcm-technology/payroll-compliance' },
        ]}
      />
    </main>
  );
