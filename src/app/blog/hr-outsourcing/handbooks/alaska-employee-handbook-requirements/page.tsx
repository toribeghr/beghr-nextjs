...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Alaska Employee Handbook Rules (2026 Guide) | BEG', description: 'What an Alaska employee handbook must cover in 2026: federal baselines, state paid sick leave, overtime rules, and common employer mistakes.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
