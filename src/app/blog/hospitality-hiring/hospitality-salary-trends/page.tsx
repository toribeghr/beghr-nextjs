...
export const metadata: Metadata = {
  title: 'Hospitality Salary Trends 2026: What Averages Hide | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-hospitality-hiring-hospitality-salary-trends.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Hospitality Salary Trends 2026: What Averages Hide | BEG', description: 'Hospitality comp is climbing, but the best leaders are passive and pay is only part of the decision. What actually closes a hospitality hire.', images: ['https://www.beghr.com/blog-images/blog-hospitality-hiring-hospitality-salary-trends.webp'] },
};
  ...
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-hospitality-hiring-hospitality-salary-trends.webp", "headline": "Hospitality Salary Trends 2026: What Averages Hide | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/hospitality-hiring/hospitality-salary-trends"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-hospitality-hiring-hospitality-salary-trends.webp" alt={`A hotel front desk and staff welcoming guests in a modern lobby`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
