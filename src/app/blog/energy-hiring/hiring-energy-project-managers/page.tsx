...
export const metadata: Metadata = {
  title: 'Hiring Energy Project Managers Before It Stalls | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-energy-hiring-hiring-energy-project-managers.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Hiring Energy Project Managers Before It Stalls | BEG', description: 'A vacant project manager seat puts schedule, budget, and safety at risk. A playbook to hire energy project managers in 23-35 days.', images: ['https://www.beghr.com/blog-images/blog-energy-hiring-hiring-energy-project-managers.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-energy-hiring-hiring-energy-project-managers.webp" alt={`Energy sector workers at a solar or power facility in hi-vis gear`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
