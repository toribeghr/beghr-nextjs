...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/resources/payroll-glossary/ada-accommodation' },
  openGraph: {
    title: 'ADA Accommodation | Payroll Glossary | BEG',
    description: 'Understand ADA accommodation requirements, what qualifies as reasonable, and the payroll and HR implications of accommodation decisions.',
    url: 'https://www.beghr.com/resources/payroll-glossary/ada-accommodation',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://www.beghr.com/resources/payroll-glossary/ada-accommodation', url: 'https://www.beghr.com/resources/payroll-glossary/ada-accommodation', name: 'ADA Accommodation | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' } },
            { '@type': 'DefinedTerm', name: 'ADA Accommodation', description: 'Understand ADA accommodation requirements, what qualifies as reasonable, and the payroll and HR implications of accommodation decisions.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://www.beghr.com/resources/payroll-glossary' } },
            { '@type': 'FAQPage', mainEntity: faqs.map(f => ({ '@type': 'Question', name: f.q, acceptedAnswer: { '@type': 'Answer', text: f.a } })) },
            { '@type': 'BreadcrumbList', itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.beghr.com' },
              { '@type': 'ListItem', position: 2, name: 'Resources', item: 'https://www.beghr.com/resources' },
              { '@type': 'ListItem', position: 3, name: 'Payroll Glossary', item: 'https://www.beghr.com/resources/payroll-glossary' },
              { '@type': 'ListItem', position: 4, name: 'ADA Accommodation', item: 'https://www.beghr.com/resources/payroll-glossary/ada-accommodation' },
            ]},
          ]
        }) }} />
      </section>
