  ...
  return (
    <footer className="site-footer">
      <div className="container">
        ...
        {/*
          Each column is a native <details>/<summary> so it collapses into an accordion on
          mobile (< 768px) with zero JS. On desktop the columns are forced open and the summary
          is made inert via CSS (see the .footer-col rules in globals.css), so the layout and
          content are identical to the previous <div>/<h5> markup.
        */}
        <div className="footer-grid">

          {/* Contact */}
          <details className="footer-col">
            <summary className="footer-col-heading">Contact Us</summary>
          ...
          {/* Free HR Templates */}
          <details className="footer-col">
            <summary className="footer-col-heading">Free HR Templates</summary>
            <div className="footer-col-body">
          ...
          {/* Partners */}
          <details className="footer-col">
            <summary className="footer-col-heading">Partners</summary>
            <div className="footer-col-body">
