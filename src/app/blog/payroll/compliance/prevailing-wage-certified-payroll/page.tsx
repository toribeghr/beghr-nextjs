...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Prevailing Wage and Certified Payroll for Employers | BEG', description: 'Prevailing Wage and Certified Payroll: What Employers Must Know. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
