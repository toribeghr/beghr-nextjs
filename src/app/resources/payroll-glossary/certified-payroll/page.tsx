...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/certified-payroll' },
  openGraph: {
    title: 'Certified Payroll | Payroll Glossary | BEG',
    description: 'Learn what certified payroll is, when it is required under the Davis-Bacon Act, and how to complete Form WH-347 correctly.',
    url: 'https://beghr.com/resources/payroll-glossary/certified-payroll',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/certified-payroll', url: 'https://beghr.com/resources/payroll-glossary/certified-payroll', name: 'Certified Payroll | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Certified Payroll', description: 'Learn what certified payroll is, when it is required under the Davis-Bacon Act, and how to complete Form WH-347 correctly.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Certified Payroll', item: 'https://beghr.com/resources/payroll-glossary/certified-payroll' },
            ]},
          ]
        }) }} />
      </section>
