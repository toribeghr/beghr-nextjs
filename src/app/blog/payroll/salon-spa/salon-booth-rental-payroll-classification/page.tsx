...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.beghr.com/blog-images/blog-payroll-salon-spa-salon-booth-rental-payroll-classification.webp", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Salon Booth Rental vs. W-2: IRS Classification Rules | BEG", description: "Salon stylist classification: booth rental IRS test, contract requirements, and misclassification risks.", images: ["https://www.beghr.com/blog-images/blog-payroll-salon-spa-salon-booth-rental-payroll-classification.webp"] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-salon-spa-salon-booth-rental-payroll-classification.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "BlogPosting",
        "image": "https://beghr.com/blog-images/blog-payroll-salon-spa-salon-booth-rental-payroll-classification.webp",
