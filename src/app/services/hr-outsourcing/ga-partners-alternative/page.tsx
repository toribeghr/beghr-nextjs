...
export const metadata: Metadata = {
  title: 'G&A Partners Alternative: HR Outsourcing, No PEO | BEG',
  description: 'Comparing G&A Partners alternatives? Get national HR outsourcing without co-employment. Keep your EIN and benefits. Instant estimate in 90 seconds.',
  alternates: { canonical: 'https://www.beghr.com/services/hr-outsourcing/ga-partners-alternative' },
  openGraph: {
    title: 'G&A Partners Alternative: HR Outsourcing, No PEO | BEG',
    description: 'Comparing G&A Partners alternatives? Get national HR outsourcing without co-employment. Keep your EIN and benefits. Instant estimate in 90 seconds.',
    url: 'https://www.beghr.com/services/hr-outsourcing/ga-partners-alternative',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'G&A Partners Alternative: HR Outsourcing, No PEO | BEG', description: 'Comparing G&A Partners alternatives? Get national HR outsourcing without co-employment. Keep your EIN and benefits. Instant estimate in 90 seconds.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('hr-outsourcing-ga-partners-alternative');
...
export default function GAPartnersAlternativePage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'G&A Partners Alternative: HR Outsourcing Without the PEO Contract',
            description: 'What G&A Partners does well, where the co-employment model pinches, and how BEG HR outsourcing, powered by isolved, compares for growing companies.',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'G&A Partners Alternative', item: 'https://www.beghr.com/services/hr-outsourcing/ga-partners-alternative' },
            ],
          }),
        }}
      />
      <ServicePage
        ...
        title="Like G&A Partners' service, but not the co-employment contract?"
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>What G&A Partners does well</h2>
            </div>
            <div className="reveal" style={{ marginTop: '1.5rem' }}>
              <p style={{ color: '#444444', lineHeight: '1.7', fontSize: '0.97rem' }}>
                <a href="https://www.gnapartners.com" target="_blank" rel="noopener noreferrer">G&A Partners</a> grew out of Texas into a well-regarded national PEO, and it has kept a reputation for solid client service as it expanded. Its co-employment model bundles HR administration, payroll, and benefits into a single vendor relationship with dedicated support.
              </p>
              <p style={{ color: '#444444', lineHeight: '1.7', fontSize: '0.97rem' }}>
          ...
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <p style={{ marginTop: '1rem', color: '#555555', maxWidth: '640px', margin: '1rem auto 0', textAlign: 'center', lineHeight: '1.7' }}>
                These are traits of the co-employment model, not criticisms of G&A Partners specifically. Our <Link href="/services/hr-outsourcing/peo-vs-hr-outsourcing">PEO vs. HR outsourcing</Link> guide walks through the mechanics in full.
              </p>
            </div>
            <div className="reveal" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(230px, 1fr))', gap: '1.25rem', marginTop: '2rem' }}>
              {[
                ...
                { title: 'Bundled service, bundled commitment', body: 'HR, payroll, and benefits arriving as one package means the more of your employment infrastructure lives inside the PEO, the larger the project of ever taking it back.' },
                { title: 'Pricing is quote-gated', body: 'G&A Partners pricing arrives after a sales process built around your census and risk profile. That is standard for full-service PEOs; it also means no number before the meeting.' },
              ].map(({ title, body }) => (
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>BEG HR outsourcing vs. G&A Partners</h2>
            </div>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem' }}>
                <thead>
                  <tr style={{ background: '#000000', color: '#ECAC60' }}>
                    ...
                    <th style={{ padding: '14px 16px', textAlign: 'left', fontWeight: 700 }}>G&A Partners</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    ['Depth of service', 'Certified HR team, dedicated partner tier', 'Full-service PEO team, bundled into co-employment'],
                    ['Platform', 'isolved', 'G&A Partners proprietary stack'],
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Who should stay with G&A Partners</h2>
            </div>
            <div className="reveal" style={{ marginTop: '1.5rem' }}>
              <p style={{ color: '#444444', lineHeight: '1.7', fontSize: '0.97rem' }}>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>National HR depth, no employment wrapper</h2>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>G&A Partners alternatives, answered</h2>
            </div>
