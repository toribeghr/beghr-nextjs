...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Auto Dealer Payroll: Software vs. Managed Service | BEG', description: 'Managed payroll for auto dealerships. Payroll Software vs. Managed Payroll Service. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
