...
export const metadata: Metadata = {
  title: 'Vet Payroll Hourly vs. Salaried: Which Costs More? | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/veterinary/veterinary-hourly-vs-salaried-payroll' },
  openGraph: {
    title: 'Vet Payroll Hourly vs. Salaried: Which Costs More? | BEG',
    description: 'Managed payroll for veterinary. Hourly vs. Salaried Employee Payroll. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/veterinary/veterinary-hourly-vs-salaried-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-veterinary-veterinary-hourly-vs-salaried-payroll.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Vet Payroll Hourly vs. Salaried: Which Costs More? | BEG', description: 'Managed payroll for veterinary. Hourly vs. Salaried Employee Payroll. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-veterinary-veterinary-hourly-vs-salaried-payroll.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-veterinary-veterinary-hourly-vs-salaried-payroll.webp" alt={`A veterinary clinic with a vet examining a dog, staff assisting`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://www.beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"Veterinary Practices: Hourly vs. Salaried Employee Payroll (2026)","item":"https://www.beghr.com/blog/payroll/veterinary/veterinary-hourly-vs-salaried-payroll"}]}`,
        }}
      />
