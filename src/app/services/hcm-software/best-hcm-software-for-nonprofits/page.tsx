...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/best-hcm-software-for-nonprofits' },
  openGraph: {
    title: 'Best HCM Software for Nonprofits 2026 | BEG',
    description: 'What to look for in nonprofit HCM software in 2026, the grant allocation and funder reporting challenges nonprofits face, and why iSolved plus BEG fits.',
    url: 'https://beghr.com/services/hcm-software/best-hcm-software-for-nonprofits',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Best HCM Software for Nonprofits 2026 | BEG', description: 'What to look for in nonprofit HCM software in 2026, the grant allocation and funder reporting challenges nonprofits face, and why iSolved plus BEG fits.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Best HCM Software for Nonprofits', item: 'https://beghr.com/services/hcm-software/best-hcm-software-for-nonprofits' },
  ],
};
  ...
  return (
    <main>
      ...
      <RelatedPosts
        ...
        posts={[
          { category: 'HCM technology', title: "iSolved HCM Platform Review: Modules, Pricing, and Who It's Built For (2026)", excerpt: 'Full isolved platform review covering payroll, benefits, time tracking, allocation, and the Connector for Claude.', href: '/blog/hcm-technology/isolved-platform' },
          { category: 'HCM technology', title: 'HR Automation: What to Automate, What Not To, and How Much Time You Save (2026)', excerpt: 'Grant allocation and funder reporting are high-effort tasks for lean teams. Here is what to automate.', href: '/blog/hcm-technology/hr-automation' },
          { category: 'HCM technology', title: 'Payroll Tax Compliance 2026: What Changed and What Your System Must Handle', excerpt: 'What your HCM platform should be tracking automatically to keep compliance manageable for a small team.', href: '/blog/hcm-technology/payroll-compliance' },
        ]}
      />
    </main>
  );
