...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/form-i9' },
  openGraph: {
    title: 'Form I-9 | Payroll Glossary | BEG',
    description: 'Learn how to complete Form I-9, what documents are acceptable, the 3-day deadline, and penalties for I-9 violations.',
    url: 'https://beghr.com/resources/payroll-glossary/form-i9',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/form-i9', url: 'https://beghr.com/resources/payroll-glossary/form-i9', name: 'Form I-9 | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Form I-9', description: 'Learn how to complete Form I-9, what documents are acceptable, the 3-day deadline, and penalties for I-9 violations.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Form I-9', item: 'https://beghr.com/resources/payroll-glossary/form-i9' },
            ]},
          ]
        }) }} />
      </section>
