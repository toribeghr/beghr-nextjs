...
export const metadata: Metadata = {
  title: 'Engineering Recruiters in Tucson | BEG',
  description: 'Engineering placement in Tucson. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/engineering/tucson' },
  openGraph: { title: 'Engineering Recruiters in Tucson | BEG', description: 'Engineering placement in Tucson in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/engineering/tucson', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Engineering Recruiters in Tucson | BEG', description: 'Engineering placement in Tucson in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-engineering-tucson');

export default function PlacementEngineeringTucsonPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Tucson"
      title="That open engineering role in Tucson is costing you every week."
      description="Tucson is a healthcare, defense, and education market where senior roles often require relocation sourcing. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Tucson? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Tucson</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Tucson?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Tucson and across Arizona, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
