...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Nonprofit Payroll | Grant Allocation & 990. Done Right. | BEG', description: 'Nonprofit payroll outsourcing for 501(c)(3) organizations. Grant-funded payroll, Form 990, FUTA exemption, PSLF certification. Save $50K–$85K annually.', images: ['https://beghr.com/assets/og-image.png'] },
  ...
  return (
    <article className="blog-post">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Charity Payroll', item: 'https://beghr.com/blog/payroll/nonprofits/charity-payroll' },
            ],
          }),
        }}
      />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        url: 'https://beghr.com/blog/payroll/nonprofits/charity-payroll',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://beghr.com/blog/payroll/nonprofits/charity-payroll' },
      }) }} />
    </article>
  );
}
