...
export const metadata: Metadata = {
  title: 'Construction Payroll: Outsourcing Cost vs. In-House | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Construction Payroll: Outsourcing Cost vs. In-House | BEG', description: 'Managed payroll for construction. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Construction Payroll: Outsourcing Cost vs. In-House | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/construction/construction-payroll-outsourcing-cost"}) }} />
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        ...
        <p>All-inclusive: payroll processing, tax filing, W-2 production, prevailing wage compliance, certified payroll, and year-round compliance monitoring. No per-run fees, no add-on modules, no year-end surcharges.</p>
