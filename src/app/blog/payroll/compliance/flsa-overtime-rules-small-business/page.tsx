...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/compliance/flsa-overtime-rules-small-business' },
  openGraph: {
    title: 'FLSA Overtime Rules for Small Businesses | BEG',
    description: 'FLSA Overtime Rules for Small Businesses. Expert guidance from BEG managed payroll. Book a free 15-min call to review your payroll compliance at beghr.com.',
    url: 'https://beghr.com/blog/payroll/compliance/flsa-overtime-rules-small-business',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'FLSA Overtime Rules for Small Businesses | BEG', description: 'FLSA Overtime Rules for Small Businesses. Expert guidance from BEG managed payroll. Book a free 15-min call to review your payroll compliance at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
