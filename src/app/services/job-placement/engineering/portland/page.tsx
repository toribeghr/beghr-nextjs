...
export default function PlacementEngineeringPortlandPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Portland"
      title="That open engineering role in Portland is costing you every week."
      description="Portland is a tech, manufacturing, and healthcare market where specialized candidates weigh lifestyle heavily. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Engineering roles in Portland stay open because the best candidates are passive and rarely on job boards.</li>
              <li>BEG sources engineering talent in Portland directly and fills permanent roles in 23-35 days.</li>
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Portland? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Portland</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/engineering" style={{ color: '#000000', fontWeight: 600 }}>engineering placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/engineering/seattle" style={{ color: '#000000', fontWeight: 600 }}>Seattle</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Portland?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Portland and across Oregon, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
