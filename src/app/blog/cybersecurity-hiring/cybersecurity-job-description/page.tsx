...
export const metadata: Metadata = {
  title: 'How to Write a Cybersecurity Job Description That Attracts Security Talent | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'How to Write a Cybersecurity Job Description That Attracts Security Talent | BEG', description: 'Most cybersecurity JDs list 20 certifications and scare off the best candidates. How to write a security engineer, analyst, or CISO job description that actually works.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/cybersecurity-hiring/cybersecurity-job-description');
