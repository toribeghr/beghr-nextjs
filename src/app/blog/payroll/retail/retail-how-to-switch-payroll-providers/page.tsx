...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Switching Retail Payroll Providers Without the Chaos | BEG', description: 'Managed payroll for retail. How to Switch Payroll Providers. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
