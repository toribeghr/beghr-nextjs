...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-hr-outsourcing-handbooks-rhode-island-employee-handbook-requirements.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'RI Employee Handbook Rules (2026 Guide) | BEG', description: 'What a Rhode Island employee handbook must cover in 2026: federal baseline, paid sick leave, paid leave, retail premium pay, and mistakes to avoid.', images: ['https://www.beghr.com/blog-images/blog-hr-outsourcing-handbooks-rhode-island-employee-handbook-requirements.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-hr-outsourcing-handbooks-rhode-island-employee-handbook-requirements.webp" alt={`An HR team reviewing employee documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
