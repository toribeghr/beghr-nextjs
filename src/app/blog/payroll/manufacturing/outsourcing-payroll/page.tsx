        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Outsourcing Payroll', item: 'https://beghr.com/blog/payroll/manufacturing/outsourcing-payroll' },
            ],
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://beghr.com/blog/payroll/manufacturing/outsourcing-payroll',
            mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://beghr.com/blog/payroll/manufacturing/outsourcing-payroll' },
          }),
        }}
      />
    </article>
