...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/managed-payroll/iowa' },
  openGraph: {
    title: 'Iowa Managed Payroll Services | BEG | $25-$45 PEPM',
    description: 'Fully managed payroll for Iowa employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.',
    url: 'https://beghr.com/services/managed-payroll/iowa',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Iowa Managed Payroll Services | BEG | $25-$45 PEPM', description: 'Fully managed payroll for Iowa employers at $25-$45 PEPM. State tax, SUI, and compliance handled. No migration required.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Iowa', item: 'https://beghr.com/services/managed-payroll/iowa' },
            ],
          })
        }}
      />
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Paying for payroll in Iowa? See what you are really paying.</h2>
