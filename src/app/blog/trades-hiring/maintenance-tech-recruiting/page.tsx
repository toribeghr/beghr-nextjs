...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-trades-hiring-maintenance-tech-recruiting.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Maintenance Tech Recruiting: What Nobody Tells You | BEG', description: 'A vacant maintenance tech seat means downtime and overtime. How to recruit and hire reliable maintenance technicians in 23-35 days.', images: ['https://www.beghr.com/blog-images/blog-trades-hiring-maintenance-tech-recruiting.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-trades-hiring-maintenance-tech-recruiting.webp" alt={`Skilled trade workers on a job site with tools and equipment`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
