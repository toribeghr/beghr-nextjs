      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Top-quota AEs are the most poached role in B2B, and speed plus direct outreach is what wins them. That is why a posting-and-waiting search rarely fills a account executive seat with the right person. We source passive account executive candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
