...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Healthcare Practices: Hourly vs. Salaried Employee Payroll |', description: 'Managed payroll for healthcare. Hourly vs. Salaried Employee Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
