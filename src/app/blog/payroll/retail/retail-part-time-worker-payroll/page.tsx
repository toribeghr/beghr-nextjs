...
export const metadata: Metadata = {
  title: 'Retail Payroll: Part-Time Workers | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Retail Payroll: Part-Time Workers | BEG', description: 'Managed payroll for retail. Managing Part-Time Worker Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
