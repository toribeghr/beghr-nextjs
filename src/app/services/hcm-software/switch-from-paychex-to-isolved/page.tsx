...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/switch-from-paychex-to-isolved' },
  openGraph: {
    title: 'Switch From Paychex to iSolved | BEG Manages It',
    description: 'Switching from Paychex to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.',
    url: 'https://beghr.com/services/hcm-software/switch-from-paychex-to-isolved',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Switch From Paychex to iSolved | BEG Manages It', description: 'Switching from Paychex to iSolved is painless when BEG manages the migration. We move your data, configure the platform, and support you year-round. Book a call.', images: ['https://beghr.com/assets/og-image.png'] },
...
const faqs = [
  ...
  {
    q: 'What if my Paychex contract is not up yet?',
    a: 'BEG can begin implementation now so you are ready to go live the moment your Paychex contract expires. We help you plan the timeline around your renewal.',
  },
  {
...
export default function SwitchFromPaychexToiSolvedPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Switch From Paychex to iSolved', item: 'https://beghr.com/services/hcm-software/switch-from-paychex-to-isolved' },
    ],
  };
  ...
  return (
    <main>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p style={{ color: '#444', lineHeight: '1.7', marginBottom: '1.5rem' }}>
            Paychex is long established with a strong support network. If you are weighing a move, it is usually about a dated experience, add-on pricing, and wanting one connected platform. The thing that stops people is the migration itself. So BEG owns it. We do not hand you a checklist and wish you luck. We run the migration for you.
          </p>
      ...
      <section style={{ padding: '3rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <h2 style={{ fontSize: '1.6rem', fontWeight: '700', marginBottom: '1.5rem' }}>Switching From Paychex FAQ</h2>
          {faqs.map(({ q, a }, i) => (
