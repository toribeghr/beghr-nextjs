...
export const metadata: Metadata = {
  title: 'Veterinary Salary Trends 2026: What Actually Closes | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-veterinary-hiring-veterinary-salary-trends.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Veterinary Salary Trends 2026: What Actually Closes | BEG', description: 'Veterinary comp is climbing, but the best DVMs are passive and pay is only part of the decision. What actually closes a veterinary hire in 2026.', images: ['https://www.beghr.com/blog-images/blog-veterinary-hiring-veterinary-salary-trends.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-veterinary-hiring-veterinary-salary-trends.webp" alt={`A veterinary clinic with a vet examining a dog, staff assisting`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
