...
export const metadata: Metadata = {
  title: 'Retail Payroll: Garnishments Guide | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Retail Payroll: Garnishments Guide | BEG', description: 'Managed payroll for retail. Payroll Garnishments: What You Need to Know. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
