...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/employer-of-record' },
  openGraph: {
    title: 'Employer of Record (EOR) | Payroll Glossary | BEG',
    description: 'Learn what an Employer of Record is, how it differs from a PEO and staffing agency, and when using an EOR makes sense.',
    url: 'https://beghr.com/resources/payroll-glossary/employer-of-record',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/employer-of-record', url: 'https://beghr.com/resources/payroll-glossary/employer-of-record', name: 'Employer of Record (EOR) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Employer of Record (EOR)', description: 'Learn what an Employer of Record is, how it differs from a PEO and staffing agency, and when using an EOR makes sense.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Employer of Record (EOR)', item: 'https://beghr.com/resources/payroll-glossary/employer-of-record' },
            ]},
          ]
        }) }} />
      </section>
