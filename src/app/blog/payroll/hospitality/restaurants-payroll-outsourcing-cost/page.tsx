...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/hospitality/restaurants-payroll-outsourcing-cost' },
  openGraph: {
    title: 'Restaurant Payroll: Outsourcing Cost vs. In-House | BEG',
    description: 'Managed payroll for restaurants. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/hospitality/restaurants-payroll-outsourcing-cost',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Restaurant Payroll: Outsourcing Cost vs. In-House | BEG', description: 'Managed payroll for restaurants. Payroll Outsourcing Cost vs. In-House Hire. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
