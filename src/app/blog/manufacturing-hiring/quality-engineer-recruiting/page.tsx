...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/manufacturing-hiring/quality-engineer-recruiting' },
  openGraph: {
    title: 'Quality Engineer Recruiting Guide 2026 | BEG',
    description: 'Quality engineers protect compliance and customers. How to source and close strong quality talent in 23-35 days in a tight manufacturing market.',
    url: 'https://beghr.com/blog/manufacturing-hiring/quality-engineer-recruiting',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Quality Engineer Recruiting Guide 2026 | BEG', description: 'Quality engineers protect compliance and customers. How to source and close strong quality talent in 23-35 days in a tight manufacturing market.', images: ['https://beghr.com/assets/og-image.png'] },
};
