...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/security/security-company-payroll-guide" },
  openGraph: {
    title: "Security Company Payroll Guide 2026 | Guard Shifts | BEG",
    ...
    url: "https://beghr.com/blog/payroll/security/security-company-payroll-guide",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Security Company Payroll Guide 2026 | BEG", description: "Security company payroll: SCA compliance, 24/7 shifts, overtime, and high-volume W-2s.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Security Company Payroll Guide", "item": "https://beghr.com/blog/payroll/security/security-company-payroll-guide" }
        ]
      }) }} />
    </article>
  );
