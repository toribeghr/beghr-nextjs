...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Firing Someone in Idaho? Get These Steps Right First', description: 'What Idaho employers must handle at termination: at-will basics, final pay timing, documentation, and COBRA, explained clearly for 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
