...
export const metadata: Metadata = {
  title: 'How to Hire Mechanical Engineers Fast | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/engineering-hiring/hiring-mechanical-engineers' },
  openGraph: {
    title: 'How to Hire Mechanical Engineers Fast | BEG',
    description: 'A vacant mechanical engineer seat stalls your product and projects. A practical playbook to hire mechanical engineers in 23-35 days without settling.',
    url: 'https://beghr.com/blog/engineering-hiring/hiring-mechanical-engineers',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'How to Hire Mechanical Engineers Fast | BEG', description: 'A vacant mechanical engineer seat stalls your product and projects. A practical playbook to hire mechanical engineers in 23-35 days without settling.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/engineering-hiring/hiring-mechanical-engineers');
...
export default function HiringMechanicalEngineersPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "How to Hire Mechanical Engineers Fast | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/engineering-hiring/hiring-mechanical-engineers"}) }} />
