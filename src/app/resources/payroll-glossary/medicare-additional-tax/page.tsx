...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/medicare-additional-tax' },
  openGraph: { title: 'Medicare Additional Tax (0.9%) | Payroll Glossary | BEG', description: 'Additional 0.9% Medicare tax on wages above $200,000 that employers must withhold but are not required to match.', url: 'https://beghr.com/resources/payroll-glossary/medicare-additional-tax', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Medicare Additional Tax (0.9%) | Payroll Glossary | BEG', description: 'Additional 0.9% Medicare tax on wages above $200,000 that employers must withhold but are not required to match.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/medicare-additional-tax', url: 'https://beghr.com/resources/payroll-glossary/medicare-additional-tax', name: 'Medicare Additional Tax (0.9%) | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Medicare Additional Tax (0.9%)', description: 'Additional 0.9% Medicare tax on wages above $200,000 that employers must withhold but are not required to match.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Medicare Additional Tax (0.9%)', item: 'https://beghr.com/resources/payroll-glossary/medicare-additional-tax' },
            ]},
          ]
        }) }} />
      </section>
