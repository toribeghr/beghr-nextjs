...
export const metadata: Metadata = {
  title: 'Franchise Payroll: Must-Have Features | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Franchise Payroll: Must-Have Features | BEG', description: 'Managed payroll for franchise. Payroll Features Every Business Needs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
