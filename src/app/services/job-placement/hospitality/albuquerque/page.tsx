...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/hospitality/albuquerque' },
  openGraph: { title: 'Hospitality Recruiters in Albuquerque | BEG', description: 'Hospitality placement in Albuquerque in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/hospitality/albuquerque', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Hospitality Recruiters in Albuquerque | BEG', description: 'Hospitality placement in Albuquerque in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
