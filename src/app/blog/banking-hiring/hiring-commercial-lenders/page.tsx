...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'How to Hire Commercial Lenders Fast | BEG', description: 'A vacant commercial lender seat stalls your loan pipeline. A practical playbook to hire lenders in 23-35 days with passive candidate sourcing.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <RelatedTool
          variant="grader"
          eyebrow={`Free Tool`}
          heading={`Grade your banking job description in 30 seconds`}
