...
export const metadata: Metadata = {
  title: 'Managed Payroll vs. Payroll Software: Full Cost Comp.. | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Managed Payroll vs. Payroll Software: Full Cost Comp.. | BEG', description: 'Managed Payroll vs. Payroll Software: Full Cost Comparison. Managed payroll at $25-$45 PEPM all-inclusive. Get a free cost comparison for your business size at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Managed Payroll vs. Payroll Software: Full Cost Comp.. | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/cost/managed-payroll-vs-software-cost"}) }} />
