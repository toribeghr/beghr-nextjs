...
export default function PlacementTradesMinneapolisPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Skilled Trades placement\",\"name\":\"Skilled Trades Placement in Minneapolis\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Minneapolis\"},\"url\":\"https://beghr.com/services/job-placement/trades/minneapolis\",\"description\":\"Permanent skilled trades placement in Minneapolis in 23-35 days at roughly 50% less than contingency.\"}" }} />
