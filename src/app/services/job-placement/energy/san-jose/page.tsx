...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/energy/san-jose' },
  openGraph: { title: 'Energy Recruiters in San Jose | BEG', description: 'Energy placement in San Jose in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/energy/san-jose', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Energy Recruiters in San Jose | BEG', description: 'Energy placement in San Jose in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementEnergySanjosePage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Energy placement\",\"name\":\"Energy Placement in San Jose\",\"areaServed\":{\"@type\":\"City\",\"name\":\"San Jose\"},\"url\":\"https://beghr.com/services/job-placement/energy/san-jose\",\"description\":\"Permanent energy placement in San Jose in 23-35 days at roughly 50% less than contingency.\"}" }} />
