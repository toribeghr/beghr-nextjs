...
export const metadata: Metadata = {
  title: 'Engineering Placement & Recruiting | Instant Fee Quote | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/engineering' },
  openGraph: { title: 'Engineering Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill engineering and technical roles on time. Specialized engineering recruiting with milestone billing and 45-day replacement guarantee.', url: 'https://www.beghr.com/services/job-placement/engineering', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Engineering Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill engineering and technical roles on time. Specialized engineering recruiting with milestone billing and 45-day replacement guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementEngineeringPage() {
  return (
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Engineering roles stay open because the strongest candidates are employed, passive, and rarely on job boards.</li>
          ...
          <div className="beg-grid-3 reveal">
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  <div style={{ fontSize: '2rem', fontWeight: '800', color: '#000000', lineHeight: 1 }}>$5,000+</div>
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Per week in project delay cost from one unfilled engineering role</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Engineering project overruns cost money, client relationships, and future bid competitiveness. Headcount gaps are the most common cause.</div>
                </div>
              ))()
            }
            {
            ...
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Before a qualified PE or senior engineer accepts another offer</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Licensed engineers are approached constantly. A slow search process always ends up with whoever was left.</div>
                </div>
              ))()
            }
          </div>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Civil engineers, structural engineers, mechanical engineers, electrical engineers, project engineers, PE-licensed professionals, engineering managers, and technical project directors across construction, infrastructure, manufacturing, and industrial sectors.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'What roles do you place?', acceptedAnswer: { '@type': 'Answer', text: 'Civil engineers, structural engineers, mechanical engineers, electrical engineers, project engineers, PE-licensed professionals, engineering managers, and technical project directors across construction, infrastructure, manufacturing, and industrial sectors.' } },
    ...
    <JobPlacementHubLinks industry="engineering" />
