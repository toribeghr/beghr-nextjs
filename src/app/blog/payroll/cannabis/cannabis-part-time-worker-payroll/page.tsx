...
export const metadata: Metadata = {
  title: 'Cannabis Payroll: Part-Time Workers | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/cannabis/cannabis-part-time-worker-payroll' },
  openGraph: {
    title: 'Cannabis Payroll: Part-Time Workers | BEG',
    description: 'Managed payroll for cannabis. Managing Part-Time Worker Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/cannabis/cannabis-part-time-worker-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Cannabis Payroll: Part-Time Workers | BEG', description: 'Managed payroll for cannabis. Managing Part-Time Worker Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
