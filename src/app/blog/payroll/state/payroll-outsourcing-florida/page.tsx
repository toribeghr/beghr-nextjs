...
export const metadata: Metadata = {
  title: 'Payroll Outsourcing in Florida: What to Know | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-florida' },
  openGraph: {
    title: 'Payroll Outsourcing in Florida: What to Know | BEG',
    description: 'Payroll Outsourcing in Florida: What to Know. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.',
    url: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-florida',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing in Florida: What to Know | BEG', description: 'Payroll Outsourcing in Florida: What to Know. BEG provides managed payroll nationwide. Book a free 15-min call to discuss your state-specific requirements at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Payroll Outsourcing in Florida: What to Know | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/payroll/state/payroll-outsourcing-florida"}) }} />
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        ...
        <p>BEG serves businesses nationally, including Florida. All Florida state filings are included in the base PEPM fee. No per-state add-ons.</p>
