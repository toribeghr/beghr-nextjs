...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/senior-care/nursing-home-payroll-compliance' },
  openGraph: {
    title: 'Nursing Home Payroll Compliance 2026 | CMS + FLSA | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/senior-care/nursing-home-payroll-compliance',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Nursing Home Payroll Compliance 2026 | CMS + FLSA | BEG', description: 'Nursing home payroll compliance: CMS staffing, FLSA, state wage laws, and PBJ reporting.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Nursing Home Payroll Compliance', item: 'https://beghr.com/blog/payroll/senior-care/nursing-home-payroll-compliance' },
        ]
      }) }} />
    </article>
  );
