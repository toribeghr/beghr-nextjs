...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-new-york' },
  openGraph: {
    title: 'Payroll Outsourcing in New York: Compliance Requirem.. | BEG',
    ...
    url: 'https://beghr.com/blog/payroll/state/payroll-outsourcing-new-york',
