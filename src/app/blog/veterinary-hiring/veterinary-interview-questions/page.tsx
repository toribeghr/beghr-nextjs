...
export const metadata: Metadata = {
  title: 'Veterinary Interview Questions for Associate Vets, Practice Managers, and Lead Technicians | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Veterinary Interview Questions for Associate Vets, Practice Managers, and Lead Technicians | BEG', description: 'Veterinary interviews that reveal clinical philosophy, client communication quality, and practice culture fit. Questions that identify associate veterinarians and practice managers who will stay.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/veterinary-hiring/veterinary-interview-questions');
