...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Franchise Payroll, Switching Providers Without Chaos | BEG', description: 'Managed payroll for franchise. How to Switch Payroll Providers. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
