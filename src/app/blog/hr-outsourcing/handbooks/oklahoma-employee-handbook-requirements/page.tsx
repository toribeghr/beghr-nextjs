...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Oklahoma Employee Handbook Rules (2026 Guide) | BEG', description: 'What an Oklahoma employee handbook must cover in 2026: federal baseline, overtime, wage tiers, and policies employers often get wrong.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
