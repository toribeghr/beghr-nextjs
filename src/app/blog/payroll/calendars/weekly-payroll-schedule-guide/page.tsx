...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Weekly Payroll Schedule Guide: 52 Runs a Year | BEG', description: 'Weekly payroll schedule guide covering all 52 annual runs, a sample month breakdown, and the cost and compliance tradeoffs versus biweekly or semimonthly.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
