...
export const metadata: Metadata = {
  title: 'Payroll Outsourcing for Small Business (Full Breakdown) | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/guides/payroll-outsourcing-for-small-business-owners' },
  openGraph: {
    title: 'Payroll Outsourcing for Small Business (Full Breakdown) | BEG',
    description: 'Payroll Outsourcing for Small Business Owners: Starter Guide. Expert guidance from BEG managed payroll at $25-$45 PEPM. Get instant pricing at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/guides/payroll-outsourcing-for-small-business-owners',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-guides-payroll-outsourcing-for-small-business-owners.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing for Small Business (Full Breakdown) | BEG', description: 'Payroll Outsourcing for Small Business Owners: Starter Guide. Expert guidance from BEG managed payroll at $25-$45 PEPM. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-guides-payroll-outsourcing-for-small-business-owners.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-payroll-guides-payroll-outsourcing-for-small-business-owners.webp", "headline": "Payroll Outsourcing for Small Business Owners: Start.. | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/guides/payroll-outsourcing-for-small-business-owners"}) }} />
      <section className="hero">
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              <p className="eyebrow">Blog · Payroll Management</p>
              <h1>Payroll Outsourcing for Small Business Owners: Starter Guide</h1>
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-guides-payroll-outsourcing-for-small-business-owners.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>

      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        <p>Payroll Outsourcing for Small Business Owners: Starter Guide -- this is a question BEG managed payroll handles for businesses every week. Here is the practical answer.</p>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Payroll Outsourcing for Small Business Owners: Starter Guide","description":"Payroll Outsourcing for Small Business Owners: Starter Guide. Expert guidance from BEG managed payroll at $25-$45 PEPM. Get instant pricing at beghr.com.","datePublished":"2026-06-28","dateModified":"2026-06-28","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","worksFor":{"@type":"Organization","name":"Business Executive Group"}},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://www.beghr.com/assets/beg-header-image.png"}},"url":"https://www.beghr.com/blog/payroll/guides/payroll-outsourcing-for-small-business-owners","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.beghr.com/blog/payroll/guides/payroll-outsourcing-for-small-business-owners"}}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://www.beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"Payroll Outsourcing for Small Business Owners: Starter Guide","item":"https://www.beghr.com/blog/payroll/guides/payroll-outsourcing-for-small-business-owners"}]}`,
        }}
      />
