...
export const metadata: Metadata = {
  ...
  description: 'Account Executive direct hire placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
...
export default function PlacementSalesAccountexecutivePage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Sales · Account Executive"
      title="Your account executive search has been open too long."
      description="Top-quota AEs are the most poached role in B2B, and speed plus direct outreach is what wins them. We place permanent account executive candidates in 23-35 days at roughly 50% less than contingency firms, with a 45-day replacement guarantee."
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Account Executive searches stall because the best candidates are passive and field multiple offers.</li>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>The best account executive candidates are not on job boards</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Top-quota AEs are the most poached role in B2B, and speed plus direct outreach is what wins them. That is why a posting-and-waiting search rarely fills a account executive seat with the right person. Our recruiters source passive account executive candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/sales" style={{ color: '#000000', fontWeight: 600 }}>sales placement service</Link>, or explore: <Link href="/services/job-placement/sales/vp-sales" style={{ color: '#000000', fontWeight: 600 }}>VP of Sales</Link>, <Link href="/services/job-placement/sales/sales-director" style={{ color: '#000000', fontWeight: 600 }}>Sales Director</Link>, <Link href="/services/job-placement/sales/sdr-manager" style={{ color: '#000000', fontWeight: 600 }}>SDR Manager</Link>, <Link href="/services/job-placement/sales/enterprise-account-executive" style={{ color: '#000000', fontWeight: 600 }}>Enterprise Account Executive</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'How long does it take to place a account executive?', acceptedAnswer: { '@type': 'Answer', text: 'On average 23-35 days from discovery call to placed hire, with an 86% fill rate on active searches.' } },
