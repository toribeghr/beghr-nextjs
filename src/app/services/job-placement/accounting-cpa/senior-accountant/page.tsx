...
export const metadata: Metadata = {
  ...
  description: 'Senior Accountant placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://beghr.com/services/job-placement/accounting-cpa/senior-accountant' },
  openGraph: { title: 'Senior Accountant Recruiters | 23-35 Days | BEG', description: 'Senior Accountant placement in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/accounting-cpa/senior-accountant', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Senior Accountant Recruiters | 23-35 Days | BEG', description: 'Senior Accountant placement in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementAccountingcpaSenioraccountantPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Senior Accountant placement\",\"name\":\"Senior Accountant Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/accounting-cpa/senior-accountant\",\"description\":\"Permanent senior accountant placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
