...
export const metadata: Metadata = {
  title: 'Engineering Salary Trends 2026 | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/engineering-hiring/engineering-salary-trends' },
  openGraph: {
    title: 'Engineering Salary Trends 2026 | BEG',
    description: 'Engineering comp is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes an engineering hire.',
    url: 'https://beghr.com/blog/engineering-hiring/engineering-salary-trends',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Engineering Salary Trends 2026 | BEG', description: 'Engineering comp is climbing, but the best candidates are passive and pay is only part of the decision. What actually closes an engineering hire.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/engineering-hiring/engineering-salary-trends');
...
export default function EngineeringSalaryTrendsPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Engineering Salary Trends 2026 | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/engineering-hiring/engineering-salary-trends"}) }} />
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <div style={{ background: '#000', color: '#fff', padding: '2.5rem', borderRadius: '8px', textAlign: 'center', margin: '3rem 0' }}>
          ...
          <p style={{ marginBottom: '1.5rem', color: '#ddd' }}>Free 15-minute call. Tell us the role and the timeline. We will benchmark the comp and show you what our engineering pipeline looks like.</p>
          <a href={CALENDLY} target="_blank" rel="noopener noreferrer"
