...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/accounting-cpa/cpa-firm-payroll-guide" },
  openGraph: {
    title: "CPA Firm Payroll Guide 2026 | Partner Draws + Busy Season",
    description: "CPA firm payroll: partner draws vs K-1 vs W-2, busy season overtime, billing-code allocation, 401(k) tied to variable comp, and remote staff compliance. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/accounting-cpa/cpa-firm-payroll-guide",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "CPA Firm Payroll Guide 2026 | Partner Draws + Busy Season", description: "CPA firm payroll: partner draws, busy season overtime, billing codes, and 401(k) for accounting firms. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "CPA Firm Payroll Guide", "item": "https://beghr.com/blog/payroll/accounting-cpa/cpa-firm-payroll-guide" }
        ]
      }) }} />
    </article>
  );
