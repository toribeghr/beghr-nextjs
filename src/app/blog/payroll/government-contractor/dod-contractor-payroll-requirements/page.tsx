...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-government-contractor-dod-contractor-payroll-requirements.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'DoD Contractor Payroll, Before a DCAA Audit Finds You | BEG', description: 'DoD contractor payroll compliance: ITAR, DCAA audit readiness, cleared employees, and indirect cost allocation.', images: ['https://www.beghr.com/blog-images/blog-payroll-government-contractor-dod-contractor-payroll-requirements.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-government-contractor-dod-contractor-payroll-requirements.webp" alt={`Professional staff working in a modern public-sector office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
