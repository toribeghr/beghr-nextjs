...
export const metadata: Metadata = {
  title: 'The Manufacturing Talent Shortage 2026 | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/manufacturing-hiring/manufacturing-talent-shortage' },
  openGraph: {
    title: 'The Manufacturing Talent Shortage 2026 | BEG',
    description: 'Skilled trades are retiring and the pipeline is thin. What the 2026 manufacturing shortage means for hiring and how to fill roles in 23-35 days.',
    url: 'https://beghr.com/blog/manufacturing-hiring/manufacturing-talent-shortage',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'The Manufacturing Talent Shortage 2026 | BEG', description: 'Skilled trades are retiring and the pipeline is thin. What the 2026 manufacturing shortage means for hiring and how to fill roles in 23-35 days.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/manufacturing-hiring/manufacturing-talent-shortage');
...
export default function ManufacturingTalentShortagePage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "The Manufacturing Talent Shortage 2026 | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/manufacturing-hiring/manufacturing-talent-shortage"}) }} />
