...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://beghr.com/blog/payroll/compliance/w2-vs-1099-which-to-use',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'W-2 vs. 1099: Which to Use for Each Worker Type | BEG', description: 'W-2 vs. 1099: Which to Use for Each Worker Type. Expert guidance from BEG managed payroll. Book a free 15-min call to review your payroll compliance at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "W-2 vs. 1099: Which to Use for Each Worker Type | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/payroll/compliance/w2-vs-1099-which-to-use"}) }} />
