...
export const metadata: Metadata = {
  title: 'Auto Dealer Payroll: How to Switch Providers | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/auto-dealership/auto-dealership-how-to-switch-payroll-providers' },
  openGraph: {
    title: 'Auto Dealer Payroll: How to Switch Providers | BEG',
    description: 'Managed payroll for auto dealerships. How to Switch Payroll Providers. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/auto-dealership/auto-dealership-how-to-switch-payroll-providers',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-auto-dealership-auto-dealership-how-to-switch-payroll-providers.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Auto Dealer Payroll: How to Switch Providers | BEG', description: 'Managed payroll for auto dealerships. How to Switch Payroll Providers. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-auto-dealership-auto-dealership-how-to-switch-payroll-providers.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-payroll-auto-dealership-auto-dealership-how-to-switch-payroll-providers.webp", "headline": "Auto Dealer Payroll: How to Switch Providers | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/auto-dealership/auto-dealership-how-to-switch-payroll-providers"}) }} />
      <section className="hero">
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              <p className="eyebrow">Blog · Payroll Management · Auto Dealership</p>
              <h1>Auto Dealerships: How to Switch Payroll Providers (2026)</h1>
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-auto-dealership-auto-dealership-how-to-switch-payroll-providers.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>

      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        <p>Setting up or managing payroll for auto dealerships involves more steps than the basic payroll guides cover. FLSA dealer exemptions for salespeople, flat-rate technician minimum wage compliance, commission draw requirements applies on top of standard federal requirements.</p>

        <p>This guide covers the specific payroll setup and management requirements for auto dealerships.</p>
        ...
        <p>Before running payroll for auto dealerships, you need an Employer Identification Number (EIN) from the IRS, a state employer withholding account in each state where you have employees, and a state unemployment insurance (SUTA) account. For auto dealerships operating in multiple states, this means separate registrations in each state.</p>

        <h2 style={{ marginTop: '2rem', marginBottom: '1rem', borderBottom: '2px solid #ECAC60', paddingBottom: '0.5rem' }}>Step 2: Configure Pay Types for Auto Dealerships</h2>

        <p>Auto Dealerships have non-standard pay types that require specific configuration: front-end and back-end commission structures, flat-rate tech pay, F&I chargebacks, draw-against-commission. Each of these must be set up as a separate pay code in your payroll system with the correct tax treatment applied.</p>
        ...
        <p>Auto Dealerships payroll compliance requires: FLSA dealer exemptions for salespeople, flat-rate technician minimum wage compliance, commission draw requirements. Each of these has filing deadlines, rate requirements, or calculation rules that must be maintained current.</p>
        ...
        <p>With accounts set up and pay types configured, run payroll on your selected frequency. For auto dealerships, bi-weekly or semi-monthly works for most salaried staff. front-end and back-end commission structures may require different frequency or supplemental runs.</p>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Auto Dealerships: How to Switch Payroll Providers (2026)","description":"Managed payroll for auto dealerships. How to Switch Payroll Providers. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.","datePublished":"2026-06-28","dateModified":"2026-06-28","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","worksFor":{"@type":"Organization","name":"Business Executive Group"}},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://www.beghr.com/assets/beg-header-image.png"}},"url":"https://www.beghr.com/blog/payroll/auto-dealership/auto-dealership-how-to-switch-payroll-providers","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.beghr.com/blog/payroll/auto-dealership/auto-dealership-how-to-switch-payroll-providers"}}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://www.beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"Auto Dealerships: How to Switch Payroll Providers (2026)","item":"https://www.beghr.com/blog/payroll/auto-dealership/auto-dealership-how-to-switch-payroll-providers"}]}`,
        }}
      />
