...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hr/las-vegas' },
  openGraph: { title: 'HR Recruiters in Las Vegas | BEG', description: 'HR placement in Las Vegas in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hr/las-vegas', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'HR Recruiters in Las Vegas | BEG', description: 'HR placement in Las Vegas in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementHrLasvegasPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"HR placement\",\"name\":\"HR Placement in Las Vegas\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Las Vegas\"},\"url\":\"https://www.beghr.com/services/job-placement/hr/las-vegas\",\"description\":\"Permanent hr placement in Las Vegas in 23-35 days at roughly 50% less than contingency.\"}" }} />
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring HR in Las Vegas? Grade your job description first.</h2>
