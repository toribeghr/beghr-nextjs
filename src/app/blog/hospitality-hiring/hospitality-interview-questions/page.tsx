...
export const metadata: Metadata = {
  title: 'Hospitality Interview Questions for GMs, F&B Directors, and Operations Managers | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Hospitality Interview Questions for GMs, F&B Directors, and Operations Managers | BEG', description: 'Hospitality interviews that reveal service philosophy, P&L ownership, and culture-building ability. Questions that identify general managers and F&B directors who will lead and stay.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/hospitality-hiring/hospitality-interview-questions');
