...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Demand Gen Recruiting Before Pipeline Dries Up | BEG', description: 'Demand gen talent is measured on pipeline and revenue, which makes the best people hard to win. How to recruit demand gen managers in 23-35 days.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function DemandGenRecruitingPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Demand Gen Recruiting Before Pipeline Dries Up | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/marketing-hiring/demand-gen-recruiting"}) }} />
