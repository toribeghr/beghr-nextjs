...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'How to Set Up Payroll Deductions for Benefits | BEG', description: 'How to Set Up Payroll Deductions for Benefits. Step-by-step guidance from BEG managed payroll specialists. Questions? Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
