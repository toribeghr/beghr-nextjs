...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Fitness Year-End Payroll Checklist (Full Breakdown) | BEG', description: 'Managed payroll for fitness. Year-End Payroll Checklist. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
