...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Auto Dealer Payroll: For Small Business (<25 EE) | BEG', description: 'Managed payroll for auto dealerships. Managed Payroll for Small Businesses (Under 25 Employees). $25-$45 PEPM all-inclusive.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
