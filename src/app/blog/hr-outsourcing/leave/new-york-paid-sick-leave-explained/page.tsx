...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'New York Paid Sick Leave Explained (2026) | BEG', description: 'What New York paid sick leave requires, how it differs from Paid Family Leave, and the federal FMLA baseline employers must document.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
