...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/reasonable-compensation' },
  openGraph: { title: 'Reasonable Compensation | Payroll Glossary | BEG', description: 'IRS requirement that S-corporation owner-employees receive a fair market salary before taking distributions, enforced through payroll audits.', url: 'https://beghr.com/resources/payroll-glossary/reasonable-compensation', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Reasonable Compensation | Payroll Glossary | BEG', description: 'IRS requirement that S-corporation owner-employees receive a fair market salary before taking distributions, enforced through payroll audits.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/reasonable-compensation', url: 'https://beghr.com/resources/payroll-glossary/reasonable-compensation', name: 'Reasonable Compensation | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Reasonable Compensation', description: 'IRS requirement that S-corporation owner-employees receive a fair market salary before taking distributions, enforced through payroll audits.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Reasonable Compensation', item: 'https://beghr.com/resources/payroll-glossary/reasonable-compensation' },
            ]},
          ]
        }) }} />
      </section>
