...
export const metadata: Metadata = {
  title: 'PTO Accrual Tracking: Where Payroll Systems Fail | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/features/pto-accrual-tracking-payroll' },
  openGraph: {
    title: 'PTO Accrual Tracking: Where Payroll Systems Fail | BEG',
    description: 'PTO Accrual Tracking in Managed Payroll Systems. Expert guidance from BEG managed payroll at $25-$45 PEPM. Get instant pricing at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/features/pto-accrual-tracking-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-features-pto-accrual-tracking-payroll.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'PTO Accrual Tracking: Where Payroll Systems Fail | BEG', description: 'PTO Accrual Tracking in Managed Payroll Systems. Expert guidance from BEG managed payroll at $25-$45 PEPM. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-features-pto-accrual-tracking-payroll.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-payroll-features-pto-accrual-tracking-payroll.webp", "headline": "PTO Accrual Tracking in Managed Payroll Systems | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/payroll/features/pto-accrual-tracking-payroll"}) }} />
      <section className="hero">
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              <p className="eyebrow">Blog · Payroll Management</p>
              <h1>PTO Accrual Tracking in Managed Payroll Systems</h1>
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-features-pto-accrual-tracking-payroll.webp" alt={`Business professionals reviewing payroll and HR documents in a bright modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>

      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        <p>PTO Accrual Tracking in Managed Payroll Systems -- this is a question BEG managed payroll handles for businesses every week. Here is the practical answer.</p>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"PTO Accrual Tracking in Managed Payroll Systems","description":"PTO Accrual Tracking in Managed Payroll Systems. Expert guidance from BEG managed payroll at $25-$45 PEPM. Get instant pricing at beghr.com.","datePublished":"2026-06-28","dateModified":"2026-06-28","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","worksFor":{"@type":"Organization","name":"Business Executive Group"}},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://www.beghr.com/assets/beg-header-image.png"}},"url":"https://www.beghr.com/blog/payroll/features/pto-accrual-tracking-payroll","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.beghr.com/blog/payroll/features/pto-accrual-tracking-payroll"}}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://www.beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"PTO Accrual Tracking in Managed Payroll Systems","item":"https://www.beghr.com/blog/payroll/features/pto-accrual-tracking-payroll"}]}`,
        }}
      />
