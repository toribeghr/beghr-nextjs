...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/fica' },
  openGraph: {
    title: 'FICA | Payroll Glossary | BEG',
    description: 'Learn how FICA taxes work, the rates for Social Security and Medicare, the wage base, and how employers deposit and report FICA.',
    url: 'https://beghr.com/resources/payroll-glossary/fica',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/fica', url: 'https://beghr.com/resources/payroll-glossary/fica', name: 'FICA | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'FICA', description: 'Learn how FICA taxes work, the rates for Social Security and Medicare, the wage base, and how employers deposit and report FICA.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'FICA', item: 'https://beghr.com/resources/payroll-glossary/fica' },
            ]},
          ]
        }) }} />
      </section>
