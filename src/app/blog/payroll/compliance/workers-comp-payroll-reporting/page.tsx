...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Workers Comp Payroll Reporting for Employers | BEG', description: 'Workers Comp and Payroll: Reporting Requirements. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
