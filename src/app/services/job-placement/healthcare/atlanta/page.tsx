...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/healthcare/atlanta' },
  openGraph: { title: 'Healthcare Recruiters in Atlanta | BEG', description: 'Healthcare placement in Atlanta in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/healthcare/atlanta', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Healthcare Recruiters in Atlanta | BEG', description: 'Healthcare placement in Atlanta in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementHealthcareAtlantaPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Healthcare placement\",\"name\":\"Healthcare Placement in Atlanta\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Atlanta\"},\"url\":\"https://beghr.com/services/job-placement/healthcare/atlanta\",\"description\":\"Permanent healthcare placement in Atlanta in 23-35 days at roughly 50% less than contingency.\"}" }} />
