...
export const metadata: Metadata = {
  title: "Union Manufacturing Payroll | CBA Rates & Fringes | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/manufacturing/union-manufacturing-payroll" },
  openGraph: {
    title: "Union Manufacturing Payroll | CBA Rates & Fringes | BEG",
    ...
    url: "https://beghr.com/blog/payroll/manufacturing/union-manufacturing-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Union Manufacturing Payroll | CBA Rates, Fringes & Grievances | BEG", description: "Union manufacturing payroll: CBA wages, fringe remittances, grievance documentation, and NLRA compliance. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: "BEG manages union manufacturing payroll at $25 per employee per month on your existing system, or $45 per employee per month on BEG's iSolved platform. For a 150-person union plant, that is $3,750 to $6,750 per month, all-inclusive: CBA wage schedule management, fringe remittance calculation, dues checkoff, overtime under CBA terms, and tax filings. No per-run fees.",
  },
];
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "Manufacturing", "item": "https://beghr.com/blog/payroll/manufacturing" },
          { "@type": "ListItem", "position": 5, "name": "Union Manufacturing Payroll", "item": "https://beghr.com/blog/payroll/manufacturing/union-manufacturing-payroll" }
        ]
      }) }} />
    </article>
  );
