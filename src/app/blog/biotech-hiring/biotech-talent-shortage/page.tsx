...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/biotech-hiring/biotech-talent-shortage' },
  openGraph: {
    title: 'The Biotech Talent Shortage in 2026 | BEG',
    description: 'Specialized roles and fierce competition define biotech hiring. What the 2026 shortage means and how to fill roles in 23-35 days anyway.',
    url: 'https://beghr.com/blog/biotech-hiring/biotech-talent-shortage',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'The Biotech Talent Shortage in 2026 | BEG', description: 'Specialized roles and fierce competition define biotech hiring. What the 2026 shortage means and how to fill roles in 23-35 days anyway.', images: ['https://beghr.com/assets/og-image.png'] },
};
