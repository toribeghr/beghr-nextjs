...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Florida Termination and Final Paycheck Rules (2026)', description: 'What Florida employers must handle when ending employment: final pay, overtime, and documentation that decides claims.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
