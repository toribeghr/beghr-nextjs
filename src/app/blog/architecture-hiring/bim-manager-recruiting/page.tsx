...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/architecture-hiring/bim-manager-recruiting' },
  openGraph: {
    title: 'BIM Manager Recruiting (2026 Guide) | BEG',
    description: 'A strong BIM manager keeps documentation, standards, and coordination on track. How to recruit one in 23-35 days when the pool is thin.',
    url: 'https://beghr.com/blog/architecture-hiring/bim-manager-recruiting',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'BIM Manager Recruiting (2026 Guide) | BEG', description: 'A strong BIM manager keeps documentation, standards, and coordination on track. How to recruit one in 23-35 days when the pool is thin.', images: ['https://beghr.com/assets/og-image.png'] },
};
