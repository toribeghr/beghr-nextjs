...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://beghr.com/blog/payroll/trucking/trucking-managed-payroll-mid-size',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Trucking Payroll: For Mid-Size Business (25-100 EE) | BEG', description: 'Managed payroll for trucking. Managed Payroll for Mid-Size Businesses (25-100 Employees). $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
