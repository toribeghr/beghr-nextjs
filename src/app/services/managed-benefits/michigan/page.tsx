...
export const metadata: Metadata = {
  title: 'Michigan Mini-COBRA: No State Law | BEG',
  description: 'Michigan has no state mini-COBRA. Federal COBRA covers employers with 20 or more employees. What small Michigan employers and staff can do.',
  alternates: { canonical: 'https://www.beghr.com/services/managed-benefits/michigan' },
  openGraph: {
    title: 'Michigan Mini-COBRA: No State Law | BEG',
    description: 'Michigan has no state mini-COBRA. Federal COBRA covers employers with 20 or more employees. What small Michigan employers and staff can do.',
    url: 'https://www.beghr.com/services/managed-benefits/michigan',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Michigan Mini-COBRA: No State Law | BEG', description: 'Michigan has no state mini-COBRA. Federal COBRA covers employers with 20 or more employees. What small Michigan employers and staff can do.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('managed-benefits-michigan');
...
export default function ManagedBenefitsMichiganPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Michigan mini-COBRA and state continuation coverage rules',
            description: 'Michigan has no state mini-COBRA. Federal COBRA covers employers with 20 or more employees. What small Michigan employers and staff can do.',
            author: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' },
            publisher: { '@type': 'Organization', name: 'Business Executive Group' },
            datePublished: '2026-07-05',
            mainEntityOfPage: 'https://www.beghr.com/services/managed-benefits/michigan',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Michigan', item: 'https://www.beghr.com/services/managed-benefits/michigan' },
            ],
          }),
        }}
      />
      <ServicePage
        showHeroImage={false}
        eyebrow="Managed Benefits · Michigan"
        title="Michigan has no mini-COBRA. The benefits work still has to get done."
        description="Michigan does not require small employers to continue coverage after a qualifying event; only federal COBRA at 20-plus employees applies. But enrollment, ACA, and clean records still land on someone. BEG Managed Benefits, powered by isolved, runs that administration. You keep your broker; we do the work."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="managed-benefits" />}
        heroStats={[
          { value: 'No state law', label: 'Michigan has no mini-COBRA mandate' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '860px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Michigan Continuation, In Brief</p>
              <h2>What Michigan law does and does not require</h2>
            </div>
            <div style={{ overflowX: 'auto', marginTop: '2rem' }} className="reveal">
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                <tbody>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Marketplace</td><td style={{ padding: '12px 16px', color: '#555555' }}>Uses HealthCare.gov (federal marketplace; Michigan does not run its own state-based exchange).</td></tr>
                </tbody>
              </table>
            </div>
            <p className="reveal" style={{ fontSize: '0.8rem', color: '#888888', marginTop: '1rem', textAlign: 'center', lineHeight: 1.6 }}>
              Source: <a href="https://www.legislature.mi.gov/Laws/MCL?objectName=MCL-500-3708" target="_blank" rel="noopener noreferrer">Michigan statute and department of insurance (www.legislature.mi.gov)</a>. This page is general information, not legal advice.
            </p>
          </div>
        </section>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Michigan continuation coverage, answered</h2>
            </div>
