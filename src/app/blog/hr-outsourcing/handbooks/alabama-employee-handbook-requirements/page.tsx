...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Alabama Employee Handbook Rules (2026 Guide) | BEG', description: 'What an Alabama employee handbook must cover in 2026: federal baselines, state additions, and the policies employers get wrong.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
