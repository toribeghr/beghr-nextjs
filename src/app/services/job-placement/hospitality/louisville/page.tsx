...
export const metadata: Metadata = {
  title: 'Hospitality Recruiters in Louisville | BEG',
  description: 'Hospitality placement in Louisville. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hospitality/louisville' },
  openGraph: { title: 'Hospitality Recruiters in Louisville | BEG', description: 'Hospitality placement in Louisville in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hospitality/louisville', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Hospitality Recruiters in Louisville | BEG', description: 'Hospitality placement in Louisville in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-hospitality-louisville');

export default function PlacementHospitalityLouisvillePage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Hospitality · Louisville"
      title="That open hospitality role in Louisville is costing you every week."
      description="Louisville is a logistics, healthcare, and manufacturing market with persistent shortages in skilled professional roles. We source passive hospitality candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Hospitality in Louisville? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Hospitality placement near Louisville</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place hospitality candidates in Louisville?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent hospitality searches in Louisville and across Kentucky, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
