...
export const metadata: Metadata = {
  title: 'Insurance Interview Questions for Underwriters, Producers, and Claims Leaders | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Insurance Interview Questions for Underwriters, Producers, and Claims Leaders | BEG', description: 'Insurance interviews that reveal underwriting judgment, book-of-business quality, and claims leadership. The questions that identify the right producer or underwriter hire.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/insurance-hiring/insurance-interview-questions');
