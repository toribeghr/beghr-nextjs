...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/banking-hiring' },
  openGraph: {
    title: 'Banking & Finance Hiring | BEG Blog',
    description: 'Banking talent trends, commercial lender and credit analyst recruiting, and compensation insights for banks that need to fill roles fast.',
    url: 'https://beghr.com/blog/banking-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Banking & Finance Hiring | BEG Blog', description: 'Banking talent trends, commercial lender and credit analyst recruiting, and compensation insights for banks that need to fill roles fast.', images: ['https://beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Banking Hiring', item: 'https://beghr.com/blog/banking-hiring' },
            ],
          }),
        }}
      />
