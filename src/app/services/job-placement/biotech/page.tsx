...
export const metadata: Metadata = {
  title: 'Biotech Placement & Recruiting | Instant Fee Quote | BEG',
  description: 'Fill clinical, regulatory, and QA roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/biotech' },
  openGraph: { title: 'Biotech Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill clinical, regulatory, and QA roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', url: 'https://www.beghr.com/services/job-placement/biotech', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Biotech Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill clinical, regulatory, and QA roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementBiotechPage() {
  return (
    ...
    <JobPlacementHubLinks industry="biotech" />
