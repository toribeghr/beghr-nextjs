...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/computer-employee-exemption' },
  openGraph: {
    title: 'Computer Employee Exemption | Payroll Glossary | BEG',
    description: 'Learn the FLSA computer employee exemption criteria, qualifying duties, and salary requirements for IT professionals.',
    url: 'https://beghr.com/resources/payroll-glossary/computer-employee-exemption',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/computer-employee-exemption', url: 'https://beghr.com/resources/payroll-glossary/computer-employee-exemption', name: 'Computer Employee Exemption | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Computer Employee Exemption', description: 'Learn the FLSA computer employee exemption criteria, qualifying duties, and salary requirements for IT professionals.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Computer Employee Exemption', item: 'https://beghr.com/resources/payroll-glossary/computer-employee-exemption' },
            ]},
          ]
        }) }} />
      </section>
