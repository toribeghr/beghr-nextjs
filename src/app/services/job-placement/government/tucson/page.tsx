...
export default function PlacementGovernmentTucsonPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Government · Tucson"
      title="That open government role in Tucson is costing you every week."
      description="Tucson is a healthcare, defense, and education market where senior roles often require relocation sourcing. We source passive government candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Government roles in Tucson stay open because the best candidates are passive and rarely on job boards.</li>
              <li>BEG sources government talent in Tucson directly and fills permanent roles in 23-35 days.</li>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Why government roles are hard to fill in Tucson</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Tucson sits in the West and is a healthcare, defense, and education market where senior roles often require relocation sourcing. The strongest government candidates here are already employed and are contacted constantly, which means a job posting reaches the people who are easiest to find, not the ones you actually want. We reach the passive government talent in Tucson and the surrounding AZ market directly, before they ever see a listing.
          </p>
        </div>
      </section>
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Government in Tucson? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Government placement near Tucson</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place government candidates in Tucson?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent government searches in Tucson and across Arizona, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
