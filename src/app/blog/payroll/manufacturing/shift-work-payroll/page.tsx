...
export const metadata: Metadata = {
  title: "Shift Work Payroll | Differentials, Overtime & 24/7 Ops | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/manufacturing/shift-work-payroll" },
  openGraph: {
    title: "Shift Work Payroll | Differentials, Overtime & 24/7 Ops | BEG",
    description: "Shift work payroll: differentials, rotating schedules, 24/7 overtime, and FLSA compliance. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/manufacturing/shift-work-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Shift Work Payroll | Differentials, Overtime & 24/7 Ops | BEG", description: "Shift work payroll: differentials, rotating schedules, 24/7 overtime, and FLSA compliance. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Shift Work Payroll", "item": "https://beghr.com/blog/payroll/manufacturing/shift-work-payroll" }
        ]
      }) }} />
    </article>
  );
