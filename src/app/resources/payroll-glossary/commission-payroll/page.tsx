...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/commission-payroll' },
  openGraph: {
    title: 'Commission Payroll | Payroll Glossary | BEG',
    description: 'Learn how commission payroll works under the FLSA, how to calculate overtime for commission employees, and what the retail or service 7(i) exemption covers.',
    url: 'https://beghr.com/resources/payroll-glossary/commission-payroll',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/commission-payroll', url: 'https://beghr.com/resources/payroll-glossary/commission-payroll', name: 'Commission Payroll | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Commission Payroll', description: 'Learn how commission payroll works under the FLSA, how to calculate overtime for commission employees, and what the retail or service 7(i) exemption covers.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Commission Payroll', item: 'https://beghr.com/resources/payroll-glossary/commission-payroll' },
            ]},
          ]
        }) }} />
      </section>
