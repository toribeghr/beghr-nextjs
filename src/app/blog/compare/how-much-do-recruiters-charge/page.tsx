...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/compare/how-much-do-recruiters-charge' },
  openGraph: {
    title: 'How Much Do Recruiters Charge? Fees Explained | BEG',
    description: 'Recruiter fees explained: contingency runs 20-25% of salary, retained adds a retainer. See what each model costs and a roughly 50% less alternative.',
    url: 'https://beghr.com/blog/compare/how-much-do-recruiters-charge',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'How Much Do Recruiters Charge? Fees Explained | BEG', description: 'Recruiter fees explained: contingency runs 20-25% of salary, retained adds a retainer. See what each model costs and a roughly 50% less alternative.', images: ['https://beghr.com/assets/og-image.png'] },
};
