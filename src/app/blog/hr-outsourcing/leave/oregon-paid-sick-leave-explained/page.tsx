...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Oregon Paid Sick Leave Explained (2026) | BEG', description: 'What Oregon paid sick leave requires, how it differs from Paid Leave Oregon, and the federal FMLA baseline employers must document.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
