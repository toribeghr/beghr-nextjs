...
export const metadata: Metadata = {
  title: 'Trucking Payroll: Cost Calculator Guide | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/trucking/trucking-payroll-cost-calculator' },
  openGraph: {
    title: 'Trucking Payroll: Cost Calculator Guide | BEG',
    description: 'Managed payroll for trucking. How to Calculate Your Payroll Costs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/trucking/trucking-payroll-cost-calculator',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Trucking Payroll: Cost Calculator Guide | BEG', description: 'Managed payroll for trucking. How to Calculate Your Payroll Costs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "Trucking Payroll: Cost Calculator Guide | BEG", "datePublished": "2026-06-28", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://beghr.com/blog/payroll/trucking/trucking-payroll-cost-calculator"}) }} />
      <section className="hero">
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              <p className="eyebrow">Blog · Payroll Management · Trucking</p>
              <h1>Trucking & Transportation Companies: How to Calculate Your Payroll Costs (2026)</h1>
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        ...
        <p>All-inclusive: payroll processing, tax filing, W-2 production, per-diem pay for drivers, owner-operator vs W-2 classification, and year-round compliance monitoring. No per-run fees, no add-on modules, no year-end surcharges.</p>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Trucking & Transportation Companies: How to Calculate Your Payroll Costs (2026)","description":"Managed payroll for trucking. How to Calculate Your Payroll Costs. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.","datePublished":"2026-06-28","dateModified":"2026-06-28","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","worksFor":{"@type":"Organization","name":"Business Executive Group"}},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://beghr.com/assets/beg-header-image.png"}},"url":"https://beghr.com/blog/payroll/trucking/trucking-payroll-cost-calculator","mainEntityOfPage":{"@type":"WebPage","@id":"https://beghr.com/blog/payroll/trucking/trucking-payroll-cost-calculator"}}`,
        }}
      />
