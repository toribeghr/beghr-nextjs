...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/problems/missed-payroll-tax-deposit-what-to-do' },
  openGraph: {
    title: 'Missed a Payroll Tax Deposit: Steps to Take Immediat.. | BEG',
    description: 'Missed a Payroll Tax Deposit: Steps to Take Immediately. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/problems/missed-payroll-tax-deposit-what-to-do',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Missed a Payroll Tax Deposit: Steps to Take Immediat.. | BEG', description: 'Missed a Payroll Tax Deposit: Steps to Take Immediately. Expert guidance from BEG managed payroll at $25-$45 PEPM. Book a free 15-min call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
