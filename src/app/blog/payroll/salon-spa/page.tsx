...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Salon & Spa Payroll Guides | Booth Rental + Tips | BEG", description: "Salon and spa payroll guides: booth rental, commission, tips, and worker classification.", images: ["https://www.beghr.com/assets/og-image.png"] },
};
