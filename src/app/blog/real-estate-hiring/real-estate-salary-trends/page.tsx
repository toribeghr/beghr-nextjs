...
export const metadata: Metadata = {
  title: 'Real Estate Salary Trends 2026: What Nobody Tells You | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-real-estate-hiring-real-estate-salary-trends.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Real Estate Salary Trends 2026: What Nobody Tells You | BEG', description: 'Real estate comp is climbing and the best candidates are passive. What actually closes a real estate hire beyond the salary number.', images: ['https://www.beghr.com/blog-images/blog-real-estate-hiring-real-estate-salary-trends.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-real-estate-hiring-real-estate-salary-trends.webp" alt={`A real estate agent showing a modern home to clients`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
