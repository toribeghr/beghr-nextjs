...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/reciprocity-agreement' },
  openGraph: { title: 'Reciprocity Agreement | Payroll Glossary | BEG', description: 'A state tax agreement allowing employees who live in one state and work in another to pay income tax only in their home state.', url: 'https://beghr.com/resources/payroll-glossary/reciprocity-agreement', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Reciprocity Agreement | Payroll Glossary | BEG', description: 'A state tax agreement allowing employees who live in one state and work in another to pay income tax only in their home state.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/reciprocity-agreement', url: 'https://beghr.com/resources/payroll-glossary/reciprocity-agreement', name: 'Reciprocity Agreement | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Reciprocity Agreement', description: 'A state tax agreement allowing employees who live in one state and work in another to pay income tax only in their home state.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Reciprocity Agreement', item: 'https://beghr.com/resources/payroll-glossary/reciprocity-agreement' },
            ]},
          ]
        }) }} />
      </section>
