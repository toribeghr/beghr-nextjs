...
export const metadata: Metadata = {
  title: 'Switching Vet Payroll Providers: How Does It Work? | BEG',
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/payroll/veterinary/veterinary-how-to-switch-payroll-providers' },
  openGraph: {
    title: 'Switching Vet Payroll Providers: How Does It Work? | BEG',
    description: 'Managed payroll for veterinary. How to Switch Payroll Providers. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.',
    url: 'https://www.beghr.com/blog/payroll/veterinary/veterinary-how-to-switch-payroll-providers',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-veterinary-veterinary-how-to-switch-payroll-providers.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Switching Vet Payroll Providers: How Does It Work? | BEG', description: 'Managed payroll for veterinary. How to Switch Payroll Providers. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-veterinary-veterinary-how-to-switch-payroll-providers.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-veterinary-veterinary-how-to-switch-payroll-providers.webp" alt={`A veterinary clinic with a vet examining a dog, staff assisting`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>

      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
        <p>Setting up or managing payroll for veterinary practices involves more steps than the basic payroll guides cover. DVM production compensation reporting, state veterinary board payroll records, ACA reporting for practices with 50+ FTEs applies on top of standard federal requirements.</p>

        <p>This guide covers the specific payroll setup and management requirements for veterinary practices.</p>
        ...
        <p>Before running payroll for veterinary practices, you need an Employer Identification Number (EIN) from the IRS, a state employer withholding account in each state where you have employees, and a state unemployment insurance (SUTA) account. For veterinary practices operating in multiple states, this means separate registrations in each state.</p>

        <h2 style={{ marginTop: '2rem', marginBottom: '1rem', borderBottom: '2px solid #ECAC60', paddingBottom: '0.5rem' }}>Step 2: Configure Pay Types for Veterinary Practices</h2>

        <p>Veterinary Practices have non-standard pay types that require specific configuration: production-based DVM comp, vet tech certification pay tiers, multi-location group payroll, controlled substance compliance. Each of these must be set up as a separate pay code in your payroll system with the correct tax treatment applied.</p>
        ...
        <p>Veterinary Practices payroll compliance requires: DVM production compensation reporting, state veterinary board payroll records, ACA reporting for practices with 50+ FTEs. Each of these has filing deadlines, rate requirements, or calculation rules that must be maintained current.</p>
        ...
        <p>With accounts set up and pay types configured, run payroll on your selected frequency. For veterinary practices, bi-weekly or semi-monthly works for most salaried staff. production-based DVM comp may require different frequency or supplemental runs.</p>
        ...
        <h2 style={{ marginTop: '2rem', marginBottom: '1rem', borderBottom: '2px solid #ECAC60', paddingBottom: '0.5rem' }}>The Faster Path: Managed Payroll for Veterinary Practices</h2>

        <p>BEG managed payroll handles all of the above for veterinary practices at $25-$45 PEPM, all-inclusive. Setup takes 3-5 business days. We configure your pay types, establish your tax accounts, and run your first payroll on schedule.</p>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"Payroll","item":"https://www.beghr.com/blog/payroll"},{"@type":"ListItem","position":4,"name":"Veterinary Practices: How to Switch Payroll Providers (2026)","item":"https://www.beghr.com/blog/payroll/veterinary/veterinary-how-to-switch-payroll-providers"}]}`,
        }}
      />
