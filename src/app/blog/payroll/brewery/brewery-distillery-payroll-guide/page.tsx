...
export const metadata: Metadata = {
  title: "Brewery & Distillery Payroll Guide 2026 | Tips + Prod | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/brewery/brewery-distillery-payroll-guide" },
  openGraph: {
    title: "Brewery & Distillery Payroll Guide 2026 | Tips + Prod | BEG",
    ...
    url: "https://beghr.com/blog/payroll/brewery/brewery-distillery-payroll-guide",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Brewery & Distillery Payroll Guide 2026 | BEG", description: "Brewery and distillery payroll: taproom tips, production staff, sales rep commissions, and compliance.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Brewery Distillery Payroll Guide", "item": "https://beghr.com/blog/payroll/brewery/brewery-distillery-payroll-guide" }
        ]
      }) }} />
    </article>
  );
