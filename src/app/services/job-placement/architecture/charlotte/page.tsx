...
export default function PlacementArchitectureCharlottePage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Architecture placement\",\"name\":\"Architecture Placement in Charlotte\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Charlotte\"},\"url\":\"https://beghr.com/services/job-placement/architecture/charlotte\",\"description\":\"Permanent architecture placement in Charlotte in 23-35 days at roughly 50% less than contingency.\"}" }} />
