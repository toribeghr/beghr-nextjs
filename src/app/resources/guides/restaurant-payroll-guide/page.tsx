...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://beghr.com/resources/guides/restaurant-payroll-guide',
  },
  openGraph: {
    title: 'Restaurant Payroll Guide | Tips, Tip Credit & FICA | BEG',
    description: 'Restaurant payroll guide covering tip credits, tipped minimum wage, tip pooling, the FICA tip credit, and multi-location compliance.',
    url: 'https://beghr.com/resources/guides/restaurant-payroll-guide',
            ...
            '@graph': [
              ...
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 4, name: 'Restaurant Payroll Guide', item: 'https://beghr.com/resources/guides/restaurant-payroll-guide' },
                ],
              },
            ],
          }),
