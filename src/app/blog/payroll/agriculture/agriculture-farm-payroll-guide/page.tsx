...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Farm and Agriculture Payroll Guide in 2026 | BEG', description: 'Complete farm payroll guide: H-2A workers, seasonal crews, MSPA compliance, and piece rate calculations.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
