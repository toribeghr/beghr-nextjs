...
export const metadata: Metadata = {
  ...
  description: 'Financial Analyst placement in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.',
  alternates: { canonical: 'https://beghr.com/services/job-placement/finance/financial-analyst' },
  openGraph: { title: 'Financial Analyst Recruiters | 23-35 Days | BEG', description: 'Financial Analyst placement in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/finance/financial-analyst', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Financial Analyst Recruiters | 23-35 Days | BEG', description: 'Financial Analyst placement in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementFinanceFinancialanalystPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Financial Analyst placement\",\"name\":\"Financial Analyst Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/finance/financial-analyst\",\"description\":\"Permanent financial analyst placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Strong analysts are promoted or poached quickly, keeping the experienced pool thin. That is why a posting-and-waiting search rarely fills a financial analyst seat with the right person. We source passive financial analyst candidates directly, screen them against your specific criteria, and deliver a shortlist of 3 to 5 people, not a stack of resumes.
          </p>
        </div>
      </section>
