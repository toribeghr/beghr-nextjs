...
export const metadata: Metadata = {
  title: 'Marketing Placement & Recruiting | Instant Fee Quote | BEG',
  ...
  openGraph: { title: 'Marketing Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill marketing director, demand gen, and growth roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', url: 'https://www.beghr.com/services/job-placement/marketing', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Marketing Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill marketing director, demand gen, and growth roles in 23-35 days at roughly 50% less than contingency. Milestone billing, 45-day replacement guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementMarketingPage() {
  return (
    <ServicePage
      ...
      heroCta={<PricingCta service="job-placement" industry="marketing" />}
    ...
    <JobPlacementHubLinks industry="marketing" />
