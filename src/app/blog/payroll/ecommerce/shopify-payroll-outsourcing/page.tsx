...
export const metadata: Metadata = {
  title: "Shopify Payroll Outsourcing | Scale Without the Headache | BEG",
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/ecommerce/shopify-payroll-outsourcing" },
  openGraph: {
    title: "Shopify Payroll Outsourcing | Scale Without the Headache | BEG",
    description: "Shopify payroll outsourcing: staff classification, multi-state compliance, and tax filings as your store grows. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/ecommerce/shopify-payroll-outsourcing",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Shopify Payroll Outsourcing | Scale Without the Headache | BEG", description: "Shopify payroll outsourcing: staff classification, multi-state compliance, and tax filings as your store grows. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: "BEG manages e-commerce and Shopify store payroll at $25 per employee per month on your existing payroll system, or $45 per employee per month on BEG's iSolved platform. Both are all-inclusive: payroll processing, tax filings, W-2 production, and compliance updates. For a 10-person Shopify operation, that is $250 to $450 per month. No per-run fees, no state surcharges, no year-end W-2 fees.",
  },
];
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "820px", paddingTop: "3rem", paddingBottom: "4rem" }}>
        ...
        <div style={{ background: "#f5f0e8", border: "2px solid #ECAC60", borderRadius: "8px", padding: "2rem", marginBottom: "2.5rem" }}>
          ...
          <p style={{ lineHeight: "1.7", marginBottom: "1rem" }}>
            BEG manages Shopify and e-commerce payroll at $25 to $45 per employee per month. All-inclusive, no per-run fees, all 50 states. Live in 3 to 5 business days.
          </p>
          <a
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "E-Commerce", "item": "https://beghr.com/blog/payroll/ecommerce" },
          { "@type": "ListItem", "position": 5, "name": "Shopify Payroll Outsourcing", "item": "https://beghr.com/blog/payroll/ecommerce/shopify-payroll-outsourcing" }
        ]
      }) }} />
    </article>
  );
