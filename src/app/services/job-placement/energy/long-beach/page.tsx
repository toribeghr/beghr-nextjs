...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/energy/long-beach' },
  ...
  twitter: { card: 'summary_large_image', title: 'Energy Recruiters in Long Beach | BEG', description: 'Energy placement in Long Beach in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};
...
export default function PlacementEnergyLongbeachPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Energy placement\",\"name\":\"Energy Placement in Long Beach\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Long Beach\"},\"url\":\"https://beghr.com/services/job-placement/energy/long-beach\",\"description\":\"Permanent energy placement in Long Beach in 23-35 days at roughly 50% less than contingency.\"}" }} />
