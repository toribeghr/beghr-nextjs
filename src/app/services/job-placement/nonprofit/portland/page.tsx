...
export default function PlacementNonprofitPortlandPage() {
  return (
    ...
    >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"Nonprofit placement\",\"name\":\"Nonprofit Placement in Portland\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Portland\"},\"url\":\"https://beghr.com/services/job-placement/nonprofit/portland\",\"description\":\"Permanent nonprofit placement in Portland in 23-35 days at roughly 50% less than contingency.\"}" }} />
