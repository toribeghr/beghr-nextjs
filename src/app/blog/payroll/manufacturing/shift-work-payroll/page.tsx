...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.beghr.com/blog-images/blog-payroll-manufacturing-shift-work-payroll.webp", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Shift Work Payroll: The Truth About 24/7 Overtime | BEG", description: "Shift work payroll: differentials, rotating schedules, 24/7 overtime, and FLSA compliance. BEG at $25-$45 PEPM.", images: ["https://www.beghr.com/blog-images/blog-payroll-manufacturing-shift-work-payroll.webp"] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-manufacturing-shift-work-payroll.webp" alt={`A clean modern factory floor with workers operating machinery`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "BlogPosting",
        "image": "https://beghr.com/blog-images/blog-payroll-manufacturing-shift-work-payroll.webp",
