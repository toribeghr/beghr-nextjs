  ...
  return (
    <article className="blog-post">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Online Stores', item: 'https://beghr.com/blog/payroll/ecommerce/online-stores' },
            ],
          }),
        }}
      />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        url: 'https://beghr.com/blog/payroll/ecommerce/online-stores',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://beghr.com/blog/payroll/ecommerce/online-stores' },
      }) }} />
    </article>
  );
}
