...
export const metadata: Metadata = {
  title: 'Engineering Recruiters in Columbus | BEG',
  description: 'Engineering placement in Columbus. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/engineering/columbus' },
  openGraph: { title: 'Engineering Recruiters in Columbus | BEG', description: 'Engineering placement in Columbus in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/engineering/columbus', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Engineering Recruiters in Columbus | BEG', description: 'Engineering placement in Columbus in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-engineering-columbus');

export default function PlacementEngineeringColumbusPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Engineering · Columbus"
      title="That open engineering role in Columbus is costing you every week."
      description="Columbus is an insurance, finance, and logistics center where mid-market employers compete for the same talent. We source passive engineering candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Engineering in Columbus? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Engineering placement near Columbus</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place engineering candidates in Columbus?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent engineering searches in Columbus and across Ohio, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
