...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/hospitality/bar-nightclub-payroll" },
  openGraph: {
    title: "Bar & Nightclub Payroll | Tip Pools & Late-Night Staff | BEG",
    description: "Bar and nightclub payroll outsourcing: tip credits, tip pools, late-night shift rules, bartender classification. BEG manages it all at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/hospitality/bar-nightclub-payroll",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Bar & Nightclub Payroll | Tip Pools, Late-Night Staff. Handled. | BEG", description: "Bar and nightclub payroll: tip credits, tip pools, late-night shift rules, bartender classification. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Bar and Nightclub Payroll", "item": "https://beghr.com/blog/payroll/hospitality/bar-nightclub-payroll" }
        ]
      }) }} />
    </article>
  );
