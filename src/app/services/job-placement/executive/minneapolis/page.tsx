...
export const metadata: Metadata = {
  title: 'Executive Recruiters in Minneapolis | BEG',
  description: 'Executive placement in Minneapolis. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/executive/minneapolis' },
  openGraph: { title: 'Executive Recruiters in Minneapolis | BEG', description: 'Executive placement in Minneapolis in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/executive/minneapolis', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Executive Recruiters in Minneapolis | BEG', description: 'Executive placement in Minneapolis in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-executive-minneapolis');

export default function PlacementExecutiveMinneapolisPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Executive · Minneapolis"
      title="That open executive role in Minneapolis is costing you every week."
      description="Minneapolis is a Fortune 500 headquarters market in finance, healthcare, and retail with deep but contested talent. We source passive executive candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Executive roles in Minneapolis stay open because the best candidates are passive and rarely on job boards.</li>
              <li>BEG sources executive talent in Minneapolis directly and fills permanent roles in 23-35 days.</li>
              <li>Milestone billing costs roughly 50% less than contingency, with a 45-day replacement guarantee.</li>
            </ul>
          </aside>
        </div>
      </section>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Executive placement\",\"name\":\"Executive Placement in Minneapolis\",\"areaServed\":{\"@type\":\"City\",\"name\":\"Minneapolis\"},\"url\":\"https://www.beghr.com/services/job-placement/executive/minneapolis\",\"description\":\"Permanent executive placement in Minneapolis in 23-35 days at roughly 50% less than contingency.\"}" }} />

      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            <p className="eyebrow">The Minneapolis Talent Market</p>
            <h2>Why executive roles are hard to fill in Minneapolis</h2>
          </div>
          <p className="reveal" style={{ fontSize: '1rem', color: '#444444', lineHeight: 1.8, marginTop: '1.5rem' }}>
            Minneapolis sits in the Midwest and is a Fortune 500 headquarters market in finance, healthcare, and retail with deep but contested talent. The strongest executive candidates here are already employed and are contacted constantly, which means a job posting reaches the people who are easiest to find, not the ones you actually want. We reach the passive executive talent in Minneapolis and the surrounding MN market directly, before they ever see a listing.
          </p>
        </div>
      </section>
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Executive in Minneapolis? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Executive placement near Minneapolis</h2>
          </div>
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/executive" style={{ color: '#000000', fontWeight: 600 }}>executive placement service</Link>, or explore nearby markets: <Link href="/services/job-placement/executive/milwaukee" style={{ color: '#000000', fontWeight: 600 }}>Milwaukee</Link>.
          </p>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place executive candidates in Minneapolis?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent executive searches in Minneapolis and across Minnesota, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
