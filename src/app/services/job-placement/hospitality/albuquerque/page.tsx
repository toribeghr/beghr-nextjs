...
export const metadata: Metadata = {
  title: 'Hospitality Recruiters in Albuquerque | BEG',
  description: 'Hospitality placement in Albuquerque. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hospitality/albuquerque' },
  openGraph: { title: 'Hospitality Recruiters in Albuquerque | BEG', description: 'Hospitality placement in Albuquerque in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hospitality/albuquerque', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Hospitality Recruiters in Albuquerque | BEG', description: 'Hospitality placement in Albuquerque in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-hospitality-albuquerque');

export default function PlacementHospitalityAlbuquerquePage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Hospitality · Albuquerque"
      title="That open hospitality role in Albuquerque is costing you every week."
      description="Albuquerque is a healthcare, defense, and tech market where specialized roles draw from a thin local pool. We source passive hospitality candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Hospitality in Albuquerque? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Hospitality placement near Albuquerque</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place hospitality candidates in Albuquerque?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent hospitality searches in Albuquerque and across New Mexico, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
