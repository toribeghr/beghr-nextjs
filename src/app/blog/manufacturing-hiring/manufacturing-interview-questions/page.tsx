...
export const metadata: Metadata = {
  title: 'Manufacturing Interview Questions for Plant Managers, Quality Leaders, and Ops Directors | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Manufacturing Interview Questions for Plant Managers, Quality Leaders, and Ops Directors | BEG', description: 'Manufacturing interviews that reveal production track record, quality philosophy, and continuous improvement depth. Questions that identify plant managers and operations directors who deliver.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('/blog/manufacturing-hiring/manufacturing-interview-questions');
