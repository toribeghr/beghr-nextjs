...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://beghr.com/blog/payroll/architecture/licensed-professional-payroll-tracking" },
  openGraph: {
    title: "Licensed Professional Payroll | PE + Architect | BEG",
    description: "Payroll compliance for licensed architects and engineers: state license tracking, FLSA classification, multi-state obligations, and PE credentialing. BEG at $25-$45 PEPM.",
    url: "https://beghr.com/blog/payroll/architecture/licensed-professional-payroll-tracking",
    siteName: "Business Executive Group",
    images: [{ url: "https://beghr.com/assets/og-image.png", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Licensed Professional Payroll | PE + Architect | BEG", description: "Payroll for licensed architects and engineers: state license tracking, FLSA classification, multi-state compliance. BEG at $25-$45 PEPM.", images: ["https://beghr.com/assets/og-image.png"] },
};
    ...
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 5, "name": "Licensed Professional Payroll", "item": "https://beghr.com/blog/payroll/architecture/licensed-professional-payroll-tracking" }
        ]
      }) }} />
    </article>
  );
