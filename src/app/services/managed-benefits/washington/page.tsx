...
export const metadata: Metadata = {
  title: 'Washington Mini-COBRA Continuation Rules | BEG',
  description: 'Washington mini-COBRA: state continuation coverage rules, employer size, duration, and who runs the notices. You keep your broker.',
  alternates: { canonical: 'https://www.beghr.com/services/managed-benefits/washington' },
  openGraph: {
    title: 'Washington Mini-COBRA Continuation Rules | BEG',
    description: 'Washington mini-COBRA: state continuation coverage rules, employer size, duration, and who runs the notices. You keep your broker.',
    url: 'https://www.beghr.com/services/managed-benefits/washington',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Washington Mini-COBRA Continuation Rules | BEG', description: 'Washington mini-COBRA: state continuation coverage rules, employer size, duration, and who runs the notices. You keep your broker.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('managed-benefits-washington');
...
export default function ManagedBenefitsWashingtonPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Washington mini-COBRA and state continuation coverage rules',
            description: 'Washington mini-COBRA: state continuation coverage rules, employer size, duration, and who runs the notices. You keep your broker.',
            author: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://www.beghr.com' },
            publisher: { '@type': 'Organization', name: 'Business Executive Group' },
            datePublished: '2026-07-05',
            mainEntityOfPage: 'https://www.beghr.com/services/managed-benefits/washington',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Washington', item: 'https://www.beghr.com/services/managed-benefits/washington' },
            ],
          }),
        }}
      />
      <ServicePage
        showHeroImage={false}
        eyebrow="Managed Benefits · Washington"
        title="Washington makes small employers offer continuation. Someone has to run it."
        description="Washington is a mini-COBRA state: smaller employers must let departing employees keep group coverage under state law. BEG Managed Benefits, powered by isolved, runs the notices, elections, and premium tracking so the rules are handled. You keep your broker; we do the administration."
        calendlyLink={CALENDLY}
        heroCta={<PricingCta service="managed-benefits" />}
        heroStats={[
          { value: 'Yes', label: 'Washington state continuation limit' },
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '860px' }}>
            <div className="head center reveal">
              <p className="eyebrow">Washington Continuation, In Brief</p>
              <h2>What Washington law requires</h2>
            </div>
            <div style={{ overflowX: 'auto', marginTop: '2rem' }} className="reveal">
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem', background: '#ffffff', border: '1px solid #e5e5e5', borderRadius: '8px' }}>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>State law</td><td style={{ padding: '12px 16px', color: '#555555' }}>RCW 48.21.250 (continuation option); RCW 48.21.260 (conversion). Parallel provisions apply to health care service contractors (RCW 48.44) and HMOs (RCW 48.46).</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Employers covered</td><td style={{ padding: '12px 16px', color: '#555555' }}>Applies to insurers issuing group hospital/medical coverage; the continuation provision is offered to the policyholder (employer) as an option regardless of size. Federal COBRA covers employers with 20+ employees; Washington's continuation option fills the.</td></tr>
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Maximum continuation</td><td style={{ padding: '12px 16px', color: '#555555' }}>Set by state statute</td></tr>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e5e5' }}><td style={{ padding: '12px 16px', fontWeight: 600, color: '#333333', width: '38%' }}>Marketplace</td><td style={{ padding: '12px 16px', color: '#555555' }}>Runs its own state-based marketplace: Washington Healthplanfinder (https://www.wahealthplanfinder.org/).</td></tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="section">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>A small Washington employer carries big-company continuation duties</h2>
            </div>
        ...
        <section className="section section--soft">
          <div className="container" style={{ maxWidth: '820px' }}>
            <div className="head center reveal">
              ...
              <h2>Washington continuation coverage, answered</h2>
            </div>
