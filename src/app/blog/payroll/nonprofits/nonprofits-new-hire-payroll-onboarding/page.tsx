...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Nonprofit New Hire Payroll Onboarding, Done Right | BEG', description: 'Managed payroll for nonprofits. New Hire Payroll Onboarding. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
