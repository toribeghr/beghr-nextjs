...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Home Health Payroll, State Compliance Issues to Watch | BEG', description: 'Managed payroll for home health. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
