...
export const metadata: Metadata = {
  title: "Bar and Nightclub Payroll, Tip Pools Explained | BEG",
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.beghr.com/blog-images/blog-payroll-hospitality-bar-nightclub-payroll.webp", width: 1200, height: 630, alt: "Business Executive Group" }],
    type: "website",
  },
  twitter: { card: "summary_large_image", title: "Bar and Nightclub Payroll, Tip Pools Explained | BEG", description: "Bar and nightclub payroll: tip credits, tip pools, late-night shift rules, bartender classification. BEG at $25-$45 PEPM.", images: ["https://www.beghr.com/blog-images/blog-payroll-hospitality-bar-nightclub-payroll.webp"] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-hospitality-bar-nightclub-payroll.webp" alt={`A hotel front desk and staff welcoming guests in a modern lobby`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "BlogPosting",
        "image": "https://beghr.com/blog-images/blog-payroll-hospitality-bar-nightclub-payroll.webp",
