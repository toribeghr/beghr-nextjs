...
export const metadata: Metadata = {
  title: 'Healthcare Placement & Recruiting | Instant Fee Quote | BEG',
  ...
  openGraph: { title: 'Healthcare Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill nursing and clinical roles before burnout sets in. Specialized healthcare recruiting with milestone billing and a 45-day replacement guarantee.', url: 'https://www.beghr.com/services/job-placement/healthcare', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Healthcare Placement & Recruiting | Instant Fee Quote | BEG', description: 'Fill nursing and clinical roles before burnout sets in. Specialized healthcare recruiting with milestone billing and a 45-day replacement guarantee.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function PlacementHealthcarePage() {
  return (
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>Healthcare roles stay open because the strongest candidates are employed, passive, and rarely on job boards.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://www.beghr.com\"},\"serviceType\":\"Healthcare placement\",\"name\":\"Healthcare Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://www.beghr.com/services/job-placement/healthcare\",\"description\":\"Permanent healthcare placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
            ...
            }
            {
              (() => (
                <div style={{ background: '#ffffff', border: '1px solid #e5e5e5', borderTop: '4px solid #ECAC60', borderRadius: '8px', padding: '1.5rem' }}>
                  ...
                  <div style={{ fontWeight: '600', margin: '0.5rem 0 0.4rem', fontSize: '0.95rem' }}>Window before top candidates accept another offer</div>
                  <div style={{ fontSize: '0.88rem', color: '#666666', lineHeight: '1.5' }}>Clinical talent in demand does not stay available long. A slow search misses the best people every time.</div>
                </div>
              ))()
            }
          </div>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div className="faq reveal">
            <div className="faq-item">
              ...
              <p>Registered nurses, nurse practitioners, licensed practical nurses, physicians, medical assistants, clinical coordinators, healthcare administrators, and other clinical and administrative healthcare roles.</p>
            </div>
            <div className="faq-item">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'What roles do you place?', acceptedAnswer: { '@type': 'Answer', text: 'Registered nurses, nurse practitioners, licensed practical nurses, physicians, medical assistants, clinical coordinators, healthcare administrators, and other clinical and administrative healthcare roles.' } },
    ...
    <JobPlacementHubLinks industry="healthcare" />
