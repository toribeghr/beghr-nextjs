...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'West Virginia Paid Sick Leave Explained (2026) | BEG', description: 'Does West Virginia require paid sick leave? What employers must know about local ordinances, remote workers, and FMLA in 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
