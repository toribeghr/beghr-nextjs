...
export const metadata: Metadata = {
  title: 'Childcare Payroll: Benefits Integration | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/blog/payroll/childcare/childcare-benefits-integration-payroll' },
  openGraph: {
    title: 'Childcare Payroll: Benefits Integration | BEG',
    description: 'Managed payroll for childcare. Integrating Benefits with Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.',
    url: 'https://beghr.com/blog/payroll/childcare/childcare-benefits-integration-payroll',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Childcare Payroll: Benefits Integration | BEG', description: 'Managed payroll for childcare. Integrating Benefits with Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://beghr.com/assets/og-image.png'] },
};
