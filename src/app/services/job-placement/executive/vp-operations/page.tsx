...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/job-placement/executive/vp-operations' },
  openGraph: { title: 'VP of Operations Recruiters | 23-35 Days | BEG', description: 'VP of Operations placement in 23-35 days at roughly 50% less than contingency.', url: 'https://beghr.com/services/job-placement/executive/vp-operations', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'VP of Operations Recruiters | 23-35 Days | BEG', description: 'VP of Operations placement in 23-35 days at roughly 50% less than contingency.', images: ['https://beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-executive-vp-operations');

export default function PlacementExecutiveVpoperationsPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Executive · VP of Operations"
      title="Your vp of operations search has been open too long."
      description="Operations leaders who can build and run at scale are passive and selectively recruited. We place permanent vp of operations candidates in 23-35 days at roughly 50% less than contingency firms, with a 45-day replacement guarantee."
    ...
    >
        ...
        <div className="container" style={{ maxWidth: '820px' }}>
          <aside style={{ background: '#FBF3E8', border: '1px solid #ECAC60', borderRadius: '8px', padding: '1.25rem 1.5rem' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.1rem', lineHeight: 1.6, fontSize: '0.97rem', color: '#333333' }}>
              <li>VP of Operations searches stall because the best candidates are passive and field multiple offers.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Service\",\"provider\":{\"@type\":\"Organization\",\"name\":\"Business Executive Group\",\"url\":\"https://beghr.com\"},\"serviceType\":\"VP of Operations placement\",\"name\":\"VP of Operations Placement\",\"areaServed\":{\"@type\":\"Country\",\"name\":\"United States\"},\"url\":\"https://beghr.com/services/job-placement/executive/vp-operations\",\"description\":\"Permanent vp of operations placement in 23-35 days at roughly 50% less than contingency, with a 45-day replacement guarantee.\"}" }} />
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <p className="reveal" style={{ textAlign: 'center', marginTop: '1rem', color: '#444444' }}>
            See our <Link href="/services/job-placement/executive" style={{ color: '#000000', fontWeight: 600 }}>executive placement service</Link>, or explore: <Link href="/services/job-placement/executive/chief-executive-officer" style={{ color: '#000000', fontWeight: 600 }}>Chief Executive Officer</Link>, <Link href="/services/job-placement/executive/chief-operating-officer" style={{ color: '#000000', fontWeight: 600 }}>Chief Operating Officer</Link>, <Link href="/services/job-placement/executive/chief-financial-officer" style={{ color: '#000000', fontWeight: 600 }}>Chief Financial Officer</Link>, <Link href="/services/job-placement/executive/general-manager" style={{ color: '#000000', fontWeight: 600 }}>General Manager</Link>.
          </p>
        </div>
      </section>
