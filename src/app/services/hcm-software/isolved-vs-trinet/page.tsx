...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/isolved-vs-trinet' },
  openGraph: {
    title: 'iSolved vs TriNet | One Platform + Claude AI | BEG',
    description: 'iSolved vs TriNet compared on platform breadth, pricing, control, support, and AI. See which fits firms that want to own HR versus a PEO co-employment model.',
    url: 'https://beghr.com/services/hcm-software/isolved-vs-trinet',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'iSolved vs TriNet | One Platform + Claude AI | BEG', description: 'iSolved vs TriNet compared on platform breadth, pricing, control, support, and AI. See which fits firms that want to own HR versus a PEO co-employment model.', images: ['https://beghr.com/assets/og-image.png'] },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'iSolved vs TriNet', item: 'https://beghr.com/services/hcm-software/isolved-vs-trinet' },
  ],
};
