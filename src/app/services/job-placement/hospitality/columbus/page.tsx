...
export const metadata: Metadata = {
  title: 'Hospitality Recruiters in Columbus | BEG',
  description: 'Hospitality placement in Columbus. Permanent hires in 23-35 days at roughly 50% less than contingency. 45-day guarantee.',
  alternates: { canonical: 'https://www.beghr.com/services/job-placement/hospitality/columbus' },
  openGraph: { title: 'Hospitality Recruiters in Columbus | BEG', description: 'Hospitality placement in Columbus in 23-35 days at roughly 50% less than contingency.', url: 'https://www.beghr.com/services/job-placement/hospitality/columbus', siteName: 'Business Executive Group', images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Hospitality Recruiters in Columbus | BEG', description: 'Hospitality placement in Columbus in 23-35 days at roughly 50% less than contingency.', images: ['https://www.beghr.com/assets/og-image.png'] },
};

const CALENDLY = getCalendlyLink('placement-hospitality-columbus');

export default function PlacementHospitalityColumbusPage() {
  return (
    <ServicePage
      eyebrow="Job Placement · Hospitality · Columbus"
      title="That open hospitality role in Columbus is costing you every week."
      description="Columbus is an insurance, finance, and logistics center where mid-market employers compete for the same talent. We source passive hospitality candidates directly and place permanent hires in 23-35 days at roughly 50% less than contingency firms."
      ...
      <section className="section" style={{ paddingBottom: '0' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          <div className="head center reveal">
            ...
            <h2>Hiring Hospitality in Columbus? Grade your job description first.</h2>
      ...
      <section className="section section--soft">
        <div className="container" style={{ maxWidth: '780px' }}>
          <div className="head center reveal">
            ...
            <h2>Hospitality placement near Columbus</h2>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Do you place hospitality candidates in Columbus?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We run permanent hospitality searches in Columbus and across Ohio, sourcing passive candidates directly. Average time to fill is 23-35 days.' } },
