...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Delaware Paid Sick Leave Explained (2026) | BEG', description: 'Does Delaware require paid sick leave? How its new paid family leave program changes the picture for employers in 2026.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
export default function Page() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BlogPosting", "headline": "Delaware Paid Sick Leave Explained: No Mandate, But a New Paid Leave Program", "description": "Does Delaware require paid sick leave? How its new paid family leave program changes the picture for employers in 2026.", "datePublished": "2026-07-06", "dateModified": "2026-07-06", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/hr-outsourcing/leave/delaware-paid-sick-leave-explained"}) }} />
