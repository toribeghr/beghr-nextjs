...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/at-will-employment' },
  openGraph: {
    title: 'At-Will Employment | Payroll Glossary | BEG',
    description: 'Understand at-will employment, what exceptions apply, and what at-will status means for payroll, final paychecks, and severance.',
    url: 'https://beghr.com/resources/payroll-glossary/at-will-employment',
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/at-will-employment', url: 'https://beghr.com/resources/payroll-glossary/at-will-employment', name: 'At-Will Employment | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'At-Will Employment', description: 'Understand at-will employment, what exceptions apply, and what at-will status means for payroll, final paychecks, and severance.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'At-Will Employment', item: 'https://beghr.com/resources/payroll-glossary/at-will-employment' },
            ]},
          ]
        }) }} />
      </section>
