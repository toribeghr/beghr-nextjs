  ...
  return (
    <article className="blog-post">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        description: 'Deel is built for global contractors and EOR. BEG managed payroll is built for domestic W-2 teams. Full comparison of cost, use case, and which is right for your workforce.',
