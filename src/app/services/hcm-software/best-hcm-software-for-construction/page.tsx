...
export const metadata: Metadata = {
  title: 'Best HCM Software for Construction | Instant Quote | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Best HCM Software for Construction | Instant Quote | BEG', description: 'What to look for in construction HCM software in 2026, the certified payroll and job costing challenges contractors face, and why isolved plus BEG fits.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Best HCM Software for Construction', item: 'https://www.beghr.com/services/hcm-software/best-hcm-software-for-construction' },
  ],
};
