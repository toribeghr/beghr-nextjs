...
export const metadata: Metadata = {
  title: 'People Ops Recruiting: Before You Post the Role | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-hr-hiring-people-operations-recruiting.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'People Ops Recruiting: Before You Post the Role | BEG', description: 'Modern people-ops leaders blend HR judgment with systems and data fluency. How to source the rare candidates who do both in 23-35 days.', images: ['https://www.beghr.com/blog-images/blog-hr-hiring-people-operations-recruiting.webp'] },
};
...
export default function PeopleOperationsRecruitingPage() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "People Ops Recruiting: Before You Post the Role | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/hr-hiring/people-operations-recruiting"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-hr-hiring-people-operations-recruiting.webp" alt={`People Ops Recruiting: Before You Post the Role`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
