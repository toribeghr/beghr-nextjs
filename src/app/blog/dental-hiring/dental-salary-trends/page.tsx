...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-dental-hiring-dental-salary-trends.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Dental Salary Trends 2026: What Averages Hide | BEG', description: 'Dental pay is climbing but the best candidates are passive. What actually closes a dental hire and how to fill roles in 23-35 days.', images: ['https://www.beghr.com/blog-images/blog-dental-hiring-dental-salary-trends.webp'] },
};
  ...
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article",
        "image": "https://beghr.com/blog-images/blog-dental-hiring-dental-salary-trends.webp", "headline": "Dental Salary Trends 2026: What Averages Hide | BEG", "datePublished": "2026-06-25", "dateModified": "2026-06-28", "author": {"@type": "Person", "name": "Anthony Moretti", "jobTitle": "VP of Sales", "url": "https://www.linkedin.com/in/theanthonymoretti"}, "publisher": {"@type": "Organization", "name": "Business Executive Group", "logo": {"@type": "ImageObject", "url": "https://www.beghr.com/assets/beg-header-image.png"}}, "mainEntityOfPage": "https://www.beghr.com/blog/dental-hiring/dental-salary-trends"}) }} />
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-dental-hiring-dental-salary-trends.webp" alt={`A modern dental office with a dentist and hygienist and a patient`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
