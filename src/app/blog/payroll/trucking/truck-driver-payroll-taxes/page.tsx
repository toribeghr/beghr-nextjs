...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Trucking Payroll Taxes | What Fleet Owners Need to Know | BEG', description: 'A plain-English guide to payroll taxes for trucking companies -- FUTA, SUTA, Social Security, Medicare, multi-state withholding, and what changes when dr...', images: ['https://www.beghr.com/assets/og-image.png'] },
