...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/trades-hiring/hiring-electricians' },
  openGraph: {
    title: 'How to Hire Electricians Fast (2026) | BEG',
    description: 'Licensed electricians are scarce and in demand. A practical playbook to source and hire qualified electricians in 23-35 days.',
    url: 'https://beghr.com/blog/trades-hiring/hiring-electricians',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'How to Hire Electricians Fast (2026) | BEG', description: 'Licensed electricians are scarce and in demand. A practical playbook to source and hire qualified electricians in 23-35 days.', images: ['https://beghr.com/assets/og-image.png'] },
};
