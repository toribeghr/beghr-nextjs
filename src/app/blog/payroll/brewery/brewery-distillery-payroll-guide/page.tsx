...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Brewery & Distillery Payroll Guide 2026 | BEG", description: "Brewery and distillery payroll: taproom tips, production staff, sales rep commissions, and compliance.", images: ["https://www.beghr.com/assets/og-image.png"] },
};
