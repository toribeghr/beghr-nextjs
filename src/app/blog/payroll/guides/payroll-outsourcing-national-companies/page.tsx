...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Payroll Outsourcing for National Companies (What to Know) | BEG', description: 'Can You Outsource Payroll if You Operate Nationally?. Expert guidance from BEG managed payroll at $25-$45 PEPM. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
