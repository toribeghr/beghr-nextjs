...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.beghr.com/blog/biotech-hiring' },
  openGraph: {
    title: 'Biotech & Life Sciences Hiring | BEG Blog',
    description: 'Biotech talent shortage trends, regulatory affairs and clinical research recruiting, and comp insights for teams that need to fill roles fast.',
    url: 'https://www.beghr.com/blog/biotech-hiring',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Biotech & Life Sciences Hiring | BEG Blog', description: 'Biotech talent shortage trends, regulatory affairs and clinical research recruiting, and comp insights for teams that need to fill roles fast.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Biotech Hiring', item: 'https://www.beghr.com/blog/biotech-hiring' },
            ],
          }),
        }}
      />
