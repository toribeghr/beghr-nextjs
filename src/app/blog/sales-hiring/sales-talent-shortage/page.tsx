...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'The B2B Sales Talent Shortage in 2026 | BEG', description: 'Sales turnover is high and tenure is short. Why job postings fail in 2026 and how revenue leaders fill quota-carrying roles in 23-35 days anyway.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.8', fontSize: '1.05rem' }}>
        ...
        <RelatedTool
          variant="link"
          eyebrow={`Free Tool`}
          heading={`What is this open sales role costing you right now?`}
