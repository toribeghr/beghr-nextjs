...
export const metadata: Metadata = {
  title: 'Franchise Payroll: Employee Classification Guide | BEG',
  ...
  twitter: { card: 'summary_large_image', title: 'Franchise Payroll: Employee Classification Guide | BEG', description: 'Managed payroll for franchise. Employee Classification for Payroll. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
