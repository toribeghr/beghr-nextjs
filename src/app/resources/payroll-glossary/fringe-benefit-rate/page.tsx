...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/resources/payroll-glossary/fringe-benefit-rate' },
  openGraph: { title: 'Fringe Benefit Rate | Payroll Glossary | BEG', description: 'The ratio of total fringe benefits to base wages, used in government contracting and project cost accounting to allocate benefit costs.', url: 'https://beghr.com/resources/payroll-glossary/fringe-benefit-rate', siteName: 'Business Executive Group', images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Fringe Benefit Rate | Payroll Glossary | BEG', description: 'The ratio of total fringe benefits to base wages, used in government contracting and project cost accounting to allocate benefit costs.', images: ['https://beghr.com/assets/og-image.png'] },
};
    ...
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: '820px', paddingTop: '3rem', paddingBottom: '4rem' }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            { '@type': 'WebPage', '@id': 'https://beghr.com/resources/payroll-glossary/fringe-benefit-rate', url: 'https://beghr.com/resources/payroll-glossary/fringe-benefit-rate', name: 'Fringe Benefit Rate | Payroll Glossary | BEG', datePublished: '2026-06-28', dateModified: '2026-06-28', author: { '@type': 'Person', name: 'Anthony Moretti', url: 'https://www.linkedin.com/in/theanthonymoretti', sameAs: ['https://www.linkedin.com/in/theanthonymoretti'], jobTitle: 'VP of Sales', worksFor: { '@type': 'Organization', name: 'Business Executive Group' } }, publisher: { '@type': 'Organization', name: 'Business Executive Group', url: 'https://beghr.com' } },
            { '@type': 'DefinedTerm', name: 'Fringe Benefit Rate', description: 'The ratio of total fringe benefits to base wages, used in government contracting and project cost accounting to allocate benefit costs.', inDefinedTermSet: { '@type': 'DefinedTermSet', name: 'BEG Payroll Glossary', url: 'https://beghr.com/resources/payroll-glossary' } },
            ...
            { '@type': 'BreadcrumbList', itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Fringe Benefit Rate', item: 'https://beghr.com/resources/payroll-glossary/fringe-benefit-rate' },
            ]},
          ]
        }) }} />
      </section>
