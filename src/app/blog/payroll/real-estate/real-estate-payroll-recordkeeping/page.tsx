...
export const metadata: Metadata = {
  title: 'Real Estate Payroll Recordkeeping Rules for Brokerages | BEG',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-payroll-real-estate-real-estate-payroll-recordkeeping.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Real Estate Payroll Recordkeeping Rules for Brokerages | BEG', description: 'Managed payroll for real estate. Payroll Recordkeeping Requirements. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/blog-images/blog-payroll-real-estate-real-estate-payroll-recordkeeping.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-payroll-real-estate-real-estate-payroll-recordkeeping.webp" alt={`A real estate agent showing a modern home to clients`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
