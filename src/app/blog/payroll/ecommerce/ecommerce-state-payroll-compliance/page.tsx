...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'E-Commerce Payroll: The State Compliance Trap | BEG', description: 'Managed payroll for e-commerce. State Payroll Compliance Issues. $25-$45 PEPM all-inclusive. Book a free 15-min discovery call at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
