...
export const metadata: Metadata = {
  title: 'Does Maine Require Paid Sick Leave? | BEG',
  description: 'Does Maine mandate paid sick leave? What a compliant policy needs, plus FMLA basics and how HR outsourcing keeps it current.',
  alternates: { canonical: 'https://www.beghr.com/blog/hr-outsourcing/leave/maine-paid-sick-leave-explained' },
  openGraph: {
    title: 'Does Maine Require Paid Sick Leave? | BEG',
    description: 'Does Maine mandate paid sick leave? What a compliant policy needs, plus FMLA basics and how HR outsourcing keeps it current.',
    url: 'https://www.beghr.com/blog/hr-outsourcing/leave/maine-paid-sick-leave-explained',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://www.beghr.com/blog-images/blog-hr-outsourcing-leave-maine-paid-sick-leave-explained.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Does Maine Require Paid Sick Leave? | BEG', description: 'Does Maine mandate paid sick leave? What a compliant policy needs, plus FMLA basics and how HR outsourcing keeps it current.', images: ['https://www.beghr.com/blog-images/blog-hr-outsourcing-leave-maine-paid-sick-leave-explained.webp'] },
};

const faqs = [

  {
    question: 'Does Maine require paid sick leave?',
    answer: 'Yes. Maine requires covered employers to provide a compliant paid sick leave policy, including accrual, carryover, permitted uses, and notice procedures. Confirm current accrual rates and caps with the state labor office.',
  },
  {
  ...
  {
    question: 'How is paid sick leave different from Maine&apos;s Paid Family and Medical Leave program?',
    answer: 'Paid sick leave covers short, employee-driven absences and is usually employer-funded. Maine&apos;s Paid Family and Medical Leave program has separate funding, eligibility, and longer duration for events like bonding or serious health conditions. Confirm current dates with the state labor office.',
  },
  {
...
export default function Page() {
  return (
    <article className="blog-post">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Does Maine Require Paid Sick Leave?","description":"Does Maine mandate paid sick leave? What a compliant policy needs, plus FMLA basics and how HR outsourcing keeps it current.","datePublished":"2026-07-06","dateModified":"2026-07-06","author":{"@type":"Person","name":"Anthony Moretti","jobTitle":"VP of Sales","url":"https://www.linkedin.com/in/theanthonymoretti"},"publisher":{"@type":"Organization","name":"Business Executive Group","logo":{"@type":"ImageObject","url":"https://www.beghr.com/assets/beg-header-image.png"}},"mainEntityOfPage":"https://www.beghr.com/blog/hr-outsourcing/leave/maine-paid-sick-leave-explained"}` }} />
        ...
        <div className="container">
          <div className="hero-split">
            <div className="hero-split-text">
              ...
              <h1>Does Maine Require Paid Sick Leave?</h1>
      ...
      <section className="container" style={{ maxWidth: '840px', lineHeight: '1.6' }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.93rem' }}>
            <thead>
              <tr style={{ background: '#000', color: '#fff' }}>
                ...
                <th style={{ padding: '0.75rem', textAlign: 'left' }}>Maine status</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                ["Multi-state/remote employees", "N/A", "May trigger another state&apos;s paid sick leave law even if Maine does not require it"],
        ...
        <div style={{ background: '#ECAC60', color: '#000000', padding: '2rem', borderRadius: '8px', textAlign: 'center', margin: '2rem 0' }}>
          <h3 style={{ color: '#000000', margin: 0 }}>Leave Policy Built for Maine, Not a Generic Template</h3>
        ...
        <div className="faq" style={{ marginTop: '1rem' }}>
            <div key={0} className="faq-item">
              <h3>Does Maine require paid sick leave?</h3>
              <p>Yes. Maine requires covered employers to provide a compliant paid sick leave policy, including accrual, carryover, permitted uses, and notice procedures. Confirm current accrual rates and caps with the state labor office.</p>
            </div>
            ...
            <div key={2} className="faq-item">
              <h3>How is paid sick leave different from Maine&apos;s Paid Family and Medical Leave program?</h3>
              <p>Paid sick leave covers short, employee-driven absences and is usually employer-funded. Maine&apos;s Paid Family and Medical Leave program has separate funding, eligibility, and longer duration for events like bonding or serious health conditions. Confirm current dates with the state labor office.</p>
            </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Does Maine require paid sick leave?","acceptedAnswer":{"@type":"Answer","text":"Yes. Maine requires covered employers to provide a compliant paid sick leave policy, including accrual, carryover, permitted uses, and notice procedures. Confirm current accrual rates and caps with the state labor office."}},{"@type":"Question","name":"Is paid sick leave the same as FMLA?","acceptedAnswer":{"@type":"Answer","text":"No. FMLA is a federal, unpaid, job-protected leave for eligible employees at covered employers, while paid sick leave (where required) is a separate, typically employer-funded benefit for shorter absences."}},{"@type":"Question","name":"How is paid sick leave different from Maine's Paid Family and Medical Leave program?","acceptedAnswer":{"@type":"Answer","text":"Paid sick leave covers short, employee-driven absences and is usually employer-funded. Maine's Paid Family and Medical Leave program has separate funding, eligibility, and longer duration for events like bonding or serious health conditions. Confirm current dates with the state labor office."}},{"@type":"Question","name":"What should a compliant policy document?","acceptedAnswer":{"@type":"Answer","text":"Accrual method, carryover rules, permitted uses, a reasonable documentation standard, and a notice procedure employees can follow, all confirmed against current state guidance rather than assumed from a generic template."}},{"@type":"Question","name":"Is this a PEO?","acceptedAnswer":{"@type":"Answer","text":"No. There is no co-employment and no employer-of-record change. Your company stays the employer; certified HR professionals support your team. HR outsourcing, powered by isolved."}}]}`,
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.beghr.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://www.beghr.com/blog"},{"@type":"ListItem","position":3,"name":"HR Outsourcing","item":"https://www.beghr.com/blog/hr-outsourcing"},{"@type":"ListItem","position":4,"name":"Does Maine Require Paid Sick Leave?","item":"https://www.beghr.com/blog/hr-outsourcing/leave/maine-paid-sick-leave-explained"}]}`,
        }}
      />
