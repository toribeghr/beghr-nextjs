...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.beghr.com/blog-images/blog-compare-beg-vs-robert-half.webp', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'BEG vs Robert Half | Instant Fee Quote | BEG', description: 'BEG vs Robert Half on permanent placement: fee model, cost, and speed compared fairly. See where milestone-based placement saves roughly 50%.', images: ['https://www.beghr.com/blog-images/blog-compare-beg-vs-robert-half.webp'] },
};
  ...
  return (
    <article className="blog-post">
      ...
      <section className="container" style={{ maxWidth: "980px", marginTop: "0.5rem" }}>
        <img src="/blog-images/blog-compare-beg-vs-robert-half.webp" alt={`Business professionals comparing options on a laptop in a modern office`} width={1344} height={768} style={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
      </section>
