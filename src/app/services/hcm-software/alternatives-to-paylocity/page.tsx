...
export const metadata: Metadata = {
  title: 'Best Paylocity Alternative | iSolved + Claude AI | BEG',
  ...
  alternates: { canonical: 'https://beghr.com/services/hcm-software/alternatives-to-paylocity' },
  openGraph: {
    title: 'Best Paylocity Alternative | iSolved + Claude AI | BEG',
    description: 'Looking for a Paylocity alternative? Compare iSolved, managed by BEG, for companies with 50 to 500 employees. Smooth implementation, Claude AI, and 330% ROI.',
    url: 'https://beghr.com/services/hcm-software/alternatives-to-paylocity',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Best Paylocity Alternative | iSolved + Claude AI | BEG', description: 'Looking for a Paylocity alternative? Compare iSolved, managed by BEG, for companies with 50 to 500 employees. Smooth implementation, Claude AI, and 330% ROI.', images: ['https://beghr.com/assets/og-image.png'] },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. iSolved is the only HCM platform with a Connector for Claude, generally available in June 2026, that completes real HR tasks through a conversation. Paylocity has no equivalent.',
  },
];
...
export default function AlternativesToPaylocityPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Alternatives to Paylocity', item: 'https://beghr.com/services/hcm-software/alternatives-to-paylocity' },
    ],
  };
