...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'FLSA Overtime Rules for Small Business Owners | BEG', description: 'FLSA Overtime Rules for Small Businesses. Expert guidance from BEG managed payroll. Get instant payroll pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
