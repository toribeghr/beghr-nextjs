...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'North Carolina Termination Final Paycheck Rules (2026)', description: 'North Carolina termination and final paycheck rules for 2026: at-will basics, timing, documentation, and how HR outsourcing keeps it compliant.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
