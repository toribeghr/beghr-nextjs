...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Hawaii Minimum Wage 2026: What Employers Must Know | BEG', description: 'Hawaii minimum wage 2026 is $16.00 per hour. See overtime rules, TDI requirements, and what it means for payroll compliance in Hawaii this year.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
