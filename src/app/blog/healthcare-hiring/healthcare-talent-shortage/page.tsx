...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://beghr.com/blog/healthcare-hiring/healthcare-talent-shortage' },
  openGraph: {
    title: 'The Healthcare Talent Shortage in 2026 | BEG',
    description: 'Clinician retirements are up and the pipeline is thin. What the 2026 healthcare shortage means for hiring and how to fill roles in 23-35 days anyway.',
    url: 'https://beghr.com/blog/healthcare-hiring/healthcare-talent-shortage',
    siteName: 'Business Executive Group',
    images: [{ url: 'https://beghr.com/assets/og-image.png', width: 1200, height: 630, alt: 'Business Executive Group' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'The Healthcare Talent Shortage in 2026 | BEG', description: 'Clinician retirements are up and the pipeline is thin. What the 2026 healthcare shortage means for hiring and how to fill roles in 23-35 days anyway.', images: ['https://beghr.com/assets/og-image.png'] },
};
