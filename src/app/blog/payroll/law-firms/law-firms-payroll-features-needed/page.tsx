...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Law Firm Payroll Features: What You Actually Need | BEG', description: 'Managed payroll for law firms. Payroll Features Every Business Needs. $25-$45 PEPM all-inclusive. Get instant pricing at beghr.com.', images: ['https://www.beghr.com/assets/og-image.png'] },
};
